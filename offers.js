var Offers = {
        ...
        ajax.post('offers.php', params, {
            onDone: function(text, secret, offerId, deleteHash) {
                ...
                if (offerId) {
                    ...
                    each(links, function() {
                        this.href = (this.href || '')
                            .replace(/offer_id=([0-9]+)/, 'offer_id=' + offerId);
                    });
                }
            },
    ...
    addToBanBox: function(type, offer_id) {
        ...
        ge('offers_ban_box_input')
            .setAttribute('placeholder', getLang('offers_' + type + '_input'));
        cur.options.banType = type;
        cur.banBox = showFastBox(title, ge('offers_ban_box')
