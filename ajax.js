...
var ajaxHistory = $ah = new(function() {
    ...
    var getHash = function() {
        ...
        try {
            var hash = ge('ahFrame')
                .contentWindow.document.location.search.match(/ahHash=(.*)$/);
    ...
    _t.init = function() {
        ...
        if (isIE()) {
            ...
            document.body.innerHTML += "<iframe id='ahFrame' style='position:absolute;left:-1000px;width:0;height:0' src='/blank.html?ahHash=" + initHash +
                "'></iframe>";
            frame = ge('ahFrame');
