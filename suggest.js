var SuggestNoAjax = function(rootEl, q, formEl, textBoxEl, idEl, successHandler, instructions, suggestNames, suggestIDs, suggestLocs, placeholderText, defaultOptions,
    showNoMatches, positionEl) {
    ...
    this.init = function() {
        oThis.typeAheadObj = new TypeAhead(rootEl, formEl, textBoxEl, idEl, defaultOptions, instructions, 1, successHandler, this.onInputChange, null, null, null,
            placeholderText, showNoMatches, false, positionEl);
