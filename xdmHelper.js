...
(function(w) {
    ...
    try {
        ...
        var flash = axo.GetVariable('$version')
            .split(' ')[1].split(',');
    } catch (e) {
        var flash = [0];
    }
    ...
    if ((flash[0] < 10 || supportsNIX()) && "ActiveXObject" in w && "execScript" in w) {
        ...
        function addSwf(lcName, isClient) {
            ...
            fobj.outerHTML =
                '<object style="position: fixed; top: 0px; left: 0px;" id="_fxdm_fl" classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,0,0" width="1" height="1">\
      ...
      <embed type="application/x-shockwave-flash" swLiveConnect="true" FlashVars="' +
