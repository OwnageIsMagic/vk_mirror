var photos = {
    ...
    scrollResize: function() {
        ...
        var lnk = ge('photos_load_more'),
            albums_lnk = ge('albums_load_more');
    ...
    privacy: function(key) {
        ...
        if (el.helper) {
            ...
            if (sz[0] != el.w || sz[1] != el.h) {
                setStyle(el.helper, {
                    width: sz[0],
                    height: sz[1] - ge('photos_container')
                        .sorter.dh
                });
                extend(el, {
    ...
    saveAlbum: function() {
        ...
        ajax.post('al_photos.php', params, {
            onDone: function() {
                ...
                if (ge('photos_container')
                    .sorter) {
                    sorter.update(ge('photos_container')
                        .sorter.elems[0]);
                }
            },
    ...
    savePhotos: function() {
        ...
        for (var el = cont.firstChild; el; el = el.nextSibling) {
            ...
            params['photo_desc' + i] = ge('photo_caption' + id)
                .value;
            ++i;
        }
        ajax.post('al_photos.php', params, {
    ...
    deletePhoto: function(photo, hash) {
        ajax.post('al_photos.php', {
            ...
            onDone: function(text) {
                ...
                if ((ge('photos_container') || ge('photos_add_list'))
                    .sorter) {
...
<form target="photo_frame' + i + '" id="photo_form' + i + '" method="POST" action="' +
    ...
    onUploadSelect: function(files) {
        ...
        var back = ge('photos_upload_area')
            .innerHTML;
        ge('photos_upload_area')
            .innerHTML = '<img src="/images/upload.gif">';
        nav.go(ge('photos_upload_area')
            .href + '&html5=1', false, {
                onFail: function(text) {
                    ge('photos_upload_area')
                        .innerHTML = back;
