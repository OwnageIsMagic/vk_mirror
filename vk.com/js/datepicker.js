(function() {
    ...
    var ebrowse_dayname_length = getLang('events_mon')
        .length;
        ...
        var getMonth = function(m, y, noheight) {
            ...
            switch (mode) {
                ...
                default:
                    ...
                    var month_year = month_format.replace('{month}', mn[m - 1])
                        .replace('{year}', y);
                    ...
                    t.push(disabled ? '<td class="monthArr"><span class="monthArrow">' + larr + '</span></td>' : '<td class="monthArr"><a class="monthArrow" href="">' +
                        larr + '</a></td>');
                    t.push('<td colspan="5" align="center" class="month">' + month_year + '</td>');
                    t.push(disabled ? '<td class="monthArr"><span class="monthArrow">' + rarr + '</span></td></tr><tr>' :
                        '<td class="monthArr"><a class="monthArrow" href="">' + rarr + '</a></td></tr><tr>');
                    for (var s = 0; s < 7; s++) {
    ...
    window.DatePicker = function(params) {
        ...
        var update = function(date, mode, init) {
            ...
            if (mode == 'h') {
                ...
                if (mode == "m") {
                    ...
                    dateInput.value = month_format.replace('{month}', ebrowse_mn[date.m - 1] || '')
                        .replace('{year}', date.y);
                } else {
        ...
        calendarBox.innerHTML = "<iframe id='calendarFrame" + rnd + "' style='border:0;position:absolute;z-index:100;'></iframe><div id='calendarDiv" + rnd +
            "' style='position:absolute;z-index:200'></div>";
