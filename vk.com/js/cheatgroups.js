...
function doNotChangePassSuccess(ajaxObj, responseText) {
    ge('spam' + ajaxObj.gid)
        .innerHTML = '';
    ge('phish' + ajaxObj.gid)
        .innerHTML = '';
    ge('virus' + ajaxObj.gid)
        .innerHTML = '';
    ge('donottouch' + ajaxObj.gid)
        .innerHTML = '';
    ge('progrid' + ajaxObj.gid)
        .innerHTML = responseText;
}
...
function goodGroupSuccess(ajaxObj, responseText) {
    ge('inv' + ajaxObj.gid)
        .innerHTML = responseText;
    ge('good' + ajaxObj.gid)
        .innerHTML = "<a href=\"javascript:badGroup(" + ajaxObj.gid + ", '" + ajaxObj.hash + "')\">��� ��� �� ��������...</a>";
    ge('todelete' + ajaxObj.gid)
        .innerHTML = "";
}
...
function toDeleteSuccess(ajaxObj, responseText) {
    ge('inv' + ajaxObj.gid)
        .innerHTML = responseText;
    ge('todelete' + ajaxObj.gid)
        .innerHTML = "<a href=\"javascript:doNotDelete(" + ajaxObj.gid + ", '" + ajaxObj.hash + "')\">��� �� �� ��������...</a>";
    ge('good' + ajaxObj.gid)
        .innerHTML = "";
}
...
function doNotDeleteSuccess(ajaxObj, responseText) {
    ge('inv' + ajaxObj.gid)
        .innerHTML = responseText;
    ge('todelete' + ajaxObj.gid)
        .innerHTML = "<a href=\"javascript:toDelete(" + ajaxObj.gid + ", '" + ajaxObj.hash + "')\">�� ��������</a>";
    ge('good' + ajaxObj.gid)
        .innerHTML = "<a href=\"javascript:goodGroup(" + ajaxObj.gid + ", '" + ajaxObj.hash + "')\">�� ��������</a>";
}
...
function viewVideoTextSuccess(ajaxObj, responseText) {
    ...
    ge('button1')
        .innerHTML = "�������";
    ge("boxTitle")
        .innerHTML = "�������� � �������� ����� <a href='id" + ajax.mid + "'>id" + ajax.mid + "</a>";
    ge("boxMessage")
        .innerHTML = json.message;
    showBoxOld(function() {
        hideBox();
