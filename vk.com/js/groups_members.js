...
function editOfficer(mid, gid, hash, name) {
    ...
    position = position ? position.innerHTML.replace(/'/g, "&#39;")
        .replace(/"/g, "&quot;") : '';
    officerBox.content('<table cellpadding="0"><tr><td valign="top" style="padding: 3px 15px 0px 15px">' + groups_enter_post +
        '<td><td valign="top"><input type="text" style="width: 182px" id="position" value="' + position +
        '"><br/><div style="margin-top: 2px"><input type="hidden" id="isAdmin"></div></td></tr></table>');
    var uiIsAdmin = new Checkbox(ge('isAdmin'), {
        width: 150,
        checked: ge('isAdmin' + mid)
            .value,
...
function appointMember(mid, gid, hash, name) {
    ...
    appointMB.content('<table cellpadding="0"><tr><td valign="top" style="padding: 3px 15px 0px 15px">' + groups_enter_post +
            '<td><td valign="top"><input type="text" style="width: 182px" id="position' + mid +
            '" value=""><br/><div style="margin-top: 2px"><input type="hidden" id="isAdminAppoint' + mid + '"></div></td></tr></table><div id="appointError"></div>')
        .show();
