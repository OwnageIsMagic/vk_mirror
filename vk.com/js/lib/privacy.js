...
var privacyBox = {
    ...
    toggle: function(pref) {
        ...
        if (ge(this.pref + 'cat')
            ...
            if (ge(this.pref + 'fgContainerEx')) ge(this.pref + 'fgContainerEx')
                .style.display = "";
            ge(this.pref + 'fgContainer')
                .innerHTML = this.getCats(ge(this.pref + 'cat')
                    .value);
            ge(this.pref + 'cat')
                .checked = 'checked';
        } else {
    ...
    change: function(pref) {
        ...
        for (var i = 1; i < len; i++) {
            ...
            vlist += "<div class='FV" + this.numToColor(i) + on + "' id='" + i + "VOption'><a id='" + i + "vtxt' href='javascript:privacyBox." + de + "vColor(" + i + ")'>" +
                catNames[i] + "</a></div>";
            vlist += "</td></tr>";
        }
                ...
                .addButton({
                    ...
                    onClick: function() {
                        ...
                        if (ge(p + 'cat')
                            .value > 0) {
                            show(p + 'fgContainer');
                            if (ge(p + 'fgContainerEx')) ge(p + 'fgContainerEx')
                                .style.display = "";
                            ge(p + 'fgContainer')
                                .innerHTML = privacyBox.getCats(ge(p + 'cat')
                                    .value);
                            ge(p + 'cat')
                                .checked = 'checked';
                        } else {
    ...
    vColor: function(num) {
        ...
        ge(num + 'VOption')
            .className = "FV" + color + "On";
        ge(num + 'vcheck')
            .className = "vcheck";
        var word = ge(num + 'vtxt')
            .innerHTML;
        ge(num + 'VOption')
            .innerHTML = "<a id='" + num + "vtxt' href='javascript:privacyBox.devColor(" + num + ")'>" + word + "</a>";
        ge(this.pref + 'cat')
            .value |= (1 << num);
    ...
    devColor: function(num) {
        ...
        var word = ge(num + 'vtxt')
            .innerHTML;
        ge(num + 'VOption')
            .innerHTML = "<a id='" + num + "vtxt' href='javascript:privacyBox.vColor(" + num + ")'>" + word + "</a>";
        ge(this.pref + 'cat')
            .value &= ~(1 << num);
    ...
    submit: function(btn, form, prefs) {
        ...
        for (var i in prefs) {
            var pref = prefs[i];
            if (ge(pref + 'cat') != null && ge(pref + 'cat')
                .checked) {
                ge(pref + 'cat')
                    .value = -ge(pref + 'cat')
                    .value;
