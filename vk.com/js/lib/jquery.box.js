...
(function($) {
    ...
    FadeBox = function(options) {
        ...
        boxBG = $('<div id="fadeBoxBG" style="display:none"></div>')
            .appendTo('body');
        boxContainer = $('<div id="fadeBoxContainer" style="display:none"></div>')
            .insertAfter(boxBG);
        boxLayout = $('<div id="boxLayout"></div>')
            .appendTo(boxContainer);
        boxTitle = $('<div id="boxTitle"></div>')
            .appendTo(boxLayout)
            .wrap('<div id="boxTitleWrap"></div>');
        boxBody = $('<div id="boxBody"></div>')
            .appendTo(boxLayout);
        boxControls = $('<div id="boxControls"></div>')
            .appendTo(boxLayout);
        ...
        function addButton(options) {
            ...
            var button = $('<div></div>')
                .prependTo(boxControls)
                .wrap('<div id="button' + buttonsCount + '" class="buttonWrap ' + options.style + '"></div>');
