...
function ToolBar(a, b, c) {
    ...
    this.editor = a;
    ge("editor_toggle");
    if (b == "simple") this.toolbarButtons = c && c.simpleToolBar ? c.simpleToolBar :
        "bold,italic,gray,underline,strike,sub,sup,left,center,right,marker_list,numeric_list,outdent,indent,h1,h2,h3,image,link,unlink";
    else if (b == "extended") {
...
function Wysiwyg(a) {
    ...
    this.choosePhotoBox.addControlsText(
...
Wysiwyg.prototype = {
    ...
    getFrameDoc: function(a) {
        return a.contentDocument ? a.contentDocument : this.getFrameWin(a)
            .document
    },
    writeFrameContent: function(a) {
        ...
        a.write(
            ...
            this.params.contentCSS +
            '" type="text/css" /><base href="http://vkontakte.ru/" /></head><body spellcheck="false" class="editor_body"><p>\ufeff</p></body></html>');
        a.close()
    },
    ...
    formatText: function() {
        this.getRangeContainer()
            .nodeName == "BODY" && this.frameDoc.execCommand("FormatBlock", false, "<P>")
    },
    ...
    photoBoxInit: function() {
        var a = this.photoBox;
        this.extendObj(a, ["pb_photo_preview", "pb_photo_view", "pb_photo_url", "pb_photo_width", "pb_photo_height", "openPhotoAlbums", "pb_photo_id", "pb_photo_text",
            "pb_error"
        ]);
        a.saveRatio =
    ...
    testPhotoSetupError: function(a) {
        ...
        else if (trim(b.pb_photo_text.value) != "" && !/^[\s0-9a-z\u0430-\u044f\u0451:\.,_-]+$/i.test(trim(b.pb_photo_text.value))) c = [8,
            wiki_err_forbidden_chars_in_photo_text
        ];
        else if (trim(b.pb_photo_url.value) != "" && !/^[\s0-9a-z\u0430-\u044f\u0451=#\?:\/\.,_-]+$/i.test(trim(b.pb_photo_url.value))) c = [9,
    ...
    actTableActions: function(a) {
        ...
        if (a == "delete_row") {
            ...
            if (d.rows[0].cells.length == 1) this.alertBox(wiki_warning, getLang("wiki_col_width"), box_yes, box_cancel, function() {
                ...
                var l = "";
                if (a != null && a.getAttribute("width") != null) l = a.getAttribute("width")
                    .substr(0, a.getAttribute("width")
                        .length - 1);
                ...
                if (typeof widthAlertBox === "undefined") {
                    ...
                    widthAlertBox.addButton({
                        onClick: function() {
                            j(false, ge("col_width_input")
                                .value);
                            widthAlertBox.hide()
                        },
                        label: "\u0421\u043e\u0445\u0440\u0430\u043d\u0438\u0442\u044c"
                    });
                    widthAlertBox.content(
                        "\u0417\u0430\u0434\u0430\u0439\u0442\u0435 \u0448\u0438\u0440\u0438\u043d\u0443 \u0441\u0442\u043e\u043b\u0431\u0446\u0430: <input type='text' id='col_width_input' maxlength = '3' size = '3' value = '" +
                        l + "'>&nbsp;<b>%</b>")
                } else {
                    ge("col_width_input")
                        .value = l;
    ...
    tableBoxChange: function(a) {
        ...
        a.getElementsByTagName("TH")
            .length != 0 ? b.showHeader.checked(true) : b.showHeader.checked(false);
        c = a.rows.length;
    ...
    allowTableActions: function(a) {
        for (var b = ["table_delete", "insert_row_before", "insert_row_after", "insert_col_before", "insert_col_after", "delete_row", "delete_col", "col_width"], c = 0; c <
            b.length; c++)
    ...
    insertLink: function(a) {
        var b = this.linkBox,
            ...
            e = false;
        if (ge("container1") && ge("container1")
            .needBox) e = ge("container1")
            .needBox.checked();
        ...
        if (e) {
            e = null;
            if (e = c.match(/(vkontakte\.ru|vk\.com)\/pages.php\?o=-(\d+)&p=(.*)/i)) c = "javascript:wikiBox.loadPage(" + e[2] + ", '" + decodeURIComponent(e[3]) +
                "').show();";
        ...
        Ajax.Post({
            ...
            onDone: function(c, d) {
                ...
                if (a) a.call(this, f);
                    ...
                    this.frameWin.focus();
                    browser.msie ? this.getRange()
                        .pasteHTML(f) : this.frameDoc.execCommand("InsertHtml", false, f)
                }
                this.timer = setTimeout(function() {
                    this.timer = null
                }.bind(this), 1E3)
                ...
                if (h != null)
                    for (g = 0; g < h.length; g++) {
                        ...
                        if (!/\|.*?nolink.*?\|/i.test(h[g])) {
                            i = ["id[1-9][0-9]*", "club[1-9][0-9]*", "photo-?[0-9]+_[0-9]+", "video-?[0-9]+_[0-9]+", "topic", "page(-?[0-9]+_)?[0-9]+", "event[1-9][0-9]*",
                                "http://"
                            ];
    ...
    htmlReplaceLinks: function() {
        for (var a = this.frameDoc.getElementsByTagName("A"), b = "", c = 0; c < a.length; c++) {
            b = this.decURI(a[c].href)
                .replace(/&amp;/gi, "&");
            var d = b.replace(this.vk, "")
                .replace(this.vkcom,
                    "");
