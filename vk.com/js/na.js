...
function do_change_mail(use_old_mail) {
    ...
    if (use_old_mail !== 1) {
        ...
        resend_box.content('<div class="box_loader"></div>')
            .show();
    }
        ...
        onSuccess: function(obj, text) {
            ...
            if (response.error) {
                ...
                if (window.winBoxes.change_mail) {
                    ...
                    window.winBoxes.change_mail.removeButtons()
                        .addButton({
                            label: getLang('box_close'),
                ...
                ge('please_confirm_mail')
                    .innerHTML = response.please;
            }
        },
...
function show_change_mail_box(on_hide) {
    if (!window._please_box) {
        ...
        window._please_box.content(ge('please_confirm_mail')
            .innerHTML);
    }
