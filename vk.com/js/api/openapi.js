        ...
        VK.Api = {
            ...
            checkMethod: function(method, params, cb, queryTry) {
                ...
                if (m == 'wall.post' || m == 'activity.set') {
                    ...
                    var query = VK._protocol + '//vk.com/al_apps.php?act=wall_post_box&widget=1&method=' + m + '&aid=' + parseInt(VK._apiId, 10) + '&text=' +
