var Exchange = {
    initOfficesMenu: function(e) {
        ...
        if (window.DropdownMenu && cur.mainNavigationOfficesItems && !cur.navigationOficesMenu) {
            ge("ads_navigation_offices_menu")
                .removeAttribute("onmouseover");
            var a = "";
            a = -1 != location.hash.indexOf("#/") || -1 != location.hash.indexOf("#!") ? location.hash.replace("#/", "")
            ...
            for (var i in cur.mainNavigationOfficesItems) {
                ...
                var u = "/exchange?act=office" + r,
                    d = !1;
                o ? cur.getOfficeLink ? u = cur.getOfficeLink(n) : a.match(/act=budget(&|$)/) ? u = "/exchange?act=budget" + r : a.match(/act=export_stats(&|$)/) ? u =
                    "/exchange?act=export_stats" + r : a.match(/act=settings(&|$)/) && (u = "/exchange?act=settings" + r) : (u = "/exchange?act=office", d = function(e) {
                        return t(), showWiki({
                            w: "new_ad_union",
                            create: 1
                        }, !1, e, {
            ...
            var h = {
                title: '<span id="ads_navigation_dd_menu_header_text">' + ge("ads_navigation_offices_menu_text")
                    .innerHTML + "</span>",
    ...
    initScroll: function() {
        Exchange.scrollnode = browser.msie6 ? pageNode : window, Exchange.deinitScroll(), window.scrollTop = bodyNode.scrollTop = pageNode.scrollTop = htmlNode.scrollTop =
            0, addEvent(Exchange.scrollnode, "scroll", Exchange.scrollCheck), addEvent(window, "resize", Exchange.scrollCheck)
    },
    ...
    updateCommunitySearch: function(e, t, a, n) {
        e = e || ge("exchange_search_input"), t = t || 10, void 0 != a && (cur.searchSortRev = cur.searchSortRev || cur.searchSortBy != a && "cost" != a ? 0 : 1, cur.searchSortBy =
            a), n || (cur.searchOffset = 0), clearTimeout(cur.searchTimeout), cur.searchTimeout = setTimeout(function() {
    ...
    searchCommunity: function() {
        ...
        ajax.post("/exchange?act=community_search" + (cur.post_id ? "&ad_id=" + cur.post_id : "&union_id=" + cur.union_id), e, {
            ...
            onDone: function(t, a) {
                ...
                if (e.offset > 0) {
                    var o = ge("exchange_comm_search_table")
                        .tBodies[0];
                    if (t) {
                        if (browser.msie) {
                ...
                } else ge("exchange_comm_search_table")
                    .innerHTML = t, cur.searchOffset = 0;
    ...
    getPage: function(e, t) {
        ...
        return delete a[0], ajax.post(n, extend(a, {
            ...
            onDone: function(a) {
                ge(t || "exchange_requests_table_wrap")
                    .innerHTML = a, nav.setLoc(extend(nav.objLoc, {
                        offset: e
                    }))
            }
        }), !1
    ...
    deleteRequest: function(e, t, a, n, o, r) {
        ...
        var i = r ? 370 : 430,
            s = function() {
                ajax.post("/exchange", {
                    ...
                    onDone: function() {
                        curBox()
                            .hide(), re("exchange_request" + a), Exchange.reArrangeRows("exchange_request_row")
                    },
                    onFail: function(e) {
                        return ge("exchange_box_error")
                            .innerHTML = e, show("exchange_box_error"), !0
                    }
                })
            };
        ...
        showFastBox({
                ...
                bodyStyle: c,
                hideButtons: r
            }, '<div id="exchange_box_error" class="error" style="display: none;"></div><div>' + getLang("ads_posts_sure_delete_text") +
            '</div><div id="exchange_box_comment_wrap" class="clear_fix" style="display:none;"><textarea id="exchange_box_comment" placeholder="' + getLang(
                "ads_posts_delete_placeholder") +
            '" onkeypress="onCtrlEnter(event, cur.doDeleteRequest)"></textarea><div class="exchange_box_send_wrap button_blue fl_r"><button id="exchange_box_send" onclick="cur.doDeleteRequest()">' +
            getLang("ads_posts_delete") + "</button></div></div>", getLang("ads_posts_delete"), s, getLang("global_cancel"));
    ...
    sendRequest: function(e, t, a, n, o, r) {
        return ajax.post("/exchange", {
            ...
            onFail: function(e) {
                return ge("exchange_request_box_error")
                    .innerHTML = e, show("exchange_request_box_error"), !0
            }
        }), !1
    },
    ...
    editPost: function() {
        return this.showMsg(getLang("ads_posts_edit_notice")), cur.startedEditingPost = !1, cur.exchangeCheckEditPostTimer = setInterval(function() {
            cur.editingPost && !cur.startedEditingPost ? cur.startedEditingPost = !0 : !cur.editingPost && cur.startedEditingPost && (cur.startedEditingPost = !1,
                Exchange.updatePostActions(), cur.exchangeCheckEditPostTimer && (clearInterval(cur.exchangeCheckEditPostTimer), cur.exchangeCheckEditPostTimer =
                    null))
    ...
    archivePost: function(e, t, a, n) {
        var o = function(e, t, a) {
            addClass("exchange_info_archive", "loading"), ajax.post("/exchange", {
                ...
                onDone: function(e) {
                    ge("exchange_info_archive") && (ge("exchange_info_archive")
                        .innerHTML = e), toggle("exchange_info_actions", 2 != t), toggle("exchange_info_in_archive", 2 == t)
                },
            ...
            n && (u = extend(u, n)), ajax.post("/exchange?act=a_change_status", u, {
                onDone: function(e, t) {
                    if (s && s.onDone) s.onDone(e), s.hide();
                        ...
                        s && s.hide();
                        var a = ge("exchange_info_status")
                            .parentNode.parentNode;
                        ge("exchange_status_btn")
                            .parentNode.parentNode.innerHTML = e, t ? (ge("exchange_info_status")
                                .innerHTML = t, show(a)) : hide(a)
                    }
                },
                onFail: function(e) {
    ...
    createUnion: function(e, t) {
        return ajax.post("/exchange?act=a_new_union", {
            ...
            onFail: function(e) {
                return e && (ge("exchange_new_union_error")
                    .innerHTML = e, show("exchange_new_union_error")), !0
            }
        }), !1
    },
    ...
    createClient: function(e, t) {
        ...
        return a ? void ajax.post("/exchange?act=a_create_client", {
            ...
            onFail: function(e) {
                return curBox() && Exchange.showError(e, curBox()
                    .bodyNode), !0
            }
    ...
    changePeriod: function(e, t) {
        if (!cur.loadingPeriod) {
            ...
            delete a[0], ajax.post("/exchange", extend(a, {
                ...
                onDone: function(e, t) {
                    ge("exchange_clients_list")
                        .innerHTML = e, ge("exchange_stats_period_tabs")
                        .innerHTML = t
                }
            })
        }
    ...
    initExportStats: function(e, t, a, n) {
        cur.topUnionId = e, cur.watchControls = t, cur.unionCreatedDate = a, cur.exportStatsHash = n, cur.storedDate = {}, Ads.getNamespace("exchange_export_stats")
            .stats_period.options.onSelect = Exchange.onExportStatsPeriodChanged
    },
    ...
    submitExportStatsForm: function() {
        ...
        var e = 0 == Ads.getNamespace("exchange_export_stats")
            .export_method.value,
        ...
        if (e) {
            ...
            r.start_time = cur.exportParamsData.start_time.year + ("0" + cur.exportParamsData.start_time.month)
                .slice(-2) + ("0" + cur.exportParamsData.start_time.day)
                .slice(-2), r.end_time = cur.exportParamsData.stop_time.year + ("0" + cur.exportParamsData.stop_time.month)
                .slice(-2) + ("0" + cur.exportParamsData.stop_time.day)
                .slice(-2), r.dwcookie = n, r.hash = cur.exportStatsHash, ajax.post("/exchange?act=get_export_stats" + t, r, {
                    onDone: function(e) {
                        ge("exchange_stats_content")
                            .innerHTML = e
                    },
                    onFail: function(e) {
                        return showFastBox({
            ...
            s.appendChild(ce("input", {
                type: "hidden",
                name: "start_time",
                value: cur.exportParamsData.start_time.year + ("0" + cur.exportParamsData.start_time.month)
                    .slice(-2) + ("0" + cur.exportParamsData.start_time.day)
                    .slice(-2)
            })), s.appendChild(ce("input", {
                type: "hidden",
                ...
                type: "hidden",
                name: "end_time",
                value: cur.exportParamsData.stop_time.year + ("0" + cur.exportParamsData.stop_time.month)
                    .slice(-2) + ("0" + cur.exportParamsData.stop_time.day)
                    .slice(-2)
            })), s.appendChild(ce("input", {
                type: "hidden",
    ...
    createExportSubmitButton: function(e) {
        cur.exportExchangeStatButton = e, (new Image)
            .src = "/images/upload_inv.gif", createButton(e, function() {
