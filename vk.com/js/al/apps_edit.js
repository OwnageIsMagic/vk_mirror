var AppsEdit = {
    ...
    switchSection: function(section) {
        ajax.post("editapp", {
            ...
            onDone: function(content, script) {
                hide("apps_edit_progress"), ge("app_edit_wrap")
                    .innerHTML = content, script && eval(script), AppsEdit.hideError(), nav.setLoc(extend(nav.objLoc, {
                        section: section
    ...
    saveOptions: function(e, t) {
        ...
        ajax.post("editapp", a, {
            onDone: function(t, a, s) {
                if (r(), hide("apps_options_saved"), ge("apps_edit_error_text") && hide("apps_edit_error_text"), "confirm" == t) showFastBox(a, s, getLang(
                    "global_continue"), function() {
                    curBox()
                        .hide(), AppsEdit.saveOptions(e, !0)
                    ...
                    s.titleNotice && (ge("app_name_notice")
                        .innerHTML = s.titleNotice, show("app_name_notice"), s.titleHide ? (addClass("app_name", "apps_edit_input_readonly"), ge("app_name")
                            .readOnly = !0) : (removeClass("app_name", "apps_edit_input_readonly"), ge("app_name")
                            .readOnly = !1));
    ...
    deleteSWF: function(e, t, a) {
        ...
        var s, i = function() {
                s.showProgress(), ajax.post("editapp", {
                    ...
                    onDone: function(t) {
                        s.hideProgress(), s.content(t), s.removeButtons(), s.addButton(getLang("global_close"), s.hide), setTimeout(s.hide, 2e3), re(
                            "apps_edit_swf_" + e);
            ...
            onUploadProgress: function(e, t, a) {
                if (!ge("form" + e + "_progress")) {
                    ...
                    s.appendChild(ce("div", {
                        innerHTML: '<div class="apps_info_progress_wrap">          <div id="form' + e +
                            '_progress" class="apps_upload_progress" style="width: 0%;"></div>        </div></div>',
    ...
    ssOver: function(e) {
        ...
        if (!t) {
            var t = se('<div class="apps_edit_screen_close" onmouseover="showTooltip(this, {black: 1, text: \'' + cur.remove_screenshot +
                "', shift: [12, 2, 0], forcetoup: 1});\"></div>");
    ...
    addFunc: function() {
        ...
        AppsEdit.switchEditFunc(e), geByClass1("apps_edit_cont_name", a)
            .focus(), AppsEdit.updateFuncsSort()
    },
    ...
    removeFuncVersion: function(e, t) {
        for (var a = cur.funcsVersions[e].versions, s = -1, i = 0; i < a.length; i++)
            if (a[i][0] == t) {
                s = a[i + 1][0];
                var n = a.slice(i + 1);
                cur.funcsVersions[e].versions = a.slice(0, i)
                    .concat(n);
                break
            }
        AppsEdit.updateVersionsDD(e), AppsEdit.putVersionCode(e, s), cur.funcsVersions[e].disable_add == t && (show("apps_edit_add_version" + e), delete cur.funcsVersions[
            e].disable_add), cur.funcsVersions[e].last_v == t && cur.funcsVersions[e].last_v--, cur.funcsVersions[e].versions.length <= 1 && addClass("func_row_" + e,
            "dev_no_func_versions"), delete cur.editedFuncs[e]
    },
    removeFuncBox: function(e) {
        if (!cur.funcSaving) {
            ...
            if (s > 0) var i = cur.lang.developers_func_remove_confirm.replace("{v}", s)
                .replace("{name}", clean(a));
    ...
    initVersionDropdown: function(e) {
        cur.verDD || (cur.verDD = {}), ge("apps_edit_const_v_" + e)
            .value = cur.lastVersion, cur.verDD[e] = new Dropdown(ge("apps_edit_const_v_" + e), cur.versions, {
                width: 118,
                big: 1,
            ...
            ajax.post("editapp", p, {
                onDone: function(a, d) {
                    if ("name" == a) notaBene(n);
                        ...
                        }), removeClass(i, "apps_edit_new_func"), cur.needSaveSort[t] && (i = i.parentNode, delete cur.needSaveSort[t], AppsEdit.saveFuncsPosition(
                            i, !1, i.previousSibling))
                    }
                    e && unlockButton(e), delete cur.editedFuncs[t], cur.funcSaving = !1, cur.funcsSaveCallbacks[t] && (cur.funcsSaveCallbacks[t](), delete cur
                        .funcsSaveCallbacks[t])
                },
    ...
    adjustHeight: function(e, t) {
        for (var a = e.renderer.lineHeight <= 1 ? 16 : e.renderer.lineHeight, s = e.getSession()
                .getScreenLength() * a + e.renderer.scrollBar.width, i = domPN(t); !hasClass(i, "apps_edit_cont_row");) i = domPN(i);
    ...
    updateExecuteParams: function(e, t) {
        ...
        if (1 == o.length && 1 == _.length) {
            var l = _[0],
                v = o[0],
                g = geByClass1("execute_param_" + l, a);
            removeClass(g, "execute_param_" + l), addClass(g, "execute_param_" + v), geByClass1("execute_field_name", g)
                .innerHTML = v
        } else {
            var f = geByClass1("apps_edit_params", a);
            for (m = 0; m < _.length; m++) {
                var l = _[m],
                    h = geByClass1("execute_param_" + l, f);
                f.removeChild(h)
            }
    ...
    initFuncsSort: function() {
        cur.sorter && cur.sorter.destroy(), setTimeout(function() {
            cur.qsorterNoOperaStyle = !0, cur.qsorterRowClass = "apps_edit_sortable_row clear_fix ", cur.qsorterRowUpClass =
                "apps_edit_sortable_row apps_edit_sortable_row_up", cur.sorter = qsorter.init(ge("apps_edit_funcs"), {
                    width: 665,
                    height: 62,
                    xsize: 1,
    ...
    switchEditFunc: function(e, t) {
        ...
        if (!cur.funcDDShown || e != cur.funcDDShown) {
            if (AppsEdit.closeEditFunc(), cur.initedFunctions[e] || (AppsEdit.initEditor(geByClass("apps_edit_editor", ge("func_row_" + e))[0], e), AppsEdit.initVersionDropdown(
                    e), cur.initedFunctions[e] = 1, AppsEdit.loadFuncVersions(e), cur.funcsVersionsDD[e] = new Dropdown(ge("funcs_versions_dd" + e), [], {
                    width: 200,
                    big: 1,
                    autocomplete: !0,
                    multiselect: !1,
            ...
            addClass("apps_edit_funcs", "apps_edit_no_sortable"), cur.funcsVersions[e] && !cur.funcsVersions[e].disable_add && show("apps_edit_add_version" + e), cur.currentFunc =
                e;
            var s = ge("func_row_" + e);
            addClass(s, "active");
    ...
    addFuncVersion: function(e, t) {
        ...
        if (!(!t && cur.funcsSaveCallbacks[e] || cur.funcsVersions[e].disable_add))
            if (cur.editedFuncs[e]) var s = new MessageBox({
                ...
                .content(cur.lang.developers_confirmation_sh_func)
                .addButton(getLang("box_yes"), a)
                .addButton(getLang("box_no"), a, "gray")
                .show();
            else {
                ...
                cur.funcsVersions[e].versions.unshift([i, n]), AppsEdit.updateVersionsDD(e), AppsEdit.putVersionCode(e, i), removeClass("func_row_" + e,
                    "dev_no_func_versions"), hide("apps_edit_add_version" + e), cur.funcsVersions[e].disable_add = i
            }
    },
    saveFuncsPosition: function() {
        ...
        for (var s in t) {
            if (t[s] && 1 == t[s].nodeType) var i = geByClass1("apps_edit_cont_name", t[s])
                .value;
            else i = null;
            e.push(i)
        }
    ...
    showVersionsDD: function(e) {
        show("apps_edit_ver_dd" + e), cur.funcsVersionsDD[e].focus(), cur.funcDDShown = e, cur.funcsVersions[e] && !cur.funcsVersions[e].disable_add && show(
            "apps_edit_add_version" + e)
    },
    ...
    putVersionCode: function(e, t) {
        var a = AppsEdit.getFuncVersionCode(e, t); - 1 == t ? ge("func_remove_btn" + e)
            .innerHTML = cur.lang.developers_func_remove : ge("func_remove_btn" + e)
            .innerHTML = cur.lang.developers_remove_func_version, cur.funcsVersion[e] = parseInt(t);
    ...
    checkActivityFields: function(e) {
        ...
        return t.name ? t.text_m ? t.text_f ? t.points ? (t.response = t.response ? 1 : 0, t) : (notaBene(domPN(ge("activity_text_points_" + e))), elfocus(
            "activity_text_mul_" + e), !1) : (notaBene(domPN(ge("activity_text_f_" + e))), elfocus("activity_text_f_" + e), !1) : (notaBene(domPN(ge("activity_text_m_" +
            e))), elfocus("activity_text_m_" + e), !1) : (notaBene("activity_name_" + e), t.name && this.showRequestMsg(ge("activity_row_" + e), !0, getLang(
            "apps_wrong_activity_name")), !1)
    },
    checkRequestFields: function(e) {
        var t = this.collectRequestData(e);
        return t.name.match(/^([a-zA-Z0-9_]+)$/) ? t.text_m ? t.text_f ? t.text_mul ? t.button ? (t.response = t.response ? 1 : 0, t) : (notaBene("request_accept_text_" +
            e), !1) : (notaBene(domPN(ge("request_text_mul_" + e))), elfocus("request_text_mul_" + e), !1) : (notaBene(domPN(ge("request_text_f_" + e))), elfocus(
            "request_text_f_" + e), !1) : (notaBene(domPN(ge("request_text_m_" + e))), elfocus("request_text_m_" + e), !1) : (notaBene("request_name_" + e), t.name &&
            this.showRequestMsg(ge("request_row_" + e), !0, getLang("apps_wrong_request_name")), !1)
    },
    ...
    defaultActivityData: function() {
        var e = unclean(cur.activitySamples)
            .split("<#>");
    ...
    toggleRequestsBtn: function() {
        toggle("add_requests_btn", geByClass("apps_edit_cont_row", ge("apps_edit_requests"))
            .length < cur.maxRequests)
    },
    toggleActivitiesBtn: function() {
        toggle("add_activities_btn", geByClass("apps_edit_cont_row", ge("apps_edit_activities"))
            .length < cur.maxActivities)
    },
    ...
    onActivityInputsChange: function(e, t) {
        ...
        if (a) {
            ...
            var i = geByClass1("apps_edit_activity_name", a),
                ...
                c = parseInt(val(n)) || 0;
            (c > cur.maxPointsPerActivity || 0 > c) && val(n, Math.max(0, Math.min(cur.maxPointsPerActivity, c))), clearTimeout(cur._activityInputChangeTO), cur._activityInputChangeTO =
                setTimeout(function() {
    ...
    addActivity: function() {
        ...
        AppsEdit.requestInsertRow(a, e), show(e), AppsEdit.toggleRequestsBtn(), AppsEdit.switchEditRequest(t), AppsEdit.updateRemainingPoints(), geByClass1(
                "apps_edit_activity_name", a)
            .select(), re(geByClass1("apps_edit_activity_delete_btn", a))
    },
    addRequest: function() {
        ...
        AppsEdit.requestInsertRow(a, e), show(e), AppsEdit.toggleRequestsBtn(), AppsEdit.switchEditRequest(t), geByClass1("apps_edit_cont_name", a)
            .focus()
    },
    ...
    cancelActivityChange: function(e) {
        if (!cur.activitySaving) {
            ...
            var n = showFastBox({
                ...
                a ? ((ge("activity_text_m_" + e) || {})
                        .value = unclean(a.text_m), (ge("activity_text_f_" + e) || {})
                        .value = unclean(a.text_f), (ge("activity_text_name_" + e) || {})
                        .value = unclean(a.name), val("activity_points_" + e, a.points), val(i, trim(a.name) || getLang("apps_activities_unnamed")), toggle(s)) :
                    AppsEdit.removeActivity(e), n.hide()
            })
        }
    },
    cancelRequestChange: function(e) {
        if (!cur.requestSaving) {
            ...
            var s = showFastBox({
                    ...
                    dark: 1,
                    bodyStyle: "padding: 20px; line-height: 160%;"
                }, getLang("apps_cancel_request_confrim")
                .replace("%s", clean(a)), getLang("developers_do_cancel"),
                function() {
                    request ? (val("request_name_" + e, request.name), val("request_text_m_" + e, request.text_m), val("request_text_f_" + e, request.text_f), val(
                            "request_text_mul_" + e, request.text_mul), val("request_accept_text_" + e, request.button), checkbox("request_response_" + e, request.response)) :
                        AppsEdit.removeRequest(e), s.hide()
                })
        }
    },
    ...
    removeActivityBox: function(e) {
        ...
        var a = ge("activity_row_" + e),
            ...
            i = showFastBox({
                    ...
                    dark: 1
                }, getLang("apps_remove_activity_confirm")
                .replace("%s", clean(s)), getLang("developers_do_remove"),
                function() {
    ...
    removeRequestBox: function(e) {
        ...
        var a = ge("request_row_" + e),
            ...
            i = showFastBox({
                    ...
                    dark: 1
                }, getLang("apps_remove_request_confrim")
                .replace("%s", clean(s)), getLang("developers_do_remove"),
                function() {
    ...
    searchList: function(e) {
        e ? (e = e.toLowerCase(), cur.disableSort = !0, addClass("apps_edit_funcs", "apps_edit_no_sortable")) : (delete cur.disableSort, removeClass("apps_edit_funcs",
            "apps_edit_no_sortable")), toggle("apps_edit_reset_search", !!e);
    ...
    uInitScroll: function() {
        AppsEdit.scrollnode = browser.msie6 ? pageNode : window, AppsEdit.uDeinitScroll(), addEvent(AppsEdit.scrollnode, "scroll", AppsEdit.uScroll), addEvent(window,
            "resize", AppsEdit.uScroll)
    },
    ...
    uGetAddr: function(e) {
        var t = e.match(/^(https?:\/\/)?([a-z0-9]+\.)*(vkontakte\.ru|vk\.com)\/(.+)$/),
            a = t[4].substr(t[4].indexOf("#") + 1)
            .replace(/^[\/\!]*/, "");
        return (t = a.match(/^profile\.php\?id=(\d+)/)) ? a = intval(t[1]) : (-1 !== a.indexOf("?") && (a = a.substr(0, a.indexOf("?"))), (t = a.match(/^id(\d+)/)) && (a =
            intval(t[1]))), a
    },
    uSearchUpdate: function() {
        if ("apps_edit_search_inp" == (cur.searchInp || {})
            .id) {
            var e = trim(val(cur.searchInp));
        ...
        clearTimeout(cur.addAdminTO), cur.addAdminTO = setTimeout(function() {
            ajax.post("/al_apps_edit.php", {
                ...
                onFail: function(e) {
                    ...
                    return t ? (ge("apps_edit_add_user_error")
                        .innerHTML = e, show("apps_edit_add_user_error"), hide(t), curBox()
                        .setOptions({
                            hideButtons: !0
                        }), !0) : !1
                },
    ...
    uGenRow: function(e, t) {
        ...
        return t || !p || p.match(/^(https?:\/\/)?([a-z0-9]+\.)*(vkontakte\.ru|vk\.com)\/.+/) || (highlight = AppsEdit.uGetHighlight(p), c = c.replace(highlight.re,
            ...
            ')">' + getLang("apps_main_admin_promote") + "</a>" : o = '<a class="apps_edit_user_action" onclick="AppsEdit.uMainAdmin(true)">' + getLang(
                ...
                "apps_add_admin") + "</a>" : 3 != n ? (o += '<a class="apps_edit_user_action" onclick="AppsEdit.uEditAdmin(' + a + ')">' + getLang("Edit") + "</a>", o +=
                ' | <a class="apps_edit_user_action" onclick="AppsEdit.uRemoveAdmin(' + a + ')">' + getLang("apps_edit_admin_demote") + "</a>") : cur.opts.main_admin &&
            cur.opts.all_count > 1 && (o = '<a class="apps_edit_user_action" onclick="AppsEdit.uMainAdmin()">' + getLang("apps_main_admin_change") + "</a>"), rs(cur.opts.template, {
                oid: a,
                name: c,
                photo: i,
                href: s,
    ...
    uSelAdminLevel: function(e, t, a) {
        radiobtn(e, t, a);
        var s = ge("apps_admin_partial_level_desc")
    ...
    uSaveAdmin: function(e, t) {
        ...
        each(geByClass("checkbox", ge("apps_edit_admin_rights")), function(e, t) {
            isChecked(t) && a.rights.push(t.getAttribute("id")
                .replace(/^apps_admin_right_/, ""))
        }), a.rights.length && ajax.post("al_apps_edit.php", a, {
            onDone: function(t, a) {
                if (curBox()
                    .hide(), t && AppsEdit.uShowMessage(t), a) {
                    ...
                    r ? (delete cur.qShown, AppsEdit.uSearchUpdate()) : (cur.opts.data.unshift(a), ++cur.opts.all_count, val(cur.searchInp, ""), delete cur.qShown,
                        AppsEdit.uIndex(cur.opts.data)), AppsEdit.uUpdateSummary()
                }
            },
            showProgress: curBox()
                .showProgress,
    ...
    uDoChangeMainAdmin: function(e, t) {
        ...
        ajax.post("al_apps_edit.php", a, {
            onDone: function(t, a) {
                curBox()
                    .hide(), t && AppsEdit.uShowMessage(t), cur.mainAdminChanging = !1, cur.opts.main_admin = a;
                var s, i, n = cur.opts.data;
                if (isArray(n)) {
            ...
            onFail: function(e) {
                return curBox()
                    .hide(), AppsEdit.uShowMessage(e), !0
            },
            showProgress: curBox()
                .showProgress,
            hideProgress: curBox()
    ...
    loadStatApiData: function(method, stat_interval) {
        return cur.api_stat_interval == stat_interval && cur.api_stat_filter_method == method ? !1 : void ajax.post("editapp", {
            ...
            cache: 1,
            onDone: function(content, script) {
                if (ge("apps_edit_stats_api")
                    .innerHTML = content, cur.api_stat_interval = stat_interval, cur.api_stat_filter_method = method, script && eval(script), "2days" !=
                    stat_interval || "" != method) {
                    var newLocVars = {};
                    "" != method && (newLocVars.method = method), "2days" != stat_interval && (newLocVars.stat_interval = stat_interval), nav.setLoc(extend(nav
                        .objLoc, {
                            method: method,
                            stat_interval: stat_interval
                        }))
            ...
            onFail: AppsEdit.showError,
            showProgress: function() {
                cur.api_stat_interval = stat_interval, removeClass(ge("api_interval_selector_2days"), "selected"), removeClass(ge("api_interval_selector_week"),
                    "selected"), removeClass(ge("api_interval_selector_month"), "selected"), addClass(ge("api_interval_selector_" + cur.api_stat_interval),
                    "selected"), show(ge("apps_edit_api_prg"))
            },
            hideProgress: function() {
    ...
    changeStatBlockPeriod: function(e) {
        cur.stat_main_block_period || (cur.stat_main_block_period = "yesterday"), cur.stat_main_block_period != e && (cur.stat_main_block_period = e, "yesterday" == e ? (
            removeClass(ge("app_stat_main_blocks_selector_month"), "selected"), addClass(ge("app_stat_main_blocks_selector_yesterday"), "selected")) : (removeClass(
            ge("app_stat_main_blocks_selector_yesterday"), "selected"), addClass(ge("app_stat_main_blocks_selector_month"), "selected")), toggle(ge(
            "app_stat_main_block1_day")), toggle(ge("app_stat_main_block2_day")), toggle(ge("app_stat_main_block3_day")), toggle(ge(
            "app_stat_main_block1_subtitle_day")), toggle(ge("app_stat_main_block1_month")), toggle(ge("app_stat_main_block2_month")), toggle(ge(
            "app_stat_main_block3_month")), toggle(ge("app_stat_main_block1_subtitle_month")))
    },
