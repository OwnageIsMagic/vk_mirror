var usorter = {
        ...
        for (var o in usorter.animcache)
            if (0 != o) {
                var s = usorter.animcache[o],
                    ...
                    i = 200,
                    u = vkNow();
                s.t += u - s.prev, s.prev = u, s.t < i ? (t = !1, n.style.left = a(s.t, s.sx, s.dx, i) + "px", n.style.top = a(s.t, s.sy, s.dy, i) + "px", browser.msie8 &&
                    (e = n.offsetLeft)) : (n.style.left = s.sx + s.dx + "px", n.style.top = s.sy + s.dy + "px", browser.msie8 && (e = n.offsetLeft), clearInterval(s.timer),
                    r.push(n.parentNode.id), s.h && s.h.apply(n))
    ...
    animate: function(e, r, t, o, s, n, a) {
        if (data(e, "tween") && data(e, "tween")
            .stop(!0), browser.msie8 || r == o && t == s) return removeClass(domPN(e), a.clsUp), setStyle(e, {
            left: 0,
            top: 0
    ...
    mousemove: function(e) {
        if (usorter.current) {
            ...
            if ("scroll" == e.type) r = !1;
                ...
                100 > o ? usorter.animcache[0] = o - 100 : o > lastWindowHeight - 100 ? usorter.animcache[0] = o + 100 - lastWindowHeight : usorter.animcache[0] && delete usorter
                    .animcache[0], usorter.animcache[0] && !usorter.animtimer && (usorter.animtimer = setInterval(usorter.animstep, 13))
            }
            ...
            for (var f, h, p = !1, b = !1, v = domPN(a)
                    .childNodes, w = v[0], g = w.x, y = l + a.w, x = m + a.h, N = 0, S = v.length; S > N; ++N) {
                var C = S > N + 1 ? v[N + 1] : {
                        id: !1,
                        x: g - 1
                    },
                    P = w.y + w.h;
                b === !1 && g + w.w >= y && (b = w, (p === !1 || Math.abs(f - x) > Math.abs(P - x)) && (p = w, f = P)), h = g, w = C, g = w.x, h > g && (b === !1 && (p ===
                    !1 || Math.abs(f - x) > Math.abs(P - x)) && (p = w, f = P), b = !1)
            }
        ...
        if (usorter.current) {
            ...
            if (setStyle(usorter.first(t), {
                ...
                for (var i = 0, u = s.length; u > i; ++i) {
                    var d = s[i],
                        l = usorter.first(d);
                    d != t && (addClass(d, r.clsUp), setStyle(d, {
                        width: 2 * d.w,
                        height: 2 * d.h
                    }), setStyle(l, {
                        zIndex: 90,
                ...
                r.newbef ? domPN(t)
                    .insertBefore(t, r.newbef) : s[s.length - 1].getAttribute("nodrag") ? domPN(t)
                    .insertBefore(t, s[s.length - 1]) : domPN(t)
                    .appendChild(t);
                for (var i = 0, u = s.length; u > i; ++i) {
                    var d = s[i],
                        l = usorter.first(d),
                        c = d.offsetLeft,
                        m = d.offsetTop;
                    d == t ? usorter.animate(l, d.x + n, d.y + a, c, m, usorter.animdone.bind(l, r), r) : usorter.animate(l, d.x, d.y, c, m, usorter.animdone.bind(l, r), r),
                        d.x = c, d.y = m
                }
    ...
    stop: function() {
        ...
        removeEvent(document, "mousemove drag touchmove", usorter.mousemove), removeEvent(document, "mouseup touchend touchcancel", usorter.mouseup), e.drag = usorter.current = !
            1
    },
    added: function(e) {
            ...
            var t = {
                ...
                stop: function() {
                    ...
                    for (var e = t.parent.childNodes, r = 0, o = e.length; o > r; ++r) {
                        var s = e[r];
                        s.getAttribute("nodrag") || usorter.animcache[s.id] && delete usorter.animcache[s.id]
                    }
                },
                destroy: function() {
                    t.stop();
