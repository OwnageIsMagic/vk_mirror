var Board = {
    createTopic: function(e, o) {
        for (var t = trim(val("bnt_title")), r = trim(val("bnt_text")), d = {}, i = cur.boardNewMedia.getMedias() || {}, a = [], s = [], n = !1, c = 0, l = i.length; l > c; ++
            c) {
            var u = i[c];
            if (u) {
                if ("poll" == u[0]) {
        ...
        globalHistoryDestroy("board" + -e), _tbLink && _tbLink.loc && (cur.__phinputs = cur.__phinputs || [], globalHistoryDestroy(_tbLink.loc)), ajax.post("/al_board.php",
            extend({
                act: "do_create",
                oid: e,
                hash: o,
    ...
    initScroll: function() {
        ...
        }), cur.searchField && elfocus(cur.searchField), addEvent(window, "scroll", Board.scrollResize), addEvent(window, "resize", Board.scrollResize), removeEvent(
            window, "load", Board.initScroll), cur.destroy.push(Board.deinitScroll)
    },
        ...
        if (isVisible("blst_load_more") && !isVisible("blst_more_progress")) {
            ...
            ajax.post("/board" + cur.gid, extend(e, {
                ...
                showProgress: function() {
                    show("blst_more_progress"), hide(ge("blst_load_more")
                        .firstChild)
                },
                hideProgress: function() {
                    show(ge("blst_load_more")
                        .firstChild), hide("blst_more_progress")
                },
                cache: 1
            })
        }
    ...
    saveTopic: function(e) {
        var o = curBox(),
            ...
            s = trim(val(t));
        return s ? (e || (e = geByClass("flat_button", domNS(curBox()
            .bodyNode))[1]), poll = cur.boardEditMedia.pollData(), poll && (poll.question = poll.media, delete poll.media, delete poll.anonymous), void ajax.post(
            "/al_board.php", extend({
                act: "save_topic_info",
                topic: cur.topic,
                hash: cur.hash,
    ...
    initTopic: function(e, o) {
        ...
        extend(cur, {
            ...
            editable: 1
        }), Board.topicFieldUpdated(), cur.onReplyFormSizeUpdate = Board.topicFieldUpdated, cur.onMediaChanged = Board.topicAttachWillAdd), Board.topicOnScroll(!1, !1, !
            0), Pagination.init(e.bottom), cur.destroy.push(Pagination.deinit), cur.destroy.push(removeEvent.pbind(window, "keydown", Board.handleEditEsc))
    },
    initUpdates: function() {
        cur.updates && window.Notifier && (Board.checkUpdates(), cur.updates.unread = 0, cur.updates.interval = setInterval(Board.checkUpdates, 2e4), cur.destroy.push(
            function() {
    ...
    getAbsDate: function(e) {
        var o, t = new Date(e || vkNow()),
            ...
            d = t.getMinutes(),
            i = "";
        return cur.updates.time_system && (i = cur.updates.time_system[r > 11 ? 1 : 0], r = r % 12 || 12), o = r > 9 ? r : "0" + r, d = d > 9 ? d : "0" + d, cur.updates.date_format
            .replace("{am_pm}", i)
            .replace("{hour}", r)
            .replace("{num_hour}", o)
            .replace("{minute}", d)
                ...
                each(o.events, function() {
                    ...
                    switch (e[3] > -1 && (t = e[3]), r) {
                        case "new_post":
                            ...
                            ge("bt_rows")
                                .appendChild(c), setTimeout(addClass.pbind(c, "bp_animated"), 0), setTimeout(removeClass.pbind(c, "bp_selected"), 5e3), cur.pgOffset++,
                                cur.pgCount++, window.curNotifier && curNotifier.idle_manager && curNotifier.idle_manager.is_idle && cur.updates.unread++;
                            break;
                        case "del_post":
    ...
    topicOnScroll: function(e, o, t) {
        if ((o === !1 || void 0 === o) && (o = scrollGetY()), cur.addField) {
            ...
            setStyle(cur.addBlock, {
                    marginLeft: d
                }), r && !cur.docked ? (setStyle(cur.addBlock, "width", getSize(cur.addBlockWrap)[0]), addClass(cur.addBlock, "fixed"), cur.docked = !0) : !r && cur.docked &&
                Board.cancelAddPost(), cur.docked && e && "resize" == e.type && (cur.addBlock.style.left = ge("page_layout")
                    .offsetLeft + ge("content")
                    .offsetLeft + "px", setTimeout(Board.topicResetStyle, 0))
        }
    },
    ...
    sendPost: function(e, o, t) {
        ...
        if (!buttonLocked(r)) {
            ...
            var c = ((cur.pgCont.childNodes[cur.pgNodesCount - 1].id || "")
                .match(/\d+$/) || [0])[0];
            s = Wall.fixPostParams(extend(s, {
                ...
                onDone: function(e, o, t, r, d, i) {
                    cur.topicMyReplied = !1, re("b_no_content"), Pagination.loaded.apply(window, arguments), Board.cancelAddPost(!n), window.Emoji && Emoji.focus(
                        cur.addField), setTimeout(Board.scrollToEnd, 0), d && r && nav.setLoc(extend(nav.objLoc, {
                        offset: r
                    }))
                },
    ...
    editPost: function(e, o) {
        ...
        return ajax.post("/al_board.php", {
            ...
            onDone: function(e, o, i) {
                ...
                var a = domFC(domPN(r)
                    .insertBefore(se(rs(cur.updates.skin.editPost, {
                        text: e,
                        add: i ? '<div class="bpe_auth">' + i + "</div>" : ""
                    })), r));
                addClass(t, "bp_editing"), setTimeout(function() {
                    if (show(a.parentNode), elfocus(a), hide(r, d), cur.boardEditMedia = new MediaSelector(ge("bpe_add_media"), "bpe_media_preview",
                            cur.options.rmedia_types, {
                                limit: 10,
                                hideAfterCount: 5,
                                editable: 1,
                                sortable: 1,
                        ...
                        for (var e = 0, t = (o || [])
                                .length; t > e; ++e) cur.boardEditMedia.chooseMedia.apply(window, o[e]);
                    Wall.initComposer(a, {
                        lang: {
    ...
    cancelEditPost: function(e, o, t) {
        ...
        if (!(!r || d && buttonLocked(d)) && (cur.bEditingPost = !1, d)) {
            ...
            return show(c, a), removeClass(i, "bp_editing"), Wall.deinitComposer(ge("bpe_text")), re(ge("bpe_text")
                .parentNode), Board.topicOnScroll(!1, !1, !0), !1
        }
    },
