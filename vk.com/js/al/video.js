var Video = {
    ...
    init: function() {
        ...
        Video.isInAlbum() || Video.loadSilent(), Video.loadSilent(Video.getLoc()
            .section), "catalog" == e ? (Videocat.init(), Video._preloadPage("all")) : (Video.initOwnerVideoPage(), vk.id == cur.getOwnerId() && -1 != Video.AVAILABLE_TABS
            .indexOf(e) && Video._preloadPage("catalog")), cur.curLoc = !1, cur.section = !1, cur.currentModule = function() {
            ...
            onDone: function(o, i, t) {
                if (Video.isInCatalog() || Video.isInVideosList()) {
                    ...
                    extend(cur, i), extend(cur.videosCount[r], d), cur._preloadedPages = cur._preloadedPages || {}, cur._preloadedPages[e] = ce("div", {
                            innerHTML: o,
                            id: "video_content_" + e
                        }), cur._preloadedPages.other = t, "all" == e && Video.loadSilent(e), cur._switchOnPagePreloaded && Video._switch.apply(Video, cur._switchOnPagePreloaded),
                        cur._switchOnPagePreloaded = !1
                }
            }
        })
    },
    ...
    _switch: function(e, o) {
        ...
        if (Video.doSearch(""), Video.inputVal(cur.searchInputEl, ""), hide("video_content_" + e), toggle("videocat_other_blocks", "catalog" != e), i || ge(
                "video_layout_contents")
        ...
        return toggle("video_add_album_btn", "catalog" != o), uiTabs.switchTab(domFC(ge("videocat_tab_" + o))), uiTabs.hideProgress("video_main_tabs"), Video._updateThumbsInView(), !
            1
    },
    ...
    initNavigation: function() {
        cur.nav.push(function(e, o, i, t) {
            ...
            if (uiTabs.hideProgress("video_main_tabs"), "all" == e.section && delete i.section, c && (cur.videoLocBeforeSearch = o), s && (cur.videoSearchFilters = {},
                    Video.doSearch(), Video.inputVal(cur.searchInputEl, ""), cur.videoLocBeforeSearch && t.fromSearch)) {
                var h = clone(cur.videoLocBeforeSearch);
                return delete cur.videoLocBeforeSearch, nav.go(h), !1
            }
            trim(val(cur.searchInputEl)) != trim(i.q || "");
            var g = i.section || "all";
            if (i.q) Video.isInAlbum() || delete i.section, Video._prepareSearchFilters(i), t.fromSearch || Video.inputVal(cur.searchInputEl, i.q), t.fromSearch ||
                t.globalQuery || (t.globalQuery = i.q), Video.doSearch(i.q, t.globalQuery);
            else {
    ...
    initSearch: function() {
        function e(e, o) {
            ...
            }, Video.SEARCH_KEEP_FILTERS_DELAY)), e && cur.videoPrevSearchFilters && (i = cur.videoPrevSearchFilters, delete cur.videoPrevSearchFilters), nav.change(
                extend({
                    q: e || !1
                }, i), !1, {
                    fromSearch: !0,
    ...
    _setFilterSelector: function(e, o) {
        ...
        return t ? ("Selector" == t.__className ? (void 0 === o && (o = t.options.defaultItems[0][0]), t.selectItem(o, !1), i = clone(t.selectedItems()[0]), i.push(i[0] ==
            t.options.defaultItems[0][0])) : hasClass(t, "checkbox") && (toggleClass(t, "on", !!o), i = [!!o, data(t, "title"), !o]), i) : !1
    },
    ...
    loadSilent: function(e) {
        ...
        if ((i || this._isGeneralSection(e)) && "albums" != e) {
            cur.silentLoaded = cur.silentLoaded || {}, cur.silentLoaded[o] = cur.silentLoaded[o] || {}, cur.silentLoadingProgress = cur.silentLoadingProgress || {}, cur.silentLoadingProgress[
                o] = cur.silentLoadingProgress[o] || {};
            var t = cur.silentLoadingProgress[o][e];
            if (t !== !0 && cur.pageVideosList && cur.pageVideosList[o]) return t === !1 ? void Video._callPendingAction(e) : void("undefined" == typeof t && (cur.silentLoadingProgress[
                o][e] = !0, function(e) {
                function t(i, t) {
                ...
                if (a && n) t(cur.pageVideosList[o][e].list, cur.albumsPreload[o]);
    ...
    doSearch: function(e, o) {
        if (cur.searchInputEl) {
            ...
            Video.isInSearch() && cur.noEmptyLocalResults && r.pop(), each(r, function(e, o) {
                    hide("video_subtab_pane_" + o)
                }), toggle("videocat_other_blocks", Video.isInCatalog() && !e), i || Video._toggleSearchContent(!1), curBox() ? ge("box_layer_wrap")
            ...
            return !i && cur.globalSearchResults[t] ? void Video._showGlobalSearchResults(e) : void(cur.globalSearchInProgress != e && (cur.globalSearchInProgress = e, !i &&
                Video._toggleSearchProgress(!0), ajax.post("/al_video.php", extend({
                    ...
                    onDone: function(o, r, d, a, n, c) {
                        cur.globalSearchInProgress = !1, !i && Video._toggleSearchProgress(!1), curBox() && (n = !1), cur.globalSearchResults[t] = cur.globalSearchResults[
                            t] || {
                            count: 0,
                            countHash: r,
                            list: [],
                        ...
                        if (!s.done) {
                            ...
                            o > Video.VIDEOS_PER_PAGE && S && s.list.length < s.count && (s.list.splice(-S, Video.VIDEOS_PER_ROW), c -= S), s.realOffset =
                                c
    ...
    _toggleEmptySearchPlaceholder: function(e, o, i) {
        ...
        if (cur.getOwnerId() == vk.id && (r = "video_not_found_yours"), Video.isInAlbum() && (r = "video_not_found_in_album"), Video.isInCatalog() && (r =
                "video_not_found_globally"), o && (t.innerHTML = getLang(r)
                .replace("{searchText}", "<b>" + clean(o.replace(/\$/g, "$$$$")) + "</b>")), toggle(t, e), i) {
            var d = !0,
    ...
    _showGlobalSearchResults: function(e, o) {
        ...
        if (a && d && cur.globalSearchResults[i] && cur.globalSearchResults[i].count >= 0) {
            ...
            }, cur.noEmptyLocalResults && (Video._toggleSearchContent(!0), 0 == n.count ? Video._toggleEmptySearchPlaceholder(!0, e) : Video._toggleEmptySearchPlaceholder(!
                1)), o || (Video._showSearchResult(Video.ALBUM_GLOBAL_SEARCH_PROMO_PLAYLISTS_TYPE), Video._showSearchResult(Video.VIDEO_GLOBAL_SEARCH_TYPE)), Video._callPendingAction(
    ...
    _searchLocally: function(e) {
        ...
        return a ? (Video._toggleSearchContent(!0), Video._toggleEmptySearchPlaceholder(!1)) : cur.noEmptyLocalResults ? Video._toggleEmptySearchPlaceholder(!1, void 0, !0) :
            (Video._toggleSearchContent(!0), Video._toggleEmptySearchPlaceholder(!0, e)), i ? i.length : 0
    },
    ...
    show: function(e, o, i, t) {
        ...
        if (cur.videoSearchStats) {
            ...
            if (S && S.hasAttribute("data-search-pos")) {
                cur.videoSearchPos = parseInt(S.getAttribute("data-search-pos")), cur.videoSearchPos > cur.videoSearchStats.lastSeenIndex && (cur.videoSearchStats.lastSeenElement =
                    S, cur.videoSearchStats.lastSeenIndex = cur.videoSearchPos), cur.videoSearchStats.positions[cur.videoSearchPos] = extend({
                    clicked: 0
    ...
    _updateLastSeenElement: function(e) {
        if (cur.videoSearchStats && (null !== cur.videoSearchStats.lastSeenElement && e.contains(cur.videoSearchStats.lastSeenElement) || (cur.videoSearchStats.lastSeenElement =
                domFC(e), cur.videoSearchStats.lastSeenElement))) {
