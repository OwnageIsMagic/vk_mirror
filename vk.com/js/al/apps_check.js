var AppsCheck = {
    init: function() {
        extend(cur, {
            ...
            100 ? cur.totalCount : ""), cur.nav.push(function(e, o, t) {
    ...
    changeSummary: function() {
        ...
        if ("blocked" == cur.section || "requests" == cur.section || "comments" == cur.section || "reports" == cur.section) {
            ...
            e.innerHTML = o, ge("tab_counter_" + cur.section) && (ge("tab_counter_" + cur.section)
                ...
                delete cur.deletingRequest, o && o.hide(), n && setTimeout(showFastBox({
                    ...
                    if (re("app" + e), cur.totalCount--, cur.tabCount--, AppsCheck.changeSummary(), !cur.totalCount) {
                        ...
                        ge("apps_check_content")
                            .innerHTML = '<div class="no_rows" id="no_apps">' + o + "</div>"
                    }
                })
            },
            onFail: function() {
    ...
    showEditReply: function(e) {
        ...
        return cur.editing === e ? void elfocus(o) : (autosizeSetup(o, {
            ...
            .onclick = this.sendReply.pbind(e), cur.editing = e, void elfocus(o))
    },
    ...
    checkTextLen: function(e, o, t) {
        ...
        if (e.lastLen !== n.length || t) {
            var a = e.lastLen = n.length,
                ...
                s = a - n.replace(/\n/g, "")
                .length;
            o = ge(o), a > c - 100 || s > 4 ? (show(o), a > c ? o.innerHTML = getLang("global_recommended_exceeded", a - c) : s > 4 ? o.innerHTML = getLang(
                "global_recommended_lines", s - 4) : o.innerHTML = getLang("text_N_symbols_remain", c - a)) : hide(o)
        }
    },
    sendReply: function(e) {
        ajax.post("apps_check", {
            ...
            onDone: function(o) {
                ...
                t.value = "", t.blur(), t.phonblur(), AppsCheck.hideEditPostReply(), hide("reply_warn" + e), ge("app_comments" + e)
                    .innerHTML += o
            },
    ...
    getCommentsPage: function(e) {
        return ajax.post("apps_check", {
            ...
            onDone: function(o, t, n) {
                o && (ge("apps_check_content")
                    .innerHTML = o, n && (ge("apps_summary")
                        .innerHTML = n), nav.setLoc(extend(nav.objLoc, {
                        offset: e
                    })))
            },
            showProgress: function() {
            ...
            onDone: function(a) {
                if (unlockButton(n), a.length) showFastBox({
                    ...
                    showFastBox({
                            ...
                            onHide: AppsCheck.finishCheck.bind(AppsCheck, e)
                        }, '<iframe src="app' + e + '?check=1" style="vertical-align: top;width: 100%; height: ' + c +
    ...
    toBlackList: function(e, o) {
        cur.addingToBlacklist || (cur.addingToBlacklist = !0, ajax.post("apps_check", {
            ...
            onDone: function(e) {
                delete cur.addingToBlacklist, e && (ge("actions" + o)
                    .innerHTML = e)
            }
        }))
    },
        ...
        cur.removingAutoAnswer || (cur.removingAutoAnswer = !0, ajax.post("apps_check", {
            ...
            onDone: function(o) {
                delete cur.removingAutoAnswer, cur.deletedAutoanswers || (cur.deletedAutoanswers = []), cur.deletedAutoanswers[e] = ge("autoanswer_row" + e)
                    .innerHTML, o && (ge("autoanswer_row" + e)
                        .innerHTML = o)
            },
            onFail: function() {
            ...
            ajax.post("apps_check", {
                ...
                onDone: function(t) {
                    delete cur.editingAutoAnswer, slideUp("edit_autoanswer" + e, 200, function() {
                        cur.autoanswers[e] = o, t && (curBox()
                            .bodyNode.innerHTML = t, placeholderSetup("add_answer_text", {
                                back: !0
    ...
    addAutoanswer: function(e) {
        if (!cur.addingAutoAnswer) {
            var o = ge("add_answer_label")
                .value,
                t = ge("add_answer_text")
                .value;
            if (!o || !t) {
    ...
    collectionPhotoUploadInit: function() {
        if (curBox() && cur.collectionPhotoUploadOptions) {
            ...
            e.setOptions({
                ...
                t.upload || (t.lang = o, t.cont = geByClass1("_apps_check_collection_photo_upload_" + o), t.img = geByClass1("_apps_check_collection_photo_" + o),
                    t.cont && (debugLog("Init upload " + t.lang), t.upload = Upload.init(t.cont, t.options.url, {}, {
                        file_name: "photo",
                        ...
                        onUploadComplete: function(e, o) {
                            ...
                            if (n.error) AppsCheck.collectionPhotoUploadError(t, n.error);
                                ...
                                t.img.src = t.options.static_url + "v" + a[1] + "/" + a[2] + "/" + a[3] + ".jpg", isVisible("apps_collection_error") &&
                                    slideUp("apps_collection_error", 150)
                            } else {
                                var c = o === !1 ? "[FALSE]" : null === o ? "[NULL]" : void 0 === o ? "[UNDEFINED]" : "&laquo;" + clean(o.toString()
                                    .substr(0, 1024)) + "&raquo;";
    ...
    deleteCollection: function(e, o) {
        return !showFastBox({
            ...
            ajax.post("/apps_check", {
                ...
                onDone: function(e, o) {
                    AppsCheck.updateCollections(e, o), curBox()
                        .hide()
                },
                showProgress: lockButton.pbind(t),
                hideProgress: unlockButton.pbind(t)
    ...
    removeCollectionApp: function(e, o, t, n) {
        n && cancelEvent(n), ajax.post("apps_check", {
            ...
            onDone: function(e) {
                ...
                o.sorter && o.sorter.destroy(), o.innerHTML = e, cur.sorter && geByClass("apps_cat_row", ge("apps_search_content"))
    ...
    actFeatured: function(e, o, t, n, a, c) {
        ...
        o.innerHTML = '<img src="/images/upload.gif" />', ajax.post("apps_check", {
            ...
            onDone: function(e) {
                2 == c ? uiTabs.goTab(domFC(ge("subtab_featured"))) : c ? nav.reload() : (a || o)
                    .innerHTML = e
            },
            onFail: function(e) {
                return o.innerHTML = s, setTimeout(showFastBox(getLang("global_error"), e)
