var FriendsSearch = {
    submit: function() {
        var e = ge("fsearch_email")
            .value,
            o = ge("fsearch_pass")
            .value;
        return /^.{1,40}@.{1,40}\..{1,4}$/.test(e) ? o ? (cur.inviteBox.showProgress(), ge("fsearch_inviter_form")
            .submit(), void hide("fsearch_error")) : notaBene("fsearch_pass") : notaBene("fsearch_email")
    },
    checkResult: function(e, o, t) {
        if (cur.inviteBox) {
            cur.inviteBox.hideProgress();
            try {
                var r = ge("fsearch_inviter")
            ...
            i.type = "text/javascript", i.src = "http://" + e + ".vk.com/inviter.php?act=get_friends_list&hash=" + hash + "&skey=" + key + "&mid=" + o + "&vk=" + t +
                "&back=FriendsSearch.getEmailResult&v=" + Math.floor(1e4 * Math.random()), headNode.appendChild(i)
        }
    },
    ...
    getList: function(e, o, t) {
        ...
        ajax.post("al_friends.php", r, {
            onDone: function(e, o) {
                if (1 == o) return curBox()
                    .hide(), Friends.section("suggestions", function() {
    ...
    checkOAuth: function(e, o, t) {
        ...
        if (1 == t) var n = "https://accounts.google.com/o/oauth2/auth?scope=https://www.google.com/m8/feeds/&response_type=code&redirect_uri=" + encodeURIComponent(r) +
            "&approval_prompt=force&state=" + o + "&client_id=190525020719-3g15ppddiep5mnjbt0g8vi1kh6v160an.apps.googleusercontent.com&hl=" + e;
        else if (3 == t) var n = "https://graph.facebook.com/v2.7/oauth/authorize?client_id=128749580520227&redirect_uri=" + encodeURIComponent(r) +
            "&display=popup&state=" + o;
        else if (4 == t) var n = "http://www.odnoklassniki.ru/oauth/authorize?client_id=168388096&scope=VALUABLE+ACCESS&response_type=code&redirect_uri=" +
            encodeURIComponent(r + "&state=" + o);
    ...
    importDone: function(e) {
        cur.importDone[e.type] = 1, e.error && setTimeout(showFastBox(getLang("global_error"), e.error)
            .hide, 2e3)
    },
    ...
    showImportTT: function(e) {
        stManager.add(["intro.css"], function() {
            ...
            showTooltip(o, {
                content: '    <div id="intr_tt_pointer_left"></div>    <div id="intr_tt" style="width: 192px">      <div id="intr_hide" class="fl_r" onclick="ge(\'friends_summary\').tt.hide();" onmouseover="showTooltip(this, {text: \'' +
                    e.hide + '\', black: 1, shift: [14, 4, 0]})"></div>      <div id="intr_header">' + e.header + '</div>      <div id="intr_text">' + e.text +
                    "</div>    </div>",
                slideX: 15,
