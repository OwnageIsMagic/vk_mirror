var TagsDD = function(obj, opts) {
    ...
    this.control = ce('div', {
        ...
        innerHTML: ['<div class="tdd_control clear_fix"><div class="tdd_taglist"></div><div class="tdd_input_cont fl_l"><input class="tdd_input" placeholder="', (this.opts
            ...
            .placeholder, '" /></div></div><div class="tdd_suggest" style="width: ', (opts.width - 2),
            'px"><div class="tdd_suggest_items"></div><div class="tdd_bottom1" style="width: ', (opts.width - 2),
            'px"></div><div class="tdd_bottom2" style="width: ', (opts.width - 2), 'px"></div></div>'
        ].join('')
    }, {
        width: opts.width + 'px'
    })
...
extend(TagsDD.prototype, { // object funcs
    ...
    addTag: function(label, noUpdate) {
        ...
        var tag = ce('div', {
            ...
            innerHTML: '<span class="tdd_l">' + label +
    ...
    updateInput: function() {
        ...
        if (!back) return;
        back.innerHTML = (this.steps[this.step] || this.opts)
            .placeholder;
...
extend(TagsDD, { // class funcs
    ...
    removeTag: function(tag) {
        data(tag.parentNode.parentNode.parentNode, 'tags_dd')
            .removeTag(tag);
    },
