var TagsDD = function(t, s) {
    ...
    s = extend({
            ...
            innerHTML: ['<div class="tdd_control clear_fix"><div class="tdd_taglist"></div><div class="tdd_input_cont fl_l"><input class="tdd_input" placeholder="', (this.opts
                    .steps[this.step] || this.opts)
                .placeholder, '" /></div></div><div class="tdd_suggest" style="width: ', s.width - 2,
                'px"><div class="tdd_suggest_items"></div><div class="tdd_bottom1" style="width: ', s.width - 2, 'px"></div><div class="tdd_bottom2" style="width: ', s
                .width - 2, 'px"></div></div>'
            ].join("")
        }, {
            width: s.width + "px"
        }), t.parentNode.insertBefore(this.control, t), this.input = geByClass("tdd_input", this.control)[0], this.input.style.width = s.width - 26 + "px", this.tagCont =
        geByClass("tdd_taglist", this.control)[0], this.suggest = geByClass("tdd_suggest", this.control)[0], this.suggestItems = geByClass("tdd_suggest_items", this.suggest)[0],
        this.tags = {};
    var i = this;
...
extend(TagsDD.prototype, {
        ...
        switch (t.keyCode) {
            ...
            default:
                this.focus = "keys", setTimeout(function() {
                    this.str = val(this.input), "," == this.str.substr(this.str.length - 1, 1) && (val(this.input, this.str.substr(0, this.str.length - 1)),
                        this.addTag()), this.updateSource(!0)
    ...
    getListHTML: function(t) {
        ...
        for (var i in t) {
            var e = t[i];
            this.tags[e[1]] || s.push('<a val="', e[0],
                '" class="tdd_item" onmouseover="TagsDD.activeItem(this);" onmousedown="return TagsDD.selectItem(this, event);">', e[1], "</a>")
        }
        return s.join("")
    },
    setValue: function(t) {
    ...
    addTag: function(t, s) {
        ...
        if (t = t.replace(/<|>/g, "")) {
            ...
            if (t.length > i && (t = trim(t.substr(0, i)) + "..."), this.opts.capitalCase && (t = t.substr(0, 1)
                    .toUpperCase() + t.substr(1)), this.tags[t]) return !1;
            this.tags[t] = 1;
            var e = ce("div", {
                className: "tdd_tag fl_l",
                innerHTML: '<span class="tdd_l">' + t +
                    '</span><a class="tdd_x" onclick="TagsDD.removeTag(this.parentNode);" onmouseover="TagsDD.overTag(this);" onmouseout="TagsDD.outTag(this);"><div class="tdd_x_c"></div></a>'
            });
            this.setValue(""), this.tagCont.appendChild(e), this.step += 1, this.updateInput(), s || this.updateSource(!1, !0), this.steps[this.step] && (this.steps[
                this.step].data = {}), this.hideDD()
        }
    },
    ...
    updateInput: function() {
        ...
        if (t) {
            if (t.innerHTML = (this.steps[this.step] || this.opts)
                .placeholder, !isVisible(t.parentNode.parentNode)) {
                var s = !0;
    ...
    removeTag: function(t) {
        data(t.parentNode.parentNode.parentNode, "tags_dd")
            .removeTag(t)
    },
    tagVal: function(t) {
