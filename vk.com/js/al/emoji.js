                    ...
                    setTimeout(function() {
                        each(geByClass('emoji_smile_icon'), function(i, el) {
                            if (!geByClass1('emoji_smile_icon_promo', el.parentNode.parentNode)) {
                                el.parentNode.parentNode.appendChild(ce('div', {
        ...
        ttClick: function(optId, obj, needHide, needShow, ev, tabKey) {
            ...
            if (!tt) {
                ...
                var tt = ce('div', {
                    ...
                    innerHTML: '<div class="emoji_block_cont"><div class="emoji_block_rel"><div class="emoji_list_cont"><div class="emoji_list"><div class="emoji_scroll"></div></div></div></div><div class="emoji_tabs clear_fix">' +
                        tabs + '</div></div>',
