...
Health.toggleDistributionGraph = function(e, t, a) {
    ...
    removeClass(s, "selected"), addClass(e.target, "selected"), nav.setLoc(e.target.getAttribute("href")
            .replace(/^\//, "")), "count" === t ? (each(geByTag("img", ge("health_small_graphs_count")), a), show("health_small_graphs_count"), hide("health_small_graphs_time")) :
