var ProfileEditor = {
    ...
    initGeneral: function() {
        ...
        each([ge("pedit_first_name"), ge("pedit_last_name")], function() {
            ...
            selectedItems: e.sex,
            onChange: function(i) {
                hide("pedit_status_ptitle", "pedit_status_partner", "pedit_status_detail"), toggle("pedit_maiden_row", 1 == intval(i)), cur.uiPartner.clear(),
                    cur.uiStatus.clear(), intval(i) ? (show("pedit_status_row"), cur.uiStatus.setData(e.statuses[intval(i)])) : hide("pedit_status_row")
            },
            dark: 1
        });
        var t = function(e) {
            ...
            a = function(i) {
                ...
                if (-1 == i)
                    if (7 == a) {
                        ...
                        ajax.post("al_profileEdit.php", {
                            ...
                            onFail: function(e) {
                                return t(0), setTimeout(showFastBox(getLang("global_error"), e)
                                    .hide, 2e3), !0
                            },
                ...
                intval(i) && a > 1 && cur.uiStatus.val() < 6 ? intval(i) == e.partner ? ge("pedit_status_detail_content")
                    .innerHTML && show("pedit_status_detail") : hide("pedit_status_detail") : (intval(i) || cur.uiPartner.clear(), hide("pedit_status_detail"))
            };
        e.status > 7 || e.status < 0 ? e.status = 0 : (e.status > 1 && e.status < 6 || 7 == e.status) && show("pedit_status_partner"), cur.uiStatus = new Dropdown(ge(
            "pedit_status"), e.statuses[e.sex], {
            multiselect: !1,
            zeroPlaceholder: !0,
            selectedItems: e.status,
            onChange: function(i) {
                i = intval(i), i > 1 && 6 > i || 7 == i ? ProfileEditor.updateFriendsList(function() {
                    show("pedit_status_partner"), e.ptitles[i][cur.uiSex.val()].length ? (ge("pedit_status_ptitle")
                        .innerHTML = e.ptitles[i][cur.uiSex.val()] + ":" || "&nbsp;", show("pedit_status_ptitle")) : hide("pedit_status_ptitle"), a(
                        cur.uiPartner.val())
        ...
        addEvent(r, "focus blur", function(i) {
                ...
                }) : -1 != indexOf([2, 3, 4, 5, 7], cur.uiStatus.val()) && showTooltip(o, {
            ...
            }), e.sex && (show("pedit_status_row"), e.status > 1 && 6 != e.status && (e.ptitles[e.status][e.sex].length && (ge("pedit_status_ptitle")
                .innerHTML = e.ptitles[e.status][e.sex] + ":" || "&nbsp;", show("pedit_status_ptitle")), show("pedit_status_partner"))), e.partner && ge(
                "pedit_status_detail_content")
            .innerHTML && show("pedit_status_detail"), cur.uiBday = new Dropdown(ge("pedit_bday"), ProfileEditor.generateDays(e.byear, e.bmonth)
                .slice(intval(e.bday) ? 1 : 0), {
                    multiselect: !1,
            ...
            .value = e.home_town, cur.uiLangs = new Dropdown(ge("pedit_langs"), e.langs, {
                multiselect: !0,
                autocomplete: !0,
                indexkeys: [1, 2],
    ...
    initContacts: function() {
        cur.section = "contacts", selectsData.setCountries(cur.selectData.countries), selectsData.setCities(cur.selectData.country, cur.selectData.cities), cur.selectData.city_val =
            cur.selectData.city_val || ["", ""], cur.selectData.country_val = cur.selectData.country_val || ["", ""], cur.uiCity = new CitySelect(ge("pedit_city"), ge(
                "pedit_city_row"), {
            ...
            .value = cur.options.email, ge("pedit_mobile")
            .value = cur.options.mobile, ge("pedit_home")
            .value = cur.options.home, ge("pedit_website")
            .value = cur.options.website, ge("pedit_skype")
            .value = cur.options.skype, each(["home", "mobile", "email"], function() {
                ...
                if (i) {
                    var r = i.innerHTML;
                    i = gpeByClass("pedit_privacy_control", i), a > 0 ? (removeClass(i, "pedit_privacy"), addClass(i, "pedit_privacy_locked")) : (removeClass(i,
                            "pedit_privacy_locked"), addClass(i, "pedit_privacy")), geByTag1("a", i)
                        .setAttribute("data-title", r)
                }
    ...
    wereChanges: function(e) {
        switch (e) {
            case "general":
                var i = cur.options;
                return val("pedit_sex") != i.sex || val("pedit_status") != i.status || val("pedit_partner") != i.partner || val("pedit_bday") != i.bday || val(
                        "pedit_bmonth") != i.bmonth || val("pedit_byear") != i.byear || val("pedit_bday_visibility") != i.bday_visibility || val("pedit_home_town") != i.home_town ||
                    val("pedit_first_name") != i.first_name || val("pedit_last_name") != i.last_name || ge("pedit_middle_name") && val("pedit_middle_name") != i.middle_name ||
                    val("pedit_maiden_name") != i.maiden_name || val("pedit_langs") != i.lang && (val("pedit_langs") || i.lang);
            case "contacts":
                var i = cur.options;
                return ge("pedit_email")
                    .value != i.email || ge("pedit_mobile")
                    .value != i.mobile || ge("pedit_home")
                    .value != i.home || ge("pedit_website")
                    .value != i.website || ge("pedit_skype")
                    .value != (i.skype || "") || (parseInt(ge("pedit_country")
                        .value) || "") != (cur.selectData.country_val[0] || "") || (parseInt(ge("pedit_city")
                        .value) || "") != (cur.selectData.city_val[0] || "");
            case "interests":
                var t = !1;
                return each(["activities", "interests", "music", "movies", "tv", "books", "games", "quotes", "about"], function(e, i) {
                    var a = ge("pedit_interests_" + i);
                    t |= cur.interests_data[i].replace(/\x0d/g, "") != val(a)
                        .replace(/\x0d/g, "")
                }), t;
            case "education":
                var a = !1,
                ...
                if (isVisible("primary_uni"))
                    if (ProfileEditorEdu.uniChanged(cur.primary_uni)) r = !0;
                        ...
                        for (var n = 0; n < cur.unis.length; ++n) cur.unis[n].id > 0 && ProfileEditorEdu.uniChanged(cur.unis[n]) ? r = !0 : cur.unis[n].id < 0 && isVisible(
                            "uni_content" + cur.unis[n].id) && cur.unis[n].uiUniversity.val() && (r = !0);
                if (isVisible("schools"))
                    for (var n = 0; n < cur.schools.length; ++n) cur.schools[n].id > 0 && ProfileEditorEdu.schoolChanged(cur.schools[n]) ? a = !0 : cur.schools[n].id < 0 &&
                        isVisible("school_content" + cur.schools[n].id) && cur.schools[n].uiSchool.val() && (a = !0);
                return r || a;
            case "career":
                for (var o = !1, n = 0; n < cur.works.length; ++n) {
                    var s = (cur.works[n].uiPosition.val_full() || [])[1] || "",
                        l = ge("company" + cur.works[n].id);
                    cur.works[n].id > 0 && ProfileEditorJob.workChanged(cur.works[n]) ? o = !0 : cur.works[n].id < 0 && isVisible("content" + cur.works[n].id) && (l && l.value
                        .length || s.length) && (o = !0)
                }
                return o;
            case "military":
                for (var c = !1, n = 0; n < cur.militaries.length; ++n) cur.militaries[n].id > 0 && ProfileEditorMil.militaryChanged(cur.militaries[n]) ? c = !0 : cur.militaries[
                    n].id < 0 && isVisible("content" + cur.militaries[n].id) && intval(ge("unit" + cur.militaries[n].id)
                    .value) && (c = !0);
                return c;
            case "personal":
                var i = cur.options;
                return cur.uiPolitical.val() != i.political || cur.uiReligion.val_full()[1].toLowerCase() != i.religion.toLowerCase() && (cur.uiReligion.val() || "" != i.religion) ||
                    val("pedit_life") != i.life_priority || val("pedit_people") != i.people_priority || val("pedit_smoking") != i.smoking || val("pedit_alcohol") != i.alcohol ||
                    val("pedit_inspired_by") != i.inspired_by
        }
    },
    checkChanges: function(e) {
        if (!cur.leaving) {
            ...
            return i ? winToUtf(i.replace(/<\/?b>/g, "")
                .replace(/<br\s*\/?>/g, "\n")) : void 0
        }
    },
    ...
    updateDays: function(e, i) {
        cur.uiBday.val() > ProfileEditor.getLastDay(e, i) && cur.uiBday.clear(), cur.uiBday.setData(ProfileEditor.generateDays(e, i)
            .slice(intval(cur.options.bday) ? 1 : 0)), cur.onUpdateDays && cur.onUpdateDays(e, i)
    },
    ...
    doUpdateFriendsList: function() {
        ...
        if (!(2 > e || 6 == e) && i) {
            ...
            n || (r = 0), t[a][0][1] = getLang(5 == e ? "profileEdit_main_sel_rel_with_m" : a ? "profileEdit_main_sel_relat" : "profileEdit_main_sel_rel_with_" + (1 == i ?
                "m" : "f")), cur.uiPartner.setData(t[a + 1]), cur.uiPartner.setOptions({
                defaultItems: t[a]
    ...
    deleteLinkHtml: function(e) {
        return '<a class="pedit_del_icon _del_icon" onclick="this.tt.hide(); ' + e + '; return false;" onmouseover="showTitle(this, \'' + getLang("global_delete") +
            "');\"> </a>"
    },
    updateFamily: function(e) {
        ge("pedit_grandparents")
            .innerHTML = "", ge("pedit_parents")
            .innerHTML = "", ge("pedit_siblings")
            .innerHTML = "", ge("pedit_children")
            .innerHTML = "", ge("pedit_grandchildren")
            .innerHTML = "", cur.relGuid = 0, cur.relIds = {
                grandparent: 0,
                parent: 0,
                sibling: 0,
                child: 0,
    ...
    onFriendsLoaded: function(e, i) {
        var t = cur.options,
            ...
            n = e + cur.relGuid,
            o = "pedit_" + n,
            s = '<div class="pedit_relation_input"><div class="fl_l"><input class="pedit_dropdown" type="hidden" id="' + o + '" name="' + n +
            '"/></div><div class="pedit_right_control">' + ProfileEditor.deleteLinkHtml("ProfileEditor.removeRelation('" + e + "', " + cur.relGuid + ")") + "</div>",
            l = 0;
        r && (l = i ? parseInt(i[3]) : 0, s += '<div class="pedit_next_input clear_fix clear"><input class="pedit_date_field" type="hidden" id="' + o + '_date" value="' +
                l + '"><div class="pedit_bday fl_l"><input type="hidden" id="' + o + '_day"/></div><div class="pedit_bmonth fl_l"><input type="hidden" id="' + o +
                '_month"/></div><div class="pedit_byear fl_l"><input type="hidden" id="' + o + '_year"/></div></div>'), a.innerHTML = s, ge(cur.conts[e])
            .appendChild(a), cur.relIds[e] + 1 >= cur.relLimits[e] ? hide("pedit_add_" + e + "_link") : show("pedit_add_" + e + "_link");
        ...
        if (r) {
            ...
            for (var p = u; p <= (new Date)
                .getFullYear(); p++) d.push([p, p]);
            var _ = function() {
                    var e = 0,
                        i = intval(h.val()),
                        t = intval(m.val()),
    ...
    switchUnits: function() {
        ...
        o >= 140 && 220 >= o && each(r, function() {
            ...
            }), cur.uiWeight.setData(a), cur.uiWeight.val(n), ge("pedit_units_toggler")
            .innerHTML = 1 == e ? getLang("profileEdit_switch_to_meters") : getLang("profileEdit_switch_to_inches"), ge("pedit_height_title")
            .innerHTML = 1 == e ? getLang("profileEdit_height_in") : getLang("profileEdit_height_cm"), ge("pedit_weight_title")
            .innerHTML = 1 == e ? getLang("profileEdit_weight_lbs") : getLang("profileEdit_weight_kg")
    },
    ...
    saveGeneral: function(btn) {
        ...
        if (flmName = cleanName(fName, lName, mName), peditData.first_name == fName && peditData.last_name == lName ? (cleanFName = fName, cleanLName = lName) : (
                cleanFName = flmName[0], cleanLName = flmName[1]), cleanFName.toLowerCase() != fName.toLowerCase()) return notaBene("pedit_first_name"), !1;
        ...
        if (each(["sex", "status", "partner", "bday", "bmonth", "byear", "bday_visibility"], function() {
                ...
                e && (params["" + this] = e)
            }), params.home_town = val("pedit_home_town"), params.langs = cur.uiLangs.val(), parseInt(cur.options.bday) && !intval(params.bday)) return notaBene(geByClass1(
            "selector", cur.uiBday.container), !1, !0), void notaBene(geByClass1("selector_input", cur.uiBday.container), !1, !0);
        if (parseInt(cur.options.bmonth) && !intval(params.bmonth)) return notaBene(geByClass1("selector", cur.uiBmonth.container), !1, !0), void notaBene(geByClass1(
            "selector_input", cur.uiBmonth.container), !1, !0);
        if (parseInt(cur.options.byear) && !intval(params.byear)) return notaBene(geByClass1("selector", cur.uiByear.container), !1, !0), void notaBene(geByClass1(
            "selector_input", cur.uiByear.container), !1, !0);
        var i = 0;
        return peditData.family !== !1 && (params.familyedit = 1, i = 1, each(geByClass("pedit_relation_input", ge("pedit_grandparents")), function() {
            if (params["grandparents[" + i + "]"] = geByClass("resultField", this)[0].value, params["grandparents_custom[" + i + "]"] = geByClass("customField",
                    this)[0].value, -1 == params["grandparents[" + i + "]"] && params["grandparents_custom[" + i + "]"]) {
                var e = params["grandparents_custom[" + i + "]"],
                    t = e.split(/\s+/);
                params["grandparents_custom[" + i + "]"] = cleanName(t[0] || "", t[1] || "")
                    .join(" ")
            }
            i++
        }), i = 1, each(geByClass("pedit_relation_input", ge("pedit_parents")), function() {
            if (params["parents[" + i + "]"] = geByClass("resultField", this)[0].value, params["parents_custom[" + i + "]"] = geByClass("customField", this)[0]
                .value, -1 == params["parents[" + i + "]"] && params["parents_custom[" + i + "]"]) {
                var e = params["parents_custom[" + i + "]"],
                    t = e.split(/\s+/);
                params["parents_custom[" + i + "]"] = cleanName(t[0] || "", t[1] || "")
                    .join(" ")
            }
            i++
        }), i = 1, each(geByClass("pedit_relation_input", ge("pedit_siblings")), function() {
            if (params["siblings[" + i + "]"] = geByClass("resultField", this)[0].value, params["siblings_custom[" + i + "]"] = geByClass("customField", this)[
                    0].value, -1 == params["siblings[" + i + "]"] && params["siblings_custom[" + i + "]"]) {
                var e = params["siblings_custom[" + i + "]"],
                    t = e.split(/\s+/);
                params["siblings_custom[" + i + "]"] = cleanName(t[0] || "", t[1] || "")
                    .join(" ")
            }
            i++
        }), i = 1, each(geByClass("pedit_relation_input", ge("pedit_children")), function() {
            if (params["children[" + i + "]"] = geByClass("resultField", this)[0].value, params["children_custom[" + i + "]"] = geByClass("customField", this)[
                    0].value, params["children_date[" + i + "]"] = (geByClass("pedit_date_field", this)[0] || {
                    value: 0
                })
                .value, -1 == params["children[" + i + "]"] && params["children_custom[" + i + "]"]) {
                var e = params["children_custom[" + i + "]"],
                    t = e.split(/\s+/);
                params["children_custom[" + i + "]"] = cleanName(t[0] || "", t[1] || "")
                    .join(" ")
            }
            i++
        }), i = 1, each(geByClass("pedit_relation_input", ge("pedit_grandchildren")), function() {
            if (params["grandchildren[" + i + "]"] = geByClass("resultField", this)[0].value, params["grandchildren_custom[" + i + "]"] = geByClass(
                    "customField", this)[0].value, params["grandchildren_date[" + i + "]"] = (geByClass("pedit_date_field", this)[0] || {
                    value: 0
                })
                .value, -1 == params["grandchildren[" + i + "]"] && params["grandchildren_custom[" + i + "]"]) {
                var e = params["grandchildren_custom[" + i + "]"],
                    t = e.split(/\s+/);
                params["grandchildren_custom[" + i + "]"] = cleanName(t[0] || "", t[1] || "")
                    .join(" ")
            }
            i++
            ...
            onDone: function(response, introScript) {
                ...
                peditData.sex = cur.uiSex.val(), peditData.status = response.status, peditData.partner = response.partner, peditData.bday = cur.uiBday.val(),
                    peditData.bmonth = cur.uiBmonth.val(), peditData.byear = cur.uiByear.val(), peditData.bday_visibility = cur.uiBdayVisibility.val(),
                    peditData.lang = cur.uiLangs.val(), peditData.home_town = val("pedit_home_town"), peditData.first_name = val("pedit_first_name"), peditData
                    .last_name = val("pedit_last_name"), peditData.middle_name = val("pedit_middle_name"), peditData.maiden_name = val("pedit_maiden_name"),
                    cur.uiStatus.val(response.status, !0), cur.uiPartner.val() != response.partner && cur.uiPartner.val(response.partner, !0), peditData.family !==
                    !1 && (peditData.family = response.family, ProfileEditor.updateFamily(peditData.family), peditData.family === !1 && each(geByClass(
                        "pedit_general_family_row"), function() {
                        hide(this)
                    })), val("pedit_status_detail_content", response.relation_text), peditData.partner ? val("pedit_status_detail_content") && show(
                        "pedit_status_detail") : hide("pedit_status_detail"), hide("pedit_name_request", "status_help_wrap"), ProfileEditor.showMsg(response.name_response ||
                        getLang("profileEdit_general_changes_saved")), introScript && setTimeout(function() {
                        eval(introScript)
                    }, 3e3)
            },
    ...
    nameChangeCancel: function(e, i) {
        cur.nameChangeCancelText || (cur.nameChangeCancelText = e.innerHTML, e.innerHTML = '<div style="padding-top: 8px;"><img src="/images/upload.gif" /></div>', ajax.post(
            "al_profileEdit.php", {
                act: "a_change_cancel",
                hash: i
            }, {
    ...
    saveContacts: function(e) {
        ...
        for (var a in t) i[t[a]] = ge("pedit_" + t[a])
            .value;
        t = ["email", "mobile", "home"];
        ...
        ajax.post("al_profileEdit.php", i, {
            onDone: function(e, i) {
                if (e) {
                    for (var t in e) cur.options[t] = e[t], ge("pedit_" + t)
                        .value = e[t] || "";
    ...
    setUpFacebook: function(e, i, t, a) {
        ...
        var r = "https://graph.facebook.com/v2.7/oauth/authorize?client_id=" + e + "&redirect_uri=" + i + "&scope=email,user_birthday,publish_actions&display=popup&state=" +
            a,
            n = "scrollbars=0,resizable=1,menubar=0,location=0,left=" + (Math.floor(screen.width / 2) - 300) + ",top=" + (Math.floor(screen.height / 2) - 240) +
        ...
        window.socialCallback = function(e) {
            ge("export_service_3")
                .innerHTML = '<img src="/images/upload.gif" />', ProfileEditor.fetchServiceName(3)
        }
    },
    fetchServiceName: function(e) {
        cur["nameService" + e] = setInterval(function() {
            ajax.post("/al_profileEdit.php", {
                ...
                onDone: function(i) {
                    if (i.msg) {
                        clearInterval(cur["nameService" + e]), ge("export_service_" + e)
                            .innerHTML = i.msg_sett ? i.msg_sett : i.msg;
    ...
    setUpInstagram: function(e) {
        var i = "1fdcd1b154d54990892368072ab4d303",
            ...
            a = "scrollbars=0,resizable=1,menubar=0,location=0,left=" + (Math.floor(screen.width / 2) - 300) + ",top=" + (Math.floor(screen.height / 2) - 240) +
            ",width=600,height=400,toolbar=0,status=0",
    ...
    getLiveJournalName: function(e) {
        var i = setInterval(function() {
            ajax.post("/al_profileEdit.php", {
                ...
                onDone: function(t) {
                    return t && void 0 != t.error ? (clearInterval(i), t.msg ? (e.hide(), void(ge("export_service_2")
                        .innerHTML = t.msg)) : (e && e.hideProgress(), void(1 == t.error ? (ge("pedit_lj_error")
                        .innerHTML = "Server error.", show("pedit_lj_error")) : 2 == t.error && (ge("pedit_lj_error")
                        .innerHTML = cur.lang.settings_lj_wrong_password, show("pedit_lj_error"))))) : void 0
                }
            })
        }, 1e3)
    },
        ...
        var t = "<center>" + getLang(t) + "</center>",
            a = showFastBox(getLang(i), t, getLang("global_continue"), function() {
                ajax.post("/al_profileEdit.php", {
                    ...
                    onDone: function(i) {
                        if (i && i.msg) {
                            a.hide(), ge("export_service_" + e)
                                .innerHTML = i.msg, setTimeout(scrollToTop, 300);
                            var t = curBox();
                            t && t.hide()
                        }
                    }
    ...
    initEducation: function() {
        if (cur.section = "education", cur.nav.push(function(e, i, t) {
                return "edit" != i[0] || e[0] ? !0 : "education" != i.act && "higher_education" != i.act || "education" != t.act && "higher_education" != t.act ? !0 :
                    (uiTabs.hideProgress(geByClass1("ui_tabs", "profile_editor")), ProfileEditor.selectEduTab(e.act), !1)
                ...
                if ("education" == cur.section) {
                    ...
                    if (isVisible("primary_uni"))
                        if (ProfileEditorEdu.uniChanged(cur.primary_uni)) i = !0;
                            ...
                            for (var t = 0; t < cur.unis.length; ++t) cur.unis[t].id > 0 && ProfileEditorEdu.uniChanged(cur.unis[t]) ? i = !0 : cur.unis[t].id < 0 &&
                                isVisible("uni_content" + cur.unis[t].id) && cur.unis[t].uiUniversity.val() && (i = !0);
                    if (isVisible("schools"))
                        for (var t = 0; t < cur.schools.length; ++t) cur.schools[t].id > 0 && ProfileEditorEdu.schoolChanged(cur.schools[t]) ? e = !0 : cur.schools[t].id <
                            0 && isVisible("school_content" + cur.schools[t].id) && cur.schools[t].uiSchool.val() && (e = !0);
        ...
        if ("education" == e) {
            if (cur.filter_uni = 0, show("school"), hide("uni"), hide("pedit_result"), !isVisible("schools")) {
                if (cur.schoolsCount = cur.schools.length, cur.schoolsCount)
                    for (var a = 0; a < cur.schools.length; ++a) ge("schools")
                        .appendChild(ProfileEditorEdu.genSchoolRow(cur.schools[a].id, 0 == a)), cur.schools[a] = ProfileEditorEdu.initSchoolRow(cur.schools[a]);
            ...
            if (cur.filter_uni = 1, show("uni"), hide("school"), hide("pedit_result"), !isVisible("primary_uni") && (ge("primary_uni")
                    .appendChild(ProfileEditorEdu.genUniRow(cur.primary_uni.id, !0, !0)), cur.primary_uni = ProfileEditorEdu.initUniRow(cur.primary_uni), show(
                        "primary_uni"), cur.unisCount = cur.unis.length, cur.unisCount)) {
                for (var a = 0; a < cur.unis.length; ++a) ge("unis")
                    .appendChild(ProfileEditorEdu.genUniRow(cur.unis[a].id, !1, 0 == a)), cur.unis[a] = ProfileEditorEdu.initUniRow(cur.unis[a]);
                show("unis")
            }
    ...
    initPersonal: function() {
        ...
        cur.section = "personal", cur.uiLife = new Dropdown(ge("pedit_life"), e.life_priorities, {
                ...
                dark: 1
            }), cur.uiReligion.setData(e.religions), e.religion_id > 0 ? cur.uiReligion.val(e.religion_id, !0) : e.religion.length && cur.uiReligion.customVal(e.religion),
            placeholderInit("pedit_inspired_by"), ProfileEditor.initBeforeUnload()
    },
    savePersonal: function(e) {
        ...
        return extend(i, t), ajax.post("al_profileEdit.php", i, {
            onDone: function(e) {
                cur.options.religion_id = t.religion, cur.options.religion = cur.uiReligion.val_full()[0] < 0 ? t.religion_custom : cur.uiReligion.val_full()[1],
                    delete t.religion_custom, delete t.religion, extend(cur.options, t), each(["inspired_by"], function(i, t) {
