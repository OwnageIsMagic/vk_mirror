    ...
    extend(cur, {
        ...
        regValidate: function(e, s) {
            ...
            var a = ge(e + "email")
                ...
                g = a.lastIndexOf("."),
                u = a.indexOf("@");
            a.length < 8 ? (cur.regShowError(e, "email_details", r.reg_error_email), l = !0) : (0 > g || 0 >= u || u + 1 >= g) && (cur.regShowError(e, "email_details",
                r.reg_error_bad_email), l = !0);
            var c = ge(e + "pass")
                .value,
                d = !1;
            c.length < 6 && (cur.regShowError(e, "pass_details", r.reg_error_pass), d = !0);
            var _ = intval(ge(e + "sex")
                    .value),
                f = !1;
        ...
        regShowError: function(e, r, s) {
            ...
            i.innerHTML = "<span>" + s + "</span>", i.style.position = "relative", i.offsetHeight > 20 ? i.style.top = "0px" : i.style.top = "5px", o ? (i.style.color =
                "#777777", animate(i, {
                    color: "#880000"
                }, 200, function() {
            ...
            var i = ge(e + "email")
                ...
                a = {
                    onDone: function(s, n, t) {
                        s = intval(s), s ? (cur.regBadEM = !0, cur.regShowError(e, "email_details", r.reg_login_is_taken), elfocus(e + "email")) :
                            submitQuickLoginForm(n || i, t || o)
                    },
                    onFail: function(r) {
