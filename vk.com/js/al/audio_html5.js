var audio_html5 = {
    ...
    loadAudio: function(a) {
        var o = audio_html5;
        o.pauseAudio(), o.autoStart = !0, o.preloadUrl == a ? (o.music = o.preloadMusic, o.music.addEventListener("canplay", o.onCanPlay), o.music.addEventListener("error",
            o.onErr), o.preloadMusic = o.preloadUrl = null) : (o.music = ge("html5_audio"), o.music.addEventListener("canplay", o.onCanPlay), o.music.addEventListener(
            "error", o.onErr), o.music.src = a, o.music.load()), o.loadIntID || (o.loadIntID = setInterval(o.onLoadProgress, 200)), o.music.volume = o.defaultVolume;
        try {
            o.playAudio()
        } catch (u) {}
    },
