...
<br class="clear" />', getLang('global_add'), GroupsEdit.doAddLink,
    ...
    showAgeLimitsTT: function(el, title, text, allBlock) {
        showTooltip(el, {
            text: '<div class="age_limits_tt_pointer"></div><div class="age_limits_tt_title">' + title + '</div>' + text.replace('{link}',
                    "<a href=\"https://vk.com/support?act=new\">")
                .replace('{/link}', '</a>'),
    ...
    saveObsceneWords: function() {
        ...
        var onDone = function(code, word) {
            switch (code) {
                case 7:
                    key = 'obscene_add_pattern_success';
                    break;
                case -7:
