var GroupsEdit = {
    ...
    uNav: function(e, t, o) {
        if (!e[0] && !cur.noLocNav) {
            var r = cur.tab,
                s = o.tab || "members";
            if (delete e.tab, isEmpty(e) && s != r) return GroupsEdit.uResetSearch(), hide("group_u_wrap_" + r), show("group_u_wrap_" + s), cur.tab = s, GroupsEdit.uResetSearch(),
                GroupsEdit.uStart(), nav.setLoc(o), !1
        }
    },
    uStart: function() {
        var e = cur.tab,
            ...
            o = t,
            r = cur.rnd;
        cur.qShown = !1, cur.opts.counts[e] > 1e3 || "lazy" == t ? ("lazy" == t && (cur.opts.data[e] = t = !1), t || (cur.offsets[e] = ge("group_u_rows_" + e)
            .childNodes.length, o = "notavail", cur.offsets[e] < cur.opts.counts[e] && ajax.post("groupsedit.php", {
                act: "get_more",
                id: cur.opts.id,
                tab: e,
        ...
        })), val("group_u_header", cur.opts.headers[e] || ""), val("group_u_header_btn", cur.opts.buttons[e] || ""), val("group_u_summary", cur.opts.counts[e] ?
            langNumeric(cur.opts.counts[e], "%s", !0) : ""), cur.opts.data[e] = o, cur.searchInp.setAttribute("placeholder", cur.opts.placeholders[e] || getLang(
            "groups_users_search")), placeholderInit(cur.searchInp, {
            reload: !0
        }), window.uiRightMenu && uiRightMenu.hideProgress(domFC(ge("narrow_column"))), hasClass(cur.searchCont, "ui_search_fixed") && scrollToY(getXY(cur.searchWrap)[
            1] + 1, 0), checkPageBlocks(), hide("group_edit_msg"), GroupsEdit.uUpdateBack()
    },
    ...
    uSearch: function() {
        var e = trim(val(cur.searchInp)),
            t = cur.tab,
            o = cur.opts.data[t];
        return clearTimeout(cur.updateTimer), e ? "notavail" == o && e.match(/^(https?:\/\/)?([a-z0-9]+\.)*(vkontakte\.ru|vk\.com)\/.+/) ? GroupsEdit.uGetPage() :
            "members" == t || "unsure" == t || "admins" == t ? nav.go(nav.objLoc[0] + "?act=search&c[q]=" + encodeURIComponent(e) + "&from=" + t, !1, {
                noback: !1
            }) : GroupsEdit.uSearchUpdate(!0) : void 0
    },
    uGetAddr: function(e) {
        var t = e.match(/^(https?:\/\/)?([a-z0-9]+\.)*(vkontakte\.ru|vk\.com)\/(.+)$/),
            o = t[4].substr(t[4].indexOf("#") + 1)
            .replace(/^[\/\!]*/, "");
        return (t = o.match(/^profile\.php\?id=(\d+)/)) ? o = intval(t[1]) : (-1 !== o.indexOf("?") && (o = o.substr(0, o.indexOf("?"))), (t = o.match(/^id(\d+)/)) && (o =
            intval(t[1]))), o
    },
    uSearchUpdate: function(e) {
        if ("group_u_search_inp" == (cur.searchInp || {})
            .id) {
            var t = trim(val(cur.searchInp)),
                o = cur.tab,
                r = cur.opts.data[o];
            if (toggle("group_u_wrap_additional_admins", "admins" == o && !t && domFC(ge("group_u_rows_additional_admins"))), t || (cur.searched = !1), clearTimeout(cur.updateTimer),
                "notavail" == r) {
                ...
                t ? (cur.htmls[o] || (cur.htmls[o] = a), hide(i), a && domPN(a)
                    .replaceChild(ce("div", {
                        id: "group_u_tmp_" + o,
                        className: "group_u_rows",
                        innerHTML: GroupsEdit.uGenEmpty(getLang("members" == o || "unsure" == o || "admins" == o ? "groups_too_many_enter" :
                            "groups_too_many_for_search"))
                    }), a)) : (cur.htmls[o] && (s = ge("group_u_tmp_" + o), domPN(s)
                    .replaceChild(cur.htmls[o], s), "group_l_row" == domFC(s)
                    .className && domPN(ge(domFC(s)
                        .id)) == cur.htmls[o] && cur.htmls[o].replaceChild(domFC(s), ge(domFC(s)
                        .id)), toggle(i, cur.offsets[o] < cur.opts.counts[o]), cur.htmls[o] = s = !1), GroupsEdit.uUpdateSummary()), checkPageBlocks()
        ...
        (e === !0 || cur.searched !== t) && (cur.searched = t, ajax.post("groupsedit.php", {
            ...
            onDone: function(e, t) {
                if (cur.rnd == r) {
                    ...
                    cur.htmls[o] || (cur.htmls[o] = s), hide("group_edit_more_" + o), val("group_u_summary", langNumeric(t ? 1 : "", "%s", !0)), s ? domPN(s)
                        .replaceChild(ce("div", {
                            id: "group_u_tmp_" + o,
                            className: "group_u_rows",
                            innerHTML: e
    ...
    uGenRow: function(e, t, o) {
        var r = t[0],
            ...
            p = o || t[2],
            l = cur.qShown;
        o || !l || l.match(/^(https?:\/\/)?([a-z0-9]+\.)*(vkontakte\.ru|vk\.com)\/.+/) || (highlight = GroupsEdit.uGetHighlight(l), p = p.replace(highlight.re, highlight.val)),
            n > 0 ? c += '<div class="group_u_info_row group_u_level">' + cur.opts.levels[n] + "</div>" : i[0] && (c += '<div class="group_u_desc">' + i[0] + "</div>");
        var g = intval(i[1]),
        ...
        switch (e) {
            ...
            case "declined":
                d += 0 > n ? '<a class="group_u_action" onclick="GroupsEdit.uAction(this, ' + r + ", '" + u + "', 0)\">" + getLang("groups_restore_member") + "</a>" :
                    '<a class="group_u_action" onclick="GroupsEdit.uAction(this, ' + r + ", '" + u + "', -1)\">" + getLang("groups_members_delete") + "</a>";
                break;
            case "invites":
                d += 0 > n ? '<a class="group_u_action" onclick="GroupsEdit.uAction(this, ' + r + ", '" + u + "', 0)\">" + getLang("groups_send_invitation") + "</a>" :
                    '<a class="group_u_action" onclick="GroupsEdit.uAction(this, ' + r + ", '" + u + "', -1)\">" + getLang("groups_members_invitations_cancel") + "</a>"
        }
    ...
    uDoneAdmin: function(e, t, o) {
        ...
        return cur.notSureAdmin && r >= 3 ? showFastBox({
            ...
            curBox()
                .hide(), cur.notSureAdmin = !1, GroupsEdit.uDoneAdmin(e, t, o)
            ...
            onDone: function(t, o, s) {
                ...
                if (n || (boxQueue.hideAll(!0), t && GroupsEdit.showMessage(t, o || u && void 0 !== o ? !1 : "error")), u) return val(ge("sgedit_acts" + e), o),
                    val(ge("sgedit_lev" + e), s), val(ge("sgedit_edit" + e), s ? getLang("global_edit") : getLang("groups_members_appoint_manager")), void toggleClass(
                        gpeByClass("search_row", "sgedit_lev" + e), "sgedit_moder", !!s);
                if (o) {
                    for (a = 0; 3 > a; ++a) {
                        var c, d, p, l = i[a],
                            g = cur.opts.data[l],
                        ...
                        if (isArray(g))
                            for (c = 0, d = g.length; d > c; ++c)
                                if (g[c][0] == e) {
                                    _ = !0, "admins" == l && (o[6] > 0 && g[c][6] <= 0 ? ++cur.opts.counts[l] : o[6] <= 0 && g[c][6] > 0 && --cur.opts.counts[l]),
                                        cur.opts.data[l][c] = o;
                                    break
                                }
                                "admins" == l && !_ && r ? (cur.opts.data[l].unshift(o), ++cur.opts.counts.admins, val(cur.searchInp, ""), cur.qShown = !1,
                            GroupsEdit.uIndex(l, cur.opts.data[l])) : ((p = ge("group_u_" + l + e)) && domPN(p)
                            .replaceChild(se(GroupsEdit.uGenRow(l, o)), p), _ || (ajaxCache = {})), GroupsEdit.uUpdateSummary()
                    }
    ...
    uInitAdmin: function(e, t, o, r) {
        e.setOptions({
            ...
            onItemSelect: function(e) {
                ge("gedit_hostbox_thumb")
                    .href = ge("gedit_hostbox_name")
                    .href = e[4], ge("gedit_hostbox_img")
                    .src = e[3], val(ge("gedit_hostbox_name"), e[1]), cur.hostSel = e
            }
        }), WideDropdown.select("gedit_host_dd", !1, cur.hostSel), e.removeButtons(), e.addButton(getLang("global_save"), GroupsEdit.uSaveAdmin), e.addButton(getLang(
            "global_cancel"), e.hide, "no")
    },
    uSaveAdmin: function() {
        ajax.post("groupsedit.php", {
            ...
            onDone: function(e, t, o) {
                if ("page" == cur.hostFrom) return curBox()
                    .hide(), showDoneBox(o), void domPN(ge("event_admin"))
                    .replaceChild(se(e), ge("event_admin"));
                var r = "admins";
                toggle("group_u_wrap_additional_" + r, !!t), val("group_u_rows_additional_" + r, t);
                var s = cur.opts.data[r][cur.opts.data[r].length - 1];
                (el = ge("group_u_" + r + e[0])) && domPN(el)
                    .replaceChild(se(GroupsEdit.uGenRow(r, e)), el), e[0] > 0 && s[0] < 0 ? (cur.opts.data[r].pop(), --cur.opts.counts[r], (el = ge("group_u_" +
                            r + s[0])) && domPN(el)
                        .removeChild(el)) : e[0] < 0 && s[0] > 0 ? (cur.opts.data[r].push(e), ++cur.opts.counts[r], (el = ge("group_u_" + r + s[0])) && domPN(
                            el)
                        .appendChild(se(GroupsEdit.uGenRow(r, e)), el)) : (cur.opts.data[r][cur.opts.data[r].length - 1] = e, (el = ge("group_u_" + r + s[0])) &&
                        domPN(el)
                        .replaceChild(se(GroupsEdit.uGenRow(r, e)), el)), GroupsEdit.uIndex(r, cur.opts.data[r], !0), curBox()
                    .hide(), GroupsEdit.showMessage(o), "admins" != cur.tab && nav.go(extend(nav.objLoc, {
                        tab: "admins"
                    }))
            },
            showProgress: curBox()
    ...
    uAction: function(e, t, o, r) {
        if (curBox() || !buttonLocked(e) && "progress_inline" != (domFC(e) || {})
            .className) {
            var s = cur.tab;
            ajax.post("groupsedit.php", {
                act: "user_action",
                ...
                onDone: function(e, a) {
                    if (GroupsEdit.invalidateBack(), curBox() && curBox()
                        .hide(), "search" == nav.objLoc.act && nav.objLoc.from && cur.gid) return val(ge("sgedit_acts" + t), e), val(ge("sgedit_lev" + t), a),
                        void toggleClass(gpeByClass("search_row", "sgedit_lev" + t), "deleted", 0 > r);
                    if (isArray(e)) {
                            ...
                            if (isArray(g))
                                for (c = 0, d = g.length; d > c; ++c)
                                    if (g[c][0] == t) {
                                        ...
                                        break
                                    }(p = ge("group_u_" + l + t)) && (domPN(p)
                                        .replaceChild(se(GroupsEdit.uGenRow(l, e)), p), "admins" != l && "notavail" == g && (r ? (--cur.opts.counts[l], --cur.offsets[
                                            l]) : (++cur.opts.counts[l], ++cur.offsets[l])), toggleClass(ge("group_u_" + l + t), "deleted", 0 > r)), _ || (
                                ajaxCache = {})
                        }("requests" == s && r > 0 || "admins" == s && 0 > r) && (cur.noLocNav = !0), GroupsEdit.uUpdateSummary()
                    } else e ? GroupsEdit.showMessage(e, "error") : GroupsEdit.uRemoveAdmin(t)
                        .uRemove = [t, o, r]
                },
                showProgress: function() {
                    curBox() ? curBox()
                        .showProgress() : e && "BUTTON" == e.tagName ? lockButton(e) : (e._s || (e._s = val(e)), val(e, '<span class="progress_inline"></span>'))
                },
                hideProgress: function() {
                    curBox() ? curBox()
                        .hideProgress() : e && "BUTTON" == e.tagName ? unlockButton(e) : e._s && (val(e, e._s), e._s = !1)
                }
            })
        }
    },
    waitTwitter: function() {
        ajax.post("al_groups.php", {
            ...
            onDone: function(e) {
                e ? (hide(cur.twitterBox.progress), ge("group_status_export_data")
                    .innerHTML = getLang("groups_authorize_please"), cur.twitterBox.removeButtons(), cur.twitterBox.addButton(getLang(
                        "groups_auth_in_twitter"), function() {
                        location.href = e
                    }), cur.twitterBox.addButton(getLang("global_cancel"), cur.twitterBox.hide, "no")) : cur.twitterTimer = setTimeout(GroupsEdit.waitTwitter,
                    1e3)
            }
        })
    },
    startTwitter: function() {
        cur.twitterBox = showFastBox({
                    title: '<div class="gedit_import_box_icon gedit_import_twitter"></div><div class="gedit_import_box_title">' + getLang("groups_status_export") +
                        "</div>",
                    width: 460
                }, '<div class="gedit_status_export_info">  <div class="groups_twitter_info">' + getLang("groups_twitter_desc") +
                '</div>  <div id="group_status_export_data">' + getLang("groups_external_site_request") + "</div></div>"), cur.twitterBox.setOptions({
                onHide: clearTimeout.bind(window)
                    .pbind(cur.twitterTimer)
            }), cur.twitterBox.removeButtons(), addClass(cur.twitterBox.addButton(getLang("groups_auth_in_twitter"), cur.twitterBox.hide, "yes", !0), "button_disabled"),
            cur.twitterBox.addButton(getLang("global_cancel"), cur.twitterBox.hide, "no"), show(cur.twitterBox.progress), ajax.post("al_groups.php", {
                act: "get_twitter_auth",
                gid: cur.gid,
                first: 1
            }, {
    ...
    saveInfo: function(e) {
        ...
        var r = ge("group_sw"),
            s = {
                ...
                name: t,
                addr: o,
                description: trim(ge("group_edit_desc")
                    .value),
                website: trim(ge("group_website")
                    .value),
    ...
    checkNewLinesFirstMessage: function(e) {
        var t = e.value;
        paramValue = t.substr(0, cur.group_first_message_max_length), paramValue = GroupsEdit.replaceValueNewLines(paramValue, cur.group_first_message_max_new_lines),
    ...
    init: function(e) {
        ...
        if (addEvent(t, "keydown keyup keypress change paste cut drop input blur", GroupsEdit.checkNewLinesFirstMessage.pbind(t)), (0 == cur.cls || 2 == cur.cls) && (
            ...
            pcategoryDD: new Dropdown(ge("public_type"), e.pcategories, {
                ...
                autocomplete: !1,
                onChange: function(t) {
                    t = intval(t), t && (e.psubcategories[t] || {})
                        .length > 1 ? (cur.psubcategoryDD.setOptions({
                            defaultItems: e.psubcategories[t]
                        }), cur.psubcategoryDD.val(0), GroupsEdit.show(ge("group_edit_psubcategory"))) : GroupsEdit.hide(ge("group_edit_psubcategory")),
                        void 0 !== e.plabelsmap[t] ? val("gedit_public_date_label", e.plabels[e.plabelsmap[t]]) : val("gedit_public_date_label", e.plabels[
                            e.plabelsmap[0]])
                }
            }),
        ...
        if (r && (e || isVisible(r) && !hasClass(r, "loading")) && (!e || o != cur.searchBoxParams.q)) {
            ...
            e && (cur.oldBoxParams = {
                ...
                onDone: function(o, r, s, a) {
                    if (e) {
                        if (a) return extend(cur.searchBoxParams, cur.oldBoxParams), val(t, cur.oldBoxParams.q), void(cur.searchBoxFound && cur.searchBoxFound(
                            a));
                        cur.boxRows.innerHTML = o ? "" : cur.boxNoRowsTpl, curBox()
                            .tbToTop()
                    }
    ...
    updateBlacklist: function(e, t, o, r, s) {
        ...
        if (a && cur.gid == e) {
            var i = ge("group_bl_row" + o),
                n = se(r);
            if (!i && 0 >= s) return;
            i && s && (toggle("group_bl_actions" + o, s > 0), toggle("group_bl_restore" + o, 0 > s), toggleClass(i, "deleted", 0 > s)), i && s >= 0 ? domPN(i)
                .replaceChild(n, i) : !i && s > 0 && (a.insertBefore(n, domFC(a)), hide("group_bl_no")), GroupsEdit.recache(cur.offset, s), GroupsEdit.updateBlacklistSummary(
                    s)
        }
    },
    updateBlacklistSummary: function(e) {
        cur.count += e, ge("group_bl_summary")
            .innerHTML = cur.count > 0 ? langNumeric(cur.count, "%s", !0) : ""
    },
    ...
    initScroll: function() {
        window.scrollTop = bodyNode.scrollTop = pageNode.scrollTop = htmlNode.scrollTop = 0, addEvent(window, "scroll", GroupsEdit.scrollResize), addEvent(window, "resize",
            GroupsEdit.scrollResize), removeEvent(window, "load", GroupsEdit.initScroll)
    },
    ...
    linkAction: function(e, t, o) {
        ...
        if (GroupsEdit.linksCount(cur.count + (r ? -1 : 1)), !r) {
            for (var a = ge("group_l_row" + o)
                    .previousSibling; a && (!a.id || isVisible("group_l_restore" + a.id.replace("group_l_row", "")));) a = a.previousSibling;
            s.after = (a && a.id || "")
                .replace("group_l_row", "")
        }
    ...
    updateImgs: function() {
        cur.lnkImages.length > 1 && (ge("group_al_thumb_img")
            .parentNode.style.cursor = "pointer")
    },
    rotateImgs: function() {
        if (!(cur.lnkImages.length < 2)) {
            var e = ((cur.lnkIndex || 0) + 1) % cur.lnkImages.length;
            ge("group_al_thumb_img")
                .src = cur.lnkImages[e], cur.lnkIndex = e
        }
    },
        ...
        each({
            ...
            if (hide(o.progress), GroupsEdit.showLinkInfo(r.title || "", t || e), r.images && r.images.length) {
                ...
                for (var s in r.images) {
                    var a = "",
                        i = vkImage();
                    /^\//.test(r.images[s]) ? a = (/^https:\/\//i.test(e) ? "https://" : "http://") + GroupsEdit.getDomain(e) : /^https?:\/\//i.test(r.images[s]) || (a =
                        e.replace(/[^\/]*$/, ""), /^https?:\/\/$/i.test(a) && (a = e + "/")), i.src = a + r.images[s], r.images[s] = i
                }
                cur.imgLoadInterval = setInterval(function() {
                    ...
                    for (var t in r.images) {
                        ...
                        if (o) {
                            var s = o.width,
                                a = o.height;
                            s || a ? (s >= 50 && a >= 20 && (cur.lnkImages.push(o.src), GroupsEdit.updateImgs(), cur.lnkIndex || GroupsEdit.rotateImgs()), r.images[
                                t] = !1) : ++e
                        }
                    }
    ...
    showLinkInfo: function(e, t) {
        ...
        cur.lnk = t, cur.lnkOwnerId = cur.lnkPhotoId = !1, cur.editing = !1, ge("group_al_link_info")
            .innerHTML = rs(cur.linkInfoTpl, {
                thumb: o,
                title: trim(clean(e)),
        ...
        return t ? (cur.lnkIndex = 0, cur.lnkSent = t, void ajax.post("groupsedit.php", {
            ...
            onDone: function(r, s, a, i) {
                ...
                if (GroupsEdit.hideMessage(), r > 0) 1 & r ? (show(o.progress), ajax.plainpost(s, {
                    ...
                    cur.lnk = s, cur.lnkOwnerId = cur.lnkPhotoId = !1, ge("group_al_link_info")
                        .innerHTML = a
                }
            },
            progress: o.progress
    ...
    uploadImg: function() {
        ...
        each({
            ...
            window.onUploadFail = window.onUploadDone = function() {}, cur.lnkOwnerId = r.user_id, cur.lnkPhotoId = r.photo_id, e.removeChild(t), cur.lnkIndex = 0,
                GroupsEdit.doAddLink(!0)
    ...
    linksCount: function(e) {
        cur.count = e, ge("group_l_summary")
            .innerHTML = e ? langNumeric(e, "%s", !0) : "", toggle("group_l_bar", e < cur.linksLimit)
    },
    doAddLink: function(e) {
        ...
        if ((e || !buttonLocked(s)) && (o || r)) {
            ...
            cur.editing ? (n.act = "do_edit_link", a = function(e, o, r, s) {
                t.hide(), GroupsEdit.invalidateBack(), o !== !1 && (ge("group_l_photo" + e)
                    .src = o), r !== !1 && (ge("group_l_title" + e)
                    .innerHTML = r), s !== !1 && (ge("group_l_position" + e)
                    .innerHTML = s)
    ...
    filterLinks: function(e) {
        ...
        toggle(t, !a), !e && a && sorter.init(r, {
            onReorder: GroupsEdit.reorderLinks,
            dh: 1
        }), hasClass(ge("group_l_bar"), "ui_search_fixed") && scrollToY(ge("gedit_search_input_wrap")
            .offsetTop, 0)
    },
    editPlace: function() {
        showBox("/al_page.php", {
    ...
    switchAdSubTab: function(e, t, o) {
        ...
        return delete r[0], ajax.post(s, extend(r, {
            ...
            cache: 1,
            onDone: function(e) {
                ge("group_ad_requests_table_wrap")
                    .innerHTML = e, delete r.part, nav.setLoc(extend(r, {
                        0: nav.objLoc[0]
                    }))
            }
        }), !1
    ...
    getAdPage: function(e, t) {
        ...
        return delete o[0], ajax.post(r, extend(o, {
            ...
            onDone: function(o) {
                ge(t || "group_ad_requests_table_wrap")
    ...
    toggleAdOtherSettings: function() {
        return isVisible("group_ad_other_settings") ? (ge("group_ad_other_settings_lnk")
            .innerHTML = getLang("groups_adspost_show_other_settings"), slideUp(ge("group_ad_other_settings"), 150)) : (ge("group_ad_other_settings_lnk")
            .innerHTML = getLang("groups_adspost_hide_other_settings"), slideDown(ge("group_ad_other_settings"), 150), GroupsEdit.initAdOtherSettings()), !1
    },
    ...
    saveAdNotificationsSettings: function(e, t) {
        ...
        for (var r in cur.selData.events) o.events.push(r + ":" + isChecked("notification_event_" + r)), o.sms_events.push(r + ":" + isChecked("notification_event_sms_" +
            r)), o.pm_events.push(r + ":" + isChecked("notification_event_pm_" + r));
    ...
    toggleMarketBlock: function(e) {
        e ? (setStyle("group_edit_market_placeholder", "height", getSize("group_edit_market_link")[1] + "px"), hide("group_edit_market_link"), show(
            "group_edit_market_placeholder"), slideDown("group_edit_market", 300), slideUp("group_edit_market_placeholder", 300)) : (hide("group_edit_market_link"),
    ...
    setupMarket: function(e) {
        var t = Math.round(geByClass1("group_edit")
                .offsetHeight),
            o = function() {
                1 == cur.cls ? isChecked("enable_market") || checkbox("enable_market") : cur.privacy.g_market[0] || (cur.privacy.g_market[0] = 1, val(
                    "privacy_edit_g_market", cur.privacy.g_market_types[1])), isVisible("group_edit_market") || GroupsEdit.toggleMarketBlock(!0)
            };
        ...
        ajax.post("groupsedit.php", {
            ...
            onDone: function(e) {
                if (e) {
                    ...
                    geByClass1("group_tokens_content_token", o)
                        .innerHTML = '<input type="text" class="group_tokens_content_token_unmask dark" readonly value="' + e + '">'
                }
            }
        })
    },
    callbackCheckUrl: function(e, t, o) {
        ...
        return s ? (lockButton(e), void ajax.post("groupsedit.php", {
            ...
            onDone: function(r) {
                "error" === r ? (unlockButton(e), GroupsEdit.callbackShowError(getLang("groups_api_error_failed"))) : "incorrect_url" == r ? (unlockButton(
                    e), GroupsEdit.callbackShowError(getLang("groups_api_incorrect_url"))) : GroupsEdit.callbackGetUrlCheckResult(t, o, r, e, 0)
            },
            onFail: function() {
                unlockButton(e)
            }
        ...
        return s > 20 ? (GroupsEdit.callbackShowError(getLang("groups_api_error_failed")), void unlockButton(r)) : void ajax.post("groupsedit.php", {
            ...
            onDone: function(a, i, n) {
                switch (a) {
                    ...
                    case "failed":
                        return n ? GroupsEdit.callbackShowError(getLang("groups_api_error") + " " + n) : GroupsEdit.callbackShowError(getLang(
                            "groups_api_error_failed"), i), void unlockButton(r)
                }
            },
            onFail: function() {
                unlockButton(r)
    ...
    callbackShowError: function(e, t) {
        hide("group_api_secret_error"), hide("group_api_secret_ok"), t ? (show("group_api_error_info"), cur.curlResult = cur.curlResult || {}, cur.curlResult.error = t) :
            hide("group_api_error_info"), val("group_api_error_msg", e), hide("group_api_ok"), show("group_api_error")
    },
    callbackShowOk: function() {
        hide("group_api_error"), show("group_api_ok"), show("group_api_settings"), hide("group_api_secret_error"), hide("group_api_secret_ok"), show(
            "groups_edit_delete_url")
    },
    ...
    callbackSaveSecret: function(e, t, o) {
        ...
        s && (hide("group_api_ok"), hide("group_api_error"), lockButton(e), ajax.post("groupsedit.php", {
            ...
            onDone: function(t) {
                unlockButton(e);
                var o = null;
                "length" == t ? o = getLang("groups_api_secret_too_long") : "pattern" == t ? o = getLang("groups_api_secret_wrong_pattern") : "ok" == t &&
                    (show("groups_edit_delete_secret"), show("group_api_secret_ok")), o ? (show("group_api_secret_error"), val("group_api_secret_error_msg",
                        o), hide("group_api_secret_ok")) : hide("group_api_secret_error")
            },
            onFail: function() {
                unlockButton(e)
            }
    ...
    certInitUploadBox: function(e, t, o, r) {
        e.setOptions({
            ...
            onUploadComplete: function(t, o) {
                if (e.hideProgress(), "ok" === (o || "")
                    .substring(0, 2)) {
                    show("groups_edit_cert_uploaded"), show("groups_edit_cert_updating"), hide("groups_edit_cert_not_uploaded"), hide("groups_edit_cert_ready"),
                        e.hide();
                    var s = o.substring(3);
    ...
    callbackUpdateCertResult: function(e, t, o) {
        t > 30 || ajax.post("groupsedit.php", {
            ...
            onDone: function(r) {
                "false" == r ? setTimeout(GroupsEdit.callbackUpdateCertResult.pbind(e, t + 1, o), 1e3) : (hide("groups_edit_cert_updating"), show(
                    "groups_edit_cert_ready"))
            },
            onFail: function() {}
        })
    },
