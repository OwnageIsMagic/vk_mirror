var Photoview = {
        ...
        updateHeight: function() {
            var h = cur.pvBox.offsetHeight + 110,
        ...
        actionInfo: function() {
            return ge('pv_action_info') || cur.pvWide.insertBefore(ce('div', {
                id: 'pv_action_info'
            }), cur.pvTags);
        },
        ...
        _updateSizeSwitcher: function() {
            var ph = cur.pvCurPhoto,
                pvsActionsSSEl = geByClass1('pvs_action_ss');
            if (ph.y_src || ph.y_) {
                show(pvsActionsSSEl);
            } else {
                hide(pvsActionsSSEl);
        ...
        createLayer: function() {
            ...
            cur.pvFixed = bodyNode.appendChild(ce('div', {
                className: 'pv_fixed fixed ' + colorClass,
                innerHTML: '\
...
<div id="pv_box" onclick="cur.pvClicked = true;">\
  <a class="fl_r pv_close_link" onclick="Photoview.hide(0)">' +
  ...
  <div id="pv_photo_wrap" style="' + pwStyle +
    ...
    <div class="no_select pv_data">\
      ...
      <div class="pvs_hh"' +
                hhHide +
                ' id="pv_hh"><div class="pvs_hh_cover"><div class="pvs_hh_bg"></div><div class="pvs_hh_fg" id="pv_hh_fg" onmouseover="Photoview.hhOver(this)" onmouseout="Photoview.hhOut(this)" onmousedown="return Photoview.hhClick(this, event, 1)"></div></div></div>\
        <div class="pvs_actions" id="pvs_actions"> \
          <div class="pvs_action" id="pvs_action_fs" ' +
                fsHide +
                ' onclick="return Photoview.fullscreen();"><div></div></div> \
    ...
    <div class="clear_fix select_fix" id="pv_comments_data">\
      <div class="fl_l wide_column">\
        ...
        <div id="pv_your_comment" class="clear clear_fix" onclick="return cancelEvent(event);">\
          <div id="pv_comment_header">' +
                getLang('photos_yourcomment') + '</div>\
          <div class="pv_comment_cont">\
            <div id="pv_reply_smile" title="' + stripHTML(getLang(
                    'photos_reply_emoji_hint')) +
                '" class="emoji_smile fl_l" onmouseover="return Photoview.emojiShowTT(this, event);" onmouseout="return Photoview.emojiHideTT(this, event);" onmousedown="return cancelEvent(event);"><div class="emoji_smile_icon_on"></div><div class="emoji_smile_icon"></div></div>\
            <div id="pv_comment" placeholder="' +
                getLang('wall_reply_to_post') +
                '" contenteditable="true" onkeyup="Photoview.commentChanged()" onkeypress="onCtrlEnter(event, Photoview.sendComment);"></div>\
          </div>\
          <div id="pv_comment_warn"></div>\
          <div id="pv_media_preview" class="clear_fix"></div>\
          <div id="pv_comment_submit">\
            <button class="flat_button fl_l" id="pv_comment_send">' +
                getLang('box_send') + '</button>\
            ...
            <div id="pv_add_media" class="fl_r">\
              <span class="add_media_lnk">' +
                getLang('global_add_media') +
                '</span>\
            </div>\
          </div>\
        </div>\
  ...
  <div id="pv_albums_wrap" style="' +
                awStyle + '">' + albumsHtml + '</div>\
  <div id="pv_album_wrap" ' + (cur.pvsaMini ? 'class="pv_album_wrap_mini"' : '') + ' style="' + sawStyle + '">' +
                albumHtml + '</div>\
  <div id="pv_vtagged_wrap" style="' + vtStyle + '">' + pvVTagsHtml +
                '</div>\
</div>\
\
...
<div class="no_select" id="pv_left_nav" ' +
                'onmouseover="Photoview.activate(cur.pvLeft)" onmouseout="Photoview.deactivate(cur.pvLeft)" onmousedown="cur.pvClicked = true; Photoview.show(false, cur.pvIndex - 1, event);" onselectstart="return cancelEvent(event);"></div>\
<div class="no_select" id="pv_right_nav" ' +
                'onmouseover="Photoview.activate(cur.pvClose)" onmouseout="Photoview.deactivate(cur.pvClose)" onmousedown="cur.pvClicked = true; Photoview.onLayerClick(event, true);"></div>\
<div class="pv_switch no_select" id="pv_switch" onmouseover="if (!browser.msie6) Photoview.activate(this)" onmouseout="if (!browser.msie6) Photoview.deactivate(this)" onmousedown="Photoview.switchColor(this); cur.pvClicked = true;"><div class="pv_switch_wrap"><img class="pv_switch_img" width="10" height="22" src="/images/photoswitch' +
                (window.devicePixelRatio >= 2 ? '_2x' : '') + '.png" /></div></div>\
    ';

            if (cur.pvYourComment) {
                domPN(ge('pv_your_comment'))
                    .replaceChild(cur.pvYourComment, ge('pv_your_comment'));
            }
            extend(cur, {
                pvCont: domFC(layer),
                pvBox: ge('pv_box'),
        ...
        show: function(listId, index, ev, root) {
            ...
            if (otherList) {
                var needControls = (count > 1) || ((cur.pvJumpTo || {})
                    .z == 'albums' + val('pva_owner')) || ((cur.pvJumpTo || {})
                    .z == 'album' + val('pvsa_album'));
            ...
            if (listId == 'temp' && !cur.pvOptions.temp_final) {
                ...
                cur.pvSummary.innerHTML = ((count > 1) ? getLang('photos_photo_num_of_N')
                    .replace('%s', cur.pvIndex + 1)
                    .replace(/%s|{count}/, count) : getLang('photos_view_one_photo'));
            }
        ...
        doShow: function() {
            ...
            if (vk.pvbig) {
                ...
                domPN(cur.pvSummary)
                    .style.width = (cur.pvActualWidth - 4) + 'px';
            }
            ...
            var ph = cur.pvCurPhoto,
                notAvail = (ph.commshown >= 0) ? false : (-ph.commshown);
            ...
            actionsHTML +=
                ...
                taglnkst + '>' + getLang('photos_tagperson') + '</a>';
            ...
            if (ph.actions.dialog) {
                actionsHTML += '<a id="pv_to_dialog" onclick="showBox(\'al_page.php\', {act: \'owner_photo_edit\', photo: \'' + ph.id + '\', oid: ' + ph.actions.dialog +
                    ', list: \'' + cur.pvListId + '\'}, {stat: [\'owner_photo.css\', \'owner_photo.js\', \'tagger.css\', \'tagger.js\']});">' + getLang('photos_load_to_dialog') +
                    '</a>';
            }
            ...
            actionsHTML += '<a id="pv_open_original" target="_blank" href="' + Photoview.genData(ph, 'w')
                .src + '">' + getLang('photos_pv_act_open_original') + '</a>';

            if (ph.actions.spam) {
                var reportReasons = JSON.stringify(cur.pvReasons)
                    .replace(/\"/g, '&quot;');
            ...
            var likeop = (ph.liked ? 1 : 0.4),
                likest = (browser.msie && browser.version <= 8) ? ('filter: alpha(opacity=' + Math.floor(likeop * 100) + ')') : ('opacity: ' + likeop);

            var commstyle = '',
                commshown = '',
                commlink = '',
                commclass = '',
                commslikes = cur.pvCommsLikes[ph.id],
                comms = commslikes[0],
                likes = commslikes[1];;
...
<div id="pv_comments_header" class="clear ' + commclass + '"' +
                commstyle + ' onclick="Photoview.comments()">\
  <div>' + commshown +
                '</div><div id="pv_comments_progress" class="progress"></div>\
</div>\
<div id="pv_comments" class="clear wall_module">' + (comms.tagName ? '' : comms) +
                '</div>',
                commsNode;

            var tagsst = ph.tagshtml ? '' : ' style="display: none"',
                descText = '<div' + (ph.actions.edit & 1 ? (' class="pv_can_edit" onclick="Photoview.editInline(event)"' + (ph.desc ? (' onmouseover="Photoview.descTT(this)"') :
                    '')) : ' class="pv_cant_edit"') + '>' + (ph.desc || ('<span class="pv_desc_edit">' + getLang('photos_edit_desc') + '</span>')) + '</div>',
                placeText = ph.place ? ('<span class="pv_place_label">' + getLang('photos_place_label') +
                    '</span> <a class="pv_place_a" id="pv_place_a" onclick="Photoview.showPlace()">' + ph.place + '</a>') : '',
                addPlace = ph.actions.place ? ('<span' + (placeText ? ' style="display: none;"' : '') +
                    ' id="pv_add_place"><span class="divider fl_l">|</span><a class="fl_l" id="pv_app_place_link" onclick="Photoview.editPlace();">' + getLang(
                        'photos_edit_add_place') + '</a></span>') : '';
            ...
            if (ph.chronicle) {
                var photoApp =
                    '<a onmouseover="wall.postTooltip(this, \'snapster\', {i: -1, dark: 1})" onclick="if (!checkEvent(event)) {showBox(\'/snapster.php\', {act: \'show\'}, {containerClass: \'chronicle_layer\', dark: 1}); return false;}" href="http://snapster.io/" class="pv_chronicle_icon"></a>';
            } else {
                var photoApp = '';
            }
...
<div id="pv_desc" style="' + ((ph.actions.edit & 1 || ph.desc) ? '' : 'display: none') + '">' + descText +
                '</div>\
<div id="pv_microdata">' + (ph.microdata_html ? ph.microdata_html : '') + (ph.microdata_preview_button ? ph.microdata_preview_button : '') +
                '</div>\
<div id="pv_place">' + placeText + '</div>\
<div id="pv_tags"' + tagsst + '>' + getLang('photos_onthisphoto') + ': ' + ph.tagshtml +
                '</div>\
<div id="pv_inlineedit_prg" class="fl_r progress"></div>\
<div id="pv_date_wrap" class="fl_l">' + getLang('photos_added') + ' <span id="pv_date">' +
                ph.date + '</span><span id="pv_date_app">' + photoApp + '</span></div>\
' + addPlace + (cur.pvNoLikes ? '' :
...
<div id="pv_like_wrap" class="fl_l" onmouseover="Photoview.likeOver()" onmouseout="Photoview.likeOut()" onclick="Photoview.like()">\
  <span class="fl_l" id="pv_like_link">' +
                    getLang('photos_i_like') + '</span>\
  <i class="fl_l' + (likes ? '' : ' nolikes') + '" id="pv_like_icon" style="' + likest +
                    '"></i>\
...
<td class="info">' + ph.taginfo +
                    '</td>\
<td><nobr><button class="flat_button" id="pv_confirm_tag">' + getLang('photos_confirm_tag') +
                    '</button></td>\
<td><nobr><button class="flat_button secondary" id="pv_delete_tag">' + getLang('photos_delete_tag') +
                    '</button></td>\
<td><div id="pv_tag_handling" class="progress"></div></td>\
                ...
                ge('pv_confirm_tag')
                    .onclick = Photoview.confirmTag.pbind(ph.tagid);
                ge('pv_delete_tag')
                    .onclick = Photoview.deleteTag.pbind(ph.tagid);
            } else {
                hide(cur.pvTagInfo);
        ...
        afterShow: function() {
            ...
            var x = cur.pvPhoto.firstChild.offsetLeft,
                y = cur.pvPhoto.firstChild.offsetTop;
        ...
        canFullscreen: function() {
            ...
            return !b.mobile && (document.fullscreenEnabled || document.msFullscreenEnabled || document.mozFullScreenEnabled || document.webkitFullscreenEnabled || b.safari &&
                v > 5);
        },
    ...
    <td>\
      <div class="pvs_header_wrap"><div class="pvs_header"><span class="pvs_header_text">' +
                name + '</span></div></div>\
      <div class="pvs_acts">' + rows +
                '</div>\
    ...
    <td class="pvs_side_sh"><div class="pvs_side_sh_el"></div></td>\
        ...
        report: function(hash, reason) {
            ...
            ajax.post('reports.php', {
                ...
                onDone: function(text) {
                    ...
                    cont.parentNode.replaceChild(ce('div', {
        ...
        moveToAlbum: function(photoId, albumId, hash) {
            ajax.post('al_photos.php', {
                ...
                onDone: function(albumLink, albumId) {
                    ...
                    showDoneBox('<div class="pv_done_box">' + getLang('photos_move_to_album_success')
                        .replace('{album}', albumLink) + '</div>');
                }
            });
        },
        ...
        hide: function(noLoc, fromQueue) {
            ...
            if ((cur.pvJumpTo || {})
                .z == 'albums' + val('pva_owner') && !cur.pvAlbumsShown && noLoc === 0) {
                return Photoview.jumpToAlbums(true);
            }
            if ((cur.pvJumpTo || {})
                .z == 'album' + val('pvsa_album') && !cur.pvAlbumShown && noLoc === 0) {
                return Photoview.jumpToAlbum(true);
            }
            if ((cur.pvJumpTo || {})
                .z == 'tag' + val('pvsa_tag') && !cur.pvPhotoTagShown && noLoc === 0) {
        ...
        editInline: function(ev, noreq) {
            if (((ev || window.event || {})
                    .target || {})
                .tagName == 'A' || cur.pvEditing) return;
...
<div style="margin: ' + mrg + '">\
  <textarea id="pv_edit_text"' + taStyle +
                            ' onkeydown="onCtrlEnter(event, Photoview.saveInline)" onkeyup="checkTextLength(cur.pvCaptionLimit, this, ge(\'pv_caption_warn\'));" placeholder="' +
                            getLang('photos_edit_desc_intro') + '">' + text + '</textarea>\
  <div id="pv_caption_warn"></div>\
        ...
        updateComms: function() {
            ...
            var commshown = '',
                commprg = ge('pv_comments_progress'),
                commheader = ge('pv_comments_header');
            if (ph.commcount > ph.commshown) {
                commshown = getLang('photos_show_prev_comments', ph.commcount - ph.commshown);
            }
        ...
        commentClick: function(el, event, from) {
            var comm = el.id.replace('pv_comment', ''),
                cmnt = comm.split('_');
        ...
        commentTo: function(comm, toId, event) {
            var cmnt = (comm || '')
                ...
                replyNameOld = cur.pvReplyTo && cur.pvReplyNames[cur.pvReplyTo[0]] || '',
                replyName = cur.pvReplyNames[toId] || '',
                rf = cur.pvComment,
                tl = ge('pv_reply_to_title');
            ...
            var v = trim(val(rf)),
                cEl = comm && geByClass1('pv_reply_to', ge('pv_comment' + comm));
            if (!v || replyNameOld && !winToUtf(replyNameOld[1])
                .indexOf(v)) {
        ...
        sendComment: function(ev, stickerId) {
            var listId = cur.pvListId,
                ...
                replyToName = (cur.pvReplyNames[(cur.pvReplyTo || {})[0]] || [])[1],
                btn = 'pv_comment_send';
            ...
            if (stickerId) {
                ...
                var params = comp ? Composer.getSendParams(comp, Photoview.sendComment) : {
                    message: trim(val(fld))
                };
        ...
        commDone: function(comm, context, text, del, script) {
            ...
            var msg = node.firstChild.nextSibling,
                ph = context ? false : cur.pvData[cur.pvListId][cur.pvIndex];
            if (!text) {
        ...
        commAction: function(act, comm, context, hash) {
            ...
            ajax.post('al_photos.php', {
                ...
                context: context,
                hash: hash
            }, Photoview.commParams(comm, context));
        },
        ...
        onMouseMove: function(ev) {
            ...
            var elemXY = getXY(el),
                ph = cur.pvData[cur.pvListId][cur.pvIndex];
            var x = (ev.pageX - elemXY[0]) * 100 / cur.pvPhWidth,
                y = (ev.pageY - elemXY[1]) * 100 / cur.pvPhHeight;
        ...
        onResize: function() {
            ...
            if (cur.pvAlbumsShown || cur.pvAlbumShown || cur.pvPhotoTagShown) {
                ...
                if (lnk && lnk.firstChild && cur.pvCurData.src == lnk.firstChild.src && cur.pvCurData.width) {
                    ...
                    var x = lnk.firstChild.offsetLeft,
                        y = lnk.firstChild.offsetTop;
        ...
        switchSize: function() {
            ...
            if (vk.id) {
                ...
                cur.pvSaveBig = setTimeout(ajax.post.pbind('al_photos.php', {
                    act: 'viewer_big',
                    big: (vk.pvbig ? 1 : ''),
                    hash: cur.pvHash
                }), 1000);
        ...
        switchColor: function(el) {
            ...
            if (vk.id) {
                ...
                cur.pvSaveColor = setTimeout(ajax.post.pbind('al_photos.php', {
                    act: 'viewer_color',
                    dark: (vk.pvdark ? 1 : ''),
                    hash: cur.pvHash
                }), 1000);
  ...
  <td><div id="pv_tag_handling" class="progress"></div></td>\
        ...
        likeUpdate: function(my, count, title) {
            ...
            var listId = cur.pvListId,
                index = cur.pvIndex,
                ph = cur.pvData[listId][index];
            var countInput = ge('like_real_count_photo' + ph.id) || {},
                rows = ge('like_table_photo' + ph.id);
            var titleNode = ge('like_title_photo' + ph.id),
                countNode = ge('pv_like_count');
        ...
        likeShare: function(hash) {
            ...
            var listId = cur.pvListId,
                index = cur.pvIndex,
                ph = cur.pvData[listId][index];
            var el = ge('like_share_photo' + ph.id),
                was = isChecked(el);
            checkbox(el);
            ajax.post('like.php', {
        ...
        likeOut: function() {
            var listId = cur.pvListId,
                ...
                ph = cur.pvData[listId][index];
            if (!ph.liked) {
                setTimeout(animate.pbind(cur.pvLikeIcon, {
                    opacity: 0.4
                }, 200, false), 1);
            }
        },
        ...
        deleteTag: function(tagId) {
            ...
            ajax.post('al_photos.php', {
                ...
                onDone: function(text, tags, tagged, html, padres) {
                    if (_pads.shown == 'ph') {
                ...
                showProgress: function() {
                    if (ph.tagid) {
                        hide(ge('pv_confirm_tag')
                            .parentNode, ge('pv_delete_tag')
                            .parentNode);
                        show('pv_tag_handling');
                    } else {
                        Photoview.actionInfo()
                            .innerHTML = '<div id="pv_action_progress" class="progress" style="display: block"></div>';
                    }
                },
                hideProgress: function() {
                    if (ph.tagid) {
                        hide('pv_tag_handling');
                        show(ge('pv_confirm_tag')
                            .parentNode, ge('pv_delete_tag')
                            .parentNode);
                    } else {
        ...
        confirmTag: function(tagId) {
            ...
            ajax.post('al_photos.php', {
                ...
                onDone: function(tags, tagged, html, padres) {
                    if (_pads.shown == 'ph') {
                        Pads.phDone(ph.id, false, padres);
                    }
                    Pads.invalidate('ph');
        ...
        photoAct: function(ev) {
            ...
            if (dx < 120 && dy < 130 && dy > -45) {
                ...
                show(next);
                animate(next.firstChild, {
                    opacity: 1
                }, 400);

                if (!cur.rvPreloadBig) {
                    vkImage()
                        .src = '/images/icons/post_big_hh.png';
  ...
  <div class="pva_repeat_cont"><img class="pva_repeat_img png" src="' + stManager._srcPrefix('.css') +
        ...
        updatePlace: function(photo, place) {
            ...
            if (place) {
                ...
                ge('pv_place')
                    .innerHTML = place ? '<span class="pv_place_label">' + getLang('photos_place_label') +
                    '</span> <a class="pv_place_a" id="pv_place_a" onclick="Photoview.showPlace()">' + place + '</a>' : '';
                hide('pv_add_place');
            } else {
                setTimeout(function() {
                    ajax.post('al_photos.php', {
        ...
        nearProgress: function(obj) {
            obj.insertBefore(ce('div', {
                className: 'pv_load_near'
            }), obj.firstChild);
        },
