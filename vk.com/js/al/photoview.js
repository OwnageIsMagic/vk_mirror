var Photoview = {
        ...
        openStickersEditor: function(o) {
            cur.pvEditorMode || (o || (o = cur.pvCurPhoto), Photoview.toggleNavControls(), hide(cur.pvLikeFSWrap), Photoview.hideTag(!0), cur.pvEditorMode = !0, Photoview.updatePhotoDimensions(),
                stManager.add(["spe.js"], function() {
                    SPE.init(o, function(e, t, r, a) {
                        ...
                        if (cur.pvListId) {
                            ...
                            if (i) {
                                var f = extend({}, e);
                                _ = ++cur.pvIndex, w.splice(_, 0, f), h = f, cur.pvCommsLikes[h.id] = [h.comments, 0, vkNow(), !1], delete h.comments, delete h
                                    .likes
                            }
                            var P = cur.pvShown && m == cur.pvListId && _ == cur.pvIndex;
                            e && t && !i && (Photoview.changeThumbs(t, r, o.id), delete h.x_, delete h.x_src, delete h.y_, delete h.y_src, delete h.z_, delete h
                                .z_src, extend(h, e)), h.pe_type = Photoview.PE_V3, P && (cur.pvCurData = Photoview.genData(h, Photoview.getPhotoSize()),
                                domFC(cur.pvPhoto)
                                .src = Photoview.blank, setTimeout(Photoview.show.pbind(cur.pvListId, cur.pvIndex), 0))
                        }
                    }, function() {
                        return delete cur.pvEditorMode, delete cur.pvEditorModeDimensionsUpdated, o.closeOnPEEdit ? Photoview.hide(0) : (show(cur.pvLikeFSWrap),
                            Photoview.toggleNavControls(["left", "right", "close"]), void setTimeout(Photoview.updatePhotoDimensions, 1))
                    })
                }))
        },
        genUrl: function(o, e) {
        ...
        createLayer: function() {
            ...
            var e = "display: none",
                ...
                p = o ? e : "",
                v = o ? "" : e,
                s = cur.pvAlbumsShown ? "" : e,
                n = cur.pvAlbumShown ? "" : e,
                c = cur.pvVideoTagsShown ? "" : e;
            cur.pvPhotoTagShown && (a = cur.pvPhotoTagData[cur.pvPhotoTagShown].html, n = ""), ge("pv_comments") && (cur.pvBackupComments = ge("pv_comments"), domPN(ge(
                    "pv_comments"))
            ...
            var u = '<div style="' + v +
                ...
                _ = getProgressHtml("pv_image_progress"),
            ...
            layer.innerHTML =
                ...
                g + "          </div>" + m + '        </div>        <div id="pv_albums_wrap" class="pv_white_bg photos_container_albums" style="' + s + '">' + r +
                '</div>        <div id="pv_album_wrap" class="pv_white_bg" style="' + n + '">' + a + '</div>        <div id="pv_vtagged_wrap" class="pv_white_bg" style="' + c +
        ...
        doShow: function() {
            ...
            if (cur.pvShown) {
                ...
                Photoview.toggleLightModeClass(!0), isVisible(cur.pvAlbumsWrap) && (val("pva_scroll", layerWrap.scrollTop), hide(cur.pvAlbumsWrap), show(cur.pvPhotoWrap),
                    ...
                    Photoview.updateSize()), uiScrollBox.hide(), hide(cur.pvTitle);
                ...
                addClass(cur.pvHH, "no_transition"), toggleClass(cur.pvHH, "pv_liked", !!p.liked), setTimeout(removeClass.pbind(cur.pvHH, "no_transition"), 2), cur.pvTagger &&
                    Phototag.stopTag(), Photoview.hideTag(!0), (e.width < 200 || e.height < 200) && (p.actions.prof = !1, p.actions.dialog = !1);
                var s = "";
                ...
                if (!cur.pvIsLightMode && !n) {
                    ...
                    var u = "";
                    "NA" != p.author && (u = p.author), u && (p.author_href && (c += '<a class="pv_author_img fl_l" href="' + p.author_href + '">'), c +=
                            '<div class="ow_ava ow_ava_comm" style="background-image: url(\'' + p.author_photo + "');\"></div>", p.author_href && (c += "</a>")), c +=
                        '        <div class="pv_author_info">           <div id="pv_author_name">' + u +
                        '</div>           <div class="pv_date_info_wrap">             <span id="pv_date_info">' + p.date +
                        "</span>           </div>         </div>       </div>", c += getProgressHtml("pv_progress");
                    var l = p.liked ? "pv_liked" : "",
                        d = cur.pvCommsLikes[p.id],
                        h = d[0],
                        g = d[1];
                    c += '<div id="pv_like" class="pv_like _like_wrap ' + l +
                        '" onmouseover="Photoview.likeOver(this)" onclick="Photoview.like();">         <i class="pv_like_icon _icon"></i>         <span class="pv_like_link _link">' +
                        getLang("photos_i_like") + '</span>         <span class="pv_like_count _count">' + (g || "") + "</span>       </div>";
                    var m = 1 & p.actions.edit || p.desc;
                    if (m) var _ = (p.desc, "<div" + (1 & p.actions.edit ? ' class="pv_can_edit pv_desc_cont" onclick="Photoview.editInline(event)"' + (p.desc ?
                        ' onmouseover=""' : "") : ' class="pv_cant_edit pv_desc_cont"') + ">" + (p.desc || '<span class="pv_desc_edit">' + getLang(
                        "photos_edit_desc") + "</span>") + "</div>");
                    c += '<div id="pv_desc" class="pv_right_block" style="' + (m ? "" : "display: none") + '">' + _ + "</div>", c += '<div id="pv_microdata">' + (p.microdata_html ?
                        p.microdata_html : "") + (p.microdata_preview_button ? p.microdata_preview_button : "") + "</div>", p.microdata_html && shortCurrency();
                    ...
                    c += '<div id="pv_place" class="pv_right_block">' + f + "</div>", c += h.tagName ? '<div id="pv_comments_place"></div>' : trim(h), cur.pvReplyForm && re(
                            cur.pvReplyForm), cur.pvReplyForm = null, c +=
                        ...
                        "", Photoview.updateRightBlock(), cur.pvNarrow.innerHTML = c;
                    var P = geByClass1("pv_closed_commments_placeholder");
                    if (v || !p.actions.comm ? removeClass(P, "unshown") : p.reply_form && (addClass(P, "unshown"), p.replyFormEl = cur.pvReplyForm = p.replyFormEl || se(p.reply_form),
                            cur.pvNarrowColumn.appendChild(cur.pvReplyForm), cur.onReplyFormSizeUpdate = cur.onMediaChanged = function(o) {
                ...
                s = s || "", cur.pvAlbumName.innerHTML = s;
                var C = [];
                if (vk.id && C.push('<a id="pv_share" onclick="Photoview.sendPhoto()">' + getLang("photos_share_from_view") + "</a>"), !p.taginfo && p.actions.tag && p.tags[0] <
                    cur.pvMaxTags && C.push(
                        "<a id=\"pv_tag_link\" onclick=\"stManager.add(['phototag.js', 'phototag.css', 'tagger.css', 'tagger.js'], function() { Phototag.startTag(); })\">" +
                        getLang("photos_tagperson") + "</a>"), p.actions.del && C.push('<a id="pv_delete" onclick="Photoview.deletePhoto()">' + getLang("photos_pv_act_delete") +
                        "</a>"), p.actions.save && C.push('<a id="pv_save_to_me" onclick="Photoview.savePhoto()">' + getLang("photos_pv_act_save") + "</a>"), cur.pvShowBottomActions &&
                    !n) {
                    var L = [],
                        y = [];
                    if (p.actions.spam && (L.push(["spam", getLang("photos_report"), "", "Photoview.showSpamActions()"]), L.push("sep"), y = cur.pvReasons), p.actions.edit &&
                        (p.pe_type & Photoview.PE_V1 || p.pe_type & Photoview.PE_V2) && L.push(["pe", getLang("photos_pv_act_photoeditor"), "Photoview.openEditor()"]), p.pe_type &
                        Photoview.PE_V3 && isPhotoeditor3Available() && !inArray(nav.objLoc[0], ["support", "helpdesk"]) && L.push(["spe", getLang("global_pe_edit"),
                            "Photoview.openStickersEditor()"
                        ]), p.actions.rot && (L.push(["rotate_ccw", getLang("photos_pv_act_rotate_ccw"), "Photoview.rotatePhoto(-1)"]), L.push(["rotate_cw", getLang(
                            "photos_pv_act_rotate_cw"), "Photoview.rotatePhoto(1)"]), L.push("sep")), p.actions.place && L.push(["place", getLang("photos_edit_add_place"),
                            "Photoview.editPlace()"
                        ]), p.actions.prof && L.push(["to_profile", getLang("photos_pv_act_to_avatar"), "showBox('al_page.php', {act: 'owner_photo_edit', photo: '" + p.id +
                            "'}, {stat: ['owner_photo.css', 'owner_photo.js', 'tagger.css', 'tagger.js']})"
                        ]), p.actions.dialog && L.push(["to_dialog", getLang("photos_load_to_dialog"), "showBox('al_page.php', {act: 'owner_photo_edit', photo: '" + p.id +
                            "', oid: " + p.actions.dialog + ", list: '" + cur.pvListId + "'}, {stat: ['owner_photo.css', 'owner_photo.js', 'tagger.css', 'tagger.js']});"
                        ]), p.actions.move) {
                        var S = p.id.split("_")[0];
                        L.push(["move_to", getLang("photos_pv_act_move_to_album"), "showBox('al_photos.php', {act: 'a_move_to_album_box', photo_id: '" + p.id + "', owner_id: " +
                            S + "}, {stat: ['page.js', 'page.css', 'wide_dd.js', 'wide_dd.css']})"
                        ]), p.actions.cover && L.push(["as_title", getLang("photos_album_to_cover"), "ajax.post('al_photos.php', {act: 'a_set_as_album_title', photo: '" +
                            p.id + "', hash: '" + p.hash + "'}, {onDone: showDoneBox})"
                        ])
                    }
                    var x = "";
                    each(y, function(o, e) {
                    ...
                    var I = "";
                    each(L, function(o, e) {
                            I += "sep" == e ? '<div class="pv_more_act_item_sep"></div>' : '<div class="pv_more_act_item" onmouseover="' + (e[3] || "") + '" onclick="' + (
                                e[2] || "") + '" id="pv_more_act_' + e[0] + '">' + e[1] + "</div>"
                        }), I += '<a class="pv_more_act_item" id="pv_more_act_download" target="_blank" href="' + Photoview.genData(p, "w")
                        .src + '">' + getLang("photos_pv_act_open_original") + "</a>", I = '<div class="pv_more_acts">' + I + "</div>", L.length ? (L = JSON.stringify(L), L =
                            L.replace(/\"/g, "&quot;"), C.push('<a class="pv_actions_more" data-items="' + L + '">' + getLang("photos_actions_more") + "</a>")) : inArray(nav.objLoc[
                            0], ["support", "helpdesk"]) && C.push('<a id="pv_more_act_download" target="_blank" href="' + Photoview.genData(p, "w")
                            .src + '">' + getLang("photos_pv_act_open_original") + "</a>"), C = C.join('<span class="divider"></span>'), cur.pvIsLightMode && (C +=
                        ...
                        ), cur.pvBottomActions.innerHTML = C;
                ...
                Photoview.updatePhotoDimensions(), extend(cur, {
                        ...
                        isArray(p.deleted) && Photoview.toggleTopInfoPanel(p.deleted[0], p.deleted[1]), hide(cur.pvHHWrap), n || Photoview.toggleDeletedState(!0)) : p.taginfo ?
                    (cleanElems("pv_confirm_tag", "pv_delete_tag", "pv_prof_cancel", "pv_prof_done"), Photoview.toggleTopInfoPanel(p.taginfo,
                        '        <button class="flat_button" id="pv_confirm_tag" onclick="Photoview.confirmTag(' + p.tagid + ', this)">' + getLang("photos_confirm_tag") +
                        '</button>         <button class="flat_button secondary black" id="pv_delete_tag" onclick="Photoview.deleteTag(' + p.tagid + ', this)">' + getLang(
        ...
        afterShow: function() {
            ...
            Photoview.updateLoc(), cur.pvCandidate && (o == document.URL && (o = ""), setTimeout(window.comScoreUDM && comScoreUDM.pbind(locProtocol + "//" + location.host +
                "/al_photos.php?comscorekw=pageview_candidate", o), 10), delete cur.pvCandidate), Photoview.updatePhotoDimensions()
        },
        ...
        updatePhotoDimensions: function(o) {
            if (!Photoview.isPhotosList() && !cur.pvEditorModeDimensionsUpdated) {
                ...
                cur.pvEditorMode && (e = Photoview.PE_MIN_WIDTH, t = Photoview.PE_MIN_HEIGHT, cur.pvEditorModeDimensionsUpdated = !0), removeClass(cur.pvBottomInfo,
                    "pv_with_line_break");
        ...
        likeUpdate: function(o, e, t) {
            ...
            if (p) {
                ...
                t && u && val(u, t), v && (v.likeInvalidated = !0), n && (n.value = e), animateCount(p, e), toggleClass(i, "pv_liked", o), toggleClass(i, "no_likes", !e),
                    toggleClass(c, "me_hidden", !o), e ? !v.el || isVisible(v.container) || t || tooltips.show(v.el, extend(s, {
                        showdt: 0
