var Fave = {
    ...
    getLinkInfo: function(e) {
        ...
        return r ? (cur.lnkSent = r, void ajax.post("al_fave.php", {
            ...
            onDone: function(n, a, o, s) {
                return r != cur.lnkSent ? !1 : (Fave.hideMessage(), 0 > n ? (Fave.showMessage(a, !0), elfocus(e)) : (cur.lnk = a, ge("fave_al_link_info")
                    .innerHTML = o, placeholderInit("fave_al_position"), elfocus("fave_al_position"), void 0))
            },
            progress: n.progress
        })) : elfocus(e)
    },
        ...
        if (e || !isVisible(r.progress)) {
            ...
            ajax.post("al_fave.php", {
                ...
                onDone: function(e, n) {
                    if (e) {
                        var a, o;
                        ge("empty_links") ? (o = ge("empty_links"), a = o.parentNode) : ge("links") && (o = ge("links"), a = o.parentNode), a.removeChild(o), a
                            .innerHTML += n, r.hide()
    ...
    updateList: function() {
        var e = val("fave_search")
            .toLowerCase();
        if (e = trim(e), 0 == e.length) return cur.prevQuery && cur.prevQuery.length > 0 && (Fave.drawUsers(cur.faveData.faveUsers), show(ge("users_online"))), cur.prevQuery =
            e, void("users" == cur.section && cur.faveSorter && cur.faveSorter.disable());
    ...
    init: function() {
        extend(cur, {
            ...
            }), Fave.scrollNode = browser.msie6 ? pageNode : window, addEvent(Fave.scrollNode, "scroll", Fave.scrollCheck), addEvent(window, "resize", Fave.scrollCheck),
        ...
        ("users" == cur.section || "users_online" == cur.section) && elfocus(e), cur.faveData.faveUsers && cur.faveData.faveUsers.length > 0 && "users" == cur.section &&
            Fave.initSorter(), setTimeout(Fave.scrollCheck, 0)
    },
    ...
    remove: function(e, r, n, a, o) {
        return e.tt && e.tt.destroy && e.tt.destroy(), showFastBox({
            ...
            .replace("{user}", n), getLang("global_delete"),
            function() {
                isVisible(curBox()
                    .progress) || ajax.post("al_fave.php", {
                    act: "unfave_user",
                    uid: r,
                    hash: a
                }, {
