function PhotoEdit(t, e, r, i, a, o) {
    function n() {
        if (d._imageLoaded) {
            var t = x.width / f,
                e = x.height / f;
            if (t > e ? (i.width = Math.min(t, i.maxEditorSizeWidth), i.height = Math.round(e / t * i.width)) : (i.height = Math.min(e, i.maxEditorSizeWidth), i.width = Math.round(
                    t / e * i.height)), m || (E = d._initCanvas("pe_main"), d._setCurrentContext("pe_main"), m = !0), v || (v = document.createElement("canvas"), v.width = x.width *
                    f, v.height = x.height * f, v.getContext("2d")
                    .drawImage(x, 0, 0, x.width * f, x.height * f)), d._initCanvas("pe_main"), x.width != i.width || x.height != i.height) {
    ...
    this.clean = function() {
        var t = A;
        t.currTexture && t.currTexture.destroy(), t.cleanCurrentTexture && t.cleanCurrentTexture.destroy(), x = null, p = null, v = null, T = null, w = null, re(t.canvasEl), t
            .canvasEl = null
    };
    var _ = 0;
    C.onload = function() {
        ...
        if (this._mode) {
            this.revert(), delete this.saturation, delete this.exposure, delete this.sepia, delete this.saturation, delete this.unsharpAmount, delete this.blurSize, delete this
                .blurPosition, delete this.blurType, delete this._text, delete this._fontType, delete this._mode, delete this._currentFilter, delete this._currentFilterAmount,
                this.setText("", 0), this.applyAuto(!1), this.resetCrop(), delete this.lastCrop;
        ...
        return this._mode = "filter", void 0 !== t && t != this._currentFilter && this.setFadeImage(), void 0 == t ? (t = this._currentFilter, e = this._currentFilterAmount) :
            (this._currentFilter = t, this._currentFilterAmount = e), t && "original" != t ? (void 0 == e && (e = 1), void this._applyFilter(t, e)) : (this.revert(), this._applyBlur(),
                this._drawText(), this.update(), void this.removeFadeImage())
        ...
        return A.gl.blurExclusion = A.gl.blurExclusion || new F(null,
            ...
            .textures({
                texture1: 1
            }), A.gl.blurExclusionTiltShift = A.gl.blurExclusionTiltShift || new F(null,
        ...
        e.onload = function() {
            ...
            x = document.createElement("canvas"), x.width = d, x.height = c, a = x.getContext("2d"), browser.safari && parseInt(browser.version) >= 8 && (a.translate(0, x.height),
                    a.scale(1, -1)), a.drawImage(r, h, u, d, c, 0, 0, d, c), t.isSaving = !0, t._setCurrentContext("pe_big_save"), t._initialize(), T = null, t.isAuto() &&
                t._auto(), s(x), t.setText(), t.applyChanges(), A.gl.canvas.toBlob(function(t) {
                    var e = new FormData;
        ...
        if (!(void 0 == t && void 0 == this._text || t == this._text && this._fontType == e)) {
            void 0 == t && (t = this._text, e = this._fontType), this._text = t.substr(0, 200), this._fontType = e, this.textCanvasEl = this.textCanvasEl || document.createElement(
                "canvas"), this.textCanvasEl.width = x.width, this.textCanvasEl.height = x.height;
            ...
            if (this.isSaving && browser.safari && parseInt(browser.version) >= 8 && (r.translate(0, this.textCanvasEl.height), r.scale(1, -1)), 1 == e) {
                ...
                i.addColorStop(0, "rgba(0, 0, 0, 0)"), i.addColorStop(1, "rgba(0, 0, 0, 0.3)"), r.fillStyle = i, r.fill(), r.shadowColor = "rgba(0, 0, 0, 1)", r.shadowOffsetX =
                    0, r.shadowOffsetY = 0, r.shadowBlur = .006 * x.width
            }
            ...
            for (var l = s.length - 1; l >= 0; l--) {
                if (0 == e) {
                    var C = 0;
                    0 == l && s.length > 1 ? (C = p, E = 1.1 * p + .04 * x.height) : C = v, lineHeight = 1.1 * C, r.font = C + "px 'ImpactPE'", 9999 == p && (p = v), r.lineWidth =
                        .08 * Math.max(v, p)
                } else r.font = .2 * a + "px 'Lobster'", lineHeight = .22 * a;
                r.lineJoin = "round";
                var g = r.measureText(s[l]);
                0 == e ? (r.strokeText(s[l], (x.width - g.width) / 2, E), r.fillText(s[l], (x.width - g.width) / 2, E)) : r.fillText(s[l], x.width / 2 - g.width / 2, E), E -=
                    lineHeight
            }
        ...
        this._text && (A.gl.textShader = A.gl.textShader || new F(null,
            "        uniform sampler2D originalTexture;        uniform sampler2D textTexture;        varying vec2 texCoord;        void main() {            vec4 color = texture2D(originalTexture, texCoord);            vec4 tc = texture2D(textTexture, texCoord);            color = mix(color, tc, tc.a); color.a = 1.0;             gl_FragColor = color;        }      "
        ), A.textTexture.use(10), A.gl.textShader.textures({
            textTexture: 10
        ...
        if (o) o.width = f * (e || i.width), o.height = f * (r || i.height), o.style.width = i.width + "px", o.style.height = i.height + "px";
            ...
            a.canvasEl = ge(t), a.canvasEl || (a.canvasEl = document.createElement("canvas"), a.canvasEl.id = t, a.canvasEl.width = e || i.width * f, a.canvasEl.height = r ||
                i.height * f, a.canvasEl.style.width = i.width + "px", a.canvasEl.style.height = i.height + "px");
            try {
                var n = {
    ...
    this._setCurrentContext = function(t) {
        ...
        if (!t.isInited) {
            ...
            t.texture && t.texture.destroy(), t.spareTexture && t.spareTexture.destroy(), t.extraTexture && t.extraTexture.destroy(), t.texture = new y(t.canvasEl.width, t.canvasEl
                    .height, t.gl.RGBA, e), t.spareTexture = new y(t.canvasEl.width, t.canvasEl.height, t.gl.RGBA, e), t.extraTexture = new y(0, 0, t.gl.RGBA, e), t.textTexture =
                new y(0, 0, t.gl.RGBA, e), t.flippedShader = new F(null,
                    "          uniform sampler2D texture;          varying vec2 texCoord;          void main() {              vec4 color = texture2D(texture, vec2(texCoord.x, 1.0 - texCoord.y));               gl_FragColor = color;           }      "
                ), t.isInited = !0
        }
    };
    var y = function() {
            function t(t, e, r, i) {
                var a = A;
                this.id = a.gl.createTexture(), this.width = t, this.height = e, this.format = r, this.type = i, a.gl.bindTexture(a.gl.TEXTURE_2D, this.id), a.gl.texParameteri(a.gl
                    .TEXTURE_2D, a.gl.TEXTURE_MAG_FILTER, a.gl.LINEAR), a.gl.texParameteri(a.gl.TEXTURE_2D, a.gl.TEXTURE_MIN_FILTER, a.gl.LINEAR), a.gl.texParameteri(a.gl.TEXTURE_2D,
                    a.gl.TEXTURE_WRAP_S, a.gl.CLAMP_TO_EDGE), a.gl.texParameteri(a.gl.TEXTURE_2D, a.gl.TEXTURE_WRAP_T, a.gl.CLAMP_TO_EDGE), t && e && a.gl.texImage2D(a.gl.TEXTURE_2D,
                    0, this.format, t, e, 0, this.format, this.type, null)
            }
            t.fromElement = function(e) {
                ...
                var e = A;
                this.width = t.width || t.videoWidth, this.height = t.height || t.videoHeight, e.gl.bindTexture(e.gl.TEXTURE_2D, this.id), e.gl.texImage2D(e.gl.TEXTURE_2D, 0,
                    this.format, this.format, this.type, t)
                ...
                }(t != this.width || e != this.height || r != this.format || i != this.type) && (this.width = t, this.height = e, this.format = r, this.type = i, A.gl.bindTexture(
                    A.gl.TEXTURE_2D, this.id), A.gl.texImage2D(A.gl.TEXTURE_2D, 0, this.format, t, e, 0, this.format, this.type, null))
            }, t.prototype.drawTo = function(t) {
                if (A.gl.framebuffer = A.gl.framebuffer || A.gl.createFramebuffer(), A.gl.bindFramebuffer(A.gl.FRAMEBUFFER, A.gl.framebuffer), A.gl.framebufferTexture2D(A.gl.FRAMEBUFFER,
                        A.gl.COLOR_ATTACHMENT0, A.gl.TEXTURE_2D, this.id, 0), A.gl.checkFramebufferStatus(A.gl.FRAMEBUFFER) !== A.gl.FRAMEBUFFER_COMPLETE) throw new Error(
            ...
            return t.prototype.swapWith = function(t) {
                var e;
                e = t.id, t.id = this.id, this.id = e, e = t.width, t.width = this.width, this.width = e, e = t.height, t.height = this.height, this.height = e, e = t.format,
                    t.format = this.format, this.format = e
            }, t
        }(),
        F = function() {
            function t(t) {
            ...
            function i(t, e) {
                var i = A;
                if (this.vertexAttribute = null, this.texCoordAttribute = null, this.program = i.gl.createProgram(), t = t || a, e = e || o, e = "precision highp float;" + e, i.gl
                    .attachShader(this.program, r(i.gl.VERTEX_SHADER, t)), i.gl.attachShader(this.program, r(i.gl.FRAGMENT_SHADER, e)), i.gl.linkProgram(this.program), !i.gl.getProgramParameter(
                        this.program, i.gl.LINK_STATUS)) throw "link error: " + i.gl.getProgramInfoLog(this.program)
            }
            var a =
                ...
                o =
                "      uniform sampler2D texture;      varying vec2 texCoord;      void main() {          vec4 color = texture2D(texture, texCoord);          gl_FragColor = color;      }";
            return i.prototype.destroy = function() {
                    ...
                    if (r.hasOwnProperty(a)) {
                        ...
                        if (null !== o) {
                            ...
                            if (t(n)) switch (n.length) {
                                ...
                                if (!e(n)) throw 'attempted to set uniform "' + a + '" to invalid value ' + (n || "undefined")
                                    .toString();
                                i.gl.uniform1f(o, n)
                            }
                        }
                ...
                e = e !== a ? (e - n[1]) / n[3] : 0, t = t !== a ? (t - n[0]) / n[2] : 0, r = r !== a ? (r - n[0]) / n[2] : 1, i = i !== a ? (i - n[1]) / n[3] : 1, o.gl.vertexBuffer ||
                    (o.gl.vertexBuffer = o.gl.createBuffer()), o.gl.bindBuffer(o.gl.ARRAY_BUFFER, o.gl.vertexBuffer), o.gl.bufferData(o.gl.ARRAY_BUFFER, new Float32Array([t, e,
                        t, i, r, e, r, i
                    ]), o.gl.STATIC_DRAW), o.gl.texCoordBuffer || (o.gl.texCoordBuffer = o.gl.createBuffer(), o.gl.bindBuffer(o.gl.ARRAY_BUFFER, o.gl.texCoordBuffer), o.gl.bufferData(
                        o.gl.ARRAY_BUFFER, new Float32Array([0, 0, 0, 1, 1, 0, 1, 1]), o.gl.STATIC_DRAW)), this.vertexAttribute || (this.vertexAttribute = o.gl.getAttribLocation(
                        this.program, "vertex"), o.gl.enableVertexAttribArray(this.vertexAttribute)), this.texCoordAttribute || (this.texCoordAttribute = o.gl.getAttribLocation(
                        this.program, "_texCoord"), o.gl.enableVertexAttribArray(this.texCoordAttribute)), o.gl.useProgram(this.program), o.gl.bindBuffer(o.gl.ARRAY_BUFFER, o.gl
                        .vertexBuffer), o.gl.vertexAttribPointer(this.vertexAttribute, 2, o.gl.FLOAT, !1, 0, 0), o.gl.bindBuffer(o.gl.ARRAY_BUFFER, o.gl.texCoordBuffer), o.gl.vertexAttribPointer(
                        this.texCoordAttribute, 2, o.gl.FLOAT, !1, 0, 0), o.gl.drawArrays(o.gl.TRIANGLE_STRIP, 0, 4)
