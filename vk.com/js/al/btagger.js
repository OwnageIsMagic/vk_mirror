    ...
    prototype: {
        move: function(e, t, r) {
            ...
            var o, h, d = clone(a),
                ...
                m = t.substr(0, 1);
            return h = function(e) {
                removeClass(this.corners, "btagger_active"), removeEvent(i, "mousemove", o), removeEvent(i, "mouseup", h), re(i), extend(this.opts.s, d), this.opts
                    .onMove(d)
                ...
                if (80 > i || 80 > o) {
                    var p = m,
                        c = g;
                    "m" != m && (80 > i ? (e.pageY += "t" == m ? i : -i, p = "t" == m ? "b" : "t") : 160 > i ? (e.pageY += "t" == m ? i - 160 : -(i - 160),
                        debugLog("case here")) : s + a[m] < 0 && (e.pageY += "b" == m ? s + a[m] : -(s + a[m]))), "m" != g && (80 > o ? (e.pageX += "l" == g ?
                        o : -o, c = "l" == g ? "r" : "l") : 160 > o ? (debugLog(o, r, a.w), e.pageX += "l" == g ? o - 160 : -(o - 160)) : r + a[g] < 0 && (
                        e.pageX += "r" == g ? r + a[g] : -(r + a[g]))), setTimeout(function() {
                        var t = geByClass1("btagger_" + p + c, ge("pv_filter_under"));
                        return h(), this.move(t, p + c, e)
                    }.bind(this), 0)
                }
                "m" != m && (s -= Math.min(s + a[m], 0), s -= Math.max(160 - a.h + s, 0)), "m" != g && (r -= Math.min(r + a[g], 0), r -= Math.max(160 - a.w + r, 0)),
                    "m" == g && "m" == m ? (s += Math.min(-s + a.t, 0), s -= Math.min(s + a.b, 0), r += Math.min(-r + a.l, 0), r -= Math.min(r + a.r, 0), d.t = a.t -
                        s, d.b = a.b + s, d.l = a.l - r, d.r = a.r + r, d.w = a.w, d.h = a.h) : "m" == g ? (d[m] = a[m] + s, d.h = a.h - s, d.w = a.w) : "m" == m ?
                    (d[g] = a[g] + r, d.w = a.w - r, d.h = a.h) : (d[g] = a[g] + r, d[m] = a[m] + s, d.w = a.w - r, d.h = a.h - s);
