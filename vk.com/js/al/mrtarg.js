    ...
    ! function(t, e) {
        t.RB = t.RB || function() {
            ...
            function l(t) {
                ...
                }(e) : H[e] && f(H[e].c) < 50 ? H[e].t && (clearTimeout(H[e].t), delete H[e].t) : H[e] && !s() ? H[e].t && (clearTimeout(H[e].t), delete H[e].t,
                    clearTimeout(w), t = !1) : H[e] || u(e);
            ...
            function h(t, e) {
                ...
                if (H[t]) {
                    ...
                    (new Image)
                    .src = e.getAttribute("data-counter"), u(t), y(H) || m()
                }
            }
            ...
            function f(i) {
                var n = {};
                if (n.w = n.h = 1 / 0, !isNaN(e.body.clientWidth) && e.body.clientWidth > 0 && (n.w = e.body.clientWidth), !isNaN(e.body.clientHeight) && e.body.clientHeight >
                    0 && (n.h = e.body.clientHeight), W && W.clientWidth && !isNaN(W.clientWidth) && (n.w = W.clientWidth), W && W.clientHeight && !isNaN(W.clientHeight) && (n
                        .h = W.clientHeight), t.innerWidth && !isNaN(t.innerWidth) && (n.w = Math.min(n.w, t.innerWidth)), t.innerHeight && !isNaN(t.innerHeight) && (n.h =
                        Math.min(n.h, t.innerHeight)), n.h == 1 / 0 || n.h == 1 / 0) n = {
                    E: ":-("
                };
                else {
