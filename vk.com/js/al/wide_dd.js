    ...
    var e = {
        ...
        _search: function(e, t) {
            ...
            for (i = 0, s = e.index[o].length; s > i; ++i) {
                for (var p = e.index[o][i], f = e.opts.items[p], v = !1, h = "", _ = 0; u > _; ++_) h += " " + (f[c[_]] || "")
                    .replace(e.opts.delimeter, " ")
                    .replace(/<[^>]*>/g, "");
                for (h = h.toLowerCase(), _ = 0, u = t.length; u > _; ++_)
                    if (-1 == h.indexOf(" " + t[_])) {
                        v = !0;
                        break
                    }
        ...
        _renderList: function(t, d, i, s) {
            var r = [],
                ...
                n = e._highlight,
                l = t.opts.itemMark;
            t.outdated && (s = !1), s ? a = t.list.childNodes.length : (t.shown = {}, a = 0);
                ...
                if (!(t.selected[v] || t.shown[v] || t.selCount && p[8] > 0)) {
                    ...
                    var h, _ = isArray(p[3]) ? "" : " " + onlinePlatformClass(l(p)),
                        m = p[3] ? '<b class="fl_l wddi_thumb' + _ + '"><img class="wddi_img" src="' + (isArray(p[3]) ? "/images/community_" + (window.devicePixelRatio >=
                            2 ? 100 : 50) + ".png" : p[3]) + '" /></b>' : "";
                    a ? h = "wddi" : (h = "wddi_over", t.over = f);
                    var x = o && n(p[1] || "", o) || p[1] || "",
                        w = o && n(p[2] || "", o) || p[2] || "";
                    r.push('<div class="' + h + '" onmousedown="WideDropdown.select(\'' + t.id + "', event)\" onmouseover=\"WideDropdown.over('" + t.id + "', '" + clean(f) +
                        '\')" id="wddi' + f + "_" + t.id + '" onclick="">  <div class="wddi_data">' + m + '    <div class="wddi_text">' + x +
                        '</div>    <div class="wddi_sub">' + w + "</div>  </div></div>"), ++a
                }
            }
            r = r.join(""), !a && i && (r = '<div class="wddi_no">' + (o ? t.opts.noResult : t.opts.introText) + "</div>"), s ? t.list.innerHTML += r : r ? (t.outdated = !
                1, t.list.innerHTML = r) : t.outdated = !0, t.outdated || (t.list.style.height = a > 5 ? "242px" : "", e._showList(t), t.scroll && (a > 6 ? (t.scroll.show(),
                s ? t.scroll.update(!1, !0) : t.scroll.scrollTop()) : t.scroll.hide()), setTimeout(e._checkScroll.pbind(t), 0)), e._updatePos(t)
        },
        _highlight: function(e, t) {
            ...
            var d = "",
                i = parseLatin(t);
            null != i && (t = t + "|" + i);
            var s = new RegExp("(?![^&;]+;)(?!<[^<>]*)((\\(*)(" + escapeRE(t) + "))(?![^<>]*>)(?![^&;]+;)", "gi");
            for (var r in e) d += (r > 0 ? " " : "") + e[r].replace(s, '$2<span class="wdd_hl">$3</span>');
            return d
        },
            ...
            if (e.img) {
                ...
                for (var n in e.selected) {
                    var l = e.selected[n],
                        ...
                        f = l[6];
                    if (isArray(c))
                        for (var d, v = 0, h = c.length; h > v; ++v) d = clone(l), d[0] = f[v], d[3] = c[v], d[4] = u[v], d[5] = p[v], a.push(d);
                    else a.push(l)
                }
                o = a.length;
                for (var n in a) {
                    var _, i, m, x, w, l = a[n],
                        c = l[3],
                        u = l[4];
                    if (o > 3 ? (++s, _ = "wdd_img_tiny " + (1 == s || 4 == s ? "fl_l" : "fl_r")) : _ = 3 == o ? s++ ? "wdd_img_tiny fl_r" : "wdd_img_half fl_l" : 2 == o ?
                        "wdd_img_half " + (s++ ? "fl_r" : "fl_l") : "wdd_img_full", r.push(u ? '<a href="' + u + '" class="' + _ + '">' : '<div class="' + _ + '">'), r.push(
        ...
        over: function(e, t, d) {
            var i, s = cur.wdd[e];
            if (s.over && (i = ge("wddi" + s.over + "_" + e)) && (i.className = i.className.replace("wddi_over", "wddi")), s.over = t, (i = ge("wddi" + s.over + "_" + e)) &&
                (i.className = i.className.replace(/wddi(\s|$)/, "wddi_over "), d && s.scroll)) {
                var r = i.offsetTop,
                    a = i.offsetHeight,
                    o = s.list.scrollTop,
                    n = s.list.offsetHeight;
                o > r ? (s.list.scrollTop = r, s.scroll.update()) : r + a > o + n && (s.list.scrollTop = r + a - n, s.scroll.update())
            }
        },
