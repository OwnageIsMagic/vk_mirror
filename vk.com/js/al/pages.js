var Pages = {
    ...
    switchSection: function(section, changed, old, n, draft) {
        ...
        "source" != section && "view" != section || "edit" != curSection && "source" != curSection || ("source" != section && (params.Body = cur.editor.val()), params.draft =
            1), ajax.post("al_pages.php", params, {
    ...
    compare: function(e) {
        ...
        if (o && i.push(o), hasClass(a, "pages_compare")) {
            ...
            removeClass(a, "pages_compare"), void 0 === cur.compare2 ? (Pages.disableCompare(), slideUp("pages_compare_cont", 100), delete cur.compare1) : e == cur.compare2 ?
                (ge("pages_compare2")
                    .innerHTML = cur.compareEmptyCont, Pages.disableCompare(), delete cur.compare2) : (ge("pages_compare1")
                    .innerHTML = ge("pages_compare2")
                    .innerHTML, ge("pages_compare2")
                    .innerHTML = cur.compareEmptyCont, cur.compare1 = cur.compare2, Pages.disableCompare(), delete cur.compare2)
        } else {
            for (var t in i) i[t].innerHTML = cur.lang.pages_cancel2;
            addClass(a, "pages_compare"), void 0 === cur.compare1 ? (cur.compare1 = e, ge("pages_compare1")
                .innerHTML = a.innerHTML, slideDown("pages_compare_cont", 100), Pages.disableCompare()) : (void 0 !== cur.compare2 && Pages.compare(cur.compare2), cur.compareEmptyCont ||
                (cur.compareEmptyCont = ge("pages_compare2")
                    .innerHTML), cur.compare2 = e, ge("pages_compare2")
                .innerHTML = a.innerHTML, Pages.enableCompare())
        }
    },
    ...
    actReport: function(e, a, i, o) {
        ajax.post("al_pages.php", {
            ...
            showProgress: function() {
                return "BUTTON" == i.tagName ? lockButton(i) : (cur.applyVersionCont || (cur.applyVersionCont = i.innerHTML), void(i.innerHTML =
