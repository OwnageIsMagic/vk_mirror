var Pages = {
    ...
    switchSection: function(section, changed, old, n, draft) {
        ...
        var callback = function() {
            ge('pages')
                .className = 'pages_section_' + section;
            Pages.hideError();
            var loc = extend(n, {
                section: section
            })
    ...
    viewVersion: function(hid) {
        ...
        return Pages.switchTab('view', event, {
            hid: hid
        });
    },
    ...
    compare: function(hid) {
        ...
        if (hasClass(row, 'pages_compare')) {
            ...
            if (cur.compare2 === undefined) {
                ...
                if (hid == cur.compare2) {
                    ge('pages_compare2')
                        .innerHTML = cur.compareEmptyCont;
                    Pages.disableCompare();
                    delete cur.compare2;
                } else {
                    ge('pages_compare1')
    ...
    compareView: function() {
        ...
        return Pages.switchTab('view', false, {
            hid: hid,
            hid2: hid2
        });
    },
    ...
    onScroll: function(resize) {
        ...
        if (resize && cur.fixedBottom) {
            setStyle(panel, {
                left: getXY(ge('pages_cont_cache_edit'))[0] + 'px'
            })
        }
    ...
    wysiwygInit: function(options) {
        ...
        extendedToolBar +=
            'table,table_delete,insert_row_before,insert_row_after,insert_col_before,insert_col_after,delete_row,delete_col,col_width,link,unlink,citate,character,video,audio,doc,hider';
