var Filters = {
    init: function(e, t, r, i, l, u, o) {
        stManager.add(["btagger.css", "btagger.js"]), cur.settingsMoreShown = !1, cur.pvTagger && window.Phototag && Phototag.stopTag(), cur.cropActs = ge(
            "pv_crop_actions");
        var s = {
        ...
        if (!a) return hide("pv_filter_wrap"), hide("pv_filter_roll"), show("pv_other_settings"), hide(geByClass1("pv_change_setting", c.bodyNode)), void setStyle(ge(
            "pv_filter_panel"), {
            marginTop: 10
        });
        if (cur.filtersFont = ls.get("filter_font"), void 0 == cur.filtersFont ? cur.filtersFont = 1 : ge("pv_filter_font")
            .className = "pv_filter_font pv_filter_font" + cur.filtersFont, cur.filterFl = ge("pv_filter_embed"), cur.filterApplied = 0, cur.filterSaveOptions = r, cur.filterParams =
            i, cur.customOpts = l, cur.filterUnderLeft = 0, cur.filterParams.disableCrop) {
        ...
        var p = {
            ...
            startCrop: function() {
                ...
                var e = function(e) {
                        ...
                        vk.rtl ? t.marginRight = e.r + e.w / 2 - 50 + cur.filterUnderLeft : t.marginLeft = e.l + e.w / 2 - 50 + cur.filterUnderLeft, setStyle(cur.cropActs,
                            t), fadeIn(cur.cropActs, 150)
                    },
                    t = {
                        onStart: e,
                        onMove: e,
                        onMoveStart: function(e) {
                            ...
                            vk.rtl ? t.marginRight = e.r + e.w / 2 - 50 + cur.filterUnderLeft : t.marginLeft = e.l + e.w / 2 - 50 + cur.filterUnderLeft,
                                setStyle(cur.cropActs, t), fadeOut(cur.cropActs, 150)
                        }
                    };
    ...
    showMoreSettings: function(e) {
        cur.settingsMoreShown ? (slideUp("pv_other_settings", 200), cur.settingsMoreShown = !1, e.innerHTML = getLang("photos_change_setting")) : (slideDown(
            "pv_other_settings", 200), cur.settingsMoreShown = !0, e.innerHTML = getLang("photos_hide_change_setting"))
    },
    ...
    hideBlur: function() {
        ...
        setTimeout(function() {
            ...
            r[vk.rtl ? "marginRight" : "marginLeft"] = 24, isVisible(ge("pv_filters_cont")) ? cssAnim(e, r, {
                ...
                hide(e)
            }) : setStyle(e, r), cur.blurShown = !1, removeClass(t, "pv_filter_pointer"), removeEvent(t, "click mousemove", Filters.setBlurPos), removeEvent(t,
                "mousedown")
        }, 0)
    },
    showBlur: function(e) {
    ...
    switchFont: function(e, t) {
        return cur.filtersFont = parseInt(cur.filtersFont) ? 0 : 1, Filters.updateText(!1, t), ls.set("filter_font", cur.filtersFont), e.className =
            "pv_filter_font pv_filter_font" + cur.filtersFont, cancelEvent(t)
    },
    updateText: function(e, t) {
        t && t.keyCode == KEY.RETURN && (t.ctrlKey || t.metaKey) && Filters.showText(t), setTimeout(function() {
            var t = ge("pv_filter_text_ta"),
                r = val(t) || "";
            return r.length > 140 && (r = r.substr(0, 140), val(t, r)), cur.filterText = r, cur.filterFl.setText ? void cur.filterFl.setText(r, cur.filtersFont, e ||
                0) : !1
        }, 0)
    },
    ...
    setAmount: function(e, t) {
        ...
        return cur.amountSize = getSize(geByClass1("pv_blur_line", e))[0], cur.filtersAmount = cur.amountSize / r, cur.filtersAmount = .8 - .8 * cur.filtersAmount, t ?
            void cur.filterFl.setAmount(cur.filtersAmount) : void(cur.amountTimeout || (cur.amountTimeout = setTimeout(function() {
    ...
    applyCustom: function() {
        (cur.filterApplied || cur.filtersBlur) && (cur.filterFl.restoreOriginal(), cur.filterApplied = 0), cur.customOpts[cur.customNum][0] = val("pv_fl_brightness"), cur.customOpts[
                cur.customNum][1] = val("pv_fl_contrast"), cur.customOpts[cur.customNum][2] = val("pv_fl_saturation"), cur.customOpts[cur.customNum][3] = val("pv_fl_sepia"),
            cur.customOpts[cur.customNum][4] = val("pv_fl_vig1"), cur.customOpts[cur.customNum][5] = val("pv_fl_vig2"), cur.customOpts[cur.customNum][6] = val(
                "pv_fl_color1"), cur.customOpts[cur.customNum][7] = val("pv_fl_color2"), cur.customOpts[cur.customNum][8] = val("pv_fl_color3");
        var e = cur.customOpts[cur.customNum];
        cur.filterFl.addFilter("brightness", e[0]), cur.filterFl.addFilter("contrast", e[1]), cur.filterFl.addFilter("saturation", e[2]), cur.filterFl.addFilter("sepia", e[
                3]), cur.filterFl.addFilter("vignette", e[4], e[5]), cur.filterFl.addFilter("color", e[6], e[7], e[8]), cur.filterApplied = -1, cur.filterFl.applyFilter(!0),
            clearTimeout(cur.saveCustomTimeout), cur.saveCustomTimeout = setTimeout(Filters.saveCustom, 1e3)
    },
    ...
    fromStr: function(e) {
        ...
        if ("f" != t[0] && "p" != t[0]) {
            ...
            var o = t[3];
            o && (cur.filterText = replaceEntities(o), void 0 == t[4] && (t[4] = "1"), cur.filtersFont = t[4], ge("pv_filter_font")
                .className = "pv_filter_font pv_filter_font" + cur.filtersFont, val("pv_filter_text_ta", cur.filterText), ge("pv_filter_text_ta")
                .autosize.update(), Filters.updateText(1));
            var s = t[1].split(",");
            t[1] && s && (cur.filtersBlur = intval(s[0]), cur.blurType = intval(s[1]), cur.fBlurPos = [intval(s[2]) / 100, intval(s[3]) / 100], debugLog("blur here", cur.filtersBlur,
                cur.fBlurPos), cur.filterFl.setBlur(cur.blurType || 1, cur.filtersBlur, cur.fBlurPos[0], cur.fBlurPos[1])), i && l && (cur.amountSize = 66 * (.8 - cur.filtersAmount) /
                .8, debugLog("amount", cur.filtersAmount), Filters.applyFilter(i, !0), cur.filterFl.setAmount(cur.filtersAmount))
        }
    },
    toStr: function() {
        ...
        return cur.filtersBlur && (e += intval(cur.filtersBlur) + "," + intval(cur.blurType || 1) + "," + intval(100 * cur.fBlurPos[0]) + "," + intval(100 * cur.fBlurPos[1])),
            e += "/", cur.filterCropped && cur.lastCrop && cur.lastCrop.w && cur.lastCrop.h && (e += cur.lastCrop.t + "," + cur.lastCrop.l + "," + cur.lastCrop.w + "," +
                cur.lastCrop.h), cur.filterText && (e += "/" + cur.filterText.replace("/", "&#47;") + "/" + cur.filtersFont), e.match(/^\/*$/) && (e = ""), e
    },
    applyFilter: function(e, t) {
        ...
        if (i != r) {
            ...
            l && (addClass(l, "pv_level_before_hide"), removeClass(l, "pv_level_shown")), Filters.hideLevels(r), e && (Filters.showLevel(r), cur.filtersAmount || Filters.setAmount(
                r, !0))
        }
        ...
        switch ((cur.filterApplied || cur.filtersBlur) && (cur.filterFl.restoreOriginal(), cur.filterApplied = 0), e) {
            ...
            case 8:
                ...
                break;
            case 10:
                cur.filterFl.addFilter("sepia", 30), cur.filterFl.addFilter("vignette", 25, 80), cur.filterFl.addFilter("saturation", -30), cur.filterFl.addFilter(
                    "contrast", 30);
                break;
            case 13:
                cur.filterFl.addFilter("color", 95, 105, 145), cur.filterFl.addFilter("sepia", 30), cur.filterFl.addFilter("contrast", 20), cur.filterFl.addFilter(
                    "vignette", 15, 60);
                break;
            case 21:
                cur.filterFl.addFilter("color", 125, 115, 95), cur.filterFl.addFilter("sepia", 40), cur.filterFl.addFilter("saturation", -20), cur.filterFl.addFilter(
                    "vignette", 40, 70), cur.filterFl.addFilter("contrast", -10);
                break;
            case 22:
                cur.filterFl.addFilter("color", 125, 110, 95), cur.filterFl.addFilter("vignette", 30, 80), cur.filterFl.addFilter("contrast", 15), cur.filterFl.addFilter(
                    "saturation", -100), cur.filterFl.addFilter("sepia", 100);
                break;
            case 23:
                cur.filterFl.addFilter("color", 110, 95, 105), cur.filterFl.addFilter("sepia", 50), cur.filterFl.addFilter("vignette", 30, 65), cur.filterFl.addFilter(
                    "saturation", -60), cur.filterFl.addFilter("contrast", 40);
                break;
            case 24:
                cur.filterFl.addFilter("pro", 2), cur.filterFl.addFilter("vignette", 20, 65), cur.filterFl.addFilter("contrast", 15), cur.filterFl.addFilter("brightness",
                    15), cur.filterFl.addFilter("vignette", 30, 65);
                break;
            case 25:
    ...
    save: function(e) {
        ...
        e && (e.hash ? extend(t, {
            ...
            onDone: function(e, r, i, l, u) {
                ...
                if (i && l && (Filters.changeThumbs(l, u), delete n.x_, delete n.x_src, delete n.y_, delete n.y_src, delete n.z_, delete n.z_src, extend(n, i)),
                    v) {
                    var f = domFC(cur.pvDesc);
                    val(f, e || '<span class="pv_desc_edit">' + getLang("photos_edit_desc") + "</span>"), f.onmouseover = e ? Photoview.descTT.pbind(f) :
                        function() {}, r && ge("pv_album") && (ge("pv_album")
                            .innerHTML = r), cur.pvCurData = Photoview.genData(n, vk.pvbig ? cur.pvVeryBig ? (cur.pvVeryBig > 1, "z") : "y" : "x"), domFC(cur.pvPhoto)
    ...
    restoreOriginal: function(e, t, r, i) {
        ajax.post("al_photos.php", {
            ...
            onDone: function(e, t, r) {
                ...
                var s = curBox();
                s && s.hide(), Filters.changeThumbs(t, r), o && (cur.pvCurData = Photoview.genData(u, vk.pvbig ? cur.pvVeryBig ? (cur.pvVeryBig > 1, "z") : "y" :
                    "x"), cur.pvPhoto.firstChild.src = cur.pvCurData.src, setTimeout(Photoview.show.pbind(cur.pvListId, cur.pvIndex), 0))
            },
            loader: 1
        })
    },
