var Index = {
    ...
    updateDays: function(e, t, n) {
        n || (n = cur.uiBday), n.val() > Index.getLastDay(e, t) && n.clear(), n.setData(Index.generateDays(e, t)
    ...
    fbJoin: function(e) {
        ...
        var t = location.protocol + "//" + location.host + "/join?act=fb_sign",
            n = "https://graph.facebook.com/v2.7/oauth/authorize?client_id=" + cur.fbApp + "&redirect_uri=" + encodeURIComponent(t) +
    ...
    fbFinish: function(e) {
        e.error ? setTimeout(showFastBox(getLang("global_error"), e.error)
            .hide, 2e3) : e.date && (lockButton(ge("index_fb" + (cur.fbContext || ""))), nav.go("/join?act=fb_start"))
    }
};
try {
