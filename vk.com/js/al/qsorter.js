var qsorter = {
        ...
        for (var o in qsorter.animcache)
            if (0 != o) {
                var s = qsorter.animcache[o],
                    ...
                    i = 200,
                    l = vkNow();
                s.t += l - s.prev, s.prev = l, s.t < i ? (t = !1, a.style.left = n(s.t, s.sx, s.dx, i) + "px", a.style.top = n(s.t, s.sy, s.dy, i) + "px", browser.msie8 &&
                    (e = a.offsetLeft)) : (a.style.left = s.sx + s.dx + "px", a.style.top = s.sy + s.dy + "px", browser.msie8 && (e = a.offsetLeft), clearInterval(s.timer),
                    r.push(a.parentNode.id), s.h && s.h.apply(a))
    ...
    animdone: function(e) {
        e.cls ? domPN(this)
            .className = e.cls : removeClass(domPN(this), e.clsUp), this.style.left = this.style.top = this.style.zIndex = "", cur.qsorterSetSize && setStyle(this.parentNode, {
                width: "",
                height: ""
            })
    },
    animate: function(e, r, t, o, s, a, n) {
        if (browser.msie8) return n.cls ? domPN(e)
            .className = n.cls : removeClass(domPN(e), n.clsUp), e.style.left = e.style.top = "", void(cur.qsorterSetSize && setStyle(e.parentNode, {
                width: "",
                height: ""
            }));
        var i = {
    ...
    mousedown: function(e) {
        ...
        if (!qsorter.current) {
            ...
            return qsorter.current = a, qsorter.nextEl = o.nextSibling, extend(a, {
                    ...
                    width: t[0],
                    height: t[1]
                }), addEvent(document, "mousemove drag touchmove", qsorter.mousemove), addEvent(document, "mouseup touchend touchcancel", qsorter.mouseup), browser.opera ||
                browser.msie || browser.mozilla || browser.safari_mobile || browser.android || a.noscroll || addEvent(qsorter.scrollNode, "scroll", qsorter.mousemove),
                extend(a, {
                    startX: n[0],
    ...
    checkOver: function(e, r) {
        for (var t in e.dragEls) {
            var o = e.dragEls[t];
            o.xy && 0 != o.xy[0] || (o.xy = getXY(o), o.sz = getSize(o)), r[0] > o.xy[0] && r[1] > o.xy[1] && r[0] < o.xy[0] + o.sz[0] && r[1] < o.xy[1] + o.sz[1] ? cur.qsorterOver !=
                o && (cur.qsorterOver && e.onDragOut(cur.qsorterOver), cur.qsorterOver = o, e.onDragOver(o)) : cur.qsorterOver && cur.qsorterOver == o && (cur.qsorterOver = !
                    1, e.onDragOut(o))
        }
    },
    mousemove: function(e) {
        if (qsorter.current) {
            ...
            if ("scroll" == e.type) r = !1;
                ...
                100 > s ? qsorter.animcache[0] = s - 100 : s > lastWindowHeight - 100 ? qsorter.animcache[0] = s + 100 - lastWindowHeight : qsorter.animcache[0] && delete qsorter
                    .animcache[0], qsorter.animcache[0] && !qsorter.animtimer && (qsorter.animtimer = setInterval(qsorter.animstep, 13))
            }
            var a = o.drag,
                n = t[0] - o.startX,
            ...
            var m, f = a.x,
                ...
                x = y % b,
                w = Math.floor((y + .1) / b);
            if ((n > 10 || -10 > n || i > 10 || -10 > i) && (addClass(a, "qs_drag_started"), cur.cancelClick = !0), o.noMoveCursorFirst && !a.cursor_changed && (a.cursor_changed = !
                    0, a.old_cursor = a.style.cursor, a.style.cursor = "move"), setStyle(qsorter.first(a), {
                    left: g,
                    top: q + o.offset
                }), browser.msie8 && (m = a.offsetLeft), o.dragCont && o.dragCont.visible) {
                if (t[0] > o.dragCont.x1 && t[1] > o.dragCont.y1 && t[0] < o.dragCont.x2 && t[1] < o.dragCont.y2) return cur.sorterDragIn || (cur.sorterDragIn = 1, animate(
                    a, {
                        opacity: .2
            ...
            return 0 > I ? o.parent.insertBefore(a, _) : _.nextSibling ? o.parent.insertBefore(a, _.nextSibling) : o.parent.appendChild(a), n = (x - E) * p, i = (w - M) *
                h, o.elems[C][S] = a, extend(a, {
                    i: z,
                    x: a.x + n,
                    y: a.y + i
    ...
    mouseup: function(e) {
        if (qsorter.current) {
            ...
            if (setStyle(qsorter.first(t), {
                    zIndex: 11
                }), r.noMoveCursorFirst && (t.style.cursor = t.old_cursor, delete t.old_cursor, delete t.cursor_changed), qsorter.current = r.drag = !1, cur.qsorterOver &&
                r.onDrop(cur.qsorterOver, t)) {
                var n = qsorter.first(t);
                return setStyle(n, {
                    top: 0,
                    left: 0
                }), qsorter.nextEl ? t.parentNode.insertBefore(t, qsorter.nextEl) : t.parentNode.appendChild(t), qsorter.animdone.bind(n)(r), qsorter.stop(), qsorter.animcache[
                    0] && (delete qsorter.animcache[0], isEmpty(qsorter.animcache) && qsorter.animstop()), cur.sorterDragIn && (cur.sorterDragIn = 0, setStyle(t, {
                    opacity: 1
                })), cancelEvent(e)
            }
            qsorter.animate(qsorter.first(t), t.x + s, t.y + a, t.x, t.y + r.offset, qsorter.animdone.bind(qsorter.first(t), r), r), qsorter.stop(), qsorter.animcache[0] &&
                (delete qsorter.animcache[0], isEmpty(qsorter.animcache) && qsorter.animstop()), cur.sorterDragIn && (cur.sorterDragIn = 0, animate(t, {
                    opacity: 1
                }, 100));
            var i = t.nextSibling,
                l = t.previousSibling;
    ...
    stop: function() {
        ...
        removeEvent(document, "mousemove drag touchmove", qsorter.mousemove), removeEvent(document, "mouseup touchend touchcancel", qsorter.mouseup), e.drag = qsorter.current = !
            1
    },
    update: function(e, r) {
            ...
            for (var n = t, i = 0; a; a = a.nextSibling, ++n)
                if (3 != a.nodeType && !a.getAttribute("nodragend")) {
                    ...
                    (browser.msie7 || browser.msie6) && (d += a.offsetLeft, u += a.offsetTop), extend(a, {
                        ...
                        y: u,
                        i: n
                    }), addEvent(a, "mousedown touchstart", qsorter.mousedown), browser.opera && !cur.qsorterNoOperaStyle && (a.style.display = "block", a.style.cssFloat =
                        "left"), l || r.noMoveCursor || r.noMoveCursorFirst || (a.style.cursor = "move"), ++s, s >= o && (s -= o)
                }
            r.count += i
        }
    },
