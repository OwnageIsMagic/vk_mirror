    ...
    window.cals || (window.cals = {
        ...
        if (n) {
            ...
            this.setDay = function(e, t, a) {
                ...
                d = (s[e] || e || "d")
                    .replace(/(this|next|prev)/, ""), p.getMonth(h.m, h.y, !0)
            };
                ...
                C = function(n, s, l) {
                    if (!(!l && r.noPast && new Date(n.y, n.m - 1, n.d, 23, 59) < new Date)) {
                        ...
                        "h" === s ? addClass(u, "disabled") : (removeClass(u, "disabled"), "m" === s ? ge(p)
                                ...
                                .value = t.replace("{day}", n.d)
                                .replace("{month}", winToUtf(e.mnOf[n.m - 1]))
                                .replace("{year}", n.y)), d.hide(), "plain" === D ? ge(h)
                            .value = n.d + "." + n.m + "." + n.y + (r.time ? " " + o + ":" + c : "") : "ts" === D && (ge(h)
                                .value = Math.floor(new Date(n.y, n.m - 1, n.d, o, c)
                                    .getTime() / 1e3) - (60 * (new Date)
                                    .getTimezoneOffset() + intval(vk.tz)) - intval(vk.dt)), l || w(n, s)
                    }
                };
            this.hide = function() {
        ...
        if (e = ge(e)) {
            ...
            var l = i.hour || 0,
                ...
                c = i.resfmt;
            o -= o % i.minStep;
            var h = '<input type="hidden" name="' + n + '" id="' + a + '" value="' + r + '"/>' + i.format.replace("{hour}", '<div class="fl_l"><input type="hidden" id="' + a +
                    '_hour_input" value="' + l + '"/></div>')
                .replace("{min}", '<div class="fl_l"><input type="hidden" id="' + a + '_min_input" value="' + o + '"/></div>') +
            ...
            for (var u = function() {
                    ...
                    "plain" === c ? ge(a)
                        .value = e + ":" + t : "ts" === c && (ge(a)
                            .value = 3600 * e + 60 * t), i.onUpdate(e, t)
        ...
        if (t = ge(t)) {
            ...
            var c = '<div class="fl_l"><input type="hidden" name="' + r + '" id="' + n + '" value="' + s + '"/>' + d.format.replace("{year}",
                    '<div class="fl_l"><input type="hidden" id="' + n + '_year_input" value="' + d.year + '"/></div>')
                .replace("{month}", '<div class="fl_l"><input type="hidden" id="' + n + '_month_input" value="' + d.month + '"/></div>')
                .replace("{day}", '<div class="fl_l"><input type="hidden" id="' + n + '_day_input" value="' + d.day + '"/></div>') + "</div>",
                h = ce("div", {
            ...
            for (var p = function(e, t) {
                    for (var a = new Date(t ? t : 2004, e, 0)
                            .getDate(), n = [
                    ...
                    var e = parseInt(_.val()),
                        ...
                        a = parseInt(y.val());
                    ge(n)
                        .value = 1e4 * e + 100 * t + a, y.setData(p(t, e)), d.onUpdate(e, t, a)
                }, o = new Date, m = [
