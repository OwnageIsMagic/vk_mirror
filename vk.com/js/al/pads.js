var Pads = {
    ...
    getCache: function(a, e) {
        var s = _pads.cache[a],
            d = vkNow();
        return (s || {})
            .tim && d - s.tim < 864e5 || d - intval(s) < 2e4 ? s : (e && (_pads.cache[a] = d), !1)
    },
    preload: function(id) {
        if (_pads.shown != id && !Pads.getCache(id, !0) && !vk.isBanned) {
            ...
            "mus" == id && (padAudioPlaylist() || (query.playlist = 1), Pads.audioInited || (query.init = 1)), ajax.post("pads.php", query, {
                onDone: function(html, script, data, cnt) {
                    void 0 !== cnt && null !== cnt && cnt > -1 && handlePageCount(id, cnt), data.onLoadScript && (eval(data.onLoadScript), delete data.onLoadScript),
                        _pads.cache[id] = {
                            html: html,
                            script: script,
                            data: data,
    ...
    setPos: function(a) {
        ...
        if ("mus" == a) {
            ...
            ("im" == cur.module || "audio" == cur.module) && (v = 1), p = vk.rtl ? m ? getXY(c)[0] + getSize(c)[0] - e.w - 1 : getXY(c)[0] + 1 : m ? getXY(c)[0] + 1 :
                getXY(c)[0] + getSize(c)[0] - e.w - 1, l = m ? "auto" : (g >= i && isVisible(f) || !h ? 12 : r) + o, _ = m ? 15 : "auto", setStyle(_pads.wrap, {
                    left: p,
                    top: l,
                    bottom: _
                ...
                }, 0), toggleClass(_pads.arrow, "head", (i > g || !isVisible(f)) && h && !_pads.gpClicked), toggleClass(f, "head", (i > g || !isVisible(f)) && h && !_pads.gpClicked),
                toggleClass(_pads.arrow, "right", (g >= i && isVisible(f) || !h) && !hasClass(f, "reverse")), toggleClass(_pads.arrow, "left", (g >= i && isVisible(f) || !
                    h) && hasClass(f, "reverse"));
            var w = (i > g || !isVisible(f)) && h && !_pads.gpClicked;
            vk.rtl ? (p = m ? "auto" : w ? getXY(h)[0] - getXY(c)[0] + 1 : -10, n = m ? -10 : "auto") : (p = m ? -10 : "auto", n = m ? "auto" : w ? getSize(c)[0] + getXY(c)[
                0] - getXY(h)[0] - 20 : -10), l = m ? "auto" : w ? -10 : 17, _ = m ? 15 : "auto", setStyle(_pads.arrow, {
                top: l,
                bottom: _,
                left: p,
                right: n
            ...
            var s = {},
                ...
                b = Pads.coords[a];
            if (P || show(_stlSide), s.fixpos = 0, P || hide(_stlSide), s.menuh = d.offsetHeight, s.middle = Math.floor((_pads.restrict[1] + _pads.restrict[0] - s.menuh) /
                    2), s.fixtop = Math.max(s.fixpos - s.middle, 4), s.fixbot = 7, s.justarrtop = t[1], s.basearrtop = t[1] - s.fixtop, s.basetop = t[1] - s.middle, extend(
                    _pads.cur, s), removeClass(_pads.arrow, "left"), removeClass(_pads.arrow, "right"), b.bottom) {
                var c = ge("wrap3");
            ...
            } else removeClass(_pads.arrow, "head"), removeClass(f, "head"), _pads.wrap.style.left = t[0] + (vk.rtl ? -e.w - 7 : 168) + "px", _pads.wrap.style.bottom =
                "auto"
        }
        Pads.onScroll(!0, a)
    },
    onScroll: function(a, e) {
        ...
        if ("mus" == (e || _pads.shown)) {
            ...
            if (n) {
                ...
                toggleClass(_pads.arrow, "left", p), removeClass(_pads.arrow, "right"), toggleClass(_pads.arrow, "head", !p && !_pads.gpClicked), toggleClass(r, "head", !p &&
                    !_pads.gpClicked), setStyle(_pads.wrap, {
                    bottom: p ? "15px" : "auto",
                    top: p ? "auto" : o + d
                }), toggleClass(_pads.wrap, "fixed", p), toggleClass(_pads.wrap, "pad_no_fixed", !p)
            } else if (s >= t && isVisible(r) && !p || !i) addClass(_pads.arrow, "right"), removeClass(_pads.arrow, "left"), removeClass(_pads.arrow, "head"), removeClass(
                r, "head"), setStyle(_pads.wrap, {
                top: "12px",
                bottom: "auto"
            ...
            else if (removeClass(_pads.arrow, "left"), toggleClass(_pads.arrow, "right", _pads.gpClicked), toggleClass(_pads.arrow, "head", !_pads.gpClicked), toggleClass(
                    r, "head", !_pads.gpClicked), toggleClass(_pads.wrap, "fixed", p), toggleClass(_pads.wrap, "pad_no_fixed", !p), setStyle(_pads.wrap, {
                    top: o + d,
                    bottom: "auto"
            ...
            var u = _pads.cur.fixtop,
                ...
                h = a === !0;
            g > _pads.cur.middle && (u += g - _pads.cur.middle, g = _pads.cur.middle), g > _pads.restrict[1] - _pads.cur.menuh && (u = _pads.cur.basetop - s), u + _pads.height >
                lastWindowHeight - _pads.cur_fixbot && (u = lastWindowHeight - _pads.cur_fixbot - _pads.height, 4 > u && (u = 4)), 7 > u + s && (u = 7 - s), g = _pads.cur.justarrtop -
                s - u, u > _pads.cur.fixtop && u > 7 && "im" != cur.module && "audio" != cur.module ? (u += s, (h || _pads.cur.fixed !== !1) && (removeClass(_pads.wrap,
                    "fixed"), addClass(_pads.wrap, "pad_no_fixed"), _pads.cur.fixed = !1)) : (h || _pads.cur.fixed !== !0) && (removeClass(_pads.wrap, "pad_no_fixed"),
                    addClass(_pads.wrap, "fixed"), _pads.cur.fixed = !0), _pads.wrap.style.top = u + "px", g < _pads.restrict[0] - _pads.cur.menuh && g > 0 ? (h || "blue" !==
                    _pads.cur.arrshown) && (show(_pads.arrow), addClass(_pads.arrow, "blue"), _pads.cur.arrshown = "blue") : g > _pads.restrict[1] - _pads.cur.menuh || g <
                _pads.restrict[0] ? (h || _pads.cur.arrshown !== !1) && (hide(_pads.arrow), _pads.cur.arrshown = !1) : (h || _pads.cur.arrshown !== !0) && (show(_pads.arrow),
                    removeClass(_pads.arrow, "blue"), _pads.cur.arrshown = !0), _pads.cur.arrshown && (_pads.arrow.style.top = Math.ceil(g + (_pads.cur.menuh - 17) / 2) +
                    "px")
        }
    },
    show: function(id, ev) {
        if (checkEvent(ev) !== !0 && !browser.msie6 && !vk.isBanned) {
            ...
            _pads.shown && _pads.topLoad && removeClass(ge("head_" + ("mus" == _pads.shown ? "music" : "games")), "over"), _pads.topLoad = !1, "msg" == id && stManager.add(
                ["pads_im.css", "pads_im.js", "page.css", "page.js"]), "mus" != id || padAudioPlaylist() || Pads.invalidate(id), "mus" != id && _pads.gpClicked && (
                _pads.gpClicked = !1), _pads.gpClicked = !!_pads.gpClicked;
            ...
            if (c ? c.tim || (c = 0) : Pads.preload(id), _pads.wrap || (_pads.cont = domLC(_pads.wrap = bodyNode.appendChild(ce("div", {
                ...
                toggleClass(ge("gp"), "head", "mus" == id && scrollGetY() < topOffset && !hasClass(ge("gp"), "reverse") && !_pads.gpClicked), toggleClass(ge("gp")
                    .firstChild, "active", "mus" == id)
            }
            if ("mus" == id && (c || addClass(_pads.arrow, "no_data")), "game" == id || "mus" == id && !_pads.gpClicked) {
                ...
                if (loadEl)
                    if (c) loadEl.padLoad && (loadEl.innerHTML = loadEl.padLoad, delete loadEl.padLoad), animate(_pads.wrap, {
                        ...
                        }), loadEl.padLoad = loadEl.innerHTML, loadEl.innerHTML = '<img style="position: absolute; margin-top: 3px; margin-left: ' + ((s[0] + wDiff) /
                            2 - 16) + 'px;" src="/images/upload_inv' + (window.devicePixelRatio >= 2 ? "_2x" : "") + '.gif" width="32" height="8"/>&nbsp;'
                    }
                addClass(ge("head_" + ("mus" == id ? "music" : "games")), "over"), _pads.topLoad = !0
            }
            if (setStyle(_pads.cont, {
                    width: c ? d.w : d.w - 2
                }), (c ? removeClass : addClass)(_pads.cont, "pad_loading"), val(_pads.cont, (c || {})
                    .html || ""), _pads.shown) {
                if (_pads.shown != id) {
            ...
            if (cur.hideGifts && cur.hideGifts(), addClass(domFC(el), "left_nav_over"), Pads.deinit(), _pads.wrap.style.position = _pads.arrow.style.left = _pads.arrow.style
                .right = _pads.arrow.style.bottom = "", removeClass(_pads.arrow, "blue"), _pads.cur = {}, _pads.content = ge("pad_content"), c && c.script && eval(
                    "(function(id){" + c.script + "})('" + id + "')"), "msg" == id && window.PadsIm && ge("pad_im_hrows")) PadsIm.init();
            ...
            return Pads.init(id), Pads.setPos(id), _pads.shown = id, row ? vkNow() - c.tim > 3e3 ? ajax.post("pads.php", {
                ...
                onDone: function(a, e, s) {
                    void 0 !== s && null !== s && s > -1 && handlePageCount(id, s), _pads.shown == id && (a || Pads.invalidate(), Pads.feed(a, e, !0),
    ...
    deinit: function() {
        _pads.cur && ("msg" == _pads.shown && window.PadsIm && ge("pad_im_hrows") && PadsIm.destroy(), ((_pads.cur.tipEl || {})
                .tt || {})
            .destroy && _pads.cur.tipEl.tt.destroy(), _pads.cur = 0)
    },
    hide: function() {
        if (!_pads.shown || _pads.cont && hasClass(_pads.cont, "pad_loading")) return !0;
        "mus" == _pads.shown && (ge("gp") && (removeClass(ge("gp")
                    .firstChild, "active"), _pads.gpClicked = !1), window.audioPlayer && audioPlayer.controls && audioPlayer.controls.pd && audioPlayer.controls.pd.status &&
                audioPlayer.controls.pd.status.tt && hide(audioPlayer.controls.pd.status.tt.container), window.Audio && Audio.stopPadEvents()), _pads.topLoad &&
            removeClass(ge("head_" + ("mus" == _pads.shown ? "music" : "games")), "over"), _pads.layerBG && (re(_pads.layerBG), _pads.layerBG = 0);
        var a = ge("l_" + _pads.shown);
        return removeClass(domFC(a), "left_nav_over"), vk.counts[_pads.shown] < 0 && hide(a), _pads.shown = 0, updGlobalPlayer(), browser.msie && browser.version < 9 ?
            Pads.hidden() : animate(_pads.wrap, {
                opacity: 0
            }, 200, Pads.hidden), !0
    },
    boxHide: function() {
    ...
    feed: function(a, e, s) {
        var d = ce("div", {
            ...
            o = ge("pad_rows"),
            i = o.firstChild;
        if ((!a || e) && hide("pad_more"), s && !ge(domLC(d)
                .id)) return val(o, a), void Pads.init(_pads.shown);
        for (var r = domFC(d); r; r = domFC(d))
            if (++_pads.cur.offset, ge(r.id)) {
                ...
                re(r)
            } else s ? (o.insertBefore(r, i), Pads.invalidate()) : o.appendChild(r), hasClass(r, "pad_msg_new") ? t.push(r.id.replace("pad_msg", "")) : hasClass(r,
                "pad_ap_new") && t.push(r.id.replace(/pad_apn_\d+_/, ""));
        Pads.updateHeight(), "msg" == _pads.shown ? Pads.msgMark(t) : "ap" == _pads.shown && Pads.apMark(t)
    },
    more: function(a) {
        return checkEvent(a) !== !0 ? (void 0 !== _pads.cur.more ? "load" == _pads.cur.more ? _pads.cur.more = "show" : "show" != _pads.cur.more && (Pads.feed(_pads.cur.more,
            _pads.cur.all), delete _pads.cur.more, Pads.preloadMore()) : (_pads.cur.more = "show", Pads.preloadMore()), a ? cancelEvent(a) : !1) : void 0
    },
    ...
    showTip: function(a, e) {
        var s = geByClass1("pad_" + _pads.shown + "_btns"),
            d = _pads.cur.tipEl;
        if (s && d) return e ? (domPN(d) != s && s.insertBefore(d, domFC(d)), (d.tt || {})
            .show ? void d.tt.show() : void showTooltip(d, {
                text: _pads.cur.tip,
    ...
    onSubmit: function(a, e, s) {
        if (e = e || window.event, (e.keyCode == KEY.RETURN || 10 == e.keyCode) && (_pads.cur.subm && (e.ctrlKey || browser.mac && e.metaKey) || !_pads.cur.subm && !e.shiftKey &&
                !(e.ctrlKey || browser.mac && e.metaKey))) return s(), cancelEvent(e);
    ...
    updateHeight: function(a) {
        ...
        _pads.height = _pads.wrap.offsetHeight, s && "mus" != (a || _pads.shown) && (d = Math.max(Math.min(d, s - (_pads.height - o) - 11), 150)), d = Math.min(e.offsetHeight,
            d), setStyle(_pads.content, {
            height: d
    ...
    frPhotoOver: function(a, e) {
        if (window.lang && lang.global_photo_full_size && !browser.mobile) {
            ...
            ("A" != s.tagName || "pad_fr_phbig" != s.className) && ((s = a.insertBefore(ce("a", {
                ...
                .onclick = Pads.frPhotoClick.pbind(e), s._uid = e), clearTimeout(s.hideTO), animate(s, {
                marginTop: 50
            }, {
                duration: 200,
    ...
    phDone: function(a, e, s) {
        ...
        if (t) return geByClass1("pad_ph_lnk", t)
            .href = "/photo" + a, domPN(o)
            .replaceChild(ce("div", {
                innerHTML: s,
    ...
    grDone: function(a, e, s, d, t) {
        if (e) t = '<span class="pad_error">' + t + "</span>", _pads.cur.processed[a] > 0 && delete _pads.cur.processed[a];
            ...
            d > 0 ? (t = '<div class="pads_gr_clubinv_block">' + t.replace("{club}", "<b>" + val(domPS(ge("pads_clubinv" + a))) + "</b>") + "</div>", t +=
                    '<div class="pads_gr_clubinv_block"><a onclick="Pads.grProcess(this, ' + a + ', -2, -1)">' + getLang("global_cancel") + "</a></div>") : !d && 0 > s &&
                ge("pads_clubinv" + a) && (t += '<div class="pads_gr_clubinv_block"><a onclick="Pads.grProcess(this, ' + a + ', -2, 1)">' + val("groups_block_clubinv")
                    .replace("{club}", "<b>" + val(domPS(ge("pads_clubinv" + a))) + "</b>") + "</a></div>")
        }
        delete _pads.cur.savedcnts[a];
        var i = ge("pad_gr" + a),
            r = geByClass1("pad_gr_btns", i) || geByClass1("pad_gr_result", i);
        return !e && 0 > d && (t = r.oldtext), domPN(r)
            .replaceChild(ce("div", {
                innerHTML: t,
    ...
    msgAnswer: function(a, e, s) {
        ...
        if (s === !1 || s === !0) {
            ...
            for (var i = s.target || s.srcElement; i; i = domPN(i))
                if ("A" == i.tagName || (i.className || "")
                    .match(/(\s|^)pad_msgr(\s|$)/)) return;
            if (trim((window.getSelection && window.getSelection() || document.getSelection && document.getSelection() || document.selection && document.selection.createRange()
                        .text || "")
                    .toString())
                .length) return
        }
        if (d) {
            ...
            re(geByClass1("pad_msgr", a)), removeClass(a, "pad_msg_reply"), delete _pads.editing[e], s !== !0 && (isEmpty(_pads.editing) && _pads.layerBG && (re(_pads.layerBG),
                _pads.layerBG = 0), Pads.update())
        } else {
            for (var r in _pads.editing) Pads.msgAnswer(ge("pad_msg" + r), r, !0);
            t[1] && (o = "<a onclick=\"showBox('al_im.php', {act: 'a_show_members_box', chat: " + (intval(t[0]) - 2e9) +
                "}, {stat: ['im.css', 'boxes.css'], params: {dark: 1}})\" class=\"pad_msg_rcpts fl_l\">" + getLang("mail_chat_X_rcpts", intval(t[1])) + "</a>");
            var p = geByClass1("pad_msg_wrap", a)
                .appendChild(ce("div", {
                    className: "pad_msga pad_msgr",
                    innerHTML: val("pad_msg_reply_tpl")
                        .replace("{field}", "<textarea onkeydown=\"Pads.onSubmit(this, event, Pads.msgSend.pbind(geByTag1('button', this.parentNode), " + e +
                            '))" id="pad_msg_field' + e +
                            '" class="pad_msg_field"></textarea><div class="pad_msg_btns clear_fix">  <div class="pad_msg_btn button_blue fl_l">    <button onclick="Pads.msgSend(this, ' +
                            e + ')" onmouseover="Pads.showTip(' + e + ', 1)" onmouseout="Pads.showTip(' + e + ', 0)">' + getLang("global_send") +
                            "</button>  </div>" + o + "</div>")
                }));
    ...
    msgHide: function(a) {
        if (a = a || window.event, a.target == ge("pad_layer_bg")) {
            for (var e in _pads.editing)
                if (trim(val("pad_msg_field" + e))) return showFastBox(getLang("global_warning"), getLang("mail_are_sure_close"), getLang("mail_pad_cancel"), Pads.boxHide,
    ...
    nwsAnswer: function(a, e, s) {
        ...
        if (e === !1 || e === !0) {
            ...
            for (var r = e.target || e.srcElement; r; r = domPN(r))
                if ("A" == r.tagName || (r.className || "")
                    .match(/(\s|^)pad_nwsr(\s|$)/)) return;
            if (trim((window.getSelection && window.getSelection() || document.getSelection && document.getSelection() || document.selection && document.selection.createRange()
                        .text || "")
                    .toString())
                .length) return
        ...
        if (d) {
            ...
            t && cleanElems(t), re(geByClass1("pad_nwsr", i)), removeClass(i, "pad_nws_reply"), delete _pads.editing[a], e !== !0 && (isEmpty(_pads.editing) && _pads.layerBG &&
                (re(_pads.layerBG), _pads.layerBG = 0), Pads.update())
        } else {
            for (var n in _pads.editing) Pads.nwsAnswer(n, !0, _pads.editing[n]);
            if (addClass(i, "pad_nws_reply"), _pads.editing[a] = s, s.disabled) var l = geByClass1("pad_nws_cont", i)
                .appendChild(ce("div", {
                    className: "pad_nwsa pad_nwsr",
                    innerHTML: val("pad_nws_dis_tpl")
                        .replace("{text}", s.disabled)
                }));
            else {
                var l = geByClass1("pad_nws_cont", i)
                    .appendChild(ce("div", {
                        className: "pad_nwsa pad_nwsr",
                        innerHTML: val("pad_nws_reply_tpl")
                            .replace("{field}", "<textarea onkeydown=\"Pads.onSubmit(this, event, Pads.nwsSend.pbind(geByTag1('button', this.parentNode), '" + a +
                                '\'))" id="pad_nws_field' + a + '" class="pad_nws_field" placeholder="' + s.ph + '">' + s.greet +
                                '</textarea><div class="pad_nws_btns clear_fix">  <div class="pad_nws_btn button_blue fl_l">    <button onclick="Pads.nwsSend(this, \'' +
                                a + "')\" onmouseover=\"Pads.showTip('" + a + "', 1)\" onmouseout=\"Pads.showTip('" + a + "', 0)\">" + s.btn +
                                "</button>  </div></div>")
                    }));
    ...
    nwsHide: function(a) {
        if (a = a || window.event, a.target == ge("pad_layer_bg")) {
            for (var e in _pads.editing) {
                ...
                if (trim(s) && 0 !== _pads.editing[e].greet.indexOf(s)) return showFastBox(getLang("global_warning"), getLang("news_are_sure_close"), getLang(
                    "news_pad_cancel"), Pads.boxHide, getLang("global_cancel"))
            }
            Pads.hide()
        }
    },
    ...
    nwsTooltip: function(a, e) {
        var s = "al_wall.php";
        e.indexOf("topic_comment") ? e = e.replace("wall_reply", "")
            .replace("wall", "") : (s = "al_board.php", e = e.replace("topic_comment", "")), showTooltip(a, {
                url: s,
                params: extend({
                    act: "post_tt",
                    post: e,
            ...
            onDone: function(data, res) {
                if (data && window.Audio) {
                    ...
                    aobj = aobj.all[0], setTimeout(function() {
                        cur.id == vk.id && cur.audiosIndex && cur.audiosList && cur.audiosList.all && cur.aSearch && (all_list = cur.audiosList.all,
                                all_list && all_list.length ? (aobj._order = all_list[0]._order - 1, cur.audiosList.all.splice(0, 0, aobj)) : (aobj._order =
                                    0, cur.audiosList.all = [aobj]), cur.audios[aobj[1]] = aobj, cur.audiosIndex.add(aobj)), window._pads && _pads.cur &&
                            _pads.cur.audiosIndex && _pads.cur.audiosList && (all_list = _pads.cur.audiosList.all, all_list && all_list.length ? (aobj._order =
                                all_list[0]._order - 1, _pads.cur.audiosList.all.splice(0, 0, aobj)) : (aobj._order = 0, _pads.cur.audiosList.all = [
                                aobj
                            ]), _pads.cur.audios && (_pads.cur.audios[aobj[1]] = aobj), "all" == _pads.cur.allAudiosIndex && _pads.cur.audiosIndex.add(
                                aobj)), Pads.clearAudioLoadCache()
    ...
    onAudioReorder: function(a, e, s) {
        ...
        if (d && i && !i[d] && (d = d.replace("_pad", ""), t = t.replace("_pad", ""), o = o.replace("_pad", "")), d && i && i[d]) {
            ...
            if (r && r.sorter && r.sorter.elems) {
                var p = (r.sorter.elems[0].id || "")
                    .substr(5);
                p && !i[p] && (p = p.replace("_pad", "")), i.start = p
            }
            var n = i[d]._prev,
                l = i[d]._next;
            n && i[n] && l && i[l] && t && i[t] && o && i[o] && o != d && t != d && (i[n]._next = l, i[l]._prev = n, i[d]._prev = o, i[o]._next = d, i[d]._next = t, i[t]._prev =
                d), window.audioPlaylist && audioPlaylist[d] && (window.audioPlaylist = i), ls.set("pad_playlist", i), ls.set("pad_pltime", vkNow())
        }
    },
    setAudioCurPos: function(a) {
        ...
        if (s && ("_pad" != s.substr(-4) && (s += "_pad"), ge("audio" + s))) {
            ...
            var o = ge("audio" + s)
                .offsetTop + ge("pad_playlist")
                .offsetTop - Math.min(ge("pad_cont")
                    .offsetHeight, t) / 2 + 17;
    ...
    playLastStatus: function() {
        ...
        if (cur.nextPlaylist && cur.nextPlaylist.start) {
            ...
            if (s && s[1] && a.statusData && a.statusData[s[1]]) {
                ...
                window.audioPlaylist = clone(cur.nextPlaylist), window.audioPlayer && audioPlayer.setPadPlaylist(audioPlaylist), playAudioNew(audioPlaylist.start), e.innerHTML =
                    '<div class="pad_audio_status">' + d.audio_litening_to_user + "</div>", ge("pad_footer_text")
                    .innerHTML = d.audio_goto_user, hide("pad_more_audio")
            }
        }
    },
    audioRow: function(a, e) {
        ...
        if (vk.id != a[0] || a[9] && intval(a[9]))
            if (cur.addedIds && cur.addedIds[a[0] + "_" + a[1]]) d +=
                '<div class="audio_add_wrap added fl_r" onclick="return cancelEvent(event);"><div class="audio_add"></div></div>';
            else {
        ...
        return d += rs(_pads.recommendBtnTpl, {
            ...
            playtime: a[3],
            duration: a[4],
            attr: 'href="/search?c[q]=' + encodeURIComponent(t.replace(/(<span>|<\/span>)/g, "")) +
                '&c[section]=audio&c[performer]=1" onclick="if (checkEvent(event)) return; Audio.selectPerformer({from_pad: true, event: event, name: \'' + clean(t
                    .replace(/(<span>|<\/span>)/g, "")) + "'}); return false\"",
            actions: d,
            author: "",
    ...
    showAudios: function() {
        var a = window._pads && _pads.cur,
            ...
            d = s.recsLoaded && cur.nextPlaylist ? cur.nextPlaylist || {} : !window.audioPlaylist || window.curNotifier && (padPlData = ls.get("pad_pldata")) && padPlData.source ==
            curNotifier.instance_id ? ls.get("pad_playlist") || window.audioPlaylist : padAudioPlaylist();
        if (!a.allLoading && d) {
            var s, t = domLC(e),
                o = "",
                i = "",
                r = 25,
                p = (geByClass("audio", e)
                    .length, (s = window.audioPlayer) && s.isPlaylistGlobal() ? ls.get("audio_id") || currentAudioId() : currentAudioId());
            if (t) {
                i = geByClass1("audio", e)
                    .id.substr(5)
                    .replace("_pad", "");
                var n = t.id.substr(5)
                    .replace("_pad", "");
            ...
            if (i) {
                if (i) {
                    ...
                    if (_ && _[1] && (d.statusData || s.statusData && s.statusData[_[1]]) && !d[i]._next) {
                        ...
                        return e.appendChild(t), setTimeout(function() {
                                setStyle(t, {
                                    height: getSize(_pads.content)[1] - 110 - ge("pad_playlist")
                                        .offsetTop
                                })
                            }, 0), ge("pad_footer_text")
                            .innerHTML = c.audio_goto_user, void hide("pad_more_audio")
                    }
                }
                var u = 0;
                if (o) {
                ...
                }, 0)), d.htitle && (ge("pad_footer_text")
                    .innerHTML = '<span class="audio_album_length">' + d.htitle + "</span>"), t || s.recsLoaded || Pads.setAudioCurPos()
            } else {
                if (p) {
