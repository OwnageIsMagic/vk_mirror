var adminAddItem = {
    ...
    schoolInit: function() {
        ...
        if (cur.addItem.uiSchool) {
            ...
            cur.addItem.uiSchool = new SchoolSelect(ge('adm_additem_school'), ge('row_adm_additem_school'), ge('adm_additem_school_type'), ge('row_adm_additem_school_type'),
                options);
        }
            ...
            onDone: function(res, msg) {
                if (intval(res) === 0) {
                    ...
                    if (cur.addItem.options.isBox) {
                        ...
                        this.clear(true);
                        ge('adm_additem_result')
                            .innerHTML = '<div class="msg">' + msg + '</div>';
