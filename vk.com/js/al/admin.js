var adminAddItem = {
    init: function(t) {
        if (this.clear(), t = t || "", cur.addItem.options.obj_id)
            if ("school" == t) {
                ...
                i && i.uiSchool && (cur.addItem.options.country = i.uiCountry.val(), cur.addItem.options.country_val = i.uiCountry.val_full(), cur.addItem.options.city = i
                    .uiCity.val(), cur.addItem.options.city_val = i.uiCity.val_full(), cur.addItem.options.school = i.uiSchool.val(), cur.addItem.options.school_val =
                    i.uiSchool.val_full())
            } else if ("uni" == t || "faculty" == t || "chair" == t) {
            var d = this.getUni();
            d && d.uiUniversity && (cur.addItem.options.country = d.uiCountry.val(), cur.addItem.options.country_val = d.uiCountry.val_full(), cur.addItem.options.city = d
                .uiCity.val(), cur.addItem.options.city_val = d.uiCity.val_full(), cur.addItem.options.uni = d.uiUniversity.val(), cur.addItem.options.uni_val = d.uiUniversity
                .val_full(), cur.addItem.options.faculty = d.uiFaculty.val(), cur.addItem.options.faculty_val = d.uiFaculty.val_full(), cur.addItem.options.chair = d.uiChair
                .val(), cur.addItem.options.chair_val = d.uiChair.val_full())
        }
    ...
    cityInit: function(t) {
        ...
        t = extend(i, t || {}), cur.addItem.uiCity ? cur.addItem.uiCity.setOptions(t) : cur.addItem.uiCity = new CitySelect(ge("adm_additem_city"), ge(
            "row_adm_additem_city"), t), this.countryInit({
    ...
    countryInit: function(t) {
        ...
        t = extend(i, t || {}), cur.addItem.uiCountry ? cur.addItem.uiCountry.setOptions(t) : cur.addItem.uiCountry = new CountrySelect(ge("adm_additem_country"), ge(
            "row_adm_additem_country"), t)
    },
    ...
    schoolInit: function() {
        ...
        cur.addItem.uiSchool ? cur.addItem.uiSchool.setOptions(t) : cur.addItem.uiSchool = new SchoolSelect(ge("adm_additem_school"), ge("row_adm_additem_school"), !1, !1,
            t), this.cityInit({
    ...
    uniInit: function(t, i) {
        ...
        t = extend(d, t || {}), cur.addItem.uiUni ? cur.addItem.uiUni.setOptions(t) : cur.addItem.uiUni = new UniversitySelect(ge("adm_additem_uni"), ge(
            "row_adm_additem_uni"), t);
        var a = function(t) {
    ...
    uniDestroy: function() {
        cur.addItem.uiUni.clear(), cur.addItem.uiUni.hide(), val("adm_additem_short", ""), val("adm_additem_link", ""), hide("row_adm_additem_short",
            "row_adm_additem_link"), this.cityDestroy()
    },
    facultyInit: function(t, i) {
        ...
        t = extend(d, t || {}), cur.addItem.uiFaculty ? cur.addItem.uiFaculty.setOptions(t) : cur.addItem.uiFaculty = new FacultySelect(ge("adm_additem_fac"), ge(
            "row_adm_additem_fac"), t), this.uniInit(extend({
            forceEnableCustom: -1,
    ...
    validateValue: function(t, i) {
        return t && intval(t.val()) > 0 ? (this.showError(i), !1) : t && -1 == intval(t.val()) && t.customVal() ? (val("adm_additem_result", ""), !0) : (t && val(
            "adm_additem_result", ""), !1)
    },
    destroyScope: function() {
        cur.addItem.uiSchool && cur.addItem.uiSchool.destroy(), cur.addItem.uiUni && cur.addItem.uiUni.destroy(), cur.addItem.uiFaculty && cur.addItem.uiFaculty.destroy(),
            cur.addItem.uiChair && cur.addItem.uiChair.destroy(), cur.addItem.uiStreet && cur.addItem.uiStreet.destroy(), cur.addItem = {}, nav.objLoc.add_item && (delete nav
                .objLoc.add_item, nav.setLoc(nav.objLoc))
    },
    getUni: function() {
