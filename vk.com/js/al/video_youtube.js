var VideoYoutube = {
    ...
    init: function(e, o) {
        ...
        e && t && (VideoYoutube.cur = {
                ...
                liked: o.liked,
                added: o.added
            }, o.lang_quality_auto && (VideoYoutube.qualityValues.auto = o.lang_quality_auto), t.appendChild(se(VideoYoutube.getUIHtml())), e.addEventListener(
                "onReady", VideoYoutube.onPlayerReady), e.addEventListener("onStateChange", VideoYoutube.onStateChange), e.addEventListener("onPlaybackQualityChange",
                VideoYoutube.onPlaybackQualityChange), e.addEventListener("onError", VideoYoutube.onError), addEvent(t, "mouseenter", VideoYoutube.onMouseEnter),
            addEvent(t, "mouseleave", VideoYoutube.onMouseLeave), addEvent(t, "mousemove", VideoYoutube.onMouseMove), addEvent(t, "keydown", VideoYoutube.onKeyDown),
            addEvent(document, fullscreenApi.fullscreenEventName, VideoYoutube.onFullscreenChange), addEvent(window, "resize", VideoYoutube.onResize), VideoYoutube.onResize(),
    ...
    initStatOnly: function(e, o) {
        ...
        e && t && (VideoYoutube.cur = {
                ...
                liked: o.liked,
                added: o.added
            }, e.addEventListener("onStateChange", VideoYoutube.onStateChangeStatOnly), addEvent(document, fullscreenApi.fullscreenEventName, VideoYoutube.onFullscreenChange),
            VideoYoutube.onResize(), addEvent(window, "resize", VideoYoutube.onResize), o.autoplay && ! function i() {
                var e = VideoYoutube.cur.player;
                if (e)
                    if (e.getPlayerState && e.getPlayerState() != YT.PlayerState.UNSTARTED && !VideoYoutube.cur.started) {
                        var o = {
    ...
    getUIHtml: function() {
        ...
        return '<div id="video_yt_ui" class="no_select">  <!--div id="video_yt_poster" style="background-image: url(' + e.jpg +
            ')"></div-->  <div id="video_yt_mousetrap" onclick="VideoYoutube.togglePlay()" ondblclick="VideoYoutube.toggleFullscreen()" style="display:none"></div>  <div id="video_yt_actions" class="clear_fix hidden">    <div id="video_yt_like" class="fl_l video_yt_like ' +
            (e.liked ? "selected" : "") +
            '" onmouseover="VideoYoutube.onLikeOver(this)" onmouseout="VideoYoutube.onLikeOut(this)" onclick="VideoYoutube.onLikeClick(this)">      <span class="video_yt_like_icon video_yt_icon"></span>      <span class="video_yt_liked_icon video_yt_icon"></span>    </div>    <div id="video_yt_share" class="fl_l video_yt_share" onmouseover="VideoYoutube.onShareOver(this)" onmouseout="VideoYoutube.onShareOut(this)" onclick="VideoYoutube.onShareClick(this)">      <span class="video_yt_share_icon video_yt_icon"></span>    </div>    <div id="video_yt_add" class="fl_l video_yt_add ' +
            (e.added ? "selected" : "") +
            '" onmouseover="VideoYoutube.onAddOver(this)" onmouseout="VideoYoutube.onAddOut(this)" onclick="VideoYoutube.onAddClick(this, 1)" style="' + (e.can_add ? "" :
                "display:none") +
            '">      <span class="video_yt_add_icon video_yt_icon"></span>      <span class="video_yt_added_icon video_yt_icon"></span>    </div>  </div>  <div id="video_yt_controls" class="hidden">    <table cellspacing="0" cellpadding="0" border="0" id="video_yt_controls_table">      <tr>        <td style="padding:0 14px 0 2px" id="video_yt_play_btn_td">          <div id="video_yt_play_btn" class="video_yt_icon" onclick="VideoYoutube.togglePlay()"></div>        </td>        <td style="padding-right:10px; display:none" id="video_yt_replay_btn_td">          <div id="video_yt_replay_btn" class="video_yt_icon" onclick="VideoYoutube.replayVideo()"></div>        </td>        <td style="padding-right:12px;' +
            (e.show_next ? "" : "display:none") +
            '">          <div id="video_yt_next_btn" class="video_yt_icon" onmouseover="VideoYoutube.onNextBtnOver(this)" onmouseout="VideoYoutube.onNextBtnOut(this)" onclick="VideoYoutube.nextVideo()"></div>        </td>        <td width="100%" style="padding:6px 0">          <div id="video_yt_progressbar" onmousemove="VideoYoutube.onProgressMove(event)" onmouseover="VideoYoutube.onProgressOver()" onmouseout="VideoYoutube.onProgressOut()" onmousedown="VideoYoutube.onProgressDragStart(event)">            <div class="video_yt_progressbar_bg"></div>            <div id="video_yt_progressbar_loaded"></div>            <div id="video_yt_progressbar_viewed">              <div class="video_yt_progressbar_slider"></div>            </div>          </div>        </td>        <td style="padding-left:14px" id="video_yt_time_td">          <div id="video_yt_time_label" class="video_yt_time_label ' +
            (VideoYoutube.cur.reverseTime ? "video_yt_time_label_reversed" : "") +
            '" onclick="VideoYoutube.onTimeLabelClick(this)">            <span id="video_yt_time_current" class="video_yt_time_current">' + o +
            '</span>            <span id="video_yt_time_duration" class="video_yt_time_duration"> / ' + t +
            '</span>          </div>        </td>        <td style="padding-left:16px">          <div class="volume_wrap" onmouseenter="VideoYoutube.onVolumeWrapOver()" onmouseleave="VideoYoutube.onVolumeWrapOut()">            <div id="video_yt_volumebar_dropdown" class="hidden"></div>            <div id="video_yt_volume_btn" class="video_yt_icon" onmouseover="VideoYoutube.onVolumeBtnOver(this)" onmouseout="VideoYoutube.onVolumeBtnOut(this)" onclick="VideoYoutube.onVolumeBtnClick(this)"></div>          </div>        </td>        <td style="padding:0 6px" id="video_yt_volumebar_td">          <div id="video_yt_volumebar" onmousedown="VideoYoutube.onVolumeDragStart(event)">            <div class="video_yt_volumebar_bg"></div>            <div id="video_yt_volumebar_filled">              <div class="video_yt_volumebar_slider"></div>            </div>          </div>        </td>        <td style="padding-left:9px;' +
            (e.is_inline ? "" : "display:none") +
            '">          <div id="video_yt_expand_btn" class="video_yt_icon" onmouseover="VideoYoutube.onExpandBtnOver(this)" onmouseout="VideoYoutube.onExpandBtnOut(this)" onclick="VideoYoutube.onExpandBtnClick(this)"></div>        </td>        <td style="padding-left:9px;' +
            (i ? "" : "display:none") +
            '">          <div id="video_yt_fullscreen_btn" class="video_yt_icon" onmouseover="VideoYoutube.onFullScreenBtnOver(this)" onmouseout="VideoYoutube.onFullScreenBtnOut(this)" onclick="VideoYoutube.toggleFullscreen()"></div>        </td>        <td style="padding:0 9px 0 8px" id="video_yt_quality_td">          <div id="video_yt_quality_label" onmouseenter="VideoYoutube.onQualityLabelOver()" onmouseleave="VideoYoutube.onQualityLabelOut()">            <div id="video_yt_quality_dropdown" class="hidden"></div>            <span id="video_yt_quality_btn" onmouseover="VideoYoutube.onQualityBtnOver(this)" onmouseout="VideoYoutube.onQualityBtnOut(this)" onclick="VideoYoutube.toggleQualityDropdown()">              <span id="video_yt_quality_btn_value"></span>              <span id="video_yt_quality_btn_icon"></span>            </span>          </div>        </td>        <td style="padding-left:9px">          <div id="video_yt_logo_btn" onclick="VideoYoutube.onLogoClick()"></div>        </td>      </tr>    </table>  </div>  <div id="video_yt_popup" class="hidden" onclick="VideoYoutube.togglePlay()" ondblclick="VideoYoutube.toggleFullscreen()">    <div class="video_yt_popup_play video_yt_icon"></div>    <div class="video_yt_popup_title" style="' +
            (e.no_title ? "display:none" : "") + '">' + e.title + '</div>    <a href="' + e.author_href +
            '" target="_blank" onclick="event.stopPropagation()" class="video_yt_popup_author">' + e.author_name +
            '</a>  </div>  <div id="video_yt_tip">    <div id="video_yt_tip_arrow"></div>    <div id="video_yt_tip_bk"></div>    <span id="video_yt_tip_text"></div>  </div></div>    '
    },
    getQualityItemsHtml: function(e) {
        ...
        return each(e, function(e, t) {
            ...
            if (!(240 > i)) {
                var u;
                i >= 720 && 1080 >= i ? u = "hd" : 1440 == i ? u = "2k" : 2160 == i ? u = "4k" : 4320 == i && (u = "8k"), o += '<div class="video_yt_quality_item ' +
                    ("auto" == t ? "selected" : "") + '" onclick="VideoYoutube.setQuality(\'' + t + '\', this)">  <span class="video_yt_quality_item_text">' + i +
                    "</span>  " + (u ? '<span class="video_yt_quality_item_' + u + '_label video_yt_icon"></span>' : "") + "</div>      "
            }
        }), o
    },
    togglePlay: function(e) {
        var o = VideoYoutube.cur.player;
        o && (e = null != e ? e : !VideoYoutube.cur.playing, e ? o.playVideo() : o.pauseVideo(), toggleClass("video_yt_play_btn", "playing", e), toggleClass(
            "video_yt_popup", "hidden", e), VideoYoutube.cur.playing = e)
    },
    replayVideo: function() {
        VideoYoutube.cur.player.seekTo(0), VideoYoutube.cur.player.playVideo()
    },
    setQuality: function(e, o) {
        VideoYoutube.cur.player.setPlaybackQuality(e), each(ge("video_yt_quality_dropdown")
            .children,
            function(e, o) {
    ...
    toggleMute: function() {
        var e = VideoYoutube.cur.player,
            o = e.getVolume();
        e.isMuted() || !o ? (e.unMute(), o ? window.localStorage && localStorage.setItem("video_volume", o) : VideoYoutube.setVolume(60)) : (e.mute(), window.localStorage &&
            localStorage.setItem("video_volume", 0)), setTimeout(VideoYoutube.updateVolume, 10)
    },
    ...
    onStateChange: function(e) {
        switch (e.data == YT.PlayerState.BUFFERING ? VideoYoutube.cur.buffering = !0 : (VideoYoutube.cur.state = e.data, VideoYoutube.cur.buffering = !1, VideoYoutube.cur.playing = !
            1), e.data) {
    ...
    onVideoStarted: function() {
        ...
        t.innerHTML = VideoYoutube.getQualityItemsHtml(o), VideoYoutube.updateQualityLabel(e.getPlaybackQuality()), VideoYoutube.resizeTimeLabel(), VideoYoutube.updateProgress(),
            show("video_yt_mousetrap"), hide("video_yt_replay_btn_td"), show("video_yt_play_btn_td"), removeClass("video_yt_controls", "hidden"), removeClass(
                "video_yt_actions", "hidden"), VideoYoutube.progressLoopStart(), VideoYoutube.cur.started = !0, cur && cur.incViews && cur.incViews()
    },
    ...
    onVideoPlaying: function() {
        addClass("video_yt_play_btn", "playing"), addClass("video_yt_popup", "hidden"), VideoYoutube.cur.isFS ? (clearTimeout(VideoYoutube.cur.hideControlsTimeoutId),
                VideoYoutube.cur.hideControlsTimeoutId = setTimeout(VideoYoutube.onHideControlsTimer, 2e3)) : VideoYoutube.cur.mouseInside || VideoYoutube.cur.progressDragging ||
    ...
    onVideoEnded: function() {
        VideoYoutube.cur.isFS && VideoYoutube.toggleFullscreen(), removeClass("video_yt_play_btn", "playing"), hide("video_yt_play_btn_td"), show("video_yt_replay_btn_td"),
            VideoYoutube.toggleControls(!0), VideoYoutube.cur.started = !1, VideoYoutube.progressLoopStop(), VideoYoutube.cur.progressDragging && VideoYoutube.onProgressDragEnd(),
    ...
    updateProgress: function(e) {
        ...
        if (o.getPlayerState) {
            ...
            ge("video_yt_time_current")
                .innerHTML = VideoYoutube.formatTime(u ? i - t : t), ge("video_yt_time_duration")
                .innerHTML = " / " + VideoYoutube.formatTime(i)
        }
    },
    ...
    showTip: function(e, o, t, i) {
        ...
        ge("video_yt_tip_text")
            .innerHTML = e.replace(/</g, "&lt;")
            .replace(/>/g, "&gt;");
        var d, n, r, a = getSize("video_yt"),
            l = 36,
            s = getSize(u),
            c = 4;
        o - s[0] / 2 < 8 ? (d = 8, r = o - d) : o + s[0] / 2 > a[0] - 8 ? (d = a[0] - s[0] - 8, r = o - d) : d = Math.round(o - s[0] / 2), n = i ? Math.round(t + c) : Math
            .round(t - s[1] - c), toggleClass(u, "video_yt_tip_down", !!i), setStyle(u, {
                display: "block",
                left: d + "px",
                top: n + "px"
    ...
    toggleControls: function(e) {
        VideoYoutube.cur.progressDragging || VideoYoutube.cur.volumeDragging || hasClass("video_yt_quality_dropdown", "hidden") && (e !== !0 || VideoYoutube.cur.started) &&
            (e !== !1 || VideoYoutube.cur.playing) && (toggleClass("video_yt_controls", "hidden", !e), toggleClass("video_yt_actions", "hidden", !e), toggleClass(
                "video_yt", "no_cursor", !e), e === !1 && VideoYoutube.hideTip())
    },
    onResize: function() {
        var e = ge("video_yt");
        if (e) {
    ...
    resizeTimeLabel: function() {
        ...
        if (o) {
            ...
            setStyle(i, {
                ...
                .innerHTML = t, ge("video_yt_time_duration")
                .innerHTML = "/ " + t, setStyle(i, {
    ...
    updateQualityLabel: function(e) {
        ...
        VideoYoutube.cur.quality = e, ge("video_yt_quality_btn_value")
            .textContent = o;
    ...
    onTimeLabelClick: function(e) {
        VideoYoutube.cur.minSize && (VideoYoutube.cur.reverseTime = !VideoYoutube.cur.reverseTime, toggleClass(e, "video_yt_time_label_reversed", VideoYoutube.cur.reverseTime),
            VideoYoutube.updateProgress(), window.localStorage && localStorage.setItem("video_reverse_time", VideoYoutube.cur.reverseTime))
    },
    ...
    onQualityLabelOut: function() {
        VideoYoutube.cur.hideQualityDDTimer = setTimeout(function() {
            VideoYoutube.toggleQualityDropdown(!1), VideoYoutube.cur.isFS && VideoYoutube.cur.state == YT.PlayerState.PLAYING && (new Date)
                .getTime() - VideoYoutube.cur.lastMouseMove > 2e3 && VideoYoutube.toggleControls(!1)
        }, 3e3)
    },
    ...
    onFullscreenChange: function() {
        ...
        VideoYoutube.cur.isFS = e, toggleClass("video_yt", "video_yt_fullscreen", e), toggleClass("video_yt_fullscreen_btn", "fullscreen", e), VideoYoutube.hideTip(),
            VideoYoutube.onResize(), videoCallback(["fullscreen", e])
    },
    ...
    onProgressDragStart: function(e) {
        addEvent(document, "mousemove", VideoYoutube.onProgressDrag), addEvent(document, "mouseup", VideoYoutube.onProgressDragEnd), addClass("video_yt_progressbar",
            "dragging"), VideoYoutube.cur.progressDragging = !0, VideoYoutube.onProgressDrag(e, !0)
    },
    ...
    onProgressDragEnd: function(e) {
        removeEvent(document, "mousemove", VideoYoutube.onProgressDrag), removeEvent(document, "mouseup", VideoYoutube.onProgressDragEnd), VideoYoutube.cur.progressDragging = !
            1;
    ...
    onVolumeDragStart: function(e) {
        addEvent(document, "mousemove", VideoYoutube.onVolumeDrag), addEvent(document, "mouseup", VideoYoutube.onVolumeDragEnd), addClass("video_yt_volumebar", "dragging"),
            VideoYoutube.cur.volumeDragging = !0, VideoYoutube.onVolumeDrag(e, !0)
    },
    onVolumeDrag: function(e, o) {
        ...
        else var d = ge("video_yt_volumebar")
    ...
    onVolumeDragEnd: function(e) {
        removeEvent(document, "mousemove", VideoYoutube.onVolumeDrag), removeEvent(document, "mouseup", VideoYoutube.onVolumeDragEnd), VideoYoutube.cur.volumeDragging = !1,
            removeClass("video_yt_volumebar", "dragging"), VideoYoutube.hideTip(), VideoYoutube.cur.minSize && addClass("video_yt_volumebar_dropdown", "hidden")
    },
    onKeyDown: function(e) {
        ...
        t && (cancelEvent(e), VideoYoutube.toggleControls(!0), clearTimeout(VideoYoutube.cur.hideControlsTimeoutId), VideoYoutube.cur.hideControlsTimeoutId = setTimeout(
            VideoYoutube.onHideControlsTimer, 2e3))
    },
    ...
    onMouseMove: function(e) {
        clearTimeout(VideoYoutube.cur.hideControlsTimeoutId), VideoYoutube.cur.lastMouseMove = (new Date)
            .getTime(), VideoYoutube.toggleControls(!0), VideoYoutube.cur.isFS && VideoYoutube.cur.state == YT.PlayerState.PLAYING && (VideoYoutube.cur.hideControlsTimeoutId =
                setTimeout(VideoYoutube.onHideControlsTimer, 2e3))
    },
    ...
    destroy: function() {
        ...
        var e = ge("video_yt");
        e && (removeEvent(e, "mouseenter", VideoYoutube.onMouseEnter), removeEvent(e, "mouseleave", VideoYoutube.onMouseLeave), removeEvent(e, "mousemove", VideoYoutube.onMouseMove),
            removeEvent(e, "keydown", VideoYoutube.onKeyDown)), removeEvent(document, fullscreenApi.fullscreenEventName, VideoYoutube.onFullscreenChange), removeEvent(
            window, "resize", VideoYoutube.onResize)
    }
};
! function() {
    if (!window.fullscreenApi) {
        ...
        document.fullscreenEnabled ? e.supportsFullscreen = !0 : each(o, function(o, t) {
            ...
            return "" === this.prefix ? e.requestFullscreen() : (e[this.prefix + "RequestFullscreen"] || e[this.prefix + "RequestFullScreen"])
                .call(e)
        }, e.exitFullscreen = function() {
            return "" === this.prefix ? document.exitFullscreen() : (document[this.prefix + "ExitFullscreen"] || document[this.prefix + "CancelFullScreen"])
                .call(document)
