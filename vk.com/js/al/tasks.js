Tasks = {
    ...
    switchTab: function(e, t) {
        return t.button || t.ctrlKey || browser.mac && t.metaKey ? !0 : (show("tasks_loading"), hasClass(e.parentNode, "task_tab") ? (each(geByClass("task_tab_active", ge(
            "tasks_tabs")), function(e, t) {
            removeClass(t, "task_tab_active"), addClass(t, "task_tab")
        }), removeClass(e.parentNode, "task_tab"), addClass(e.parentNode, "task_tab_active")) : hasClass(e.firstChild, "tasks_section_filter") && (each(geByClass(
            "tasks_section_filter", ge("tasks_section_filters")), function(e, t) {
    ...
    saveRedmineKey: function() {
        ...
        ajax.post(Tasks.address, {
            ...
            onDone: function(e) {
                var t = se('<div class="' + (e ? "ok_msg" : "error") + '" style="text-align:center">' + (e ? getLang("global_done") : getLang("global_error")) +
                        "</div>"),
                    s = domNS(ge("redmine_key"));
                s ? domPN(ge("redmine_key"))
                    .insertBefore(t, s) : domPN(ge("redmine_key"))
                    .appendChild(t), setTimeout(function() {
                        slideUp(t)
                    }, 2e3)
            }
        })
    ...
    saveTask: function(bid, hash) {
        ...
        var limit_type = intval(cur.deadlineEditFilter.val()),
            ...
            query = {
                ...
                title: title,
                desc: desc,
                browser: isVisible("browser") ? ge("browser")
                    .value : "",
                ...
                hash: hash
            }; - 1 == limit_type && (query.limit_date = ge("custom_date")
            .value), bid || (query.send_sms = intval(cur.sendSMSFilter.checked()));
        var b = curBox();
        bid ? ajax.post(Tasks.address, query, {
            ...
            onDone: function(text, script) {
                curBox()
                    .content(text), script && eval(script)
            }
        })
    },
    ...
    replyViewComment: function(e, t) {
        return ge("answer_to")
            .innerHTML = '<a onclick="return Tasks.cancelReplyComment();">' + t + "</a>", cur.replyTo = e, !1
    },
    cancelReplyComment: function() {
        return delete cur.replyTo, ge("answer_to")
            .innerHTML = "", !1
    },
    editComment: function(e, t) {
        ...
        return ajax.post(Tasks.address, {
            ...
            onDone: function(o) {
                s.innerHTML = '<textarea class="tasks_edit_comment" id="comment' + e + 'edit" onkeydown="Tasks.saveComment(event, ' + e + ", '" + t + "')\">" +
                    o +
                    '</textarea>       <div style="margin: 5px 0 0 -2px; height: 23px">         <div class="fl_l button_blue">          <button id="save_but' +
                    e + '" onclick="Tasks.doSaveComment(' + e + ", '" + t + "')\">" + cur.lang.save +
                    '</button>         </div>         <div class="fl_l button_gray" style="margin-left: 6px;">          <button id="cancel_but' + e +
                    '" onclick="Tasks.cancelEditComment(' + e + ')">' + cur.lang.cancel + '</button>         </div>         <div id="editCommentProgress' + e +
                    '" style="margin: 5px 0px 0px 10px; vertical-align: 0px; float: left; display: none"><img src="/images/upload.gif"/></div>       </div>',
                    ge("comment" + e + "edit")
                    .focus(), hide(geByClass1("date", ge("comment" + e))), autosizeSetup(ge("comment" + e + "edit"), {
                        minHeight: 30
                    }), cur.editing = e
            }
        }), !1
    ...
    cancelEditComment: function(e) {
        geByClass1("tasks_comm_text", ge("comment" + e))
            .innerHTML = cur.comments[e], show(geByClass1("date", ge("comment" + e))), delete cur.editing, delete cur.comments[e]
    },
    doSaveComment: function(e, t) {
        var s = ge("comment" + e + "edit")
            .value;
    ...
    deleteComment: function(e, t, s) {
        return show("tasks_loading"), ajax.post(Tasks.address, {
            ...
            onDone: function(s) {
                var o = "viewbug" == cur.act ? ge("comment" + t)
                    .firstChild : ge("comment" + e + "_" + t)
                    .firstChild;
    ...
    viewComments: function(e, t, s) {
        return cur.bugComments || (cur.bugComments = {}), cur.bugComments[e] != t ? (ge("tph_text" + e) ? (show("tph_prg" + e), hide("tph_text" + e)) : (ge("com_links" + e)
            .innerHTML = "", show("load_comm" + e)), ajax.post(Tasks.address, {
            act: "load_comments",
            bid: e,
            fresh: t,
            from: cur.act,
    ...
    addReplyComment: function(e, t, s) {
        ...
        return o ? void(cur.commentSent || (cur.commentSent = !0, lockButton(ge("send" + e)), ajax.post(Tasks.address, {
            ...
            onDone: function(t, s) {
                delete cur.commentSent, unlockButton(ge("send" + e)), "feed" == cur.act || "comments" == cur.act ? (ge("comment" + e)
                    .innerHTML += t, addClass(ge("comment" + e), "answered"), re("reply" + e), hide(geByClass1("tasks_comm_actions", ge("comment" +
                        e)))) : (ge("comments_cont" + e)
                    .innerHTML += t, ge("com_links" + e)
                    .innerHTML = s, ge("reply_field" + e)
                    .value = "", ge("reply_field" + e)
                    .blur(), Tasks.hideReplyBox(e))
            }
        }))) : !1
    },
    showReplyBox: function(e) {
        ...
        return cur.focused && cur.focused != e && Tasks.hideReplyBox(cur.focused), t.show || (e && show("post_submit" + e), t.autosize && t.autosize.update(), t.show = !0,
            cur.focused = e), !1
    },
    hideReplyBox: function(e) {
        if (!browser.opera || !browser.mobile) {
            e = e || "";
            var t = ge("reply_field" + e);
            return t && t.show && (e && hide("post_submit" + e), ge("reply_to_name") && (ge("reply_to_name")
                .innerHTML = ""), setStyle(t, {
                height: 14
    ...
    checkFilter: function(e) {
        var t = ge("filter_" + e),
            s = cur.typeMask,
            o = cur.feedTypes[e];
        s & 1 << o ? (s &= ~(1 << o), removeClass(t, "checked")) : (s |= 1 << o, addClass(t, "checked")), cur.typeMask = s, setCookie("remixtasks_feed_filter", s, 100),
            Tasks.filterFeed()
    },
    ...
    filterFeed: function() {
        ge("feed_wrap")
            .style.opacity = .5, ajax.post(Tasks.address, {
                act: "feed",
                load: 1,
                id: cur.id
            }, {
                onDone: function(e, t) {
                    t && extend(cur, t), ge("tasks_content")
                        .innerHTML = e, window.tooltips && tooltips.hideAll(), Tasks.setupReply(), cur.id ? nav.setLoc(extend(nav.objLoc, {
                            id: cur.id
    ...
    showMore: function() {
        return hide("show_more"), show("show_more_progress"), cur.loadingFeed = !0, ajax.post(Tasks.address, {
            ...
            onDone: function(e, t, s) {
                delete cur.loadingFeed, show("show_more"), hide("show_more_progress"), ge("feed")
                    .innerHTML += e, ge("show_more_box")
                    .innerHTML = t, s && extend(cur, s), Tasks.setupReply()
            },
            onFail: function() {
    ...
    subscribe: function(e, t, s) {
        show("tasks_loading");
        var o; - 1 != e.toString()
            .indexOf("_") && (o = e, e = e.split("_"), e = parseInt(e[0])), ajax.post(Tasks.address, {
                act: "subscribe",
                from: cur.act,
                subscribe: t,
                bid: e,
                ...
                onDone: function(s) {
                    switch (cur.act) {
                        ...
                        case "feed":
                            cont = ge("comment" + o)
                                .firstChild, t ? cont.innerHTML = cur.unsubscribed[o] : (window.tooltips && tooltips.hide(ge("update_hide" + o)), cur.unsubscribed ||
                                    (cur.unsubscribed = new Array), cur.unsubscribed[o] = cont.innerHTML, cont.innerHTML = s), removeClass(cont, "over"), setStyle(
                                    ge("update_hide" + o), {
                                        opacity: .5
                                    })
                    }
    ...
    filterSettings: function(offset, value) {
        show("tasks_loading"), ajax.post(Tasks.address, {
            ...
            onDone: function(text, script) {
                hide("tasks_loading"), val("tasks_content", text), window.tooltips && tooltips.hideAll(), script && eval(script), Tasks.setupReply(), value ?
    ...
    uploadScreenshot: function(e) {
        hide("screenshot_error"), ge("tasks_add_screen")
            .submit(), e.disabled = !0, curBox()
            .showProgress()
    },
    ...
    changeTaskStatus: function(status, hash) {
        var doChangeStatus = function(e, t, s) {
                ...
                cur.hideAutoanswer && ge("task_closed_autoanswer") && (o.no_autoanswer = cur.hideAutoanswer.val(), o.answer_text = ge("task_closed_autoanswer")
                    .value), ajax.post(Tasks.address, o, {
                    onDone: function(e, t, o) {
                        s && s.hide(), hide("tasks_loading"), e && (ge("task_summary")
                            .innerHTML = e), t && (ge("task_actions")
                            .innerHTML = t), o && (ge("task_comments")
                            .innerHTML = o)
                    }
                })
            },
        ...
        if (cur.forceStop = !1, 1 == status && cur.binded_tickets && cur.binded_tickets.length) {
            var box = showFastBox({
                title: cur.lang.close_task,
                width: 430,
                bodyStyle: "line-height: 160%;",
                dark: 1
            }, cur.lang.sure_close, getLang("global_close"), function() {
                box.changed = !0, show("tasks_status_progress_wrap"), hide("tasks_sure_close_wrap"), sendReq(hash, box), box.removeButtons(), box.addButton(getLang(
                    "global_close"), function() {
            ...
            var box = showFastBox({
                ...
                '<div id="tasks_status_progress_wrap" class="tasks_upload_progress_wrap" style="margin: 20px auto"><div id="task_status_progress" class="tasks_upload_progress" style="width: 0%;"></div></div>',
    ...
    changeDeveloper: function(e, t) {
        show("tasks_loading"), ajax.post(Tasks.address, {
            ...
            onDone: function(e, t, s) {
                hide("tasks_loading"), e && (ge("task_header")
                        .innerHTML = e), t && (ge("task_actions")
                        .innerHTML = t), s && (ge("task_comments")
                        .innerHTML = s), curBox() && curBox()
                    .hide()
            }
        })
    },
