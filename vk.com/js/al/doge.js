var Doge = {
    ...
    show: function() {
        ...
        if (!dogeDom) {
            ...
            var dogeDom = ce('a', {
                id: 'vk_doge',
                innerHTML: '<div style="font-family: \'Comic Sans MS\', cursive; font-size: 24px; position: absolute; margin-top: -56px; width: 150px; text-align: center; opacity: 0;filter: alpha(opacity=0);">WOW</div><img id="nichosi_str" style="position: absolute;" src="' +
                    srcStr + '" width="150" height=37"><img src="' + src + '" width="150" height=150">',
            }, {
                position: 'fixed',
                bottom: -150,
                right: 50,
...
var Harold = {
    ...
    appear: function() {
        animate(this.obj, {
            bottom: -(this.height + this.offset)
        }, {
            duration: 1500,
            transition: function(t, b, c, d) {
                return c * cubicBezier(.47, 4.29, .51, .3, t / d, 4 / d) + b;
    ...
    hide: function() {
        ...
        this.ht = setTimeout(function() {
            ...
            animate(this.tt, {
                ...
                duration: 150,
                transition: function(t, b, c, d) {
                    return c * cubicBezier(1, -0.01, .96, .77, t / d, 4 / d) + b;
                }
            });
            animate(this.obj, {
                bottom: -(this.height + this.offset)
