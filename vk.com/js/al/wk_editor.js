...
extend(WkEditor.prototype, {
    ...
    checkBrowser: function() {
        ...
        browser.chrome && e > 11 && (t = 1), browser.mozilla && e >= 4 && (t = 1), browser.opera && e > 10 && (t = 1), browser.safari && e > 4 && (t = 1), browser.msie &&
            e >= 9 && (t = 1);
        var i = ge("wke_b_mode");
        t && !this.plain ? (show(this.cont), hide(this.textarea), this.setPlainMode(!1), this.modeBtn && this.ttUpdate(i, this.modeBtn[0])) : (hide(this.cont), show(
            this.textarea), this.setPlainMode(!0), this.modeBtn && this.ttUpdate(i, this.modeBtn[1]), t || hide(i)), this.onPlainToggle && this.onPlainToggle(!t, !
            1), this.checkEditPlace()
    },
