function WkEditor(e, t) {
    ...
    t.mode && (this.mode = 0, this.modeBtn = t.mode, s = '<a id="wke_b_mode" class="wke_b wke_b_mode" wiki="mode" tooltip="' + t.mode[0] + '" onmousedown="' + this.inst +
        '.button(this, event);" onmouseover="' + this.inst + '.ttOver(this, true);"></a>');
    ...
    for (var r in this.buttons) {
        ...
        n += '<a id="wke_b_' + r + '" class="wke_b wke_b_' + r + '" wiki="' + r + '" tooltip="' + a[0] + '" onmousedown="' + this.inst + '.button(this, event);" onmouseover="' +
...
extend(WkEditor.prototype, {
                ...
                case KEY.ENTER:
                    ...
                    if (n && 2 == n[1]) {
                        ...
                        if (!s.endOffset && this.getText(r)) {
                            ...
                            o && "BR" != o.tagName && (3 != o.nodeType || o.data) && r.parentNode.insertBefore(ce("br"), r), r.parentNode.insertBefore(a, r), this.setFocus(
                                r, {
                                    toStart: !0
                                })
    ...
    plainGetSel: function() {
        ...
        if (document.selection) {
            if (e = !0, range = document.selection.createRange(), range && range.parentElement() == this.textarea) {
                ...
                o.collapse(!1), a.compareEndPoints("StartToEnd", o) > -1 ? t = i = n : (t = -a.moveStart("character", -n), browser.msie && intval(browser.version) < 9 &&
                    (t += r.slice(0, t)
                        .split("\n")
                        .length - 1), a.compareEndPoints("EndToEnd", o) > -1 ? i = n : (i = -a.moveEnd("character", -n), browser.msie && intval(browser.version) <
                        9 && (i += r.slice(0, i)
                            .split("\n")
                            .length - 1)))
            }
    ...
    plainInsert: function(e, t, i) {
        ...
        if (d && (len = d[0].length, l = l.substr(0, l.length - len), o -= len, c = d[0] + c), i.replace && (l = ""), a >= s && h.substr(a - s, a) == e && c.substr(0,
                n) == t) e = "", t = "", h = h.substr(0, a - s), c = c.substr(n), a -= s, o -= s;
    ...
    getState: function(e) {
        ...
        for (state = {}; a;) {
            ...
            if ("LI" == o && this.fixList(a), !r) {
                ...
                h ? (h[2] ? state.h3 = 1 : h[1] ? state.h2 = 1 : h[0] && (state.h1 = 1), n = a, r = 2, (state.right || state.center) && this.fixHeader(a)) : this.isLink(
                    a) ? (n = a, r = 3) : "PRE" == o ? (n = a, r = 4) : "UL" == o || "OL" == o ? (n = a, r = 5, state.list = 1) : "BLOCKQUOTE" == o && (n = a, r =
    ...
    getPhotoHTML: function(e, t, i, s, n, r, a) {
        ...
        var h = "";
        return a && (h = ' title="' + clean(a) + '"'), '<a contenteditable="false"' + h + ' class="wk_photo" wiki="' + e + "_" + t + '" href="' + r + '" onclick="' +
                ...
                switch (i.nodeType) {
                    ...
                    case 1:
                        ...
                        ("DIV" == r || "P" == r || "PRE" == r || "BLOCKQUOTE" == r || "CENTER" == r || "RIGHT" == r || "LEFT" == r || "BR" == r) && (s += "\n"), s +=
                            "B" == r || "STRONG" == r ? "<b>" + this.getText(i, !0) + "</b>" : "I" == r || "EM" == r ? "<i>" + this.getText(i, !0) + "</i>" : this.getText(
                                i, !0)
                }
                i = i.nextSibling
            }
