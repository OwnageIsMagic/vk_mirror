function WkEditor(e, t) {
    this.cont = ge(e), this.imgWidth = 400, extend(this, t), cur._wkeId = (cur._wkeId || 0) + 1, cur._wke = cur._wke || {}, cur._wke[cur._wkeId] = this, cur.imagesInfo || (cur.imagesInfo = {}),
        this.cont.setAttribute("contenteditable", "true"), this.cont.setAttribute("spellcheck", "true");
    ...
    var s = "";
    t.mode && (this.mode = 0, this.modeBtn = t.mode, s = '<a id="wke_b_mode" class="wke_b wke_b_mode" wiki="mode" tooltip="' + t.mode[0] + '" onmousedown="' + this.inst +
            '.button(this, event);" onmouseover="' + this.inst + '.ttOver(this, true);"></a>'), s += '<a id="wke_b_help" class="wke_b wke_b_help" wiki="help" tooltip="' + t.help[0] +
        '" onmousedown="' + this.inst + '.button(this, event);" onmouseover="' + this.inst + '.ttOver(this, true);"></a>';
    ...
    for (var a in this.buttons) {
        ...
        n += '<a id="wke_b_' + a + '" class="wke_b wke_b_' + a + '" wiki="' + a + '" tooltip="' + r[0] + '" onmousedown="' + this.inst + '.button(this, event);" onmouseover="' +
            this.inst + '.ttOver(this);"></a>'
    }
    n += "</div></div>", this.panelCont ? this.panelCont.innerHTML = n : (this.panelCont = ce("div", {
            innerHTML: n,
            id: "wke_controls_cont"
        }), this.cont.parentNode.insertBefore(this.panelCont, this.source || this.cont)), addClass(this.panelCont, "wke_pcont"), this.panel = ge("wke_controls"), this.loader =
        geByClass1("wke_loader", this.panel), this.mode = 1, this.state = {}, this.panelXY = getXY(this.panel, this.isLayer), t.source ? this.textarea = this.source : this.textarea =
        this.cont.parentNode.insertBefore(ce("textarea"), this.cont), addClass(this.textarea, "wke_textarea"), autosizeSetup(this.textarea, {
    ...
    }), this.checkBrowser(), setTimeout(function() {
...
extend(WkEditor.prototype, {
                ...
                case KEY.ENTER:
                    ...
                    if (n && 2 == n[1]) {
                        ...
                        if (!s.endOffset && this.getText(a)) {
                            ...
                            o && "BR" != o.tagName && (3 != o.nodeType || o.data) && a.parentNode.insertBefore(ce("br"), a), a.parentNode.insertBefore(r, a), this.setFocus(
                                a, {
                                    toStart: !0
                                })
    ...
    button: function(e, t) {
        ...
        switch (this.plainMode || this.checkFocus(), i) {
            ...
            case "audio":
                ...
                break;
            case "left":
                this.plainMode ? this.plainInsert("<left>", "</left>") : (this.toggleEditable(!1), n.execCommand("justifyLeft", !1, !0), this.toggleEditable(!0), this.toggleState(
                    i));
                break;
            case "center":
                this.plainMode ? this.plainInsert("<center>", "</center>") : (this.toggleEditable(!1), n.execCommand("justifyCenter", !1, !0), this.toggleEditable(!0),
                    this.toggleState(i));
                break;
            case "right":
                this.plainMode ? this.plainInsert("<right>", "</right>") : (this.toggleEditable(!1), n.execCommand("justifyRight", !1, !0), this.toggleEditable(!0),
                    this.toggleState(i));
                break;
            case "h1":
    ...
    checkBrowser: function() {
        var e = intval(browser.version),
            t = !1;
        browser.chrome && e > 11 && (t = 1), browser.mozilla && e >= 4 && (t = 1), browser.opera && e > 10 && (t = 1), browser.safari && e > 4 && (t = 1), browser.msie &&
            e >= 9 && (t = 1);
        var i = ge("wke_b_mode");
        t && !this.plain ? (show(this.cont), hide(this.textarea), this.setPlainMode(!1), this.ttUpdate(i, this.modeBtn[0])) : (hide(this.cont), show(this.textarea),
            this.setPlainMode(!0), this.ttUpdate(i, this.modeBtn[1]), t || hide(i)), this.onPlainToggle && this.onPlainToggle(!t, !1), this.checkEditPlace()
    },
    ...
    togglePlainMode: function(e) {
        var t = ge("wke_b_mode");
        if (void 0 == e ? this.plainMode : e) i = this.textarea.value, i == this.prevWiki ? (show(this.cont), hide(this.textarea), this.setPlainMode(!1), triggerEvent(
            window, "scroll")) : ajax.post("al_pages.php", {
            act: "convert_wiki",
            Body: i
        }, {
            onDone: function(e, t) {
                this.wikiPref = t, this.cont.innerHTML = e, show(this.cont), this.prepareCont(this.cont), hide(this.textarea), this.setPlainMode(!1), this.onPlainToggle &&
                    this.onPlainToggle(this.plainMode, !0)
            }.bind(this),
            loader: !0
    ...
    plainGetSel: function() {
        ...
        if (document.selection) {
            if (e = !0, range = document.selection.createRange(), range && range.parentElement() == this.textarea) {
                ...
                o.collapse(!1), r.compareEndPoints("StartToEnd", o) > -1 ? t = i = n : (t = -r.moveStart("character", -n), browser.msie && intval(browser.version) < 9 &&
                    (t += a.slice(0, t)
                        .split("\n")
                        .length - 1), r.compareEndPoints("EndToEnd", o) > -1 ? i = n : (i = -r.moveEnd("character", -n), browser.msie && intval(browser.version) <
                        9 && (i += a.slice(0, i)
                            .split("\n")
                            .length - 1)))
            }
        } else this.textarea.selectionStart || "0" == this.textarea.selectionStart ? (t = this.textarea.selectionStart, i = this.textarea.selectionEnd) : i = t = this.textarea
            .value.length;
        return [t, i, e]
    },
    plainInsert: function(e, t, i) {
        ...
        if (d && (len = d[0].length, l = l.substr(0, l.length - len), o -= len, c = d[0] + c), i.replace && (l = ""), r >= s && h.substr(r - s, r) == e && c.substr(0,
                n) == t) e = "", t = "", h = h.substr(0, r - s), c = c.substr(n), r -= s, o -= s;
    ...
    showUrlBox: function(e, t) {
        if (this.plainMode) {
            ...
            var s = e[0],
                i = this.getText(s);
            if (cur.wkLinkHref = s.getAttribute("href"), cur.wkLinkNote = cur.wkLinkHref.match(this.re.noteHref), cur.wkLinkPage = cur.wkLinkHref.match(this.re.pageWikiHref),
                cur.wkLinkCustomPage = cur.wkLinkHref.match(this.re.pageHref), cur.wkBoxRange = this.setFocus(s, {
                    noCollapse: !0
                }), cur.wkLinkEl = s, t) return this.unsurround(s, !0), this.checkEditPlace(), !1
        } else {
            if (document.getSelection) var i = document.getSelection() + "";
            else if (document.selection) var i = document.selection.createRange()
                .text + "";
            else var i = "";
    ...
    insertLink: function(e, t, i) {
        ...
        cur.wkLinkEl && cur.wkLinkEl.parentNode ? cur.wkLinkEl.parentNode.replaceChild(s, cur.wkLinkEl) : (cur.wkBoxRange && this.setSelectionRange(cur.wkBoxRange),
            this.insert([s], !0)), delete cur.wkLinkRange, delete cur.wkLinkEl, this.changed = !0
    },
    ...
    toggleState: function(e) {
        ...
        t[e] = !t[e], "left" == e && t[e] && (t.center = 0, t.left = 0, t.right = 0), "right" == e && t[e] && (t.center = 0), "center" == e && t[e] && (t.right = 0),
            this.setState(t)
    },
    setState: function(e) {
    ...
    switchMode: function(e) {
        ...
        var s = ge("wke_b_url");
        3 == e ? (addClass("wke_b_url", "wke_b_remove"), s.setAttribute("tooltip", this.buttons.url[1])) : 3 == this.mode && (removeClass("wke_b_url", "wke_b_remove"),
            this.ttUpdate(s, this.buttons.url[0])), this.mode = e, this.onSwitchMode && this.onSwitchMode()
    },
    getAlign: function(e) {
    ...
    getRange: function(e, t) {
        ...
        return t ? !1 : (document.createRange ? (i = document.createRange(), i.selectNodeContents(this.cont)) : (i = document.body.createTextRange(), i.moveToElementText(
            this.cont)), i.collapse(!1), i)
    },
    ...
    getState: function(e) {
        ...
        for (state = {}; r;) {
            ...
            if ("LI" == o && this.fixList(r), !a) {
                ...
                h ? (h[2] ? state.h3 = 1 : h[1] ? state.h2 = 1 : h[0] && (state.h1 = 1), n = r, a = 2, (state.right || state.center) && this.fixHeader(r)) : this.isLink(
                    r) ? (n = r, a = 3) : "PRE" == o ? (n = r, a = 4) : "UL" == o || "OL" == o ? (n = r, a = 5, state.list = 1) : "BLOCKQUOTE" == o && (n = r, a =
                    6, state.blockquote = 1)
            }
    ...
    setFocus: function(e, t) {
        var i = this.getSel(),
            s = this.getRange();
        if (t || (t = {}), i) i.removeAllRanges(), cur.lastCursor ? (s = cur.lastCursor, s.collapse(!1)) : (void 0 != t.offset ? (s.setStart(e, 0), s.setEnd(e, 0)) : s
            .selectNodeContents(e), t.noCollapse || s.collapse(t.toStart || !1)), i.addRange(s);
        else {
    ...
    insertVideo: function(e, t, i, s, n) {
        return this.vbox.hide(), this.plainMode ? (this.plainInsert("[[video" + n + "]]", "", {
            ...
            var h = se('<a class="wk_video" href="' + s + '" contentEditable="false" onclick="return showVideo(\'' + n +
                "', '', {autoplay: 1}, event)\"><img alt=\"" + t + '" title="' + t +
                '" src="/images/play_video_wide.png?3" style="background-image: url(' + e + ');">');
            this.insert([h])
        }.bind(this)), !1)
    },
    getPhotoHTML: function(e, t, i, s, n, a, r) {
        ...
        var h = "";
        return r && (h = ' title="' + clean(r) + '"'), '<a contenteditable="false"' + h + ' class="wk_photo" wiki="' + e + "_" + t + '" href="' + a + '" onclick="' +
            act + '"><img src="' + i + '" style="' + o + '" /></a>'
    },
    ...
    getPhotoOpts: function(e, t) {
        t || (t = []), hasClass(e, "wk_photo_right") && t.unshift("right"), hasClass(e, "wk_photo_left") && t.unshift("left"), hasClass(e, "wk_photo_center") && t.unshift(
            "center");
    ...
    getElementWiki: function(e, t) {
        ...
        switch (a) {
            ...
            case "EM":
                var u = r.split("\n"),
                    g = [],
                    k = this.inItalic(e.parentNode);
                for (var f in u) {
                    var v = u[f];
                    "==" != v.substr(0, 2) && v.match(this.re.letter) && !k ? g.push("''" + v + "''") : g.push(v)
                }
                n = g.join("\n");
                break;
            case "IMG":
                if (this.isPhotoEl(e)) {
                    var b = this.cleanPrep(e.getAttribute("title") || " "),
                        w = e.getAttribute("wiki");
                    w && (w = w.split("_"), n = "[[photo" + w[0] + "_" + (w[1] || "") + "|" + this.getPhotoOpts(e, ["nolink"]) + "|" + b + "]]")
                }
                break;
            case "A":
                if (this.isPhotoEl(e)) {
                    var m = e.href.match(this.re.photoHref),
                        b = this.cleanPrep(e.getAttribute("title") || " ");
                    if (m) n = "[[photo" + m[1] + (m[2] || "") + "|" + this.getPhotoOpts(e) + "|" + b + "]]";
                    else {
                    ...
                    if (m) {
                        ...
                        if (S) {
                            cur.ii = S;
                            var b = this.cleanPrep(e.getAttribute("title") || " ");
                            n = "[[photo" + m[1] + (m[2] || "") + "|" + this.getPhotoOpts(e) + "|" + b + "]]";
                            break
                        }
                    }
                ...
                break;
            case "PRE":
                var b = this.getText(e);
                b = b.replace(this.re.n, "\r\n"), n = "<pre>" + b + "</pre>";
                break;
            case "BLOCKQUOTE":
            ...
            case "TABLE":
                ...
                for (var A = e.firstChild, H = []; A;) {
                    ...
                    if ("COLGROUP" != I) {
                        if ("COL" == I) {
                            var W = A.getAttribute("style")
                                .match(this.re.colWidth);
                            W && H.push(intval(W[1]))
                        }
                        A = A.nextSibling
                    } else A = A.firstChild
    ...
    strToWiki: function(e) {
        ...
        return e = e.replace(this.re.n, " "), e = e.replace(this.re.sp, " "), e = e.replace(/^#/g, "&#35;")
    ...
    getText: function(e, t) {
        ...
        if (t) {
            for (var i = e.firstChild, s = ""; i;) {
                switch (i.nodeType) {
                    case 3:
                        var n = i.data.replace(this.re.n, " ")
                            .replace(this.re.sp, " ");
                        s += n;
                        break;
                    case 1:
                        ...
                        ("DIV" == a || "P" == a || "PRE" == a || "BLOCKQUOTE" == a || "CENTER" == a || "RIGHT" == a || "LEFT" == a || "BR" == a) && (s += "\n"), s +=
                            "B" == a || "STRONG" == a ? "<b>" + this.getText(i, !0) + "</b>" : "I" == a || "EM" == a ? "<i>" + this.getText(i, !0) + "</i>" : this.getText(
                                i, !0)
                }
                i = i.nextSibling
            }
    ...
    showLengthMsg: function() {
        this.lengthMsg || setTimeout(showFastBox({
            ...
            }, this.lang.too_long || "text too long", getLang("global_close"))
            .hide, 2e3)
    },
