var FullWall = {
    ...
    postsGetRaws: function(e) {
        var o, a = indexOf(domPN(e)
                .children, e),
            t = {};
        return (o = e.id.match(new RegExp("^post(" + cur.oid + "_\\d+)$", ""))) && (t[o[1]] = 1, (o = (e.getAttribute("data-copy") || "")
            .match(/^(-?\d+_\d+)$/)) && (t[o[1]] = -1)), t.index = a, t.module = cur.module, t
    },
    init: function(e, o) {
        extend(cur, {
                options: e,
            ...
            Pagination.init(), cur.destroy.push(Pagination.deinit), e.with_id || (wall.initUpdates(e.add_queue_key), (!e.wall_type || "cards" != e.wall_type && "supp" != e
                .wall_type && "restore" != e.wall_type && "phone_info" != e.wall_type) && cur.nav.push(function(e, o, a) {
                var t = e.own;
    ...
    loadedPosts: function(e, o, a, t, l, r, n) {
        if (r) each(geByTag("textarea", cur.pgCont), function() {
            ...
            for (var s = (cur.pgCont.childNodes.length, 0), i = cur.pgCont.lastChild; i && ++s <= cur.pgPerPage; i = i.previousSibling) placeholderSetup(geByTag1(
                "textarea", i), {
                fast: 1
            });
            n = t
    ...
    addTetaTet: function(e, o) {
        ...
        return o[9] && o[9] != o[2].split("_")[0] && cur.wallTpl.tet_a_tet ? a.tet_a_tet = cur.wallTpl.tet_a_tet.replace("%from_uid%", o[9]) : a.own_reply_link = cur.wallTpl
            .own_reply_link.replace("%post_id%", o[2]), a
    },
    ...
    doSearch: function(e, o) {
        uiSearch.showProgress(e), nav.objLoc[0].split("/")
            .length > 1 ? nav.change({
                0: "wall" + cur.oid,
                q: o || !1,
                search: !o && 1,
        ...
        stManager.add(["ui_controls.js", "datepicker.js", "datepicker.css"], function() {
            cur.wallDP || (cur.wallSD = val("wall_datesearch"), cur.wallDP = new Datepicker(ge("wall_datesearch"), {
                ...
                addRows: nav.objLoc.day ?
                    '<tr><td class="wall_cal_clear" colspan="7"><a onclick="uiSearch.showProgress(\'wall_search\'); nav.change({day: false, offset: false, search: nav.objLoc.q ? false : 1})" id="wall_cal_clear_lnk">' +
                    getLang("wall_clear_date_filter") + "</a></td></tr>" : "",
                onUpdate: function() {
                    if (cur.wallSD != val("wall_datesearch")) {
                        var e = val("wall_datesearch")
                            .split(".");
