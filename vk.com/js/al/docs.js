var Docs = {
    ...
    getList: function(e) {
        ...
        if (e = e || cur.section, cur.searchStr ? (o = e + "_" + cur.type + "_" + cur.searchStr, cur.selection = {
                re: new RegExp("(" + cur.searchStr.replace(cur.index.delimiter, "|")
                    .replace(/[\/\\\(\)\[\]\{\}\*,]/g, "")
                    .replace(/^\||\|$/g, "") + ")", "gi"),
    ...
    addDoc: function(e) {
        cur.docs && (e._order = (cur.docs[0] && cur.docs[0]._order || 0) - 1, cur.docs.unshift(e), Docs.showList(cur.docs.slice(0, cur.perPage)), scrollToTop(200), cur.index
            .add(e), Docs.updateTags(e[6]), cur.count += 1, cur.found += 1, cur.menuProgress = cur.typesChanged = !0, nav.go(nav.objLoc[0]))
    },
    ...
    getDocHTML: function(e) {
        ...
        if (i) {
            i = i.split(",");
            for (var p in i) cur.selection && (i[p] = i[p].replace(cur.selection.re, cur.selection.val)), i[p] = rs(cur.tpl.tag, {
                title: i[p]
            });
            i = rs(cur.tpl.tags, {
                tags: i.join(", ")
        ...
        return g = rs(g ? cur.tpl.thumb : cur.tpl.icon, {
            oid: a,
            item_id: o,
            ext: r,
            url: n,
    ...
    processGlobalSearch: function(e, o, r, c, s) {
        return e != cur.searchStr ? !1 : (cur.searchCount = s, toggle(cur.searchBlock, !o || c && r), c && r && (o && (cur.searchCont.innerHTML = "", cur.searchShown = 0),
            Docs.drawList(r, cur.searchCont), cur.searchShown = cur.searchShown + c), toggleClass(cur.searchMore, "unshown", cur.searchShown >= s || cur.searchShown >=
            1e3 || !c || !r), Docs.drawSummary(!0), cur.cache[cur.searchStr] = [r, c, s], !0)
    },
    ...
    updateList: function(e, o) {
        ...
        var c = Docs.getList();
        return listLen = c.length, Docs.hideLoadProgress(), cur.searchStr || hide(cur.searchBlock), listLen || (cur.shown = 0, addClass(cur.listMore, "unshown"), cur.listCont
            .innerHTML = rs(cur.tpl.empty, {
                text: cur.searchStr ? getLang("docs_empty_search")
                    .replace("%s", "<b>" + clean(cur.searchStr) + "</b>") : cur.oid < 0 ? getLang("docs_no_group_docs") : getLang("docs_no_user_docs")
            })), (cur.searchStr || listLen) && (Docs.showList(c.slice(0, cur.perPage)), listLen && toggleClass(cur.listMore, "unshown", cur.found <= cur.shown),
            listLen < cur.perPage) ? (cur.searchStr && Docs.globalSearch(), Docs.drawSummary(), !0) : (hide(cur.searchBlock), Docs.drawSummary(), !0)
    },
    ...
    downloadItem: function(e, o, r, c) {
        if (checkEvent(c)) return !0;
        var s = domClosest("_docs_item", e);
        if (!s) return !1;
        var t = geByClass1("docs_item_icon", s) || geByClass1("docs_item_thumb", s),
            a = t.href,
            i = trim(t.getAttribute("ext"));
        return -1 == "jpg|gif|png|pdf|doc|docx|xls|xlsx|rtf|ppt|pptx".indexOf(i) ? location.href = a + (a.match(/\?/) ? "&" : "?") + "wnd=1" : window.open(a), cancelEvent(
            c)
    },
        ...
        if (t) {
                ...
                onDone: function() {
                    if (delete cur._addedDocsInfo[s], i.to_id == cur.oid) {
                        for (var e = cur.docs.length; e--;) {
                            var o = cur.docs[e];
                            o[0] == t[0] && (cur["item_restore" + t[0]] = [cur.docs.splice(e, 1)[0], e], cur.index.remove(cur["item_restore" + t[0]][0]), cur.typesChanged = !
                                0)
                        }
            ...
            ajax.post("/docs.php", i, {
                onDone: function(e, o, r) {
                    showDoneBox(e), cur._addedDocsInfo[s] = r, i.to_id == cur.oid && (r._order = (cur.docs[0] && cur.docs[0]._order || 0) - 1, cur.docs.unshift(
                        r), cur.index.add(r), Docs.updateTags(r[6]), cur.typesChanged = !0, _tbLink && _tbLink.loc && (cur.__phinputs = cur.__phinputs ||
        ...
        if (s) return e && tooltips.destroy(e), ajax.post("/docs.php", {
            ...
            onDone: function(e) {
                ...
                for (var t = cur.docs.length; t--;) {
                    var a = cur.docs[t];
                    a[0] == r && (cur["item_restore" + r] = [cur.docs.splice(t, 1)[0], t], cur.index.remove(cur["item_restore" + r][0]), cur.typesChanged = !
                        0)
                }
                cur.count -= 1, cur.found -= 1, cur.list = {}
            },
    ...
    selectTag: function(e) {
        return geByClass1("ui_rmenu_item_sel", cur.rmenu) == e ? !1 : (uiRightMenu.switchMenu(e), uiRightMenu.showProgress(e), cur.menuProgress = !0, cur.section = "all",
            cur.type = "", Docs.tagSearch(e, {
                from: "menu"
            }))
    },
    addTag: function(e, o) {
    ...
    rowActive: function(e, o) {
        ...
        r = "delete" == o || s && hasClass(s, "doc_added") && "add" == o ? getLang("docs_remove_tt") : "edit" == o ? getLang("docs_edit_tt") : cur.groupAdmin ? getLang(
            "docs_add_to_group_tt") : getLang("docs_add_tt"), r && showTooltip(e, {
            text: function() {
                return r
            },
            showdt: 500,
    ...
    showFileTT: function(e, o, r) {
        return clearTimeout(cur.fileTT), e && o && r ? void("gif" == o && (cur.fileTT = setTimeout(function() {
            ...
            cur.fileTTImage = new vkImage, cur.fileTTImage.src = o, cur.fileTTImage.onload = function() {
                cur.fileTTImage && cur.fileTTImage.getAttribute("src") == o && (cur.prevTT && cur.prevTT != e && cur.prevTT.tt && cur.prevTT.tt.hide(),
                    clearTimeout(e.hidetimer), e.hidetimer = !1, cur.prevTT = e, showTooltip(e, {
    ...
    chooseSwitch: function(e) {
        return hasClass(curBox()
            .titleWrap, "box_loading") ? !1 : (cur.docsChooseInput.setValue(""), uiSearch.onChanged(cur.docsChooseInput, !0), cur.docsTab = "user_docs" == cur.docsTab ?
            "group_docs" : "user_docs", void ajax.post("/docs.php", {
    ...
    chooseDocsSearch: function(e) {
        var o = trim(val(e));
        o != cur.docsSearchStr && (cur.docsSearchStr = o, o ? (cur.docsOffset = 0, Docs.chooseMore()) : (cur.docsOffset = cur.docsStartOffset, cur.docsChooseRows.innerHTML =
            cur.docsStartHTML))
    },
    chooseMore: function() {
    ...
    chooseDoc: function(e, o, r, c) {
        ...
        if (void 0 !== e.selected) cur.lastAddMedia && (cur.lastAddMedia.unchooseMedia(e.selected), e.selected = void 0, removeClass(e, "docs_item_selected"), s && (s.innerHTML =
            getLang("global_add_media")));
        else {
            var t = cur.attachCount && cur.attachCount() || 0;
            r.lang = {
                    profile_choose_doc: getLang("profile_choose_doc")
                }, window.event = window.event || c, cur.chooseMedia("doc", o, r), window.event = void 0, (!cur.attachCount || cur.attachCount() > t) && cur.lastAddMedia &&
                (e.selected = cur.lastAddMedia.chosenMedias.length - 1, addClass(e, "docs_item_selected"), s && (s.innerHTML = getLang("global_cancel")))
        }
    ...
    chooseUploaded: function(e, o) {
        var r = void 0 !== e.ind ? e.ind : e,
            c = ((e.fileName ? e.fileName : e.filename || e)
                .replace(/[&<>"']/g, ""), (e.fileName || e.filename)
                .replace(/[&<>"']/g, "")),
            s = c ? r + "_" + c : e;
    ...
    chooseUploadFailed: function(e, o) {
        ...
        if ("fileApi" == Upload.types[r] && !Upload.options[r].wiki_editor) {
            var s, t, a = (e.fileName || e.filename)
                .replace(/[&<>"']/g, ""),
                i = a ? r + "_" + a : e;
            cur.imMedia || cur.imwMedia ? (re("upload" + i + "_progress_wrap"), s = (-3 == cur.peer ? cur.imwMedia : cur.imMedia)
                .lnkId, cur.addMedia[s].unchooseMedia(!1)) : cur.addMedia && (re("upload" + i + "_progress_wrap"), s = (cur.attachMediaIndexes || {})[c], s && cur.addMedia[
                s].unchooseMedia(!1));
            var u = !0;
            o && "string" == typeof o.error && o.error.match(/ERR_UPLOAD_TERMINATED/) && (u = !1), t = o && "wrong_arch_file" == o.error ? getLang("docs_upload_arch_fail") :
                o && "wrong_mp3_file" == o.error ? getLang("docs_upload_mp3_fail") : getLang("docs_upload_fail"), u && setTimeout(showFastBox({
                        title: getLang("global_error")
                    }, t)
                    .hide, 4e3)
        }
    ...
    chooseUploadStart: function(e, o) {
        var r = void 0 !== e.ind ? e.ind : e,
            c = Upload.options[r],
            s = Upload.types[r];
        cur.docsChooseFiles[r] = o || e, "form" == s && (show(curBox()
                .progress), curBox()
            .changed = !0, geByClass1("file", cur.docsChooseUpload)
            .disabled = !0), "flash" == s && (boxLayerWrap.visibilityHide = !0, cur.docsChooseIsFlash = !0), c.wiki_editor || (cur.notStarted && (boxQueue.hideLast(),
            delete cur.notStarted), Docs.chooseUploadProgress(e, 0, 0)), removeClass(boxLayerWrap, "dropbox_over")
    },
    chooseUploadProgress: function(e, o, r) {
        ...
        if (void 0 === e.ind && (e = cur.docsChooseFiles[c]), Upload.options[c].wiki_editor) cur.docsChooseUploadArea.innerHTML = '<img src="/images/upload.gif"/>';
            ...
            if (void 0 === s || s && cur.addMedia[s].chosenMedia || cur.imMedia) {
                ...
                (e.fileName || e.filename) && (t.fileName = (e.fileName || e.filename)
                    .replace(/[&<>"']/g, "")), cur.showMediaProgress("photo", c, t)
            }
        }
    },
