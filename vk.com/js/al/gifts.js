var Gifts = {
    deleteGift: function(o, t, i, e) {
        e = e || {}, ajax.post("al_gifts.php", {
            ...
            onDone: function(o) {
                var i = ge("gift" + t);
                i && (domNS(domFC(i)) ? domNS(domFC(i))
                    .innerHTML = o : (i.appendChild(ce("div", {
    ...
    showGiftBox: function(o, t) {
        return window.Profile ? Profile.showGiftBox(o, t) : (cur.gftbxWasScroll = boxLayerWrap.scrollTop, boxLayerWrap.scrollTop = 0, cur.viewAsBox ? cur.viewAsBox() : !
