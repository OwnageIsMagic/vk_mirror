var Pay = {
    ...
    makePayment: function(otherPhone, retryPhone) {
        ...
        } else if (ge('pay_confirm_code') && ge('pay_confirm_code')
            .value) {
            params.confirm_code = ge('pay_confirm_code')
                .value;
        } else if (ge('pay_confirm_phone')) {
            cur.payConfirmPhone = params.confirm_phone = ge('pay_confirm_phone')
                .value;
        }
        ...
        ajax.post(cur.payUrl, params, {
            onDone: function(result, html, script) {
                switch (result) {
                    ...
                    case 2:
                        if (!cur.payConfirmBox || !cur.payConfirmBox.isVisible()) {
                            cur.payConfirmBox = showFastBox(cur.payConfirmTitle, cur.payConfirmHtml, getLang('box_send'), Pay.makePayment.pbind(false, false),
                    ...
                    case 3:
                        ...
                        cur.payBox.removeButtons()
                            .addButton(getLang('global_cancel'), Pay.cancel);
                        cur.payBox.setControlsText('');

                        var html = '<div id="pay_process_info"><div class="pay_process_please">' + cur.payPleaseWait +
    ...
    initPaymentButtons: function() {
        cur.payBox.removeButtons()
            .addButton(getLang('global_cancel'), Pay.cancel, 'no');
    ...
    showCongrats: function(text) {
        ...
        ge('pay_process_info')
            .innerHTML = '<div class="pay_process_please">' + text + '</div>';
        cur.payBox.removeButtons()
