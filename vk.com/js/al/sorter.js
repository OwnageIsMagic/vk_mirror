var sorter = {
    ...
    evCoords: function(e, r) {
        return browser.android ? [e.touches[0].pageX + (e.pageX || 0), e.touches[0].pageY + (e.pageY || 0) + (r.scrollNode && r.scrollNode.scrollTop || 0)] : [e.pageX, e.pageY +
            (r.scrollNode && r.scrollNode.scrollTop || 0)
        ]
    },
    animstop: function() {
        ...
        for (var t in sorter.animcache)
            if (0 != t) {
                var o = sorter.animcache[t],
                    ...
                    l = 200,
                    a = vkNow();
                o.t += a - o.prev, o.prev = a, o.t < l ? (r = !1, s.style.left = n(o.t, o.sx, o.dx, l) + "px", s.style.top = n(o.t, o.sy, o.dy, l) + "px") : (s.style.left =
                    o.sx + o.dx + "px", s.style.top = o.sy + o.dy + "px", clearInterval(o.timer), e.push(s.id), o.h && o.h())
    ...
    mousedown: function(e) {
        ...
        if (!sorter.current) {
            ...
            if (!("A" == e.target.tagName || "INPUT" == e.target.tagName || "TEXTAREA" == e.target.tagName || e.target.getAttribute("nosorthandle") || e.target.parentNode &&
                    "A" == e.target.parentNode.tagName)) return sorter.current = o, o.drag = t, addEvent(document, "mousemove drag touchmove", sorter.mousemove), addEvent(
                    document, "mouseup touchend touchcancel", sorter.mouseup), browser.opera || browser.msie || browser.mozilla || browser.safari_mobile || browser.android ||
                o.noscroll || (addEvent(sorter.scrollNode, "scroll", sorter.mousemove), o.scrollNode && o.scrollNode.scrollHeight > o.scrollNode.offsetHeight &&
                    addEvent(o.scrollNode, "scroll", sorter.mousemove)), extend(o, {
                    startX: s[0],
    ...
    mousemove: function(e) {
        if (sorter.current) {
            var r = sorter.current,
                t = !0,
                o = "scroll" == e.type ? [sorter.lastX, sorter.lastY + scrollNode.scrollTop + (r.scrollNode && r.scrollNode.scrollTop || 0) - sorter.lastS] : sorter.evCoords(
                    e, r);
            if ("scroll" == e.type) t = !1;
                ...
                browser.safari_mobile || browser.android || r.noscroll || (100 > s ? sorter.animcache[0] = s - 100 : s > lastWindowHeight - 100 ? sorter.animcache[0] = s +
                    100 - lastWindowHeight : sorter.animcache[0] && delete sorter.animcache[0], sorter.animcache[0] && !sorter.animtimer && (sorter.animtimer =
                        setInterval(sorter.animstep, 13)))
            }
            var n = r.drag,
                l = o[0] - r.startX,
            ...
            if ((l > 10 || -10 > l || a > 10 || -10 > a) && (cur.cancelClick = !0), r._dragtargets)
                for (var f in r._dragtargets.nodes) {
                    ...
                    v.x > 0 && v.x < h[0] && v.y > 0 && v.y < h[1] ? m._dragover || (r._dragtargets.onDragOver && r._dragtargets.onDragOver(n, m), m._dragover = !0, r._dragtarget =
                        m) : m._dragover && (r._dragtargets.onDragOut && r._dragtargets.onDragOut(n, m), m._dragover = !1, r._dragtarget = null)
                }
            if (setStyle(n, {
                    left: c,
                    top: p
            ...
            var y;
            g < n.index ? (r.parent.insertBefore(n, r.elems[g].helper), y = -1) : g > n.index && (r.elems[g].nextSibling ? r.parent.insertBefore(n, r.elems[g].nextSibling) :
                r.parent.appendChild(n), y = 1), r.parent.insertBefore(n.helper, n), (g == r.elems.length - 1 ? addClass : removeClass)(n.helper, "sort_helper_last");
    ...
    mouseup: function(e) {
        if (sorter.current) {
            ...
            if (setStyle(t, {
                ...
                var o = r._dragtarget;
                if (o && (r._dragtargets.onDragOut && r._dragtargets.onDragOut(t, o), sorter.restore(r, t)), r.onMouseUp(t, o), delete r._dragtarget, o) return cancelEvent(
                    e)
            }
    ...
    stop: function() {
        ...
        removeEvent(document, "mousemove drag touchmove", sorter.mousemove), removeEvent(document, "mouseup touchend touchcancel", sorter.mouseup), e.drag = sorter.current = !
            1
    },
    restore: function(e, r) {
        var t, o = e.startIndex;
        o < r.index ? (e.parent.insertBefore(r, e.elems[o].helper), t = -1) : o > r.index && (e.elems[o].nextSibling ? e.parent.insertBefore(r, e.elems[o].nextSibling) : e
            .parent.appendChild(r), t = 1), e.parent.insertBefore(r.helper, r);
    ...
    added: function(e) {
        for (var r = e.sorter, t = r.elems.length, o = t ? e.sorter.elems[t - 1].nextSibling : e.firstChild, s = t; o && !o.getAttribute("stopsort"); o = o.nextSibling, ++
            s)
