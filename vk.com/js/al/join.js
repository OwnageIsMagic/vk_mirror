var Join = {
    ...
    scrollResize: function(e, pp) {
        ...
        var needDock = cur.resultShown && (st + lastWindowHeight < cur.nextButtonTop + cur.nextButtonHeight + intval(getStyle('content', 'marginTop')) + ge(
                'page_header_cont')
            .offsetHeight - 8);
    ...
    updateStrength: function() {
        ...
        ge('join_pass_strength')
            .innerHTML = pwd ? getLang('join_pwd_level' + level) : getLang('join_pwd_min_length');
...
'
    ...
    submitPasswordSure: function() {
        showFastBox(getLang('join_new_page_sure_title'), getLang('join_new_page_sure'), getLang('join_new_page_sure_submit'), Join.submitPassword.pbind(-1), getLang(
            'global_cancel'));
    },
