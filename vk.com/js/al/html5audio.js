var html5audio = {
    ...
    onPrMove: function() {
        ...
        ge('audio_pr_slider')
            .style.left = html5audio.audio_curPrX + 'px';
    ...
    updVol: function(init) {
        ...
        ge('audio_vol_slider')
            .style.left = html5audio.audio_curVolX + 'px';
        ge('audio_volume_line')
            .style.opacity = 0.5 + 0.5 * vol;
        ge('the_audio')
            .volume = vol;
    ...
    updTime: function() {
        ...
        if (p && !isNaN(p.duration) && p.duration > 0 && html5audio.audio_moveState != 1) {
            ge('audio_pr_slider')
                .style.left = ((html5audio.audio_prLineW * (p.currentTime - p.startTime)) / p.duration) + 'px';
    ...
    getUrl: function() {
        var data = ge('audio_info' + html5audio.audio_player_id)
            .value.split(',');
        return data[0];
    },
    ...
    audioHTML5Code: function() {
        ...
        var res = '\
<div id="audio_player" style="top:' + ypos +
            'px">\
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0">\
    ...
    docMouseUp: function() {
        if (html5audio.audio_moveState == 1 && !ge('the_audio')
            .paused)
            fadeTo(ge('audio_pr_slider'), 200, 1);
        html5audio.audio_moveState = 0;
    },
