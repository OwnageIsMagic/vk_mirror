...
<div class="pg_fixed_pages">\
    ...
    updateFixedLeft: function(e) {
        ...
        if (vk.rtl) {
            cur.pgFixed.style.left = (ge('page_layout')
                .offsetLeft + 16) + 'px';
        } else {
            cur.pgFixed.style.left = (ge('page_layout')
                .offsetLeft + vk.width - 16 - getSize(cur.pgFixed)[0]) + 'px';
        }
    },
    ...
    clearPreload: function() {
        ...
        var re = new RegExp('^' + escapeRE(key)
    ...
    loaded: function(count, from, rows, offset, pages, preload) {
        ...
        if (gotNewPage) { // got new page
            ...
            var cont = ge(cur.pgCont),
                d = (cur.pgPrepare || Pagination.prepare)
