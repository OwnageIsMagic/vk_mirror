var FiltersPE = {
    ...
    updateUndo: function() {
        ...
        void 0 !== FiltersPE.initialSettings && e !== FiltersPE.initialSettings ? (addClass("pe_undo", "enabled"), FiltersPE.showQuitConfirm = !0) : (removeClass("pe_undo",
            "enabled"), FiltersPE.showQuitConfirm = !1), FiltersPE.updateActionButtonsEnabled()
    },
    onUndo: function() {
    ...
    onActionCrop: function(e, t) {
        ...
        function n(e) {
            f = e.pageX, g = e.pageY, m = cur._peCrop.l, E = cur._peCrop.r, b = cur._peCrop.t, C = cur._peCrop.b, addEvent(window, "mousemove", l), addEvent(window,
                "mouseup", p), addClass(cropAreaEl, "active"), addClass(cropAreaEl, "no_actions")
        }
        ...
        function l(e) {
            ...
            var s = C - e.pageY + g;
            return s = Math.max(0, s), s = Math.min(s, u[1] - cur._peCrop.t - 100), cur._peCrop.r = o, cur._peCrop.l = t, cur._peCrop.t = i, cur._peCrop.b = s, a(), r(),
                cancelEvent(e), !1
        }
        ...
        cropAreaEl = '<div class="pe_crop_area">', each("top left bottom right top_left top_right bottom_left bottom_right".split(" "), function(e, t) {
            ...
            '<div class="pe_crop_apply_wrap"><div class="pe_crop_apply_button" id="crop_apply" onclick="FiltersPE.applyCrop()"></div><div class="pe_crop_apply_button" id="crop_reset" onclick="FiltersPE.resetCrop()"></div></div>',
            cropAreaEl += "</div>", cropAreaEl = se(cropAreaEl), c.appendChild(cropAreaEl);
        ...
        each("top left bottom right top_left top_right bottom_left bottom_right".split(" "), function(e, t) {
            ...
            addEvent(r, "mousedown", function(e) {
                return _ = e.target, v = _.getAttribute("id")
                    .split("_")
                    .slice(4)
                    .join("_"), addEvent(window, "mousemove", s), addEvent(window, "mouseup", i), addClass(cropAreaEl, "no_actions"), cancelEvent(e), !1
            })
        });
        var f, g, m, E, b, C;
    ...
    _hideActionBar: function(e, t) {
        if (FiltersPE.actionBars = FiltersPE.actionBars || {}, !Object.keys(FiltersPE.actionBars)
            .length) return !1;
        if (e && e.target)
    ...
    onActionBlur: function(e, t) {
        if (!FiltersPE._hideActionBar(null, "blur")) {
            var r = FiltersPE.actionBars.blur = se(
                    '<div class="pe_blur_input pe_action_bar" id="blur"> <div class="pe_blur_slider"></div> <div class="pe_blurtype_changer" onmouseover="showTooltip(this, {text: \'' +
                    cur.lang.photos_pe_change_blur_type + "', shift: [11,4,4], showdt: 0, black: 1, showsp: 110});\"></div> </div>"),
            ...
            addEvent(window, "click", function(e) {
                if ("pe_main" != e.target.id) {
                    ...
                    removeEvent(window, "mousemove", p.onMouseMoveBlur), removeEvent(window, "mouseup", p.onMouseUpBlur), removeEvent(c, "mousedown", this.onMouseDownBlur),
    ...
    onActionText: function(e, t) {
        ...
        if (!FiltersPE._hideActionBar(null, "text")) {
            var a = FiltersPE.actionBars.text = se(
                    '<div class="pe_text_input pe_action_bar" id="text"><textarea></textarea> <div class="pe_text_font_changer" onmouseover="showTooltip(this, {text: \'' +
                    cur.lang.photos_pe_change_font + "', shift: [11,4,4], showdt: 0, black: 1, showsp: 110});\"></div> </div>"),
    ...
    init: function(e, t, r, a, o, i, s, n) {
        cur.filterApplied = null, cur.pe && (cur.pe.clean(), delete cur.pe, cur.pe = null), cur.filterHash = s, cur.filterPhoto = i, cur.filterSaveOptions = r, cur.filterParams =
            a, cur.peDesc = n.replace(/<br>/g, "\n");
        var p = ce("div", {
    ...
    clear: function() {
        FiltersPE.showQuitConfirm = !1, delete FiltersPE.initialSettings, this._parametersInited = !1, cur.filterApplied = void 0, cur.pe.clean(), FiltersPE.actionBars &&
            (each(FiltersPE.actionBars, function(e, t) {
                re(t)
    ...
    fromStr: function(e) {
        ...
        if (u) {
            ...
            var d = u[u.length - 1];
            u = u.slice(0, -1)
                .join(","), u = replaceEntities(u), cur.pe.setText(u, d)
        }
    ...
    toStr: function() {
        ...
        switch (cur.pe.getMode()) {
            ...
            case "params":
                e += "p/";
                var r = [];
                r.push(intval(100 * cur.pe.getExposure())), r.push(intval(100 * cur.pe.getContrast())), r.push(intval(100 * cur.pe.getSaturation())), r.push(intval(100 *
                    cur.pe.getVignette())), r.push(intval(100 * cur.pe.getSharpness())), r.push(intval(100 * cur.pe.getSepia())), e += r.join(",")
        }
        e += "/", e += (cur.pe.isAuto() ? 1 : "") + "/";
        ...
        e && (e.hash ? extend(t, {
            ...
            onDone: function(e, r, a, o, i) {
                ...
                if (cur.onPESave && cur.onPESave(o, i), cur.pvListId) {
                    ...
                    if (a && o && (FiltersPE.changeThumbs(o, i), delete c.x_, delete c.x_src, delete c.y_, delete c.y_src, delete c.z_, delete c.z_src, extend(
                            c, a)), d) {
                        ...
                        val(h, e || '<span class="pe_desc_edit">' + getLang("photos_edit_desc") + "</span>"), h.onmouseover = e ? Photoview.descTT.pbind(h) :
                            function() {}, r && ge("pe_album") && (ge("pe_album")
                                .innerHTML = r), cur.pvCurData = Photoview.genData(c, vk.pvbig ? cur.pvVeryBig ? (cur.pvVeryBig > 1, "z") : "y" : "x"), domFC(
                                cur.pvPhoto)
        ...
        FiltersPE.showQuitConfirm = !1, ajax.post("al_photos.php", {
            ...
            onDone: function(e, t, r) {
                if (cur.onPESave && cur.onPESave(t, r), cur.pvData) {
                    ...
                    var n = curBox();
                    n && n.hide(), FiltersPE.changeThumbs(t, r), s && (cur.pvCurData = Photoview.genData(i, vk.pvbig ? cur.pvVeryBig ? (cur.pvVeryBig > 1, "z") :
                        "y" : "x"), cur.pvPhoto.firstChild.src = cur.pvCurData.src, setTimeout(Photoview.show.pbind(cur.pvListId, cur.pvIndex), 0))
                }
            },
            loader: 1
        })
