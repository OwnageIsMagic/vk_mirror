var FiltersPE = {
    ...
    onActionCrop: function(event, ref) {
        ...
        each('top left bottom right top_left top_right bottom_left bottom_right'.split(' '), function(i, side) {
            ...
            addEvent(handle, 'mousedown', function(event) {
                ...
                currSide = currHandle.getAttribute('id')
                    .split('_')
                    .slice(4)
                    .join('_');
    ...
    _hideActionBar: function(event, id) {
        ...
        if (!Object.keys(FiltersPE.actionBars)
            .length) return false;
    ...
    onActionBlur: function(event, ref) {
        ...
        var actionBarEl = FiltersPE.actionBars['blur'] = se(
    ...
    onActionText: function(event, ref) {
        ...
        var actionBarEl = FiltersPE.actionBars['text'] = se(
            '<div class="pe_text_input pe_action_bar" id="text"><textarea></textarea> <div class="pe_text_font_changer" onmouseover="showTooltip(this, {text: \'' + cur
            .lang.photos_pe_change_font + '\', shift: [11,4,4], showdt: 0, black: 1, showsp: 110});"></div> </div>');
        var parent = geByClass1('pe_wrap');
        parent.parentNode.insertBefore(actionBarEl, parent.nextSibling);
    ...
    _initParameters: function() {
        ...
        each(sliders, function(i, sliderEl) {
            new Slider(sliderEl, {
                ...
                onChange: function(value) {
                    var name = sliderEl.getAttribute('id')
                        .split('_')[2];
        ...
        ajax.post('al_photos.php', query, {
            onDone: function(text, album, photoObj, thumb, sizes) {
                ...
                if (shown) {
                    ...
                    if (album && ge('pe_album')) ge('pe_album')
                        .innerHTML = album;
