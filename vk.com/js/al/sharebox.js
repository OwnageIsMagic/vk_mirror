var ShareBox = {
    ...
    show: function(e, a) {
        cur.shareBoxWidth = 450, e.setOptions({
            ...
            var i = domNS(a);
            hasClass(a, "disabled") && i && (addClass(i, "like_share_disabled"), (geByTag1("input", i) || {})
                .readOnly = !0)
            ...
            sbCheckLen: function(e) {
                ...
                toggle("like_share_title_wrap", a && 2 == radioBtns.like_share.val && (e.lastLen > 200 && !i || a.selCount > 1 || val("like_share_title")) ? !0 :
                    !1)
            }
        ...
        cur.postTo = !1, e.setOptions({
            onClean: function() {
                Wall.deinitComposer(cur.sbField), delete cur.sbField, cur.postTo = i, window.WideDropdown && (WideDropdown.deinit("like_club_dd"), WideDropdown
                    .deinit("like_mail_dd"))
            }
            ...
            onChange: function(e) {
                curBox()
                    .changed = !0, ShareBox.rbChanged(ge("like_share_club"), 1, !0);
                var a = cur.wdd.like_club_dd,
                    i = a.selCount,
                    s = !0;
                return 1 == e && setTimeout(elfocus.pbind(cur.sbField), 0), 1 > i && !cur.sbHidden ? (ShareBox.toggleAva(!1), s = 1) : i > 0 && cur.sbHidden &&
                    (ShareBox.toggleAva(!0), s = 1), cur.sbCheckLen(cur.sbField), s
            }
            ...
            onChange: function(e) {
                curBox()
                    .changed = !0, ShareBox.rbChanged(ge("like_share_mail"), 2, !0);
                var a = cur.wdd.like_mail_dd,
                    i = a.selCount,
                    s = !0;
                return 1 == e && setTimeout(elfocus.pbind(cur.sbField), 0), 1 > i && !cur.sbHidden ? (ShareBox.toggleAva(!1), s = 0) : i > 0 && cur.sbHidden &&
                    (ShareBox.toggleAva(!0), s = 1), cur.sbCheckLen(cur.sbField), s
            }
        }), each(geByClass("_like_share_about_select", curBox()
            .bodyNode), function() {
            hide(this)
        });
    ...
    rbChanged: function(e, a, i) {
        radiobtn(e, a, "like_share"), getLang("title_for_all") && val("dark_box_topic", getLang(2 > a ? "title_for_all" : "title_for_mail")), val("like_share_title_header",
            getLang(2 > a ? "like_select_comment" : "likes_select_message")), each(geByClass("_like_share_about_select", curBox()
            .bodyNode), function() {
            hide(this)
        }), show(domNS(e));
        ...
        if (s && s.addMedia) {
            ...
            if (1 == a || 0 == a && cur.sbShareOwn) {
                ...
                each(d.types, function(e, a) {
                    ...
                    }), d.setItems(r), show(geByClass1("add_media_type_" + s.addMedia.lnkId + "_postpone", s.addMedia.menu.menuNode, "a")), cur.sbPostponeDate &&
                    "postpone" == s.addMedia.chosenMedia[0] && s.addMedia.chosenMediaData && (s.addMedia.chosenMediaData.date = cur.sbPostponeDate, s.addMedia.chooseMedia(
                        "postpone", s.addMedia.chosenMedia[1], s.addMedia.chosenMediaData), hide(domFC(ge("like_share_add_media"))), cur.sbPostponeDate = !1), s.addMedia.postponePreview &&
                    show(domPN(s.addMedia.postponePreview)), s.addMedia.markAsAds && (o ? show(domPN(geByClass1("page_preview_mark_as_ads_wrap", ge(
                        "like_share_media_preview")))) : hide(domPN(geByClass1("page_preview_mark_as_ads_wrap", ge("like_share_media_preview")))))
            } else {
                var r = [];
                each(d.types, function(e, a) {
                        "postpone" !== a[0] && "mark_as_ads" !== a[0] && r.push(a)
                    }), d.setItems(r), hide(geByClass1("add_media_type_" + s.addMedia.lnkId + "_postpone", s.addMedia.menu.menuNode, "a")), s.addMedia.chosenMedia &&
                    "postpone" == s.addMedia.chosenMedia[0] && (cur.sbPostponeDate = val("postpone_date" + s.addMedia.lnkId), val("like_share_media_preview", ""), show(
                        domFC(ge("like_share_add_media")))), s.addMedia.postponePreview && hide(domPN(s.addMedia.postponePreview)), s.addMedia.markAsAds && hide(domPN(
                        geByClass1("page_preview_mark_as_ads_wrap", ge("like_share_media_preview"))))
            }
        }
        if (i !== !0) switch (a) {
            case 0:
    ...
    options: function() {
        return {
            ...
            onDone: function(e, a) {
                cur.likeData = a, curBox()
                    .hide(), showDoneBox(e), window.Wall && isObject(a) && Wall.likeFullUpdate(!1, cur.sbObj, a), window.Videoview && /^video\-?\d+_\d+$/.test(cur.sbObj) &&
                    Videoview.onVideoShared(cur.shareAction, cur.sbObj, cur.sbList), delete cur.shareAction
            },
            onFail: function(e) {
                return ge("like_share_error")
                    .innerHTML = '<div class="msg_text">' + e + "</div>", show("like_share_error"), !0
            }
        }
    }
};
