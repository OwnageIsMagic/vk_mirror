    ...
    show: function(box, opts) {
        ...
        extend(cur, {
            ...
            sbCheckLen: function(inp) {
                ...
                toggle('like_share_title_wrap', dd && (radioBtns['like_share'].val == 2) && (inp.lastLen > 200 && !mchat || dd.selCount > 1 || val(
                    'like_share_title')) ? true : false);
            }
        });

        cur.sbHidden = true;
        autosizeSetup(cur.sbField, {
            minHeight: 80
        })
