var friendsphotos = {
    ...
    loadedPhotos: function(e, o, i, s) {
        cur.albums[e].offset = o, ge("album_photos" + e)
            .appendChild(ce("div", {
                innerHTML: s
            }));
        var r = ge("album_more_progress" + e)
            .parentNode;
        return i ? (r.firstChild.innerHTML = i, cur.albums[e].loading = 1, void ajax.post("al_photos.php", {
            ...
            cache: 1,
            onDone: function() {
                2 == cur.albums[e].loading ? friendsphotos.loadedPhotos.pbind(e)
                    .apply(window, arguments) : cur.albums[e].loading = !1
            }
        })) : void hide(r)
    },
    ...
    loadedAlbums: function(e, o, i, s) {
        ...
        for (i = ce("div", {
                innerHTML: i
            }); i.firstChild;) ge("friends_albums")
            .appendChild(i.firstChild);
    ...
    loadAlbums: function() {
        return isVisible("albums_load_more") && !isVisible("albums_more_progress") ? cur.loading ? void(cur.loading = 2) : void ajax.post("friendsphotos", {
            ...
            showProgress: function() {
                show("albums_more_progress"), hide(ge("albums_load_more")
                    .firstChild)
            },
            hideProgress: function() {
                show(ge("albums_load_more")
                    .firstChild), hide("albums_more_progress")
            },
            cache: 1
        }) : void 0
    },
    ...
    init: function() {
        cur.module = "friendsphotos", friendsphotos.scrollnode = browser.msie6 ? pageNode : window, window.scrollTop = bodyNode.scrollTop = pageNode.scrollTop = htmlNode.scrollTop =
            0, addEvent(friendsphotos.scrollnode, "scroll", friendsphotos.scrollResize), addEvent(window, "resize", friendsphotos.scrollResize), removeEvent(window, "load",
                cur.init), cur.destroy.push(function() {
        ...
        ajax.post("al_photos.php", {
            ...
            onDone: function(o) {
                ...
                var s = (ge("album_photos" + e) || {})
                    .parentNode;
                if (s) {
                    for (var r = e.split("_")[0], n = !1, t = browser.msie6 ? pageNode : browser.chrome || browser.safari ? bodyNode : htmlNode, a = ge(
                                "friends_albums")
