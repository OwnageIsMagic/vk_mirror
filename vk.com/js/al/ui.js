...
Ui.tableInitFilters = function(e) {
    ...
    e.uiFilterDropdowns = {}, each(geByClass("ui_table_filter_dropdown", ge(i)
        .parentNode), function(i, r) {
    ...
    each(e.uiFilterDropdowns || {}, function(e, i) {
        ...
        .trim(), t && (s[r] = t), Ui.tableFilterRows(e, s)
    ...
    var i = vkNow(),
        ...
        S = 0;
    if (d) {
        for (; w && w !== t && w !== b && w !== d && w !== g && w !== f && w !== c && w !== h;) "TH" === w.nodeName ? v = w : "TD" === w.nodeName ? m = w : w.hasAttribute(
                "ui_page_number") ? y = w : w.hasAttribute("ui_per_page_limit") ? C = w : w.hasAttribute(_) ? (A = w, S = Math.abs(intval(w.getAttribute(_)))) : A && "TR" ===
            w.nodeName && (U = w), w = w.parentNode;
        w === b && v ? Ui.tableUpdateSort(t, d, g, p, v, !0) : w !== d && w !== g && w !== c || !U ? w === f && m ? Ui.tableUpdateShower(t, g, f, m) : w === h && C ? Ui.tableUpdatePerPageLimit(
            t, b, d, g, p, C) : w === h && y && Ui.tableUpdatePageNumber(t, b, d, g, p, y) : Ui.tableUpdateHiderGroup(d, g, U, S);
        var N = vkNow(),
    ...
    if (!u) {
        ...
        for (var g = 0; b = [t, i, r][g]; ++g) {
            l = b.children;
            for (var p = 0; d = l[p]; p++) o = intval(d.getAttribute("ui_sort_index")), u[o] || (u[o] = {}), u[o].row = d, u[o].hasOwnProperty("excludedByFilter") || (u[o].excludedByFilter = !
                n && !s[o]), !n && s[o] && o in a && (_ = a[o], _ && (u[_] || (u[_] = {}), u[_].excludedByFilter = !1))
        }
    ...
    if (n = e.p_group_indices, n || (n = e.getAttribute("ui_group_indices"), n = n ? parseJSON(n) : {}, Object.defineProperty && (Object.defineProperty(e, "p_group_indices", {
            configurable: !0,
            writable: !0
        }), e.p_group_indices = n)), u = e.p_wide_indices, u || (u = e.getAttribute("ui_wide_indices"), u = u ? parseJSON(u) : {}, Object.defineProperty && (Object.defineProperty(
            e, "p_wide_indices", {
                configurable: !0,
                writable: !0
            }), e.p_wide_indices = u)), s = t ? t.p_sort_indices_asc : [], a = t ? t.p_sort_indices_desc : [], !s && (s = t.getAttribute("ui_sort_indices_asc"), a = t.getAttribute(
            "ui_sort_indices_desc"), s)) {
        s = s.split(","), a = a.split(",");
    ...
    if (!s) {
        ...
        var g = b.shift();
        if ("int" === g)
            for (var l = 0, p = b.length; p > l; l++) o = l in n ? n[l] : -1, _ = intval(b[o]), u[l] ? d[l] = [l, d[l - 1][1], d[l - 1][2], d[l - 1][3], 1] : d[l] = [l, intval(
                b[l]), o, _, 0];
        else if ("float" === g)
            for (var l = 0, p = b.length; p > l; l++) o = l in n ? n[l] : -1, _ = floatval(b[o]), u[l] ? d[l] = [l, d[l - 1][1], d[l - 1][2], d[l - 1][3], 1] : d[l] = [l,
                floatval(b[l]), o, _, 0
            ];
        else
        ...
        t.setAttribute("ui_sort_indices_asc", s.join(",")), t.setAttribute("ui_sort_indices_desc", a.join(",")), Object.defineProperty && (Object.defineProperty(t,
            "p_sort_indices_asc", {
                configurable: !0,
                writable: !0
    ...
    var i, r, s, a, n = 0;
    i = e.children;
    for (var u, l = 0; u = i[l]; l++) r = hasClass(u, "unshown"), s = hasClass(u, "wide"), r || (a = "ui_table_row", a += n % 2 ? " even" : "", a += s ? " wide" : "", u.className =
        a, n++, s && (n = 1));
    if (isVisible(t)) {
        i = t.children;
        for (var u, l = 0; u = i[l]; l++) r = hasClass(u, "unshown"), s = hasClass(u, "wide"), r || (a = "ui_table_row", a += n % 2 ? " even" : "", a += s ? " wide" : "", u.className =
    ...
    if (U === !1) return !1;
    if (0 === U ? (removeClass(c, "unshown"), addClass(b, "unshown")) : (addClass(c, "unshown"), removeClass(b, "unshown")), Ui.tableClearRowsSortCache(e), e.setAttribute(
            "ui_rows_page_number", 0), Ui.tableUpdateSort(e, d, g, p, v, !1), m) {
    ...
    if (n = Ui.tableGetAllIndices(e, s)) {
        for (u = n[2], d = parseJSON(e.getAttribute("ui_filter_rows_indices")), l = Ui.tableGetRowsSort(e, t, i, r, d, u), o = l.length, _ = intval(e.getAttribute(
                "ui_rows_limit")), b = intval(e.getAttribute("ui_rows_page_number")) * _, e.removeChild(t), e.removeChild(i); t.firstChild;) t.removeChild(t.firstChild);
        ...
        for (var m, A, U, C, y, S, N, O, T = (!g && Object.defineProperty, !1), F = 0, P = !1, x = t.hasAttribute("ui_ensure_group_visibilities") ? parseJSON(t.getAttribute(
                "ui_ensure_group_visibilities")) : {}, v = 0; o > v; v++) A = f[v], m = l[A].row, U = !(A in u), C = hasClass(m, "unshown"), y = hasClass(m, "wide"), S = l[A].excludedByFilter, !
            U && m.hasAttribute("ui_group") && (O = u[A] + ":" + intval(m.getAttribute("ui_group")), C = O in x ? x[O] : C), N = "ui_table_row", N += C ? " unshown" : "", N +=
            P % 2 ? " even" : "", N += y ? " wide" : "", m.className = N, S ? r.appendChild(m) : (b > F || b >= F && !U || _ && (F - b - 1 >= _ || F - b >= _ && U) ? T ? T.push(
                m) : i.appendChild(m) : (t.appendChild(m), P === !1 && (P = 0)), F += U, P !== !1 && (P += !C, y && !C && (P = 1)));
        e.setAttribute("ui_main_rows_count", F), t.removeAttribute("ui_ensure_group_visibilities"), T && T.length && (Object.defineProperty(i, "p_rows_more", {
            configurable: !0,
            writable: !0
        }), i.p_rows_more = T), s && a && (removeClass(geByClass1("sort", s.parentNode), "sort"), c && 3 == w || addClass(s, "sort"), c && 1 != w && toggleClass(s,
            "reverse", h), w && s.setAttribute("ui_sort_original", w)), e.insertBefore(i, p), e.insertBefore(t, i)
    }
    ...
    if (1 != u) {
        ...
        for (var _ = l; o >= _; _++) s = "ui_table_page", s += _ == i ? " selected" : "", r = document.createElement("a"), r.className = s, r.setAttribute("ui_page_number", _),
            r.innerHTML = _ + 1, t.appendChild(r);
    ...
    if (s) {
        if (2 == s) return scrollToY(Math.max(Math.min(getXY(e)[1] - 10, scrollGetY()), 0), 0), r.innerHTML = r.getAttribute("ui_shower_more_text"), r.setAttribute(
            "ui_shower_less", 1), void addClass(t, "unshown");
    ...
    for (var s, a, n = i.nextSibling, u = parseInt(i.getAttribute("ui_sort_index")), l = !1, o = e.hasAttribute("ui_ensure_group_visibilities") ? parseJSON(e.getAttribute(
            "ui_ensure_group_visibilities")) : {}; n && n.hasAttribute("ui_group");) {
