var Videoview = {
        ...
        playerCallback: {
            ...
            onVideoNext: function(e, i, o) {
                setTimeout(function() {
                    var t = 0;
                    i || e ? i && o ? t = 5 : i && !o ? t = 6 : e && (t = 7) : t = 4, Videoview.sendPlayerStats(t, 0), VideoPlaylist.getBlock() ? e && !i ?
            ...
            onVideoAdEvent: function(e, i, o, t, a, n, d) {
                if (o) {
                    ...
                    r.type = a, r.events.push(t), r.pl_type = d, clearTimeout(cur._vadStatTimer), cur._vadStatTimer = setTimeout(Videoview.sendVideoAdStat.bind(Videoview, e, i,
                        o), 1e3)
                }
            },
            ...
            onInitialized: function() {
                window.mvcur && mvcur.mvShown ? (VideoPlaylist.toggle(!VideoPlaylist.isCollapsed()), mvcur.options.focusPlay && ("visible" == document.visibilityState ?
                    Videoview.togglePlay(!0) : "hidden" == document.visibilityState && addEvent(window, "focus", function o() {
            ...
            onVideoPlayProgress: function(e, i, o, t, a) {
                var n = e + "_" + i;
                5e3 > t && cur.tnsStart != n ? (this.playerCallback.scoreCardCounter(), cur.tnsStart = n) : t > a / 2 && cur.tnsEnd != n && (cur.tnsEnd = n), window.mvcur &&
            ...
            onVideoStreamPlaying: function(e, i) {
                var o = window.mvcur && mvcur.player || cur.videoInlinePlayer || ge("video_player");
                if (o && (o.isFromAutoplay && o.isFromAutoplay() || e + "_" + i == cur.pinnedVideo)) {
                    if (!o.isTouchedByUser || !o.isTouchedByUser()) return;
        ...
        initAddButton: function() {
                    ...
                    onFirstTimeShow: function(i) {
                        ...
                        each(mvcur.mvData.playlists, function(i, t) {
                                var a = t.added || e && t.id == mvcur.mvData.PLAYLIST_ADDED_ID,
                                    n = t["private"] ? '<span class="mv_tt_playlist_private_icon" onmouseover="showTooltip(this,{black:1,text: \'' + getLang(
                                ...
                                o += '<div class="mv_tt_playlist">  <div class="checkbox' + (a ? " on" : "") + (t.disabled ? " disabled" : "") + '" data-id="' +
                                    t.id + '" onclick="checkbox(this);">' + t.title + "</div>" + n + "</div>          "
            ...
            function i(i, t, a) {
                ...
                toggleClass(v, "mv_add_icon_curr", !i), toggleClass(v, "mv_add_icon_down", i), toggleClass(d, "mv_add_icon_curr", i), removeEvent(r, "click", o), removeEvent(r,
                        ...
                        mvcur.addButtonTT.destroy(), mvcur.addButtonTT = null, addEvent(r, "click", o), addEvent(r, "setAdded", o)), a || s == i || Videoview.playerOnAdded(),
                    s = i;
        ...
        receiveComms: function(e, i, o, t) {
            for (var a, n, d = ce("div", {
                ...
                a && !Videoview.cmp(a.id, n.id) ? (r.replaceChild(n, a), a = n) : (a && domNS(a) ? r.insertBefore(n, domNS(a)) : !a && domFC(r) ? o ? r.insertBefore(n, domFC(r)) :
                    (--l.commshown, d.removeChild(n)) : r.appendChild(n), o || ++l.commcount, ++l.commshown)
            }
            t && s && (mvLayerWrap.scrollTop += getXY(s, !0)[1] - v), extend(mvcur.mvReplyNames, i), window.updateWndVScroll && updateWndVScroll(), Videoview.updateCommentsHeader(),
        ...
        likeUpdate: function(e, i, o, t) {
            ...
            if (icon = domByClass(s, "_icon"), countNode = domByClass(s, "_count"), a.likes = i, a.liked = e, countNode) {
                ...
                o && d && val(d, o), r && (r.value = i), animateCount(countNode, i), toggleClass(s, "my_like", e), toggleClass(s, "no_likes", !i), toggleClass(c, "me_hidden", !
                    e), i ? t || !v.el || isVisible(v.container) || o || tooltips.show(v.el, extend(l, {
                    showdt: 0
                })) : v.el && v.hide()
            }
        },
        ...
        deleteVideo: function(e, i, o, t, a, n, d) {
            n && hasClass(n, "loading") || ajax.post("al_video.php", {
                ...
                onDone: function(t, r, s, v, l) {
                    ...
                    } else if ("result" == t && (d && d(s), "videoviewer" == a && (ge("mv_info") && (hide("mv_info"), val("mv_warning", s), show("mv_warning"),
        ...
        appendNewComment: function(e, i, o, t, a, n, d, r, s, v, l) {
            if (!ge("post" + e + "video_" + i + "mv")) {
                var c = "";
                mvcur.adminLevel > 0 || e == vk.id || o == vk.id ? c += mvcur.commentsTpl.del_reply : e != o && (c += mvcur.commentsTpl.spam_reply), (mvcur.adminLevel > 1 && e ==
                    o || t == vk.id) && (c += mvcur.commentsTpl.edit_reply), c = rs(mvcur.commentsTpl.actions, {
                    actions: c
                });
                ...
                mvcur.mvReplyNames[o] = [v, l], ge("mv_comments")
        ...
        getContPlace: function(e, i) {
            ...
            return 6 > n && (o += 1), a > t[0] - 20 && (o += 2), n > t[1] - 10 && (o += 4), 10 > a && (o += 8), 1 == o && a > t[0] - 55 && (o = 0), !o && 25 > n && a < t[0] -
                55 && (o += 16), o
        },
            ...
            if (!(Videoview.isFS || e.button && 1 !== e.button)) {
                ...
                if (i) {
                    ...
                    var a = function(e) {
                        ...
                        var n = (new Date)
                            .getTime();
                        return Videoview.getMinSize(), mvcur.resizeDiff < 8 && 400 > n - o && (16 & i || 1 == i) && Videoview.unminimize(), removeClass(mvLayerWrap,
                            "mv_resizing"), removeClass("mv_player_box", "no_events"), addEvent("mv_box", "mousemove", Videoview.changeCursor), ls.set("mv_minSize",
                            mvcur.minSize), !1
                    };
                    return addClass(mvLayerWrap, "mv_resizing"), addClass("mv_player_box", "no_events"), addEvent(document, "mouseup", a), addEvent(document, "mousemove", t),
                ...
                ajax.post("al_video.php", {
                    ...
                    onDone: function(t) {
                        ...
                        if (a) {
                            ...
                            val(n, t || '<span class="mv_desc_edit">' + getLang("video_edit_desc") + "</span>"), n.onmouseover = t ? Videoview.descTT.pbind(n) :
    ...
    VideoPlaylist = {
        ...
        getList: function(e, i) {
            ...
            if (ownerPlaylistRE.test(e)) {
                var t, a, n, d = e.split("_"),
                    r = d[0],
                    s = d[1];
                if (-2 == s ? (t = "all", a = cur.playlistAddedTitle) : -1 == s ? (t = "uploaded", a = cur.playlistUploadedTitle) : (t = "album_" + s, a = cur.playlistTitle),
        ...
        toggle: function(e, i) {
            if (isUndefined(e) && (e = VideoPlaylist.isCollapsed()), !mvcur.minimized || !e) {
                var o = VideoPlaylist.getBlock();
                if (o && VideoPlaylist.isCollapsed() != !e) return data(o, "collapsed", !e), VideoPlaylist.toggleStateClasses(), Videoview.playerOnResize(), Videoview.updateReplyFormPos(),
...
window.VideoChat = {
    ...
    initForm: function() {
        ...
        a.onkeydown = a.onkeyup = a.onchange = VideoDonate.checkCommentLength, toggle("video_donate_widget_offline", !e.user_data.alert_widget_is_online), ge(
                "video_donate_basic_submit")
        ...
        var d = VideoDonate.params.prefilled;
        d.email && val("video_donate_email", d.email.value), ge("video_donate_billing_submit")
    ...
    onChoosePayMethod: function(e) {
        var i = VideoDonate.apiData,
            ...
            t = e.currentTarget,
            a = domData(t, "value");
        radiobtn(t, a, "video_donate_pay_method");
        var n = i.payin_currencies[a].additional_fields,
            d = "";
        n && each(n, function(e, i) {
            var t = "",
                n = "",
                r = "";
            "MOBILE_FAKE" == a && "phone" == e ? (t = getLang("video_donate_box_sms_payment_phone_placeholder"), n = getLang(
                "video_donate_box_sms_payment_phone_hint"), r = o.phone ? o.phone.value : "") : "QIWI_MYCOM" == a && "phone_number" == e && (t = getLang(
                "video_donate_box_qiwi_payment_phone_placeholder"), n = getLang("video_donate_box_qiwi_payment_phone_hint")), (t || n) && (d += getTemplate(
