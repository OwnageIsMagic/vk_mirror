var FansBox = {
                        ...
                        cur.fnbxIdolsList[n] ? cur.fnbxIdolsQuery && FansBox.moreIdols(!0) : (cur.fnbxIdolsList[n] = "loading", ajax.post("/al_fans.php", {
                            ...
                            onDone: function(o) {
                                if (cur.fnbxIdolsList) {
                                    ...
                                    for (var e = cur.fnbxIdolsProcessed, a = 0, c = o.length; c > a; ++a) void 0 !== e[o[a][0]] && (o[a][1] =
                                        e[o[a][0]]), cur.fnbxIdolsCache[n].all.push(a);
                                    cur.fnbxIdolsList[n] = o, cur.fnbxIdolsIndex[n] = new vkIndexer(cur.fnbxIdolsCache[n].all, function(o) {
                                        ...
                                        cur.fnbxOwnerId == n && curBox()
                                            .tbId == cur.fnbxId && "idols" == curBox()
                                            .tbVis && FansBox.moreIdols(r)
                                    } : function() {})
                                }
                            }
                        }))
    ...
    getHighlight: function(n) {
        var o = cur.fnbxIdolsIndex[cur.fnbxOwnerId],
            r = o.delimiter,
            s = o.trimmer;
        return n += " " + (parseLatin(n) || ""), n = escapeRE(n)
            .replace(/&/g, "&amp;"), n = n.replace(s, "")
            .replace(r, "|"), {
                re: new RegExp("(" + n + ")", "gi"),
    ...
    moreIdols: function(n) {
        ...
        if (o && curBox()
            ...
            a && (val(d, _.join("")), curBox()
                .tbToTop()), toggle(b, u > h)
        }
    },
    genIdolEmpty: function(n) {
        var o = '<a href="/search?c[section]=groups&c[q]=' + encodeURIComponent(n) + '">',
            r = trim(n) ? getLang("fans_idols_not_found") + "<br>" + getLang("groups_you_can_find")
            .replace("{term}", o + clean(n) + "</a>")
            .replace("{link}", o)
            .replace("{/link}", "</a>") : getLang("fans_no_idols");
    ...
    genIdolRow: function(n, o) {
        ...
        return ['<div class="fans_idol_row inl_bl">  <div class="fans_idolph_wrap fl_l"', s, '>    <a class="fans_idol_ph" href="', e,
            '">      <img class="fans_idol_img" src="', a,
            '" />    </a>  </div>  <div class="fans_idol_info">    <div class="fans_idol_name"><a class="fans_idol_lnk" href="', e, '">', o,
            '</a></div>    <div class="fans_idol_status">', f, '</div><div class="fans_idol_size">', c, '</div>    <div id="fans_idol_sub', r,
            '" class="button_blue fans_idol_sub"', n[1] || !l ? i : "", '>      <button class="flat_button button_small" onclick="FansBox.subscribe(this, ', r, ')">',
            getLang("public_subscribe"), '</button>    </div>    <div id="fans_idol_unsub', r, '" class="fans_idol_unsub"', n[1] && l ? "" : i,
            '>      <button class="flat_button button_small secondary" onclick="FansBox.unsubscribe(this, ', r, ')">', getLang("public_unsubscribe"),
            "</button>    </div>  </div></div>"
        ].join("")
    },
        ...
        buttonLocked(o) || (ajax.post(cur.fnbxPage, extend(cur.fnbxVars(n), {
            ...
            onDone: function(r, s, e) {
                var a = ce("div", {
                    ...
                    c = ge("fans_rows" + n);
                if (c) {
                    for (var i = domFC(a); i; i = domFC(a)) c.appendChild(i);
    ...
    subscribe: function(n, o) {
        ajax.post("al_feed.php", {
            ...
            onDone: function() {
                hide("fans_idol_sub" + o), show("fans_idol_unsub" + o), show("fans_idol_feedact" + o), cur.fnbxOwnerId == vk.id && FansBox.recache(1), FansBox.markSubsc(
                    o, 1)
            },
    ...
    unsubscribe: function(n, o) {
        ajax.post("/al_fans.php", {
            ...
            onDone: function() {
                show("fans_idol_sub" + o), hide("fans_idol_unsub" + o), hide("fans_idol_feedact" + o), cur.fnbxOwnerId == vk.id && FansBox.recache(-1), FansBox
                    .markSubsc(o, 0)
            },
            showProgress: lockButton.pbind(n),
            hideProgress: unlockButton.pbind(n)
    ...
    backToBox: function() {
        if (cur.fnbxLoaded = function() {
                ...
                return n != cur.fnbxBack.tab ? void curBox()
                    .tbTab(cur.fnbxBack.tab) : (extend(cur, {
                            fnbxOffsets: cur.fnbxBack.offsets,
                            fnbxIdolsQuery: cur.fnbxBack.query
                        }), domPN(o)
                        .replaceChild(cur.fnbxBack.cont, o), toggle("fans_more_link" + n, !!cur.fnbxBack.vis), unlockButton("fans_more_link" + n), cur.fnbxLoaded = cur.fnbxBack = !
                        1, boxLayerWrap.scrollTop = r, val("fans_idol_search_inp", cur.fnbxIdolsQuery), "idols" == n && cur.fnbxIdolsQuery && (elfocus(
                            "fans_idol_search_inp"), show("fans_reset_search")), void setTimeout(function() {
