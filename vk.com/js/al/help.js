var Help = {
    ...
    submitCCObjection: function(e, t, o, n) {
        var c = ge("ccform_submit"),
            i = {
                ...
                name: ge("ccform_name")
                    .value,
                email: ge("ccform_email")
                    .value,
                country: cur.countrySelect.val(),
                city: cur.citySelect.val(),
                region: ge("ccform_region")
                    .value,
                address: ge("ccform_address")
                    .value,
                objections: ge("ccform_legality")
                    .value,
                doc_mid: ge("ccform_doc_mid")
                    .value,
                doc_photo: ge("ccform_doc_photo")
                    .value,
                doc_server: ge("ccform_doc_server")
                    .value
            };
        return i.name.length < 5 ? (notaBene("ccform_name"), !1) : /^\s*[a-zA-Z0-9_\.\-]+@[a-zA-Z0-9_\.\-]+\s*$/.test(i.email) ? i.country < 1 ? (cur.countrySelect.focus(), !
            1) : i.city < 1 ? (cur.citySelect.focus(), !1) : i.address < 9 ? (notaBene("ccform_address"), !1) : i.objections.length < 5 ? (notaBene("ccform_legality"), !
            1) : isChecked("ccobjection_agree_email") ? isChecked("ccobjection_agree_inform") ? isChecked("ccobjection_agree_rules") ? (lockButton(c), void ajax.post(
            "/al_help.php", i, {
                onDone: function(e) {
            ...
            })) : Help.showMsgBox(getLang("help_ccobjection_need_rules"), getLang("global_error")) : Help.showMsgBox(getLang("help_ccobjection_need_inform"), getLang(
            "global_error")) : Help.showMsgBox(getLang("help_ccobjection_need_email"), getLang("global_error")) : (notaBene("ccform_email"), !1)
    },
    ...
    uploadError: function(e) {
        var t = "";
        e ? 1 == e || 4 == e ? t = getLang("restore_not_uploaded") : 2 == e ? t = getLang("restore_bad_format") : 5 == e && (t = getLang("restore_bad_size")) : t = getLang(
            "global_unknown_error"), setTimeout(showFastBox(getLang("global_error"), t)
            .hide, 2e3);
    ...
    uploadComplete: function(e, t, o, n) {
        ...
        unlockButton(c), ge("ccform_doc_mid")
            .value = e, ge("ccform_doc_photo")
            .value = t, ge("ccform_doc_server")
            .value = o, show("doc_photos"), ge("doc_photos")
            .innerHTML = '<div id="photo"><img id="photo_img" src="' + n +
            '" /><span onmouseover="this.className=\'over\';" onmouseout="this.className=\'\';" onclick="Help.deleteImage()" id="del_link">' + getLang("global_delete") +
            "</span></div>"
    },
    deleteImage: function() {
        ge("ccform_doc_mid")
            .value = "0", ge("ccform_doc_photo")
            .value = "", ge("ccform_doc_server")
            .value = "0", hide("doc_photos"), ge("doc_photos")
            .innerHTML = ""
    },
    ...
    stestRadioClick: function(e, t) {
        if (void 0 === cur.doneQuestions[e]) {
            var o = ge("help_question_hint" + e),
                ...
                s = r[1],
                a = r[0];
            val(geByClass1("help_question_hint_text", o, "div"), s), toggleClass(o, "help_question_hint_wrong", !a), cur.doneQuestions[e] = t, a ? cur.doneRight++ :
                addClass(geByClass1("radiobtn", ge("help_answer" + e + "_" + t), "div"), "on"), cur.doneLen++, each(cur.questions[e], function(t) {
                    ...
                    display: "block"
                }), show(o), cur.doneLen < cur.qLen ? (val("help_test_results_warn", getLang("help_sectest_cant_finish_X_done", cur.doneLen) + " " + getLang(
                    "help_sectest_cant_finish_X_remain", cur.qLen)), show("help_question" + (e + 1))) : hide("help_test_results_warn", "help_test_finish_btn_lock")
        }
    },
    ...
    initSecurityTestResults: function(e) {
        extend(cur, e), window.VK && VK.init && VK.Widgets && VK.Widgets.Like ? Help.stestInitWLike() : (window.vkAsyncInit = Help.stestInitWLike, headNode.appendChild(ce(
            "script", {
