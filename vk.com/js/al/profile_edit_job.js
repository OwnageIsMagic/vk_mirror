var ProfileEditorJob = {
    init: function() {
        ...
        if (!isVisible("works")) {
            if (cur.worksCount = cur.works.length, cur.worksCount)
                for (var e = 0; e < cur.works.length; ++e) ge("works")
                    .appendChild(this.genWorkRow(cur.works[e].id, 0 == e)), cur.works[e] = this.initWorkRow(cur.works[e]);
            else this.addWork();
            show("works")
        }
    ...
    genOneRow: function(e, t, r, i, o, n) {
        var a = e + t;
        return i || (i = 'class="pedit_dropdown" type="hidden"'), n || (n = ""), '<div class="pedit_row clear_fix" id="row_' + a + '"' + (o || "") +
            '><div class="pedit_label">' + r + '</div><div class="pedit_labeled"><input id="' + a + '" name="' + a + '" ' + i + "/></div>" + n + "</div>"
    },
    genWorkRow: function(e, t) {
        var r = (t ? "" : '<div class="pedit_separator"></div>') + '<div id="content' + e + '">' + this.genOneRow("group", e, getLang("select_company"),
                'type="text" class="dark"', "", '<div class="pedit_right_control">' + ProfileEditor.deleteLinkHtml("ProfileEditorJob.deleteWork(" + e + ")") +
                '</div><img class="pedit_progress" src="/images/upload.gif" id="progress' + e + '" />') + '<div id="pedit_country_row' + e + '">' + this.genOneRow(
                "country", e, getLang("select_country"), "") + this.genOneRow("city", e, getLang("select_city"), "") + '</div><div id="details' + e +
            '" style="display: none">' + this.genOneRow("start", e, getLang("select_work_start")) + this.genOneRow("finish", e, getLang("select_work_finish")) + this.genOneRow(
                "position", e, getLang("select_work_position"), 'id="position' + e + '_name" class="pedit_dropdown"') + '</div></div><div class="deleted" id="deleted' + e +
            '"><div></div><a class="pedit_right_control" onclick="ProfileEditorJob.restoreWork(' + e + ')">' + getLang("global_dont_delete") + "</a></div>";
        return ce("div", {
    ...
    initWorkRow: function(e, t) {
        ...
        return e.uiStart = new Dropdown(r("start" + e.id), [
                ...
                dark: 1
            }), e.uiFinish.setData(cur.selData.years), e.uiStart.val(e.start, !0), e.uiFinish.val(e.finish, !0), e.uiPosition = new Selector(r("position" + e.id),
                "select.php?act=apositions", {
                    multiselect: !1,
                    ...
                    dark: 1
                }), ProfileEditorJob.initGroupCompany(e), ge("work" + e.id)
            .style.display = "block", (e.city || e.company_gid) && (ge("details" + e.id)
    ...
    addWork: function() {
        ...
        var e = {
            ...
            t = ge("works")
            .appendChild(this.genWorkRow(e.id, 0 == cur.worksCount));
        return cur.worksCount || hide(geByClass1("_del_icon", t)), e = this.initWorkRow(e), cur.works.length || (cur.works = new Array), cur.works.push(e), ++cur.worksCount,
            cur.worksCount >= 7 && hide("add_work_link"), !1
    },
    ...
    deleteWork: function(e) {
        if (--cur.worksCount, show("add_work_link"), ge("position" + e)
            .value.length || e > 0) hide("content" + e), ge("deleted" + e)
            .firstChild.innerHTML = getLang("profileEdit_work_will_be_deleted"), show("deleted" + e);
        else {
            var t = this.getIndex(cur.works, e);
            cur.works[t] = cur.works[cur.works.length - 1], cur.works.pop(), ge("work" + e)
                .parentNode.removeChild(ge("work" + e)), 0 == cur.works.length && this.addWork()
        }
        return !1
    },
    ...
    addFields: function() {
        for (var e = arguments[0], t = arguments[1], r = arguments[2], i = 3; i < arguments.length; ++i) intval(ge(arguments[i] + t)
            .value) && (e[arguments[i] + r] = ge(arguments[i] + t)
            .value);
        return e
    },
    saveWorks: function(e) {
        for (var t = {
            ...
            if (t["id" + r] = i, isVisible("content" + i)) {
                ...
                var n = intval(o[0]);
                if (-1 != n && (t["group" + r] = n), ge("position" + i)
                    .value.length) {
    ...
    updateWork: function(e, t, r, i) {
        e.country = e.uiCountry.val(), e.country_val = e.uiCountry.val_full(), e.city = e.uiCity.val(), e.city_val = e.uiCity.val_full(), e.company = e.uiGroup.val(), e.company_val =
            e.uiGroup.val_full(), e.company_name = e.company_val[1], e.company_val[0] && "-1" != e.company_val[0] && (e.company_gid = e.company_val[0]), e.start = e.uiStart
            .val(), e.finish = e.uiFinish.val(), e.position = e.uiPosition.val(), e.position_val = e.uiPosition.val_full();
    ...
    workChanged: function(e) {
        ...
        return !isVisible("content" + e.id) || e.country != e.uiCountry.val() || e.city != e.uiCity.val() || winToUtf(e.company_name) != winToUtf(e.uiGroup.val_full()[1]) ||
            winToUtf(t) != winToUtf(r) || e.start != e.uiStart.val() || e.finish != e.uiFinish.val()
    }
};
try {
