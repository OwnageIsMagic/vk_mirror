...
var Call = {
    ...
    log: "",
    playRing: function() {
        window.ls && ls.get("videocall_sound") && ls.get("videocall_sound") + 6e3 > (new Date)
            .getTime() || (window.ls && ls.set("videocall_sound", (new Date)
                .getTime()), Call.sound || (window.Sound ? Call.sound = new Sound("mp3/call") : Call.sound = {
                play: function() {},
                pause: function() {}
            }), Call.sound.play(), Call.ringTimer = setInterval(function() {
                Call.sound && (Call.sound.play(), window.ls && ls.set("videocall_sound", (new Date)
                    .getTime()))
            }, 5e3))
    },
    stopRing: function() {
    ...
    baseVideoBox: function(a, l, e) {
        return browser.flash < 10 || 10 == browser.flash && browser.flashfull.minor < 1 ? (ge(a)
            .innerHTML = '<div class="flash_needed"><div>' + getLang("calls_install_flash_text")
            .replace("{link}", '<a href="http://get.adobe.com/flashplayer/">')
            .replace("{/link}", "</a>") + '</div><div class="button_blue"><button id="videocalls_need_flash">' + getLang("calls_install_flash_player") +
            "</button></div></div>", ge("videocalls_need_flash")
            .onclick = function() {
    ...
    incomingBox: function(a, l, e, t, i, n, o, r, c, s, d) {
        ...
        var C = se('<div>    <div class="call_invitation_wrap clear_fix">      <div class="call_title noselect">' + getLang("calls_invitation_title") +
                '</div>      <div class="call_text noselect">' + a + '</div>      <div class="call_user_pic"><img src="' + l +
                '" /></div>      <div class="call_buttons">        <div class="button_green"><button onclick="Call.incomingReply(' + e + ", " + t + ", '" + i + "', '" + o +
                "', '" + r + "', '" + c + "', '" + s + "', '" + d + "', Call.enableCamera)\">" + getLang("calls_reply") +
                '</button></div>        <div class="button_red"><button onclick="Call.incomingReject(3,' + e + "," + t + "," + t + ",'" + o + "');\">" + getLang(
                    "calls_reject") + '</button></div>        <button class="hover_button" onclick="Call.incomingToggleCam(this);"><div class="call_camera_btn"></div>' +
                getLang("calls_camera_on") + "</button>      </div>    </div></div>"),
    ...
    videochatBox: function(a) {
        var l = Call.calcBoxPos(),
            e = defBox({
                ...
                innerHTML: '<div id="call_wrap" class="call_wrap clear_fix">      <div id="call_videochat"></div><div id="chat_toggle_btn" class="hover_button fl_r call_open_chat" onclick="Call.toggleChat(event)"><img class="call_chat_toggle_img" align="middle" src="/images/icons/call_chat_toggle.png" />      <span id="call_chat_toggle">' +
                    getLang("calls_open_chat") +
                    '</span></div>      <div id="call_cancel" class="call_cancel">        <div class="button_red"><button onclick="Call.endCall(true, 0)">' + getLang(
                        "calls_finish") + "</button></div>      </div>    </div>"
            }, function() {});
    ...
    hideChat: function(a) {
        ...
        if (a) {
            ...
            removeClass(a, "call_chat_sel"), ge("call_chat_toggle")
                .innerHTML = getLang("calls_open_chat")
        }
    },
    ...
    doShowChat: function(a, l, e, t) {
        stManager.add(["notifier.js", "notifier.css"], function() {
            ...
            Call.box && (t.startLeft = Call.box.pos[1] + Call.box.pos[3] + 10, t.startTop = Math.abs(Call.box.pos[0] + Call.box.pos[2] - 319)), FastChat.selectPeer(
                a, e, t)
        })
    },
    ...
    incomingToggleCam: function(a) {
        Call.enableCamera = Call.enableCamera ? 0 : 1, a.innerHTML = Call.enableCamera ? '<div class="call_camera_btn"></div>' + getLang("calls_camera_on") :
            '<img src="/images/icons/videocall_off.png">' + getLang("calls_camera_off")
    },
    incomingReceive: function(a) {
        if (Call.init(), Call.invitation || Call.box) return void(Call.params.far_uid == a.author_id && vk.id < a.author_id ? (Call.debug(
            "simultaneous invitations, instant reply"), Call.endCall(), Call.incomingReply(a.custom.call_id, a.author_id, a.custom.near_id, a.custom.hash,
            a.custom.stream, a.custom.rtmp, a.custom.rtmfp, a.custom.prefer)) : (Call.debug("incoming call declined, busy"), Call.incomingReject(1, a.custom.call_id,
            a.author_id, a.author_id, a.custom.hash)));
        ...
        if (Call.devices) Call.devices > 0 && Call.incomingDoReceive(a.custom.call_id, a.author_id, a.custom.near_id, a.custom.rtmp_hash, a.custom.hash, a.custom.stream, a
            .custom.rtmp, a.custom.rtmfp, a.custom.prefer, a.custom.video);
        else {
            var l = ce("div", {
                id: "vchatdevices_swf"
            });
            utilsNode.appendChild(l), window.__vchatDevicesCB = function(l, e) {
                Call.devices = l > 0 || e > 0 ? 1 : -1, Call.devices > 0 && Call.incomingDoReceive(a.custom.call_id, a.author_id, a.custom.near_id, a.custom.rtmp_hash,
                    a.custom.hash, a.custom.stream, a.custom.rtmp, a.custom.rtmfp, a.custom.prefer, a.custom.video)
            }, renderFlash(l, {
    ...
    incomingDoReceive: function(a, l, e, t, i, n, o, r, c, s) {
        ajax.post("call.php", {
            ...
            onDone: function(d, C, p) {
                d && (Call.videocallActive(!0), window.langpack = extend(window.langpack || {}, d), Call.enableCamera = 1, Call.incomingBox(C, p, a, l, e, t, i,
                        n, o, r, c), Call.far_camera = s, Call.invitation_text = stripHTML(C), Call.pingTimeout = setTimeout(Call.noPing, 2e4), cur.titleTO ||
                    (cur.titleTO = setInterval(Call.changeTitle, 1e3)), Call.playRing())
            }
        })
    },
    noPing: function() {
    ...
    dismissInvitation: function() {
        clearInterval(Call.pingTimer), clearInterval(Call.shortPollTimer), clearTimeout(Call.pingTimeout), Call.invitation && (Call.invitation.close(), Call.invitation =
            null), Call.stopRing(), Call.restoreTitle()
    },
    ...
    incomingInitialized: function() {
        if (!Call.params.init_complete && ((Call.params.cameraActive || Call.params.microphoneActive) && (Call.toggleMessage("calls_allow_access", !0), Call.toggleMessage(
                    "calls_initialization")), Call.connected && (Call.connected.rtmp || Call.connected.rtmfp) && (Call.params.cameraActive || Call.params.microphoneActive) &&
                Call.videochat)) {
            if (Call.connected.rtmp && !Call.connected.rtmfp && !Call.params.waitForRtmfp) return Call.params.waitForRtmfp = 1, void setTimeout(Call.incomingInitialized,
                1e3);
            ...
            }, Call.callbacks.onConnectionError = null, Call.callbacks.onCameraStatus = null, Call.callbacks.onMicrophoneStatus = null, Call.videochat && Call.establishConnection(
                function() {
                    Call.debug("answering with " + Call.params.near_prefer + " preferred"), ajax.post("call.php", {
                        ...
                        onDone: function(a) {
                            Call.debug("done, incoming call is started"), Call.params.near_stream = a, Call.videochat.startCallPublish(Call.params.near_stream,
                                    Call.params.near_prefer, Boolean(Call.params.video)), Call.videochat.startCallPlay(Call.params.far_stream, "rtmfp" ==
                                    Call.params.near_prefer ? Call.params.far_id : "", Call.params.near_prefer), Call.videochat.cameraAvailable(Call.far_camera),
                                Call.toggleMessage("calls_allow_access", !0), Call.toggleMessage("calls_initialization", !0)
                        }
                    })
                })
        }
    ...
    establishConnection: function(a) {
        if (Call.videochat) {
            if (Call.params.far_prefer && 1 == Call.connected[Call.params.far_prefer]) Call.params.near_prefer = Call.params.far_prefer;
                ...
                if (1 != Call.connected.rtmfp) return Call.params.establishTry = (Call.params.establishTry || 0) + 1, Call.debug("wait to establish"), Call.params.establishTry <
                    10 ? setTimeout(Call.establishConnection.pbind(a), 1e3) : (Call.debug("unable to establish any connection, terminating"), Call.doneMsg(
                        "calls_error_connection"), Call.endCall(!0, -1), !1);
            ...
            return "rtmfp" != Call.params.near_prefer || Call.params.connected || (Call.peerTimer = setTimeout(function() {
                Call.videochat && (Call.debug("no response for 5 seconds, fallback to rtmp...(2)"), Call.params.near_prefer = "rtmp", Call.connected.rtmfp = 2,
                    Call.establishConnection() && (Call.debug("reconnecting to " + Call.params.near_prefer), Call.videochat.startCallPublish(Call.params.near_stream,
                        Call.params.near_prefer, Boolean(Call.params.video)), Call.videochat.startCallPlay(Call.params.far_stream, "rtmfp" == Call.params
                        .near_prefer ? Call.params.far_id : ""), Call.videochat.cameraAvailable(Call.far_camera), ajax.post("call.php", {
                        act: "reconnect",
                        call_id: Call.params.call_id,
                        from_id: Call.params.from_id,
                        uid: Call.params.far_uid,
    ...
    changeTitle: function() {
        return Call.invitation ? void(Call.old_title ? (document.title = Call.old_title, Call.old_title = !1, setFavIcon("/images/favicon" + (vk.intnat ? "_vk" : "new") +
            _iconAdd + ".ico")) : (Call.old_title = document.title.toString(), document.title = Call.invitation_text, setFavIcon("/images/icons/fav_call" +
            _iconAdd + ".ico"))) : Call.restoreTitle()
    },
    ...
    outgoingInitialized: function() {
        if (!Call.params.init_complete && ((Call.params.cameraActive || Call.params.microphoneActive) && (Call.toggleMessage("calls_allow_access", !0), Call.toggleMessage(
                "calls_initialization")), Call.connected && (Call.connected.rtmp || Call.connected.rtmfp) && (Call.params.cameraActive || Call.params.microphoneActive))) {
            if (Call.connected.rtmp && !Call.connected.rtmfp && !Call.params.waitForRtmfp) return Call.params.waitForRtmfp = 1, void setTimeout(Call.outgoingInitialized,
                1e3);
            Call.params.init_complete = !0, Call.debug("initialization complete"), Call.callbacks.onConnectionSuccess = function(a, l) {
                Call.debug(a + " connected, proceed"), Call.connected[a] = 1, "rtmfp" != a || Call.params.near_id || (Call.params.near_id = l)
            }, Call.callbacks.onConnectionError = null, Call.callbacks.onMicrophoneStatus = null, Call.callbacks.onCameraStatus = null, Call.videochat && (Call.params.near_prefer =
                1 == Call.connected.rtmfp ? "rtmfp" : "rtmp", Call.debug("calling with " + Call.params.near_prefer + " preferred"), Call.receiveTimeout = setTimeout(
                    function() {
                    ...
                    onDone: function(a, l, e, t) {
                        return 0 == a ? (Call.debug("server says other user can not reply to this call..."), Call.doneMsg("calls_user_unavailable"), void Call.endCall()) :
                            (Call.debug("call " + a + " started, publishing"), Call.params = extend(Call.params, {
                                call_id: a,
                                near_stream: l,
                                hash: e
    ...
    startPublish: function(a) {
        return Call.connected[Call.params.near_prefer] ? (Call.videochat.startCallPublish(a, Call.params.near_prefer, Boolean(Call.params.video)), Call.toggleMessage(
                "calls_allow_access", !0), Call.shortPollTimer = setInterval(Call.sendPing.pbind(!0), 2e3), Call.pingTimer = setInterval(Call.sendPing.pbind(!1), 15e3),
            Call.sendPing(!0), void(Call.params.far_id && Call.outgoingReplied())) : (setTimeout(Call.startPublish.pbind(a), 1e3), !1)
    },
    ...
    outgoingReplied: function() {
        Call.debug("processing reply"), clearInterval(Call.pingTimer), clearTimeout(Call.pingTimeout), clearTimeout(Call.receiveTimeout), clearTimeout(Call.replyTimeout),
            Call.videochat.toggleWait(!1), Call.params.far_prefer == Call.params.near_prefer ? ("rtmfp" != Call.params.near_prefer || Call.params.connected || (Call.peerTimer =
                setTimeout(function() {
                    Call.debug("no response for 5 seconds, fallback to rtmp...(1)"), Call.params.near_prefer = "rtmp", Call.connected.rtmfp = 2, Call.establishConnection() &&
                        (Call.debug("reconnecting to " + Call.params.near_prefer), Call.videochat.startCallPublish(Call.params.near_stream, Call.params.near_prefer,
                            Boolean(Call.params.video)), Call.videochat.startCallPlay(Call.params.far_stream, "rtmfp" == Call.params.near_prefer ? Call.params.far_id :
                            "", Call.params.near_prefer), Call.videochat.cameraAvailable(Call.far_camera), ajax.post("call.php", {
                            act: "reconnect",
                            call_id: Call.params.call_id,
                            from_id: Call.params.from_id,
                            uid: Call.params.far_uid,
                ...
                }, 5e3)), Call.videochat.startCallPlay(Call.params.far_stream, "rtmfp" == Call.params.near_prefer ? Call.params.far_id : "", Call.params.near_prefer)) :
            Call.establishConnection() && (Call.debug("connecting over " + Call.params.near_prefer), Call.videochat.startCallPublish(Call.params.near_stream, Call.params.near_prefer,
                Boolean(Call.params.video)), Call.videochat.startCallPlay(Call.params.far_stream, "rtmfp" == Call.params.near_prefer ? Call.params.far_id : "", Call.params
                .near_prefer), Call.videochat.cameraAvailable(Call.far_camera))
    },
    doEndCall: function(a, l) {
        ...
        if (Call.box && (Call.box.close(0, !0), Call.box = null), Call.invitation && (Call.invitation.close(), Call.invitation = null), a && Call.params.call_id && Call.params
            .far_uid && Call.params.hash) {
            ajax.post("call.php", {
                act: "reject",
                reason: l,
                call_id: Call.params.call_id,
    ...
    endCall: function(a, l) {
        clearInterval(Call.pingTimer), clearInterval(Call.shortPollTimer), clearTimeout(Call.pingTimeout), clearTimeout(Call.peerTimer), clearTimeout(Call.receiveTimeout),
            clearTimeout(Call.replyTimeout), Call.box ? (setStyle(Call.box.wrap, {
                left: -1e3,
                top: -1e3
            }), setTimeout(function() {
                Call.doEndCall(a, l)
    ...
    processNotify: function(a, l) {
        switch (a.custom.code) {
            ...
            case "hangup":
                ...
                break;
            case "reconnect":
                Call.videochat && Call.params.near_prefer != a.custom.prefer && (clearTimeout(Call.peerTimer), Call.params.far_prefer = a.custom.prefer, Call.establishConnection() &&
                    (Call.videochat.startCallPublish(Call.params.near_stream, Call.params.near_prefer, Boolean(Call.params.video)), Call.videochat.startCallPlay(Call.params
                        .far_stream, "rtmfp" == Call.params.near_prefer ? Call.params.far_id : "", Call.params.near_prefer)));
                break;
            case "camera":
                l || clearInterval(Call.shortPollTimer), Call.videochat && (Call.videochat.cameraAvailable(a.custom.available), a.custom.available || Call.toggleMessage(
                    "calls_connection_troubles", !0)), Call.far_camera = a.custom.available
        }
    },
    debug: function(a) {
        debugLog(a);
