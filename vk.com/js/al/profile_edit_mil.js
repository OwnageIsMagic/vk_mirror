var ProfileEditorMil = {
    init: function() {
        if (cur.globalCounter = 0, cur.militariesCount = 0, selectsData.setCountries(cur.selData.countries_list), !isVisible("militaries")) {
            if (cur.militariesCount = cur.militaries.length, cur.militariesCount)
                for (var i = 0; i < cur.militaries.length; ++i) ge("militaries")
                    .appendChild(this.genMilitaryRow(cur.militaries[i].id, 0 == i)), cur.militaries[i] = this.initMilitaryRow(cur.militaries[i]);
    ...
    genOneRow: function(i, t, e, r, a) {
        var l = i + t;
        return r || (r = ""), a || (a = ""), '<div class="pedit_row clear_fix" id="row_' + l + '"><div class="pedit_label">' + e +
            '</div><div class="pedit_labeled"><input class="pedit_dropdown" type="hidden" id="' + l + '" name="' + l + '" ' + r + "/></div>" + a + "</div>"
    },
    genMilitaryRow: function(i, t) {
        return ce("div", {
            className: "pedit_edu_big_row",
            id: "military" + i,
            innerHTML: (t ? "" : '<div class="pedit_separator"></div>') + '<div id="content' + i + '">' + this.genOneRow("country", i, getLang("select_country"),
                    "", '<div class="pedit_right_control">' + ProfileEditor.deleteLinkHtml("ProfileEditorMil.deleteMilitary(" + i + ")") +
                    '</div><img src="/images/upload.gif" class="pedit_progress" id="progress' + i + '" />') + '<div id="details' + i + '" style="display: none">' +
                this.genOneRow("unit", i, getLang("select_military_unit")) + '<div id="all' + i + '" style="display: none">' + this.genOneRow("start", i, getLang(
                    "select_military_start")) + this.genOneRow("finish", i, getLang("select_military_finish")) +
                '</div></div></div><div class="deleted" id="deleted' + i + '"><div></div><a class="pedit_right_control" onclick="ProfileEditorMil.restoreMilitary(' +
    ...
    initMilitaryRow: function(i, t) {
        ...
        return i.uiStart = new Dropdown(e("start" + i.id), [
                ...
                dark: 1
            }), i.uiFinish.setData(cur.selData.until_years), i.uiStart.val(i.start, !0), i.uiFinish.val(i.finish, !0), i.uiUnit = new Selector(e("unit" + i.id),
                "select_ajax.php?act=a_get_units&country=" + i.country, {
                    multiselect: !1,
            ...
            .style.display = "block", intval(i.country) && (e("details" + i.id)
                .style.display = "block"), intval(i.unit) && (e("all" + i.id)
    ...
    addMilitary: function() {
        ...
        var i = {
            ...
            t = ge("militaries")
            .appendChild(this.genMilitaryRow(i.id, 0 == cur.militariesCount));
        return cur.militariesCount || hide(geByClass1("_del_icon", t)), i = this.initMilitaryRow(i), cur.militaries.push(i), ++cur.militariesCount, cur.militariesCount >=
            5 && hide("add_military_link"), !1
    },
    ...
    deleteMilitary: function(i) {
        if (--cur.militariesCount, show("add_military_link"), intval(ge("unit" + i)
                .value)) hide("content" + i), ge("deleted" + i)
            .firstChild.innerHTML = getLang("profileEdit_military_will_be_deleted"), show("deleted" + i);
        else {
            var t = this.getIndex(cur.militaries, i);
            cur.militaries[t] = cur.militaries[cur.militaries.length - 1], cur.militaries.pop(), ge("military" + i)
                .parentNode.removeChild(ge("military" + i)), 0 == cur.militaries.length && this.addMilitary()
        }
        return !1
    },
    ...
    addFields: function() {
        for (var i = arguments[0], t = arguments[1], e = arguments[2], r = 3; r < arguments.length; ++r) intval(ge(arguments[r] + t)
            .value) && (i[arguments[r] + e] = ge(arguments[r] + t)
            .value);
        return i
    },
    saveMilitaries: function(i) {
        for (var t = {
            ...
            t["id" + e] = r, isVisible("content" + r) && intval(ge("unit" + r)
                .value) ? (t = this.addFields(t, r, e, "country", "unit", "start", "finish"), ge("unit" + r + "_custom")
                .value.length && (t["unit" + e + "_custom"] = ge("unit" + r + "_custom")
                    .value)) : t["deleted" + e] = 1
        }
        var a = function(i) {
            ...
            for (var e = 0; e < t.length; ++e) {
                var a = t[e];
                ge("military" + cur.militaries[a].id)
                    .parentNode.removeChild(ge("military" + cur.militaries[a].id)), cur.militaries[a] = cur.militaries[cur.militaries.length - 1];
    ...
    updateMilitary: function(i, t, e, r) {
        i.country = i.uiCountry.val(), i.country_val = i.uiCountry.val_full(), i.unit = i.uiUnit.val(), i.unit_val = i.uiUnit.val_full(), i.start = i.uiStart.val(), i.finish =
            i.uiFinish.val();
