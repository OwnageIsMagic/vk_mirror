var ProfileEditorMil = {
        ...
        if (!isVisible('militaries')) {
            ...
            if (cur.militariesCount) {
                for (var i = 0; i < cur.militaries.length; ++i) {
                    ge('militaries')
                        .appendChild(this.genMilitaryRow(cur.militaries[i].id));
    ...
    addMilitary: function() {
        ...
        ge('militaries')
            .appendChild(this.genMilitaryRow(new_military.id));
    ...
    deleteMilitary: function(id) {
        ...
        if (intval(ge('unit' + id)
            ...
            hide('content' + id);
            ge('deleted' + id)
                .firstChild.innerHTML = getLang('profileEdit_military_will_be_deleted');
            show('deleted' + id);
        } else {
    ...
    saveMilitaries: function(btn) {
        ...
        var doneHandler = function(response) {
            ...
            for (var i = 0; i < to_remove.length; ++i) {
                ...
                ge('military' + cur.militaries[index].id)
                    .parentNode.removeChild(ge('military' + cur.militaries[index].id));
                cur.militaries[index] = cur.militaries[cur.militaries.length - 1];
