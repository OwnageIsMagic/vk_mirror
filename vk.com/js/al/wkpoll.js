var WkPoll = {
    ...
    tabShow: function(l) {
        cur.wkPollOpt = l, cur.wkPollInd = 0, hide("wk_poll_stats", "wk_poll_stats_total", "wk_poll_dmgr"), show("wk_poll_people"), val("wk_poll_people", cur.wkPollCache[l]
            [0][0]), WkPoll.update(), cur.wkPollQuery[l].offset = cur.wkPollCache[l][0][1], WkPoll.tabLoaded()
    },
    update: function() {
    ...
    graph: function() {
        cur.wkPollGraph || (addClass(cur.wkPollTabs, "wk_poll_graph_tabs"), WkPoll.updateTabsSize(), WkPoll.update(), cur.wkPollGraph = !0, WkPoll.updateDemography(
            function() {
    ...
    graphFilter: function(l, o, e) {
        var r = geByClass1("summary_tab_sel", ge("wk_poll_graph_tabs")),
            a = domPN(l);
        a != r && (removeClass(r, "summary_tab_sel"), addClass(r, "summary_tab"), removeClass(a, "summary_tab"), addClass(a, "summary_tab_sel")), cur.wkPollCriteria.percent =
            o, cur.wkPollCriteria.amount = e, WkPoll.updateDemography()
    },
    graphHide: function() {
        show("wk_poll_show_graph", "wk_poll_stats"), hide("wk_poll_hide_graph", "wk_poll_graph"), removeClass(cur.wkPollTabs, "wk_poll_graph_tabs"), WkPoll.updateTabsSize(),
            cur.wkPollGraph = !1
    },
    updatedDemography: function(l) {
        if (cur.wkPollCache = {}, clearTimeout(cur.wkPollUpdateTO), cur.wkPollUpdateTO = setTimeout(WkPoll.updateDemography, 500), "country" == l) {
            ...
            if (isChecked("wk_poll_extra_country")) {
                ...
                }), r >= 1 && (cur.wkPollcityDD.setItems(t), cur.wkPollcityDD.val(o)), 1 == r && val("wk_poll_filter_city_name", e), toggleClass(
                    "wk_poll_filter_city_wrap", "wk_poll_filter_name", 1 >= r)
            }
        ...
        var e = function(e) {
            ...
            if (each(e, function(l, o) {
                    ...
                    setStyle(geByClass1("page_poll_percent", e), {
                            width: o.width + "%"
                        }), val(geByClass1("page_poll_row_percent", e), o.percent + "%"), val(geByClass1("page_poll_row_count", e), o.count), ge("wk_poll_usrs" + l) &&
                        val("wk_poll_usrs" + l, o.people)
                }), r) {
            ...
            ge("wk_poll_total")
                .innerHTML != t && animate(ge("wk_poll_total"), {
                    opacity: 0
                }, 100, function() {
                    ge("wk_poll_total")
                        .innerHTML = t, animate(ge("wk_poll_total"), {
    ...
    scroll: function() {
        cur.wkPollOpt && isVisible("ui_voters_load_more") && getXY("ui_voters_load_more", !0)[1] < lastWindowHeight && WkPoll.more(), isVisible(cur.wkPollTabs) && (getXY(
                cur.wkPollTabsWrap, !0)[1] < 0 ? cur.wkPollFixed || (WkPoll.updateTabsSize(), addClass(cur.wkPollTabs, "wk_poll_fixed"), cur.wkPollFixed = !0) : cur.wkPollFixed &&
            (removeClass(cur.wkPollTabs, "wk_poll_fixed"), cur.wkPollFixed = !1))
    },
    vote: function(l, o) {
        addClass(l, "on");
        var e = curBox(),
    ...
    backToBox: function() {
        if (cur.pollBack && window.WkView) {
            ...
            domPN(l.bodyNode)
                .replaceChild(cur.pollBack.body, l.bodyNode), l.bodyNode = cur.pollBack.body, l.setOptions(cur.pollBack.options), boxLayerWrap.scrollTop = cur.pollBack.scroll,
                onBodyResize(), delete cur.pollBack
        }
    },
