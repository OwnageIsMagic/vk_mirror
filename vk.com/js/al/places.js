var Places = {
    initPhotoMap: function(o) {
        ...
        function n(t, a, i) {
            ...
            for (var s = t.length; s--;)
                if (!(t[s].loading || t[s].count <= 1)) {
                    var r = t[s],
                        l = 20 * r.diff;
                    l > o.diff && r.lat >= a.swLat - l && r.lat <= a.neLat + l && r.lng >= a.swLng - l && r.lng <= a.neLng + l ? r.expanded ? n(r.points, a, i) : i[r.photo
                        .split("_")[1]] = r : r.expanded && e(r)
                }
            return i
        }
        ...
        function a() {
            ...
            0 !== i.points.length && (o.diff ? (delete i.diffs, i.diff = o.diff) : i.diffs = i.diffs.join(","), i.points = i.points.join(","), i.ids = i.ids.join(","),
                ajax.post("al_places.php", i, {
                    onDone: function(o, e) {
        ...
        function c(e) {
            return cur.editPhotosPlace && fadeOut(ge("places_photo_hint_cont"), 200), cur.mapMoveTimeout && clearTimeout(cur.mapMoveTimeout), cur.mapMoveTimeout =
                setTimeout(a, e ? 0 : 200), _ ? (_ = !1, !1) : void(o.box && (cur.mapMoveServerTimeout && clearTimeout(cur.mapMoveServerTimeout), cur.mapMoveServerTimeout =
                    setTimeout(l, 500)))
        }
        ...
        function d(o, e, t, n, a) {
            ...
            for (i = "<div" + (s ? "" : ' id="profile_map_icon_' + n + '"') + ' class="profile_map_photo profile_map_first" style="background: url(' + o +
                ") center center no-repeat;" + (s ? " margin-left: -2px; margin-top: -4px;" : "") + '">' + i + "</div>"; s--;) i = "<div" + (s ? "" :
                ' id="profile_map_icon_' + n + '"') + ' class="profile_map_photo"' + (s ? ' style="margin-left: -2px; margin-top: -4px;"' : "") + ">" + i + "</div>";
            return i
        }
        var u, f, h, g;
        ...
        if (f) {
            ...
            if (o.nowheel && (M.scrollwheel = !1, M.disableDoubleClickZoom = !0), u = o.map ? o.map : new ymaps.Map(o.cont, M, {
                    ...
                    [o.bounds.swlat, o.bounds.swlng],
                    [o.bounds.nelat, o.bounds.nelng]
                ])) : (o.lat || o.lng || (o.lat = 30), u.setCenter([o.lat, o.lng], 1)), o.nowheel ? (u.behaviors.disable("drag"), u.behaviors.disable("scrollZoom")) : u.events
                .add("boundschange", c.pbind(!1)), o.points)
                for (var b = o.points.length; b--;) {
                    var y = o.points[b];
    ...
    showMorePhotos: function(o, e) {
        return !cur.addPhotosOffset || buttonLocked(o) ? !1 : void ajax.post("al_places.php", {
            ...
            onDone: function(e, t, n) {
                cur.addPhotosOffset = t, n || hide(o), ge("places_map_add_list") && ge("places_map_add_list")
                    .appendChild(cf(e))
            },
