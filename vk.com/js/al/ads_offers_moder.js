var OffersModer = {
        ...
        ajax.post('/offersmoder', params, {
            onDone: function(response, js) {
                ...
                if (response.requests) {
                    ge('offers_moder_requests_container')
                ...
                if (response.button) {
                    ge('offers_moder_button_container')
                        .innerHTML = response.button;
                }
                ge('offers_moder_summary')
    ...
    showPreview: function(offerId) {
        ...
        box.removeButtons()
            .addButton(getLang('ads_offers_moder_test_box_btn'), function() {
                ge('start_offer')
                    .submit();
                box.hide();
            });
    ...
    doCompensation: function() {
        ...
        ajax.post('/offersmoder?act=a_do_compensation', {
            user_id: ge('ads_offers_moder_compensation_uid')
                .value,
            app_id: ge('ads_offers_moder_compensation_app_id')
                .value,
            votes: ge('ads_offers_moder_compensation_votes')
                .value,
            comment: ge('ads_offers_moder_compensation_comment')
                .value
        }, {
            onDone: function() {
                showFastBox('�������', '�������');
