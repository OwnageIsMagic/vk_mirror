var Offers = {
    ...
    save: function() {
        ...
        ge("offer_limit") && (e.limit = val("offer_limit")), ge("offer_day_limit") && (e.day_limit = val("offer_day_limit")), ge("offer_spent") && (e.spent = val(
            "offer_spent")), ge("offer_cost_field") && (e.cost = val("offer_cost_field")), lockButton(ge("offers_save")), ajax.post("offers.php", e, {
            onDone: function(e, o, s, r) {
                ...
                if (removeClass(t, "offers_error"), t.innerHTML = e, show(t), setStyle(t, {
                    ...
                    }, 2e3), scrollToTop(200), o && (show("secret_field"), show("tab_test"), ge("offers_edit_hidden_secret")
                        .innerHTML = o), s) {
                    cur.offerId = s, cur.deleteHash = r, nav.setLoc("offersdesk?act=edit&offer_id=" + s);
                    var f = geByTag("a", ge("offers_tabs"));
                    each(f, function() {
                        this.href = (this.href || "")
                            .replace(/offer_id=([0-9]+)/, "offer_id=" + s)
                    })
                }
            },
            onFail: function(e) {
    ...
    ddStatus: function(e, o, s) {
        var r, t, f, n = o + "_" + s,
            a = cur.statusesDD[n];
        a || (3 == s ? (t = '<span class="offers_dd_title offers_dd_on_h"></span><span class="offers_dd_text">' + cur.lang.offers_statuses_on + "</span>", f =
            '<span class="offers_dd_title offers_dd_off"></span><span class="offers_dd_text">' + cur.lang.offers_statuses_off + "</span>", r = [{
                i: 2,
                l: f
            }]) : 2 == s ? (t = '<span class="offers_dd_title offers_dd_off_h"></span><span class="offers_dd_text">' + cur.lang.offers_statuses_off + "</span>", f =
            '<span class="offers_dd_title offers_dd_on"></span><span class="offers_dd_text">' + cur.lang.offers_statuses_on + "</span>", r = [{
                i: 3,
                l: f
            }]) : 1 == s ? (t = '<span class="offers_dd_title offers_dd_wait_h"></span><span class="offers_dd_text">' + cur.lang.offers_statuses_moderate +
            "</span>", f = '<span class="offers_dd_title offers_dd_off"></span><span class="offers_dd_text">' + cur.lang.offers_statuses_off + "</span>", r = [{
                i: 0,
                l: f
            }]) : 0 == s && (t = '<span class="offers_dd_title offers_dd_off_h"></span><span class="offers_dd_text">' + cur.lang.offers_statuses_off + "</span>", f =
            '<span class="offers_dd_title offers_dd_wait"></span><span class="offers_dd_text">' + cur.lang.offers_statuses_moderate_send + "</span>", r = [{
                i: 1,
                l: f
    ...
    changeLimit: function(e, o, s) {
        ...
        cur.limitOfferId = o, cur.limitObj = e, cur.limitDay = s, cur.startLimitBoxPos || (show(t), cur.startLimitBoxPos = getXY(t)), r[0] -= cur.startLimitBoxPos[0] + 18,
            r[1] -= cur.startLimitBoxPos[1] + 17, setStyle(t, {
                marginLeft: r[0],
                marginTop: r[1]
            }), show(t);
    ...
    addToBanBox: function(e, o) {
        ...
        return ge("offers_ban_box_input")
            .setAttribute("placeholder", getLang("offers_" + e + "_input")), cur.options.banType = e, cur.banBox = showFastBox(s, ge("offers_ban_box")
                .innerHTML, getLang("global_add"),
                function() {
    ...
    searchToBan: function(e) {
        ...
        return s ? (hide("offers_ban_box_error"), void ajax.post("offers.php", {
            ...
            onDone: function(e, s, t) {
                if (!e) return ge("offers_ban_box_error")
                    .innerHTML = s, void show("offers_ban_box_error");
                if (val(o, ""), s && -1 != s && (ge("offers_" + r + "_summary")
                        .innerHTML = s), t) {
                    var f = ce("div", {
                            innerHTML: t
                        })
    ...
    addToBan: function(e, o, s, r) {
        return ajax.post("offers.php", {
            ...
            onDone: function(t) {
                t && (ge("offers_" + e + "_summary")
                    .innerHTML = t), r.onclick = function() {
