...
AdsEdit.updateTargetingGroups = function() {
    ...
    hiderInfoElem.innerHTML = (cur.targetingEditor.isUserDevicesHidden() ? getLang('ads_criteria_section_additional_info_retargeting') : getLang(
        'ads_criteria_section_additional_info'));
}
...
AdsEdit.initCropPhotoBox = function(cropBox, resultPhotoWidth, resultPhotoHeight, resultPhotoWidthSmall, resultPhotoHeightSmall, cropOptions, newSizeWidth, newSizeHeight) {
    ...
    var showHintTt = showTooltip.pbind(newHintEl, {
        text: getLang('ads_edit_ad_crop_future_tooltip'),
        className: 'ads_edit_crop_photo_new_hint_tt',
        shift: [130, 0, 0],
        slide: 15
    });
    ...
    switch (paramNameHelp) {
        ...
        case 'platform':
            targetElem = ge(this.options.targetIdPrefix + paramNameHelp)
                .parentNode;
            helpText = function() {
                return (this.params.link_type.value == AdsEdit.ADS_AD_LINK_TYPE_POST) ? cur.adParamsHelp['platform_post'] : cur.adParamsHelp['platform'];
            }.bind(this);
            var showTooltip = function() {
                AdsEdit.showHelpCriterionTooltip(paramNameHelp, targetElem, handler, this.help[paramNameHelp], helpText, shiftLeft, shiftTop, this.cur);
            }.bind(this);
    ...
    switch (paramName) {
        ...
        case 'platform':
            ...
            if (this.params.platform.disabled) {
                this.params[paramName].value = (this.params.platform.values_disabled[this.params.link_type.value] ? this.params.platform.values_disabled[this.params.link_type.value] :
                    this.params.platform.values_disabled[0]);
            } else {
                this.params[paramName].value = (this.params.platform.values_normal[this.params.link_type.value] ? this.params.platform.values_normal[this.params.link_type.value] :
                    this.params.platform.values_normal[0]);
            }
    ...
    switch (paramName) {
        case 'format_type':
            ...
            toggleClass(this.options.targetIdPrefix + paramName + '_promoted_post_wrap', 'unshown', elemsHidden[AdsEdit.ADS_AD_FORMAT_TYPE_PROMOTED_POST] = !(inArray(
                linkTypeValue, [AdsEdit.ADS_AD_LINK_TYPE_POST])));
    ...
    do {
        ...
        switch (paramName) {
            ...
            case 'cost_type':
                this.params.views_limit_flag.hidden = (this.params.cost_type.value != AdsEdit.ADS_AD_COST_TYPE_VIEWS || this.params.format_type.value == AdsEdit.ADS_AD_FORMAT_TYPE_EXCLUSIVE &&
                    this.params.views_limit_exact.allow || this.params.format_type.value == AdsEdit.ADS_AD_FORMAT_TYPE_PROMOTED_POST);
                this.params.views_limit_exact.hidden = (this.params.cost_type.value != AdsEdit.ADS_AD_COST_TYPE_VIEWS || this.params.format_type.value != AdsEdit.ADS_AD_FORMAT_TYPE_EXCLUSIVE &&
                    this.params.format_type.value != AdsEdit.ADS_AD_FORMAT_TYPE_PROMOTED_POST || !this.params.views_limit_exact.allow);
            ...
            case 'link_type':
                ...
                this.params.link_url.hidden = !inArray(this.params.link_type.value, [AdsEdit.ADS_AD_LINK_TYPE_URL, AdsEdit.ADS_AD_LINK_TYPE_VIDEO, AdsEdit.ADS_AD_LINK_TYPE_MOBILE_APP_ANDROID,
                    AdsEdit.ADS_AD_LINK_TYPE_MOBILE_APP_IPHONE, AdsEdit.ADS_AD_LINK_TYPE_MOBILE_APP_WPHONE, AdsEdit.ADS_AD_LINK_TYPE_POST
                ]);
                ...
                this.params.platform.hidden = !!(this.params.link_type.value != AdsEdit.ADS_AD_LINK_TYPE_POST && (!this.params.platform.allow_web || !inArray(this.params.link_type
                    .value, [AdsEdit.ADS_AD_LINK_TYPE_GROUP, AdsEdit.ADS_AD_LINK_TYPE_EVENT, AdsEdit.ADS_AD_LINK_TYPE_PUBLIC, AdsEdit.ADS_AD_LINK_TYPE_APP, AdsEdit
                        .ADS_AD_LINK_TYPE_URL
                    ])));
...
AdsViewEditor.prototype.completeLink = function() {
    ...
    var isChangedImportant = (!this.params_old ||
        ...
        (this.params.link_id.value != this.params_old.link_id.value || this.params.link_owner_id.value != this.params_old.link_owner_id.value) && this.params.link_type.value ==
        AdsEdit.ADS_AD_LINK_TYPE_POST
    );
    ...
    if (isChangedImportant) {
        ...
        this.params.format_type.hidden = !!(inArray(this.params.link_type.value, [AdsEdit.ADS_AD_LINK_TYPE_MOBILE_APP_ANDROID, AdsEdit.ADS_AD_LINK_TYPE_MOBILE_APP_IPHONE,
            AdsEdit.ADS_AD_LINK_TYPE_MOBILE_APP_WPHONE, AdsEdit.ADS_AD_LINK_TYPE_POST
        ]));
...
AdsTargetingEditor.prototype.getUiCriterionIntroText = function(criterionName) {
    switch (criterionName) {
        ...
        case 'retargeting_groups':
            return getLang('ads_select_retargeting_group');
        case 'retargeting_groups_not':
            return getLang('ads_select_retargeting_group');
        default:
            return '';
