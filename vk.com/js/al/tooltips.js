var tooltips = {
    show: function(el, options) {
        ...
        if (el.tt) {
            ...
            var canshow = opts.js ? eval("(function(){return function(){var tip=this;" + opts.js + "};})()")
                .apply(el.tt) !== !1 : !0;
            if (canshow) return isVisible(el.tt.container) ? void(el.tt.showing || animate(el.tt.container, {
                ...
                if (!isVisible(t)) {
                    ...
                    t.style.opacity = 0, opts.width && (t.style.width = opts.width + "px"), show(t), isNewTT || (t.firstChild.className = "toup" + (opts.toup ?
                        1 : ""));
                    var l = opts.shift;
    ...
    create: function(t, e) {
        ...
        if (t.tt && t.tt.el) {
            ...
            t.tt.onClean && t.tt.onClean(), geByClass1("wrapped", r)
                .innerHTML = o.content, extend(t.tt, {
                    opts: o,
            ...
            if (o.black) var d = ce("div", {
                ...
                innerHTML: '<table cellspacing="0" cellpadding="0">    <tr><td colspan="3" class="tt_top"><div class="top_pointer"></div></td></tr>    <tr>      <td class="side_sh"></td>      <td class="outer"><table cellspacing="0" cellpadding="0">        <tr><td class="side_sh"></td>          <td class="wrapped">' +
                    o.content +
                    '</td>        <td class="side_sh"></td></tr>        <tr><td colspan="3"><div class="bottom_sh"></div></td></tr>      </table></td>      <td class="side_sh"></td>    </tr>    <tr><td colspan="3" class="tt_bottom"><div class="bottom_sh"></div><div class="bottom_pointer' +
                    i + '"></div></td></tr>  </table>',
                className: l
            }, {
                display: "none"
