var tooltips = {
    ...
    rePosition: function(el, opts) {
        ...
        if (browser.msie7) setStyle(container, {
            width: ttsize[0]
        });
    ...
    pollVote: function(post, option, attachI) {
        ...
        ajax.post('widget_poll.php', {
            ...
            onDone: function(html, js) {
                var lnk = ge('post_media_lnk' + post + '_' + attachI),
                    opts = extend(lnk.tt.opts, {
                        className: 'wall_tt',
                        content: html || ' ',
                        showdt: 0,
                        js: js
