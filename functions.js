...
function MessageBox(options) {
    ...
    hide(boxBG);
    boxBG.innerHTML =
        '<iframe class="box_frame"></iframe><div class="popup_box_container" style="display:none"><div class="box_layout" style="z-index:200"><div class="box_title_wrap"><div class="box_title"></div></div><div class="box_body"></div><div class="box_controls"></div></div></div>';
