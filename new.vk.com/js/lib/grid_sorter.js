        ...
        if (this._curDragEl) {
            ...
            this._isShiftToLeft && (r[1] -= n[1] - this._curOverCell.size[1]), setTimeout(function() {
                ...
                if (re(o._curPlaceholderEl), removeClass(o._contEl, "ui_gridsorter_cont"), o.options.dragCls && removeClass(e, o.options.dragCls), o._inited) {
                    ...
                    removeClass(e, "ui_gridsorter_moveable"), o._curOverCell = o._curPlaceholderEl = null, i && o.update(), s != e && !i && o.options.onReorder && o.options
                        .onReorder(e, l, domPS(e))
                }
            }, 210), t && this._dist(t) > 5 && (cancelEvent(t), cur.cancelClick = !0)
        }
        this._updateScrollbar(), this._deinitEvents(), e && this._overEl && this.options.onDragLeave && this.options.onDragLeave(this._overEl, e), i || e && this._overEl && this.options
                ...
                if (i = this._grid[l], 2 != o)
                    if (i.el != t) {
                        if (i.el == e && o++, 1 == o || 2 == o) {
                            var d = 0,
                                c = 0;
                            r ? (d = s.pos[0] + _[0], c = s.pos[1] + _[1], _[0] += i.size[0] - s.size[0], _[1] += i.size[1] - s.size[1]) : (_[0] += s.size[0] - i.size[0], _[1] +=
                                s.size[1] - i.size[1], d = s.pos[0] + _[0], c = s.pos[1] + _[1]), this._setPos(i.el, {
                                left: d - i.pos[0],
                                top: c - i.pos[1]
                            }), i.dirty = !0
