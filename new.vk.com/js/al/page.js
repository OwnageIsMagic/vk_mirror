function initCustomMedia(e, a, t) {
    ...
    else var s = '<div class="rows"><div class="add_media_items"><div class="add_media_head noselect"><nobr>' + e.innerHTML + "</nobr></div></div></div>";
    ...
    var l = ce("div", {
            ...
            innerHTML: '<div class="add_media_rows">' + s + "</div>"
        }, {
            position: "absolute"
        }),
        r = geByClass1("add_media_items", l, "div");
    customMenuNode.appendChild(l);
        ...
        c = {
            ...
            updateFixed: function(a) {
                if (!(-1 != c.fixed && -1 != a && void 0 !== a && c.fixed == a || -1 != c.fixed && void 0 === a)) {
                    ...
                    c.fixed ? (setStyle(customMenuNode, {
                        ...
                        position: "absolute"
                    }), removeClass(customMenuNode, "fixed")), isVisible(l) && c._updatePosition(!0)
                }
            },
            show: function(a, o) {
                if (clearTimeout(n), l && !isVisible(l)) {
                    e.blur(), c.updateFixed(-1);
                    var i = c._updatePosition(),
                        s = l.firstChild;
                    browser.msie && browser.version < 9 || browser.mobile ? show(l) : (setStyle(s, {
                        height: 26,
                        overflow: "hidden"
                    }), fadeIn(l, 200), c.reverse && (setStyle(s, {
                        position: "absolute",
                        bottom: -d,
                        width: getSize(s.firstChild)[0]
                    }), setStyle(s.firstChild, {
                        position: "absolute",
                        bottom: "0px"
                    })), animate(s, {
                        height: i - 2
            ...
            _updatePosition: function(a) {
                var o = getXY(e, c.fixed),
                    ...
                    u = l.firstChild,
                    _ = geByClass1("add_media_more", l);
                if (vk.rtl) {
                    var h = lastInnerWidth - 4 - o[0] - 3 * getSize(e)[0] / 2 + s;
                    0 > h && (i = -h, h = 0), setStyle(l, {
                        right: h,
                        top: p
                    })
                } else {
                    var g = o[0] + s - getSize(l)[0] / 2 + getSize(e)[0] / 2;
                    0 > g && (i = g, g = 0), setStyle(l, {
                        left: g,
                        top: p
                    })
                }
                setStyle(u.firstChild, {
                    width: "100%"
                }), setStyle(geByClass1("add_media_pointer", l), {
                    position: "relative",
                    left: i + "px"
                }), a || (setStyle(l, {
                    visibility: "hidden",
                ...
                var m = getSize(u),
                    ...
                    f = m;
                a || (_ && (show(_), hide(_.nextSibling), f = getSize(u)), setStyle(l, {
                    visibility: "",
                    display: "none"
                }));
                var v = !1;
                if (m[1] - d < p - w && lastWindowHeight + w < p + m[1] || t.forceUp ? (setStyle(u, "marginTop", -f[1] + d), c.reverse || (v = !0)) : (setStyle(u, "marginTop", -
                    ...
                    c.reverse = !c.reverse, (c.reverse ? addClass : removeClass)(l, "add_media_rev")
                }
                return f[1]
            },
            hide: function(e) {
                clearTimeout(n);
                var a = browser.msie && browser.version < 9 || browser.mobile ? hide.pbind(l) : fadeOut.pbind(l, 100);
            ...
            setItems: function(e) {
                for (var a = r.firstChild, s = r.lastChild; a != s; a = r.firstChild, s = r.lastChild) r.removeChild(hasClass(a, "add_media_head") ? s : a);
                ...
                if (c.moreWrap = !1, each(e, function(e, a) {
                        ...
                        if (!a[6] && t.bgSize && (m.backgroundSize = t.bgSize), _ && (u ? a[0] == u : 3 == e)) {
                            ...
                            addEvent(f, "mouseover click", function(e) {
                                ...
                                display: "none"
                            }), s = f.appendChild(p), c.moreWrap = f
                        }
                        extend(m, n), a[4] && (g.href = a[4]), s = (p ? p : r)
                            .appendChild(ce("a", g, m)), a[3] && addEvent(s, "click", function() {
                                return c.hide(!0), t.onItemClick && !t.onItemClick(a[0]) ? !1 : (a[3](), !1)
                            })
                    }), t.tooltip) {
                    var g = geByClass1("add_media_pointer", l);
    ...
    return a && c.setItems(a), browser.msie && (removeEvent(e, "MSPointerDown"), addEvent(e, "MSPointerDown", c.show.pbind(!0)), addEvent(l, "MSPointerDown", c.show.pbind(!0))),
        removeEvent(e, "mouseover"), addEvent(e, "mouseover click", c.show), addEvent(e, "mouseout", c.hide), addEvent(l, "mouseover", c.show), addEvent(l, "mouseout", c.hide),
        addEvent(l, "click", cancelEvent), addEvent(geByClass1("add_media_header", l), "click", function(e) {
            c.show(!0), cancelEvent(e)
        }), t.global || cur.destroy.push(function() {
            cleanElems(l), re(l), removeEvent(e, "click", c.show), browser.msie && (clearTimeout(c.toucht), removeEvent(bodyNode, "MSPointerDown", c.iecheckhide))
        }), c
}
...
function initAddMedia(e, a, t, o) {
    ...
    o = o || {}, each(t || [], function(e, a) {
        if (a[1]) {
            ...
            var c = "app" == a[0],
                p = c ? a[4] : !1,
                u = c ? "5px 5px" : "3px " + l[a[0]] + "px",
                _ = c ? "/app" + a[2] + "?to_id=" + r : !1;
            a[1].replace(/\s/g, "&nbsp;");
            s.push([a[0], a[1], u, t, _, p])
        }
    });
    var r = o.limit || 10,
        n = r > 1,
    ...
    if (p) {
        ...
        return i = {
            ...
            chooseMedia: function(a, t, s, l, u, h) {
                if (i.onChange && i.onChange(a, t, s, l) === !1) return !1;
                if ("note" == a && (cur.pbNoteAdded = !1), inArray(a, o.disabledTypes || [])) return !1;
                if (i.attachCount() >= r && void 0 === s.upload_ind && "postpone" !== a || geByClass1("medadd_c_market", w)) {
                    if (n) return !1;
                    i.unchooseMedia()
                }
                var k = !1,
                ...
                switch (a) {
                    case "graffiti":
                        isObject(s) || (s = {
                            thumb: s || ""
                        }), S = '<div class="fl_l page_preview_graffiti"><img class="page_preview_graffiti" src="' + s.thumb + '" /></div>', L = T = b;
                        break;
                    case "photos_list":
                        hide(this._addMediaLink), vkImage()
                            .src = s[1];
                        var E = s[3].replace(/^{|}$/g, "");
                        E && (E += ","), E += "queue:1", x = o.nocl ? "" : " onclick=\"return showPhoto('" + s[4] + "', '" + s[2] + "', " + E.replace(/"/g, "&quot;") +
                            ');"', S = "<div" + x + ' class="fl_l page_preview_photo"><img class="page_preview_photo" src="' + s[1] + '" /></div>', L = T = g;
                        break;
                    case "photo":
                        isObject(s) || (s = {
                                thumb_m: s[0] || "",
                            ...
                            .src = s.thumb_m;
                        var E = s.view_opts.replace(/^{|}$/g, "");
                        if (E && (E += ","), E += "queue:1", i.phLists[t] = s.list, d) {
                            if (!s.editable) return !1;
                            o.nocl || (s.editable.click = i.showPhoto.pbind(t, s.list, parseJSON("{" + E + "}")))
                        }
                        x = o.nocl ? "" : ' onclick="return cur.addMedia[' + i.lnkId + "].showPhoto('" + t + "', '" + s.list + "', {" + E.replace(/"/g, "&quot;") + '});"',
                            S = "<div " + x + ' class="fl_l page_preview_photo' + (h ? " page_preview_ph_graff" : "") + '"><img class="page_preview_photo" src="' + s.thumb_m +
                            '" /></div>', T = 1, L = g;
                        break;
                    case "video":
                        if (isObject(s) || (s = {
                            ...
                            if (!s.editable) return !1;
                            o.nocl || (s.editable.click = showVideo.pbind(t, !1, {
                                queue: 1
                            }))
                        }
                        x = o.nocl ? "" : " onclick=\"return showVideo('" + t + "', false, {queue:1});\"", S = "<div" + x +
                            ' class="fl_l page_preview_video"><img class="page_preview_video" src="' + s.thumb + '" /></div>', T = 1, L = g;
                        break;
                    case "audio":
                        if (!s.info) return !1;
                        S = Page.addAudioPreview(t, s), M = ' id="pam' + _ + "_audio" + t + '"';
                        break;
                    case "app":
                        S = '<div class="app fl_l"><img src="' + s[0] + '" /><span>' + s[1] + "</span></div>", each(geByClass("add_media_type_" + _ + "_app", p.menuNode,
                            "a"), function() {
                            hide(this)
                        });
                        break;
                    case "doc":
                        if (!s.lang) return !1;
                        s.thumb && s.thumb_s ? (S = '<a onclick="if (cur.cancelClick) return (cur.cancelClick = false);" target="_blank" href="' + s.href +
                            '" class="fl_l pam_dpic"><div class="page_preview_doc_photo"><img src="' + s.thumb_s +
                            '" align="center"></div><div class="page_preview_doc_photo_hint">' + s.title + "</div>", P = '</a><div class="pam_bg"></div>', L = T = m, M =
                            ' id="pam' + _ + "_doc" + t + '"') : (S = '<a target="_blank" href="' + s.href + '" class="medadd_h medadd_h_doc inl_bl">' + s.lang.profile_choose_doc +
                            "</a>", P = '<div class="medadd_c medadd_c_doc"><a target="_blank" href="' + s.href + '" title="' + s.title + '">' + s.title + "</a></div>",
                            M = ' id="pam' + _ + "_doc" + t + '"');
                        break;
                    case "share":
                        if (C.share || C.page || !s.lang) return !1;
                        if (isArray(s) && (s = {
                                domain: s[0],
                                url: s[1],
                                initialPattern: s[2],
                                ...
                                user_id: s[6],
                                photo_id: s[7]
                            }), s.media = s.media || t, s.draft) return i.checkURL(s.url), !1;
                        S = '<a target="_blank" href="/away.php?to=' + encodeURIComponent(s.url) + '" class="medadd_h medadd_h_link inl_bl">' + s.lang.profile_choose_link +
                            "</a>", i.shareData = extend(i.shareData || {}, s, {
                                imagesStyles: [""]
                            }), L = v;
                        break;
                    case "poll":
                        if (!s.lang) return !1;
                        S = '<div class="medadd_h medadd_h_poll inl_bl">' + s.lang.q + "</div>", hide(geByClass1("add_media_type_" + _ + "_poll", p.menuNode, "a")), L = f;
                        break;
                    case "map":
                        S = "<div class=\"fl_l\"><a onclick=\"return showBox('al_places.php', {act: 'geo_box', lat: " + s[0] + ", long: " + s[1] + ", provider: " + intval(
                            s[3]) + '}, {dark: 1});"><div class="page_media_map_point"></div><img class="page_preview_map" width="174" height="70" src="/maps?lat=' + s[
                            0] + "&lng=" + s[1] + "&z=11&" + (window.devicePixelRatio >= 2, "w=360&h=140") + '" /></a></div>', L = T = b, hide(geByClass1(
                            "add_media_type_" + _ + "_map", ge("add_media_menu_" + _)));
                        break;
                    case "page":
                        if (C.share || C.page || !s.lang) return !1;
                        var N = s.media.split("_");
                        S = '<a href="/page' + s.media + '" onclick="return showWiki({oid: ' + N[0] + ", id: " + N[1] +
                            '}, false, event, {queue: 1})" class="medadd_h medadd_h_page inl_bl">' + s.lang.profile_choose_page + "</a>", L = v;
                        break;
                    case "note":
                        if (!s.lang) return !1;
                        S = "<a onclick=\"showWiki({w: 'note" + s.raw + '\', edit: 1}, true, event, {queue: 1})" class="medadd_h medadd_h_note inl_bl">' + s.lang.profile_choose_note +
                            "</a>", P = '<div class="medadd_c medadd_c_note"><a onclick="showWiki({w: \'note' + s.raw +
                            '\', edit: 1}, true, event, {queue: 1})" id="share_note_title' + s.raw + '">' + s.title + "</a></div>", L = v;
                        break;
                    case "market":
                        S = '<div class="medadd_c_market fl_l"><a target="_blank" href="' + s.href + '"><img class="medadd_c_market_thumb fl_l" src="' + s.thumb +
                    ...
                    case "market_album":
                        ...
                        var N = t.split("_");
                        vkImage()
                            .src = s.thumb, x = o.nocl ? "" : ' href="/market' + N[0] + "?section=album_" + N[1] + '"';
                        var W = "fl_l page_preview_album wall_album_cover_wrap wall_market_album_cover" + (s.thumb ? "" : " page_album_nocover");
                        S = '<a class="' + W + '" ' + x + ">" + (s.thumb ? '<img class="wall_album_cover" src="' + s.thumb + '"/>' : "") +
                            '  <div class="wall_album_caption">    <div class="wall_album_title_wrap clear_fix">      <div class="wall_album_count fl_r">' + s.count +
                            '</div>      <div class="wall_album_title">' + s.title + "</div>    </div>  </div></a>", T = 1, L = g;
                        break;
                    case "postpone":
                        if (S = '<div class="medadd_h medadd_h_timer inl_bl">' + s.lang.profile_choose_timer + '<span id="postpone_preview' + _ + '"></span></div>', cur.editingPost &&
                            !n) t = intval(t), t ? s.date = t : s.date = intval(cur.editingPost[7]), ge("wpe_save")
                            .innerHTML = getLang("global_save");
                        else if (cur.editingPost && "wpe_media_preview" == domPN(y)
                            .id) {
                            t = intval(t), t ? s.date = t : s.date = intval(cur.editingPost[7]);
                            ...
                            s.draft ? s.date = intval(t) : cur.postponedLastDate && (s.date = intval(cur.postponedLastDate) + 3600);
                            var j = ge("official");
                            j && (isChecked(j) || (checkbox(j), toggle("signed", !0)), addClass(j, "disabled"));
                            var I = ge("send_post");
                            I && (I.innerHTML = s.lang.profile_wall_postpone_btn)
                        }
                ...
                if (n) {
                    ...
                    addClass(U, T ? "fl_l" : "clear_fix"), void 0 !== s.upload_ind && re("upload" + s.upload_ind + "_progress_wrap"), o.toggleLnk && toggle(e, i.attachCount() +
                        ...
                        o.toggleLnk && toggle(e, i.attachCount() + 1 < r), s.editable.remove = i.unchooseMedia.pbind(R), show(domPN(L));
                        var l = ThumbsEdit.convert(a, t, s.editable);
                        domFC(L) ? ThumbsEdit.addMedia(L, l) : o.teWidth && o.teHeight ? ThumbsEdit.init(L, [l], {
                            width: o.teWidth,
                            height: o.teHeight,
                    ...
                    var R = "postpone" === a ? 1 : 0,
                        U = se('<div class="' + (T === !1 ? "page_docs_preview" : "page_pics_preview") + '"><div class="page_preview_' + a + '_wrap"' + (o.nocl ?
                            ...
                            "</div></div>");
                    void 0 !== s.upload_ind && re("upload" + s.upload_ind + "_progress_wrap"), "postpone" !== a && (i.chosenMedia = [a, t], i.chosenMediaData = s), i.singleAdded(
                        U, a)
                }
                "share" == a ? s.title && !l ? (cur.shareShowImg = 0, i.showPreview(!0), i.shareData.images = !1) : i.showExternalPreview() : "page" == a ? s.nopreview ||
                    (cur.shareShowImg = 0, i.shareData = extend(i.shareData || {}, s, {
                        images: !1
                    }), i.showPreview()) : "poll" == a ? i.createPoll(s) : "postpone" == a && i.setupPostpone(s, B);
                var H = window.event;
                return H && "click" == H.type && (event.ctrlKey || event.metaKey || event.shiftKey) && (u = !0), cur.fileApiUploadStarted && void 0 !== s.upload_ind || cur
                    .preventBoxHide || u === !0 || inArray(a, ["poll", "share", "page", "postpone"]) || boxQueue.hideLast(), cur.lastPostMsg = !1, o.onMediaAdd && o.onMediaAdd(),
                    void 0 !== s.upload_ind && delete s.upload_ind, !1
            },
            unchooseMedia: function(a) {
                ...
                if (n) {
                    ...
                    var t, s = i.chosenMedias;
                    if (s[a]) {
                        switch (s[a][2] ? ((t = geByClass1("page_media_x_wrap", s[a][2], "div")) && t.tt && t.tt.el && t.tt.destroy(), domPN(s[a][2]) == w && w.sorter ? (
                            each(w.sorter.elems, function() {
                                ...
                                onReorder: o.onAddMediaChange
                            })) : domPN(s[a][2]) == m && m.qsorter ? (each(m.qsorter.elems, function() {
                            setStyle(domFC(this), {
                                top: "auto",
                                left: "auto"
                            }), setStyle(this, {
                        ...
                        }), m.qsorter.destroy(), re(s[a][2]), m.childNodes.length > 1 && qsorter.init(m, i.qsorterOpts())) : re(s[a][2])) : ("photo" == s[a][0] ||
                            "video" == s[a][0] || "album" == s[a][0]) && window.ThumbsEdit && ThumbsEdit.removeById("thumbs_edit" + _, s[a][0] + s[a][1]), s[a][0]) {
                            case "page":
                            case "share":
                            ...
                            case "market":
                                ...
                                break;
                            case "postpone":
                                var l = geByClass1("medadd_c_timersett", i.postponePreview);
                                cur.editingPost && l ? re(domFC(i.postponePreview)) : re(i.postponePreview), i.postponePreview = !1, removeClass("official", "disabled"),
            ...
            singleAdded: function(a, t) {
                ...
                var s = 0;
                each(geByClass("add_media_item", p.menuNode, "a"), function(e, a) {
                    "postpone" === t || hasClass(a, "add_media_type_" + _ + "_postpone") ? isVisible(a) && s++ : hide(a)
                }), o.toggleLnk && !s && hide(e)
            },
            getMedias: function() {
                if (n) {
            ...
            showMediaProgress: function(a, t, s) {
                if (i.onProgress && i.onProgress(a, t, s) === !1) return !1;
                var l = s.loaded / s.total,
                    d = intval(100 * l),
                    c = (s.fileName || s.name || "")
                    .replace(/[&<>"']/g, ""),
                    p = c ? t + "_" + c : t,
                ...
                if (g)
                    ...
                    g = ge("upload" + p + "_progress"), g.full = !1, d ? setStyle(g, {
                        width: g.full ? intval(g.full * l) + "px" : d + "%"
                    }) : (setStyle(g, {
                        width: "1px"
                    }), hide(g))
                }
            ...
            createPoll: function(e) {
                ...
                for (var s = 0, l = e.answers.length; l > s; ++s) a = e.answers[s], o.push('<div class="medadd_c_polla_wr">' + rs(cur.pollAnswerTemplate, {
                    attrs: (a[0] ? 'id="create_poll_ans' + a[0] + '" ' : "") + (a[1] ? '" value="' + a[1] + '" ' : ""),
                    lnkid: _
                }) + "</div>"), 9 == s && hide("create_poll_add" + _);
            ...
            keyPoll: function(e, a) {
                if (a = a || window.event, a && (10 == a.keyCode || 13 == a.keyCode || 9 == a.keyCode)) {
                    var t = hasClass(e, "medadd_c_pollq"),
                        o = a.shiftKey;
                    if (o && t) return;
                    var s = t ? domFC(domNS(domNS(e))) : (o ? domPS : domNS)(domPN(e));
            ...
            pollData: function(e) {
                for (var a, t = ge("create_poll_answers" + _), o = trim(val("create_poll_question" + _)), i = {
                    ...
                    }, s = 0, l = !1, r = domFC(t); r; r = domNS(r))
                    if (a = trim(val(domFC(r)))) {
                        var n = -intval((domFC(r)
                            .id.match(/^create_poll_ans(\d+)$/) || [0, -s++])[1]);
                        i["answers[" + n + "]"] = a, l = !0
                    }
                return o ? l ? i : (domFC(t) || cur.addMedia[_].incPoll(), e !== !0 && (notaBene(domFC(domFC(t))), elfocus(domFC(domFC(t)))), !1) : (e !== !0 && (notaBene(
                ...
                if (!(i.chosenMedia || i.urlAttachmentLoading && i.urlAttachmentLoading[0] > vkNow() - 1e4 || i.attachCount() >= r)) {
                    if (cur.reply_to && cur.reply_to[0]) {
                        ...
                        if (t && isArray(t) && t[1] && (t = t[1]), t) {
                            ...
                            for (var s in o) {
                                var l = o[s].url;
                                l.match(/^https?:\/\//) || (l = "http://" + l), inArray(l, i.urlsCancelled) || i.urlsCancelled.push(l)
                            }
                        }
                    }
                    ...
                    for (var s in n) {
                        var d = n[s],
                            ...
                            p = d.domain,
                            u = l;
                        if (l.match(/^https?:\/\//) || (l = "http://" + l), !inArray(l, i.urlsCancelled) && !inArray(u, i.urlsCancelled)) {
                            var _ = !0;
            ...
            showPreview: function(e) {
                var t, o, s = i.shareData,
                    l = i.sharePreview || i.addPreview();
                if (s.images && (t = s.images[cur.shareShowImg], o = i.bigLink || s.big_link || t && isArray(t) && t[0] ? "medadd_c_linkimg_big" : ""), s.failed) var r =
                    ...
                    if (s.images && s.images[cur.shareShowImg] && c) {
                        var p = s.images[cur.shareShowImg],
                            u = o ? 'style="width: 100%"' : s.imagesStyles && s.imagesStyles[cur.shareShowImg] || "";
                        if (d = '<img class="medadd_c_linkimg" src="' + c + '" ' + n + " " + u + " />", d += o ? Page.buildMediaLinkEl(s.domain) : "", s.images.length > 0) {
                            var _ = (s.images.length > 1 ? '<div class="medadd_c_linkimg_scroll_wrap medadd_c_linkimg_scroll_wrap_left ' + (0 == cur.shareShowImg ?
                                    "medadd_c_linkimg_scroll_wrap_left_first" : "") + '" onclick="' + (0 == cur.shareShowImg ? "Page.ownerPhoto('" + s.media + "');" :
                                    "cur.shareShowNext(true);") + '"><div class="medadd_c_linkimg_scroll"></div></div>' : "", ""),
                                h = "";
                            cur.shareShowImg < s.images.length - 1 ? _ =
                                ...
                                cur.shareShowImg == s.images.length - 1 && isArray(p) && p[0] && (_ = "");
                            var g = isArray(s.images[s.images.length - 1]) && !!s.images[s.images.length - 1][0],
                                m = s.uniqueImagesCount + intval(g),
                                ...
                                " onclick=\"Page.ownerPhoto('" + s.media +
                    ...
                    var k = "";
                    s.microdata && s.microdata_preview_html && (k = s.microdata_preview_html);
                    var C = s.description_short || s.description,
                        r = d + (s.title ? '<h4 class="medadd_c_linkhead">' + s.title + "</h4>" : "") + (!o && s.domain ? '<div class="page_media_link_addr">' + s.domain +
                            "</div>" : "") + (k ? '<div class="medadd_c_linkmicrodata">' + k + "</div>" : "") + (C ? '<div class="medadd_c_linkdsc">' + C + "</div>" : "") +
                        '<div class="clear"></div>'
                }
                if (e) cur.preventShareAnim && cur.preventShareAnim.stop(), val(domFC(l), r), domFC(l)
                    ...
                    var x = ge(a)
                        .appendChild(ce("div", {
                            ...
                            position: "absolute",
                            width: getSize(l)[0] - 10,
                            visibility: "hidden"
                        })),
                        S = getSize(x)[1];
                    re(x), val(domFC(l), r), shortCurrency(), cur.preventShareAnim = animate(domFC(l), {
                        height: S
            ...
            showExternalPreview: function() {
                ...
                if (each(e.images, function(i, s) {
                        o[s] || (o[s] = !0, a.push(s), e.images_proxy && t.push(e.images_proxy[i]))
                ...
                cur.shareSetOwnPhoto = function(a) {
                    ...
                    if (!e.images.length || isEmpty(e.images) || void 0 === e.images[cur.shareShowImg]) return i.showPreview(s), void(s = !0);
                    var c = i.shareImgUrl(cur.shareShowImg);
                    c && (l.src = c), isArray(e.images[cur.shareShowImg]) && e.images[cur.shareShowImg][1] && e.images[cur.shareShowImg][2] ? (e.user_id = e.images[cur
                    ...
                    var u = setTimeout(function() {
                        ...
                        _ = function() {
                            if (l.width || l.height || !c) {
                                ...
                                e.images.length > 1 && (r = ""), e.imagesStyles[cur.shareShowImg] = 'style="' + o + '"' + r, i.showPreview(s), s = !0
                            }
                        };
            ...
            setupPostpone: function(e, a) {
                ...
                var s = cur.editingPost && "wpe_media_preview" == domPN(t)
                    .id,
                    l = s || !n ? "" : "1px",
                    r = !1,
                ...
                cur.editingPost && void 0 != e.friends_only ? (d += '<div class="medadd_c_timersett">', void 0 != e.status_export && (d +=
                    ...
                    a && (d += a, r = !0), i.postponePreview = t.appendChild(ce("div", {
                        ...
                        innerHTML: d
                    })), i.postponePreview.style.height = l, stManager.add(["ui_controls.css", "ui_controls.js", "datepicker.css", "datepicker.js"], function() {
...
var Page = {
        ...
        inviteToGroup: function(e, a, t, o, i) {
            var s = domPN(e),
                ...
                r = function(e) {
                    var o = e ? 1 : 0,
                        l = e ? getLang("friends_cancel_event_invite") : getLang("friends_send_event_invite");
                    s.innerHTML = '<a onclick="return page.inviteToGroup(this, ' + a + ", " + t + ", " + o + ", '" + i + "')\">" + l + "</a>"
                };
            return o ? (ajax.post("/al_page.php", {
                ...
                onDone: function(e, a) {
                    if (!e) {
                        r(0), hide(s);
                        var t = geByClass1("error", l),
                            o = se('<div class="page_members_box_error error"><div class="msg_text">' + a + "</div></div>");
                        t ? l.replaceChild(o, t) : l.insertBefore(o, l.firstChild)
                    }
                }
            }), r(1)), !1
        },
        toggleSubscription: function(e, a, t, o) {
            void 0 != cur.toggleSubscriptionAct && (t = cur.toggleSubscriptionAct), ajax.post("al_wall.php", {
                ...
                onDone: function(a) {
                    val(e, a), cur.toggleSubscriptionAct = !t
                },
                showProgress: Page.actionsDropdownLock.pbind(e),
                hideProgress: Page.actionsDropdownUnlock.pbind(e)
            }), cancelEvent(o)
        },
        ...
        moreAudioListeners: function(e) {
            ...
            ajax.post("/al_audio.php", {
                ...
                onDone: function(e, o) {
                    for (var i = ce("div", {
                            innerHTML: e
                        }), s = domFC(i); s; s = domFC(i)) a.appendChild(s);
                    if (o) {
                        var l = ge("listeners_more_link_trigger");
                        show(l)
        ...
        postsSeen: function(e) {
            ...
            if (vk.id && e.length && !vk.pd) {
                ...
                for (a in e) {
                    ...
                    for (t in e[a]) "module" != t && "index" != t && "q" != t && (_postsSeenModules[t] = r, i = e[a][t], s = _postsSeen[t], l = _postsSaved[t], -1 == l || -1 ==
                        s || 1 == i && (l || s) || (o = _postsSeen[t] = i, _postsExtras[t] = {
                            start: d,
                            diff: -1,
                            index: index,
                            q: n
        ...
        postsSave: function() {
            ...
            var e, a, t, o, i, s = ls.get("posts_sent") || {},
                l = ls.get("posts_seen") || {},
            ...
            for (a in _postsSeen) i = _postsSeen[a], _postsExtras[a] && (n[a] = {
                ...
                }, delete _postsExtras[a]), t = a.split("_"), "ad" !== t[0] && "posthashtag" !== t[0] && (t[0] = intval(t[0]), t[1] = intval(t[1])), o = (s[t[0]] || {})[t[1]],
                t[0] != vk.id && (!o || -1 == i && o > 0) && (l[t[0]] || (l[t[0]] = {}, delete r[a]), (!l[t[0]][t[1]] || -1 == i && l[t[0]][t[1]] > 0) && (e = l[t[0]][t[1]] =
                    d * i, r[a] = _postsSeenModules[a])), _postsSaved[a] = i;
            _postsSeen = {}, _postsSeenModules = {}, e && (ls.set("posts_seen", l), ls.set("posts_seen_modules", r), ls.set("posts_extras", n))
        },
        ...
        postsSend: function() {
            var e, a, t, o, i = {},
                ...
                l = {},
                r = [];
            if (ls.checkVersion()) i = ls.get("posts_seen"), s = ls.get("posts_seen_modules") || {}, l = ls.get("posts_extras") || {};
            else {
                t = Page.postsSave();
            ...
            return r.length ? vk.id ? void ajax.post("al_page.php", {
                ...
                onDone: function() {
                    ...
                    var e, a, t = ls.get("posts_seen") || {},
                        o = ls.get("posts_sent") || {},
                        s = ls.get("posts_seen_modules");
                    for (e in i) {
                        for (a in i[e]) o[e] || (o[e] = {}), -1 != o[e][a] && (o[e][a] = i[e][a]), (t[e] || {})[a] && (delete t[e][a], delete s[e + "_" + a]);
                        t[e] && isEmpty(t[e]) && (delete t[e], delete s[e + "_" + a])
                    }
                    ls.set("posts_seen", t), ls.set("posts_sent", o), ls.set("posts_seen_modules", s), clearTimeout(_postsCleanTimer), _postsCleanTimer =
        ...
        postsClean: function() {
            ...
            var e, a, t, o = Math.floor((vk.ts + Math.floor((vkNow() - vk.started) / 1e3)) / 3600),
                ...
                s = 0;
            for (e in i) {
                for (a in i[e]) t = i[e][a], o - (t > 0 ? t : -t) > 24 && (delete i[e][a], s = 1);
                isEmpty(i[e]) && (delete i[e], s = 1)
            }
            ls.set("posts_sent", i)
        },
        postsClear: function() {
        ...
        reorderContacts: function(e, a, t, o, i) {
            var s = t.id.replace("group_contact_cell", ""),
                l = (o && o.id || "")
        ...
        infoEdit: function(e) {
            ...
            if (Page.initStatusEditable(o, cur.infoOld), cur.infoEditing = "my_current_info" == t.className, cur.infoEditing) {
                var s = i ? i.innerHTML : t.innerHTML;
                s = s.replace(/<img[^>]+alt="([^"]+)"[^>]*>/g, "$1"), cur.infoOld = trim(clean(stripHTML(s)))
            } else cur.infoOld = "";
        ...
        showGif: function(e, a, t) {
            ...
            var o, i = e.getAttribute("data-doc"),
                s = e.getAttribute("data-hash"),
                l = e.getAttribute("data-add-txt") || "",
            ...
            var k = '<div class="page_gif_share" onmouseover="showTooltip(this, {text: \'' + n +
                "', black: 1, shift: [7, 6, 6], toup: 0, needLeft: 1})\" onclick=\"return Page.shareGif(this, '" + i + "', '" + s +
                '\', event)"><div class="page_gif_share_icon"></div></div>';
            r && (k += '<div class="page_gif_add" onmouseover="return Page.overGifAdd(this, \'' + l + "', '" + i + "', event);\" onclick=\"return Page.addGif(this, '" + i +
                "', '" + s + "', '" + r + '\', event);"><div class="page_gif_add_icon"></div></div>'), k = '<div class="page_gif_actions">' + k + "</div>";
        ...
        addGif: function(e, a, t, o, i) {
            ...
            var s = gpeByClass("page_gif_large", e) || domPN(e);
            return cur.gifAdded[a] ? ajax.post("docs.php", {
                ...
                onDone: function() {
                    removeClass(s, "page_gif_added"), e.tt && e.tt.el && e.tt.destroy(), delete cur.gifAdded[a]
                }
                ...
                onDone: function(t, o, i, l) {
                    showDoneBox(t), addClass(s, "page_gif_added"), e.tt && e.tt.el && e.tt.destroy(), cur.gifAdded[a] = {
                        tooltip: o,
                        did: i[0],
                        hash: l
                    }
        ...
        actionsDropdownLocked: function(e) {
            return (e = ge(e)) ? hasClass(e, "page_actions_item_lock") : void 0
        },
        actionsDropdownLock: function(e) {
            if ((e = ge(e)) && hasClass(e, "page_actions_item") && !hasClass(e, "page_actions_item_lock")) {
                data(e, "inner", e.innerHTML), addClass(e, "page_actions_item_lock");
                var a = ce("div", {
                    className: "page_actions_item_lock_text"
                });
                val(a, e.innerHTML), e.appendChild(a), showProgress(e)
            }
        },
        actionsDropdownUnlock: function(e) {
            (e = ge(e)) && hasClass(e, "page_actions_item") && hasClass(e, "page_actions_item_lock") && (removeClass(e, "page_actions_item_lock"), e.innerHTML = data(e,
                "inner"))
        },
    ...
    Wall = {
        ...
        suggestMore: function() {
            ...
            buttonLocked(a) || ajax.post("al_wall.php", {
                ...
                onDone: function(t, o) {
                    for (var i = ce("div", {
                            innerHTML: t
                        }), s = domFC(i); s;) ge(s.id) || !hasClass(s, "post") ? re(s) : e.appendChild(s), s = domFC(i);
                    toggle(a, o)
                },
        ...
        showSearch: function(e, a) {
            ...
            return ajax.post("al_wall.php", {
                ...
                onDone: function(i, s, l) {
                    if (t === cur.oid && "search" == cur.wallTab) {
                        var r = ge("page_search_posts");
                        a || val(r, ""), r.appendChild(cf(i)), wall.switchTabContent("search"), toggle(o, l > s), o.onclick = Wall.showSearch.pbind(e, s)
                    }
                },
                showProgress: function() {
            ...
            for (el = i ? t.firstChild : t.lastChild; el; el = re(i ? t.firstChild : t.lastChild))
                if ("input" != el.tagName.toLowerCase()) {
                    if (!hasClass(el, "post_fixed")) {
                        for (; s && s.tagName && "div" == s.tagName.toLowerCase() && !hasClass(s, "post_fixed") && Wall.cmp(s.id, el.id) < 0;) s = i ? s.nextSibling : s.previousSibling;
                        ++l, s ? Wall.cmp(s.id, el.id) ? i ? o.insertBefore(el, s) : o.insertBefore(el, s.nextSibling) : (o.replaceChild(el, s), s = el, --l) : i ? o.appendChild(
                ...
                }("full_own" == cur.wallType || "full_all" == cur.wallType) && (Pagination.recache(l), FullWall.updateSummary(cur.pgCount)), Wall.update(), extend(cur.options.reply_names,
        ...
        checkTextLen: function(e, a, t) {
            ...
            if (e.lastLen !== o.length || t) {
                var i = e.lastLen = o.length,
                    ...
                    l = i - o.replace(/\n/g, "")
                    .length;
                a = ge(a), i > s - 100 || l > 4 ? (show(a), i > s ? a.innerHTML = getLang("global_recommended_exceeded", i - s) : l > 4 ? a.innerHTML = getLang(
                    "global_recommended_lines", l - 4) : a.innerHTML = getLang("text_N_symbols_remain", s - i)) : hide(a)
            }
        },
        checkPostLen: function(e, a, t, o) {
            ...
            if (t = trim(t)
                ...
                var s = i.lastLen = t.length,
                    l = cur.options.max_post_len,
                    r = s - t.replace(/\n/g, "")
                    .length,
                    n = ge(a);
                s > l - 100 || r > 4 ? (s > l ? n.innerHTML = getLang("global_recommended_exceeded", s - l) : r > 4 ? n.innerHTML = getLang("global_recommended_lines", r - 4) :
                    n.innerHTML = getLang("text_N_symbols_remain", l - s), show(n)) : hide(n)
            }
        },
                            ...
                            if (t) {
                                ...
                                switch (s) {
                                    case "poll":
                                        var r = e.pollData(!0);
                                        if (!r) return i = !0, !1;
                                        l = r.media, delete r.media, params = extend(params, r);
                                        break;
                                    case "share":
                                        ...
                                        l = o.user_id && o.photo_id ? o.user_id + "_" + o.photo_id : "", o.initialPattern && trim(msg) == o.initialPattern && (params.message =
                                ...
                                this[3] && trim(msg) == this[3] && (params.message = ""), params["attach" + (attachI + 1) + "_type"] = s, params["attach" + (attachI + 1)] =
                                    l, attachI++
                            }
                        }), i) return
                }
        ...
        sendPost: function() {
            ...
            var i = cur.options.suggesting ? "suggest" : cur.wallType,
                ...
                l = (cur.postTo == vk.id || s.official || cur.options.only_official, 0);
                        ...
                        if (t) {
                            ...
                            switch (i) {
                                case "poll":
                                    var d = e.pollData();
                                    if (!d) return r = !0, !1;
                                    n = d.media, delete d.media, s = extend(s, d);
                                    break;
                                case "share":
                                    if (o.failed || !o.url || !o.title && (!o.images || !o.images.length) && !o.photo_url) return cur.shareLastParseSubmitted && vkNow() -
                                    ...
                                    o.initialPattern && trim(msg) == o.initialPattern && (s.message = ""), s = extend(s, {
                                        url: o.url,
                                        title: replaceEntities(o.title),
                                        description: replaceEntities(o.description),
                                        extra: o.extra,
                                    ...
                                    break;
                                case "page":
                                    o.initialPattern && trim(msg) == o.initialPattern && (s.message = "");
                                    break;
                                case "postpone":
                            ...
                            this[3] && trim(msg) == this[3] && (s.message = ""), s["attach" + (l + 1) + "_type"] = i, s["attach" + (l + 1)] = n, l++
                        }
                    }), r) return
            }
            if (!l && !msg) return void elfocus("post_field");
            var n = ge("send_post");
        ...
        _repliesLoaded: function(e, a, t, o, i) {
            ...
            if (s) {
                ...
                if (a) {
                    ...
                    s.innerHTML = t, scrollToY(scrollGetY() + (s.offsetHeight - n), 0, void 0, !0), setTimeout(Wall.scrollHighlightReply.pbind("post" + a), 0)
                } else s.innerHTML = t;
                if (debugLog("render in", vkNow() - r), l && "replies_open" == l.className && re(l), ajax._framenext(), e == cur.wallLayer) {
                    var d = wkcur.reverse;
                    extend(wkcur, {
                        offset: !d && i.offset || 0,
                        loaded: i.num || geByClass("reply", s, "div")
                            .length,
                        count: i.count
        ...
        repliesSideUpdate: function(e) {
            ...
            if (a) {
                ...
                void 0 === e && (e = scrollGetY()), e < a[2] ? t = {
                    marginTop: 0,
                    opacity: 1
                } : e < a[3] ? (l += " replies_side_fixed", t = {
                    opacity: Math.max(0, Math.min(1, (a[3] - e) / 200))
                }) : (l += " replies_side_hidden", t = {
                    marginTop: a[3] - a[2],
                    opacity: 0
                }), JSON.stringify(i) !== JSON.stringify(t) && (each(i, function(e, a) {
                    i[e] = null
                }), setStyle(o, extend(i, t)), a[4] = t), s != l && (o.className = l, a[5] = l)
            }
        },
        ...
        showReplies: function(e, a, t, o) {
            ...
            if (cur.wallLayer != e || !wkcur.reverse) {
                ...
                if (t || a && !(a > 20) || (extend(i, {
                    ...
                    }), ajax.post("al_wall.php", i, s), !browser.msie && a > 0 && 10 > a) {
                    for (var l = ge("replies" + e), r = l && l.lastChild, n = []; n.length < a && r;) "DIV" == r.tagName && hasClass(r, "reply") && n.push(r), r = r.previousSibling;
                    if (n.length == a) {
                        var d = geByClass("reply", l, "div")
                            .length;
                        for (val(l, '<a class="wr_header wrh_all"></a>'), Wall.updateRepliesHeader(e, l.firstChild, a, d), hide("replies_side" + e); n.length;) l.appendChild(n
                            .pop());
                        lockButton("wrh" + e)
                    }
                }
        ...
        moreReplies: function(e, a, t, o) {
            ...
            return extend(i, {
                ...
                onDone: function(a, t, i) {
                    var s = ge("replies" + e);
                    o.clear ? s.innerHTML = a : o.rev || o.append ? s.appendChild(cf(a)) : s.innerHTML = a + s.innerHTML, extend((e == cur.wallLayer ? wkcur : cur)
        ...
        initReplyEditable: function(e, a, t, o) {
            return e.emojiInited ? !1 : (e.emojiInited = !0, void stManager.add(["emoji.js", "notifier.css"], function() {
                ...
                if (Wall.emojiOpts[t] = i, cur.afterEmojiInit && cur.afterEmojiInit[t]) {
                    var s = geByClass1("emoji_smile", Emoji.opts[i].controlsCont);
                    isVisible(s) && (cur.afterEmojiInit[t](), delete cur.afterEmojiInit[t])
                }
            }))
        },
        showEditReply: function(e, a, t) {
            ...
            var o = ge("reply_field" + e),
                ...
                s = ge("reply_fakebox" + e),
                l = ge("reply_box" + e);
            if (!i && s ? i = gpeByClass("_post_wrap", s) : !i && l && (i = gpeByClass("_post_wrap", l)), s) {
                var r = ge("post_hash" + e),
                    n = intval(r && r.getAttribute("can_reply_as_group")) > 0,
                    d = s.getAttribute("data-owner-photo") || (geByClass1("post_img", i) || {})
                    .src || "";
                l = se(rs(cur.wallTpl.reply_form, {
                    ...
                    post_id: e,
                    owner_photo: d
                })), s.parentNode.replaceChild(l, s), o = ge("reply_field" + e)
            }
            if (Wall.initReplyEditable(o, l, e, t), cur.editing === e) return Emoji.editableFocus(o, !1, !0), cancelEvent(a);
        ...
        replyTo: function(e, a, t, o) {
            ...
            var s = i.reply_to && Wall.getReplyName(i.reply_to[0]);
            i.reply_to = [t, a];
            var l = Wall.getReplyName(t),
            ...
            if (val("reply_to_title" + e, m), isArray(l) && window.Emoji) {
                var w = ge("reply_field" + e),
                    f = trim(Emoji.val(w));
                f = f.replace(/&nbsp;/g, " "), !f || s && isArray(s) && !winToUtf(s[1])
                    .indexOf(f) ? Emoji.val(w, l[1]) : h && (f = f.replace(h, l[1]), Emoji.val(w, f)), Emoji.focus(w, !0)
            }
        ...
        cancelReplyTo: function(e, a) {
            var t = window.cur.wallLayer == e ? wkcur : window.cur,
                ...
                s = trim(window.Emoji ? Emoji.editableVal(o) : ""),
                l = Wall.replyNamesRE();
            return isArray(i) && window.Emoji && (s && i[1].indexOf(s) ? l && (s = s.replace(l, ""), Emoji.val(o, s)) : (s = "", Emoji.val(o, s)), Emoji.focus(o, !0)), val(
        ...
        replySubmitTooltip: function(e, a, t) {
            var o = e && window.cur.wallLayer == e ? wkcur : window.cur,
                i = e && ge("reply_box" + e),
                s = i && geByClass1("button_blue", i, "div"),
                l = o.replySubmitSettings;
            if (!(t && s && isVisible(s) || (t = t || s, hasClass(t, "flat_button") && buttonLocked(t)))) {
                if (l || (l = o.replySubmitSettings = ce("div", {
                        className: "reply_submit_hint_tt_point"
                    })), !a) return void(l && l.tt && l.tt.hide && l.tt.hide());
                if (l.parentNode == t && l.tt && l.tt.show) return void l.tt.show();
                l.tt && l.tt.el && l.tt.destroy(), t.insertBefore(l, t.firstChild);
        ...
        sendReply: function(e, a, t) {
            ...
            var o, i = window.cur.wallLayer == e,
                s = i ? wkcur : window.cur,
                l = ge("reply_field" + e),
                r = l && data(l, "composer"),
                n = s.reply_to && Wall.getReplyName(s.reply_to[0]),
                d = l && data(l, "send");
            ...
            if (extend(c, {
                    ...
                    from: i && "wkview" || "",
                    hash: p
                }), s.reverse && (c.rev = 1), u && isVisible(u.parentNode) && (c.from_group = isChecked(u)), browser.mobile ? Wall.hideEditReply(e) : (Emoji.editableFocus(l, !
                    1, !0), Wall.cancelReplyTo(e, a)), ajax.post("al_wall.php", Wall.fixPostParams(c), {
                    onDone: function(a, t, o, i) {
                        return "full" == s.wallType ? FullWall.onReplySent.apply(window, arguments) : (s.wallMyReplied[e] = 0, re("reply_link" + e), hide("reply_warn" +
                            e), void Wall._repliesLoaded(e, !1, t, o, i))
                    },
                    onFail: function() {
                        _ && re(_), r ? o = Composer.restore(r, o) : val(l, c.message), l.autosize && l.autosize.update()
                    },
                    showProgress: lockButton.pbind(ge("reply_button" + e)),
                    hideProgress: unlockButton.pbind(ge("reply_button" + e))
                }), !c.from_group && c.message) {
                var h = ge("replies" + e),
                    g = - ++s.wallMyRepliesCnt,
                    m = Emoji.emojiToHTML(clean(c.message), !0),
                    w = c.reply_to_user < 0 ? getLang("wall_replied_to_group") : s.options.reply_names[c.reply_to_user] && s.options.reply_names[c.reply_to_user][0],
                    f = w ? rs(s.wallTpl.reply_link_to, {
                        to_user: w
                    }) : "";
                if (_ = se(rs(s.wallTpl.reply_fast, {
                        reply_id: "0_" + g,
                        message: m.replace(/\n/g, "<br/>"),
                        to_link: f,
                ...
                s.reverse ? h.insertBefore(_, h.firstChild) : h.appendChild(_), i && (WkView.wallUpdateReplies(), s.reverse || (wkLayerWrap.scrollTop = wkLayerWrap.scrollHeight,
        ...
        deletePost: function(e, a, t, o) {
            ...
            ajax.post("al_wall.php", {
                ...
                onDone: function(o, s, l) {
                    if (l) var r = showFastBox(o, l, getLang("global_delete"), function() {
                ...
                showProgress: function() {
                    lockButton("post_nopublish" + e), addClass(s, "post_actions_progress")
                },
                hideProgress: function() {
                    unlockButton("post_nopublish" + e), removeClass(s, "post_actions_progress")
                }
            });
            var l = ge("delete_post" + e);
            l && l.tt && l.tt.el && l.tt.destroy()
        },
        ...
        postClick: function(e, a, t) {
            var o = (e || "")
                .match(/^(-?\d+)_(wall)?(\d+)$/),
                i = ge("post" + e);
            if (t && t.skipCheck) var s = !0;
            else var s = Wall.checkPostClick(i, a);
            if (s) {
                if (s !== !0) {
                    var l = geByClass1("wall_post_more", s, "a");
                    if (l && isVisible(l)) return l.onclick(), void(o || removeClass(i, "wall_post_over"))
                }
        ...
        copyHistory: function(e, a, t, o) {
            ...
            var i = e.target || e.srcElement,
                ...
                r = /published_a_quote/;
            do
                if (!i || (l = i.className.match(r)) || i.onclick || i.onmousedown || inArray(i.tagName, ["A", "IMG"])) break;
            while (s-- && (i = i.parentNode));
            if (l) {
        ...
        likeUpdate: function(e, a, t, o, i, s) {
            o = intval(o);
            var l = a.match(/(-?\d+)(_?)(photo|video|note|topic|wall_reply|note_reply|photo_comment|video_comment|topic_comment|market_comment|)(\d+)/),
                r = (l[3] || "wall", l[1] + "_" + l[4]),
                n = e && gpeByClass("_post_content", e) || wall.domPost(r),
                d = domByClass(n, s ? "_share_wrap" : "_like_wrap"),
            ...
            if (c) {
                ...
                i && g && val(g, i), p && (p.likeInvalidated = !0), _ && (_.value = o), animateCount(c, o), toggleClass(d, s ? "my_share" : "my_like", t), toggleClass(d, s ?
        ...
        like: function(e, a) {
            if (vk.id && !cur.viewAsBox) {
                var t = wall.domPost(e),
                    ...
                    s = domByClass(o, "_count"),
                    l = hasClass(i, "fw_like_icon") ? hasClass(i, "fw_my_like") : hasClass(o, "my_like"),
                ...
                var c = val(ge("like_real_count_wall" + e) || s);
                Wall.likeUpdate(!1, e, !l, intval(c) + (l ? -1 : 1)), cur.onWallLike && cur.onWallLike()
            }
        },
        likeShare: function(e, a) {
            if (vk.id && !cur.viewAsBox) {
                var t = e.match(/(-?\d+)(_?)(photo|video|note|topic|market|wall_reply|note_reply|photo_comment|video_comment|topic_comment|market_comment|)(\d+)/),
                    ...
                    i = ge("like_share_" + o),
                    s = isChecked(i),
                    l = cur.wallType ? "feed" == cur.wallType ? "feed_" + cur.section : "wall_" + (cur.onepost ? "one" : (cur.wallType || "")
                        .indexOf("full_") ? "page" : "full") : cur.module;
                checkbox(i), ajax.post("like.php", {
                    act: "a_do_" + (s ? "un" : "") + "publish",
                    object: o,
                    hash: a,
                    wall: 2,
                    ref: l
        ...
        likeShareCheckLen: function(e, a, t) {
            ...
            if (e.lastLen !== o.length) {
                var i = e.lastLen = o.length,
                    s = i - o.replace(/\n/g, "")
                    .length;
                i > t - 50 || s > 4 ? (i > t ? val(a, getLang("text_exceeds_symbol_limit", i - t)) : s > 4 ? val(a, getLang("global_recommended_lines", s - 4)) : val(a,
        ...
        scrollCheck: function(e, a, t) {
            var o, i, s, l, a = void 0 == a ? scrollGetY() : a,
                r = 0,
                n = [],
            ...
            if (Wall.repliesSideUpdate(a), cur.wallPage) {
                ...
                if ((domPN(cur.topRow) != c || ((cur.topRow || {})
                    ...
                    for (Page.postsUnseen(postsUnseen), i = cur.topRow; i && (o = r ? r : i.offsetTop, !(o >= a + d)); i = s) s = domNS(i), ((s || {})
                            .id || "")
                        .match(/page_wall_count_/) && (s = null), r = s ? s.offsetTop : o + i.offsetHeight, a > r && s && (cur.topRow = s), l = i.bits || 0, l >= 3 || (l |= (o >=
                            a && a + d > o ? 1 : 0) | (r >= a && a + d > r ? 2 : 0)) && (i.bits = l, 3 == l && n.push(Wall.postsGetRaws(i)));
                    Page.postsSeen(n)
                }
        ...
        update: function() {
            ...
            if (!("all" != cur.wallType && "own" != cur.wallType || "all" != cur.wallTab && "own" != cur.wallTab)) {
                ...
                var t = ge("wall_more_link"),
                    ...
                    .length - o,
                    s = i;
                cur.options.fixed_post_id && cur.options.wall_oid < 0 && (s += 1), s >= e[cur.wallType] - o ? hide(t) : (show(t), t.onclick = Wall.showMore.pbind(i)),
        ...
        getAbsDate: function(e, a) {
            ...
            var t, o = new Date(e || vkNow()),
                ...
                s = o.getMinutes(),
                l = "";
            return a.wallTpl.time_system && (l = a.wallTpl.time_system[i > 11 ? 1 : 0], i = i % 12 || 12), t = i > 9 ? i : "0" + i, s = s > 9 ? s : "0" + s, a.wallTpl.date_format
                .replace("{am_pm}", l)
                .replace("{hour}", i)
                .replace("{num_hour}", t)
                .replace("{minute}", s)
        ...
        getNewPostHTML: function(e, a, t, o) {
            ...
            return -1 != e[6].indexOf('id="wpfo') && (c += '<span class="page_fronly inl_bl" onmouseover="Wall.foTT(this, false, {oid: \'' + r + "', pid: '" + e[2] +
                "'})\"></span>"), a > (e[9] == r ? 1 : 0) || r == vk.id || e[9] == vk.id ? s.push(o.wallTpl.del) : e[2].split("_")[0] != e[4] && s.push(o.wallTpl.spam), (a >
                1 && e[9] == r || r == vk.id || e[9] == vk.id) && s.push(o.wallTpl.edit), i = {
                oid: r,
                name: c,
                actions: s.length ? rs(o.wallTpl.post_actions, {
                    actions: s.join("")
                }) : "",
                replies: "",
                reply_link: n,
                ...
                post_url: "/wall" + l.replace("_wall_reply", "_"),
        ...
        getNewReplyHTML: function(e, a, t, o) {
            o = o || window.cur;
            var i = [],
                s = ge("reply_field" + e[2]) || ge("reply_fakebox" + e[2]) || ge("fwr_text"),
                l = "",
                r = "",
                n = "",
                d = e[10] ? " " + e[10] : "";
            a > 0 || !e[2].indexOf(vk.id + "_") || e[4] == vk.id ? i.push(o.wallTpl.del_reply) : e[2].split("_")[0] != e[4] && i.push(o.wallTpl.spam_reply), (a > 1 && e[4] ==
                intval(e[2]) || e[4] == vk.id) && i.push(o.wallTpl.edit_reply), -1 != e[8].indexOf('class="wall_reply_more"') && (l += "reply_moreable"), s && (l +=
                " reply_replieable", r = o.wallTpl.reply_link_wrap, o.options.reply_names[e[4]] || (o.options.reply_names[e[4]] = [e[11], e[12]])), l && (n =
        ...
        openNewComments: function(e) {
            ...
            }), o && (l = i + intval(o.getAttribute("offs")
                .split("/")[1])), s += -r + i, (l > 3 || l > s) && (o || a.insertBefore(o = ce("a", {
                className: "wr_header"
            }), a.firstChild), Wall.updateRepliesHeader(e, o, s, l)), cur.wallMyOpened[e] = 1, t && "replies_open" == t.className && (r > 100 ? (t.innerHTML = getLang(
                ...
                a -= cur.tsDiff, each(geByClass("rel_date_needs_update", e || ge("page_wall_posts"), "span"), function(e, o) {
                    if (o) {
                        var i = intval(o.getAttribute("time")),
                            s = a - i,
                            l = o.getAttribute("abs_time");
                        5 > s ? l = getLang("wall_just_now") : 60 > s ? l = Wall.langWordNumeric(s, cur.lang.wall_X_seconds_ago_words, cur.lang.wall_X_seconds_ago) :
                            3600 > s ? l = Wall.langWordNumeric(intval(s / 60), cur.lang.wall_X_minutes_ago_words, cur.lang.wall_X_minutes_ago) : 14400 > s ? l = Wall.langWordNumeric(
                                intval(s / 3600), cur.lang.wall_X_hours_ago_words, cur.lang.wall_X_hours_ago) : t.push(o), o.innerHTML = l
                    }
                }), each(t, function() {
        ...
        updateRepliesHeader: function(e, a, t, o) {
            if (!cur.onepost) {
                var i, s, l = a.href,
                    r = 3,
                    n = 0;
                if (!l && (s = e.match(/^(-?\d+)_(photo|video|note|topic|video|)(\d+)$/))) {
                    var d = s[2] || "wall";
                    switch (l = "/" + d + s[1] + "_" + s[3], d) {
                        case "topic":
                            l += "?offset=last&scroll=1";
                            break;
                        case "wall":
                            l += "?offset=last&f=replies"
                    }
                    a.href = l
                }
            ...
            if (o.wallAddQueue && o.wallAddQueue.key == a) {
                ...
                if (o.wallAddQueue.ts = t.ts, isArray(t.events) && t.events.length) {
                    var i = (t.events.length, e ? wkLayerWrap.scrollTop : scrollGetY()),
                        ...
                        n = e ? !0 : !1,
                        d = e;
                    if (!l || !(nav.objLoc.q || nav.objLoc.search || nav.objLoc.day)) {
                                ...
                                switch (i) {
                                    case "new_post":
                                        ...
                                        var h = ge("page_wall_posts"),
                                            ...
                                            b = h.firstChild;
                                        if (ge("post" + c)) break;
                                        for (g && g != v ? re(g) : g = !1, l ? g || o.pgOffset++ : (val("page_wall_count_all", intval(val("page_wall_count_all")) + 1),
                                    ...
                                    case "del_post":
                                        ...
                                        o.wallMyDeleted[c] || r || (p = -_.offsetHeight, u = getXY(_, d)[1], revertLastInlineVideo(_), addClass(_, "unshown"), l || n ||
                                    ...
                                    case "res_post":
                                        ...
                                        o.wallRnd == a[4] && removeClass(_, "unshown"), l ? o.pgOffset++ : (val("page_wall_count_all", intval(val("page_wall_count_all")) +
                        ...
                        scrollGetY();
                        s != i && i > 100 && (e ? wkLayerWrap.scrollTop = s : scrollToY(s, 0)), Wall.update()
                    }
                }
            }
        },
        ...
        updateMentionsIndex: function(e) {
            ...
            each(geByClass("author", bodyNode, "a"), function() {
                ...
                var e = this.href.replace(o, ""),
                    i = a[e];
                if (void 0 !== i) {
                    for (var s = domFC(this); s && "IMG" != s.tagName;) s = domNS(s);
                    s && (t[i][3] = s.getAttribute("src"), delete a[e])
                }
            }), cur.wallMentions = t
        },
        ...
        init: function(e) {
            ...
            if (addEvent(o, "scroll", Wall.scrollCheck), addEvent(window, "resize", Wall.scrollCheck), cur.destroy.push(function() {
                ...
                var i = function() {
                        removeEvent(document, "dragover dragenter drop dragleave", s)
                    },
                    s = function(e) {
                        if (r !== !1 && (clearTimeout(r), r = !1), cur.uploadInited) return i(), cancelEvent(e);
                        switch (e.type) {
                            case "drop":
                                l = !1, delete cur.wallUploadFromDrag, hide("post_upload_dropbox");
                                break;
                            case "dragleave":
                            ...
                            case "dragover":
                            case "dragenter":
                                l || (l = !e.target || "IMG" != e.target.tagName && "A" != e.target.tagName ? 2 : 1, 2 == l && setTimeout(Wall.showEditPost, 0)), 2 == l && (
                    ...
                    l = !1,
                    r = !1;
                addEvent(document, "dragover dragenter drop dragleave", s), cur.destroy.push(i)
            }
            Wall.updateMentionsIndex()
        },
...
WallUpload = {
    ...
    uploadFailed: function(e, a) {
        ...
        if ("fileApi" == Upload.types[t] && !Upload.options[t].wiki_editor) {
            var i, s = e.fileName ? t + "_" + e.fileName : e;
            cur.imMedia ? (re("upload" + s + "_progress_wrap"), i = cur.imMedia.lnkId, cur.addMedia[i].unchooseMedia()) : cur.addMedia && (re("upload" + s +
                ...
                onUploadProgress: function(e, a, t) {
                    ...
                    if ("fileApi" == Upload.types[o]) {
                        ...
                        if (void 0 === i || i && cur.addMedia[i].chosenMedia || cur.imMedia) {
                            ...
                            e.fileName && (s.fileName = e.fileName.replace(/[&<>"']/g, "")), cur.wallAddMedia.showMediaProgress("photo", o, s)
                        }
                    }
                },
...
Composer = {
        ...
        if ("keypress" == a.type || "keydown" == a.type) {
            ...
            if (a.keyCode == KEY.TAB) {
                var o = e.input,
                    ...
                    s = Composer.getCursorPosition(o);
                if (curValue = i.substr(0, s) + "" + i.substr(s), matches = curValue.match(/^[\s\S]*(@|\*)[\S]+\s*\([\s\S]*?\001[\s\S]*?\)\s*/), matches) {
                    var l = matches[0].length - 1;
                    return elfocus(e.input, l, l), cancelEvent(a)
                }
            }
            var r = 0;
    ...
    updateAutoComplete: function(e, a) {
        var t = e.input,
            ...
            i = o,
            s = Math.max(i.lastIndexOf("@"), i.lastIndexOf("*")),
            l = s > -1 ? i.substr(s + 1) : !1;
        l && l.match(/&nbsp;|[,\.\(\)\?\!\s\n \u00A0]|\#/) && (l = !1), e.curValue = o, e.curTerm = l, e.curPos = s, val(e.wddInput, l), Composer.toggleSelectList(e), (
    ...
    onItemSelect: function(e, a) {
        ...
        var t, o, i = a[2].replace("@", ""),
            s = a[1],
            l = e.curValue.substr(0, e.curPos),
            r = e.curValue.substr(e.curPos);
        i || (i = itemId > 0 ? "id" + itemId : "club" + Math.abs(itemId));
        var n = l.match(/\#[\w_\.\u0400-\u04FF]+$/i) ? !0 : !1,
            d = window.Emoji && void 0 !== e.input.emojiId;
        return d || (s = replaceEntities(s)), cur.selNum = (cur.selNum || 0) + 1, r = r.replace(/^(@|\*)[^\s]*(?:\s+\((?:(.*?)\))?\s*)?/, function(e, a, l) {
            var r = a + i + " ";
            return n ? t = o = r.length : (r += "(" + (d ? '<span id="tmp_sel_' + cur.selNum + '">' : ""), t = r.length, r += s.replace(/[\(\)\]\[]/g, ""), o = r.length,
                r += (d ? "</span>" : "") + ") "), r
        }), t += e.curPos, o += e.curPos, Composer.hideSelectList(e), d ? (Emoji.val(e.input, clean(l) + r), Emoji.focus(e.input), Emoji.editableFocus(e.input, ge(
            "tmp_sel_" + cur.selNum), !1, !0)) : (val(e.input, l + r), elfocus(e.input, t, o)), !1
    },
    getCursorPosition: function(e) {
        ...
        return t.text = o + a, s = i.text.indexOf(a), t.moveStart("character", -1), t.text = "", browser.msie && -1 == s ? e.value.length : s
    },
    getSendParams: function(e, a, t) {
        var o = e.addMedia || {},
            i = o.chosenMedia || {},
            s = o && o.getMedias ? o.getMedias() : [],
            l = o.shareData || {},
            ...
            p = 0;
        if (isArray(i) && i.length && s.push(clone(i)), setStyle(bodyNode, {
                cursor: "default"
            }), s.length) {
            each(s, function(e, i) {
                if (isArray(i) && i.length) {
                    ...
                    switch (s) {
                        case "poll":
                            ...
                            break;
                        case "share":
                            if (l.failed || !l.url || !l.title && (!l.images || !l.images.length) && !l.photo_url) return cur.shareLastParseSubmitted && vkNow() -
                                cur.shareLastParseSubmitted < 2e3 ? (c.delayed = !0, !1) : void 0;
                            if (n = l.user_id + "_" + l.photo_id, l.images && l.images.length && !t) return o.uploadShare(a), c.delayed = !0, !1;
                            l.initialPattern && trim(d) == l.initialPattern && (c.message = ""), extend(c, {
                                url: l.url,
                                title: replaceEntities(l.title),
                                description: replaceEntities(l.description),
                                extra: l.extra,
                                extra_data: l.extraData,
                                photo_url: replaceEntities(l.photo_url),
                                open_graph_data: (l.openGraph || {})
                                    .data,
                                open_graph_hash: (l.openGraph || {})
                                    .hash
                            });
                            break;
                        case "page":
                            l.initialPattern && trim(d) == l.initialPattern && (c.message = "");
                            break;
                        case "postpone":
                            return void(c.postpone = cur.postponedLastDate = val("postpone_date" + o.lnkId))
                    }
                    this[3] && trim(d) == this[3] && (c.message = ""), c["attach" + (p + 1) + "_type"] = s, c["attach" + (p + 1)] = n, p++
                }
            })
        }
