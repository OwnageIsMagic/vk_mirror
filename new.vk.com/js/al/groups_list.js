var GroupsList = {
    ...
    showMore: function(r) {
        ...
        if (t || r !== !1) {
            ...
            if (GroupsList.updateSummary(u), !u) return p.innerHTML = cur.scrollList.genEmpty(o), void(o && GroupsList.needSearch(s) ? t ? (GroupsList.serverSearch(p, o),
    ...
    toggleFastAccess: function(r, s) {
        function e(r) {
            var e = r ? getLang("groups_fast_menu_access_invert") : getLang("groups_fast_menu_access");
            s.textContent = e, s.setAttribute("data-value", r)
        }
        var o = 1 ^ intval(s.getAttribute("data-value"));
        return ajax.post("al_settings.php", {
            ...
            onDone: function(r, s) {
                geByTag1("ol", ge("side_bar"))
                    .innerHTML = s, window.Notifier && Notifier.resetCommConnection()
            },
            onFail: function() {
                return e(0), showFastBox(getLang("global_error"), getLang("groups_too_much_comms")
                    .replace("{amt}", 5)), !0
            }.bind()
        }), e(o, o), !1
    },
