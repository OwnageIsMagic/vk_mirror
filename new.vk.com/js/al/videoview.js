            ...
            incViewCounter: function(oid, vid, hash, currRes, maxRes, player, type) {
                ...
                if (cur.videoSearchStats) {
                    ...
                    if (!isNaN(pos)) {
                        ...
                        cur.videoSearchStats.positions[pos] = extend({
                            'viewStarted': 0
                        }, cur.videoSearchStats.positions[pos]);
                    ...
                    ajax.post('/al_video.php', params, {
                        onDone: function(prevSegments, prevSegmentsSig, callbackRes) {
                            ...
                            if (callbackRes > 0 && !isNaN(searchPos) && cur.videoSearchStats) {
                                cur.videoSearchStats.positions[searchPos] = extend({
                                    'viewedParts': 0
                                }, cur.videoSearchStats.positions[searchPos]);
                ...
                mvcur.addButtonTT = mvcur.addButtonTT || new ElementTooltip(btn, {
                    ...
                    onFirstTimeShow: function(content) {
                        ...
                        each(mvcur.mvData.playlists, function(i, pl) {
                            ...
                            var privateIcon = pl.private ? '<span class="mv_tt_playlist_private_icon" onmouseover="showTooltip(this,{black:1,text: \'' +
                                getLang('video_album_is_private_tt') + '\', shift:[16, 8, 0]})"></span>' : '';
                            playlistsHtml += '\
<div class="mv_tt_playlist">\
  <div class="checkbox' + (isAdded ? ' on' : '') + (pl.disabled ? ' disabled' :
                                    '') + '" data-id="' + pl.id + '" onclick="checkbox(this);">' + clean(pl.title) + '</div>' + privateIcon +
                                '\
</div>\
          ';
                        });
...
<div id="mv_container">\
  <div id="mv_box" onclick="mvcur.mvClicked = true;">\
    ...
    <div class="mv_controls clear_fix" id="mv_controls" style="' +
                showControls + '"></div>\
  ...
  ';
        ...
        initPlaylistBlock: function(videoRaw, playlistId, loadMore) {
            ...
            if (plBlockEl) {
                ...
                var curListSize = VideoPlaylist.getCurList()
                    .list.length;
        ...
        moreComments: function(showReply) {
            ...
            if (showReply && Videoview.cmp(domFC(ge('mv_comments'))
                    .id, 'post' + showReply) < 0) {
                return;
            }
        ...
        claimed: function(claim_id, action, status) {
            ...
            ajax.post('al_claims.php', {
                ...
                onDone: function() {
                    if (action == 'claim') {
                        ge('claim_link')
                            .innerHTML = '<a onclick="return Videoview.claimed(' + claim_id + ', \'unclaim\', \'' + status +
                            '\');\">\u0412\u0435\u0440\u043D\u0443\u0442\u044C</a>';
                    } else {
                        ge('claim_link')
                            .innerHTML = '<a onclick="return Videoview.claimed(' + claim_id + ', \'claim\', \'' + status +
                            '\');\">\u0418\u0437\u044A\u044F\u0442\u044C</a>';
                    }
                }
            });
        ...
        onNewCommentReceived: function(ev) {
            ...
            commentActionsHtml = rs(mvcur.commentsTpl.actions, {
                ...
                ajax.post('/al_video.php', {
                    ...
                    onDone: function(playlists) {
                        ...
                        each(playlists, function(i, pl) {
                            playlistsHtml += '<div class="mv_add_to_club_albums_list_item checkbox ' + (+pl.added ? 'on' : '') + '" data-id="' + pl.id +
                                '" onclick="checkbox(this)">' + clean(pl.title) + '</div>';
                        });
        ...
        editInline: function(evt) {
            ...
            var onDone = function(text) {
                ...
                var el = ce('div', {
                    ...
                    innerHTML: '<textarea id="mv_edit_text" style="' + inputStyle +
                        ...
                        getLang('video_edit_desc_intro') + '">' + text + '</textarea><div id="mv_caption_warn"></div>'
                });
                ge('mv_description')
                    .appendChild(el);
  ...
  ',
    ...
    showVideo: function(vid) {
        ...
        if (playlist.loaded && playlist.loaded.vid == vid) {
            ...
            Videoview.show(null, vid, loadData.listId, extend(loadData.options, {
