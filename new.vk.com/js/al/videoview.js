var Videoview = {
        ...
        hide: function(e, i, o, t) {
            if (window.mvcur && (i || mvcur.mvShown)) {
                ...
                removeClass(mvLayerWrap, p), removeClass(layerBG, p), mvcur.mvShown = mvcur.mvClicked = !1, removeEvent(window, "resize", Videoview.onResize), removeEvent(
                    ...
                    removeEvent(mvLayerWrap, "click", Videoview.onClick), mvcur.player && (mvcur.player.destroy(), delete mvcur.player), ge("html5_player") && window.html5video &&
                    html5video.destroy(), ge("video_yt") && window.VideoYoutube && VideoYoutube.destroy(), val("mv_content", ""), mvcur.changeCanvasSize = !1;
        ...
        showVideo: function(title, html, js, desc, serviceBtns, opt) {
            ...
            if (Wall.cancelEdit(!0), opt.is_vk_player && !opt.is_flv && mvcur.player && mvcur.player.el === domFC(ge("video_player"))) {
