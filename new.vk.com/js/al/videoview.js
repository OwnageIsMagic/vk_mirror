        ...
        show: function(e, i, t, o) {
            ...
            return o.queue && (debugLog("pushing in videoview.show"), layerQueue.push(), o.queue = !1), !o.noLocChange && nav.objLoc.z && 0 == nav.objLoc.z.indexOf("video") &&
                ...
                0, mvcur.player = d, o.prevLoc ? mvcur.mvPrevLoc = o.prevLoc : setTimeout(function() {
                    ...
                    mvOldY: e.pageY,
                    mvOldT: vkNow()
                }), r ? Videoview.cleanLayerContent() : Videoview.buildLayerContent(), o.player && (mvcur.player = o.player, o.player = 1, val("mv_content",
                    ...
                    o.catLoadMore) : VideoPlaylist.removeBlock(), Videoview.cleanUpStoredVSegs(), o.minimized && setTimeout(Videoview.minimize.bind(Videoview), 0), !1
        },
        ...
        hide: function(e, i, t, o) {
            if (window.mvcur && (i || mvcur.mvShown)) {
                ...
                removeClass(mvLayerWrap, p), removeClass(layerBG, p), mvcur.mvShown = mvcur.mvClicked = !1, removeEvent(window, "resize", Videoview.onResize), removeEvent(
                    ...
                    removeEvent(mvLayerWrap, "click", Videoview.onClick), clearInterval(mvcur.nextTimerUpdateInterval), Videoview.destroyPlayer(), val("mv_content", ""), mvcur
                    .changeCanvasSize = !1;
            ...
            if (mvcur.minimized) {
                ...
                return addClass(mvLayerWrap, o), addClass(layerBG, o), mvcur.needShowApprove && (mvcur.needShowApprove = !1, show("mv_approve")), Videoview.restoreStyle(
                    ...
                    onBodyResize(!0), setStyle(mvLayerWrap, {
                        left: "0px",
                        top: "0px"
                    }), Videoview.showPlayer(!0), Videoview.setTitle(), VideoPlaylist.toggleStateClasses(), Videoview.viewScroll(), Videoview.playerOnResize(), !1
            }
        },
            ...
            if (e && a && !ge("mv_external_finish")) {
                ...
                var p = window.mvcur && mvcur.minimized,
                    w = se(
                        ...
                        s + "  " + m + "</div>  ");
                a.canSubscribe || re(geByClass1("mv_finish_subscribe", w)), (a.noControls || a.nolikes) && re(geByClass1("mv_finish_actions", w)), e.appendChild(w), o && t &&
