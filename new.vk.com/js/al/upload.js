    ...
    uploadFile: function(e, o, t) {
        ...
        if (a.multi_sequence && this.onUploadStart(l), a.uploading = !0, window.FormData) {
            ...
            s.open("POST", t, !0), s.onload = function(i) {
                ...
                4 !== s.readyState && (d = !1, extend(l, Upload.getFileInfo(e, a, o)), t.lengthComputable && (a.multi_progress ? Upload.onUploadProgress(l, t.loaded,
                    t.total) : Upload.onUploadProgress(e, Math.min(t.loaded + a.filesLoadedSize, a.filesTotalSize), a.filesTotalSize)))
            }, s.send(n)
        } else try {
