function skinBoxTabs(a, t, b, o) {
    ...
    for (var n in t) {
        ...
        e.push('<div class="fl_l summary_tab' + (b == n ? "_sel" : "") + '">  <a class="summary_tab2"' + r + ' onclick="if (checkEvent(event)) return; cur.onTabSwitch[' + o +
            "]('" + n +
            "');geByClass1('summary_tab_sel', this.parentNode.parentNode).className='fl_l summary_tab';this.parentNode.className='fl_l summary_tab_sel';return false;\">    <div class=\"summary_tab3\"><nobr>" +
            t[n].label + "</nobr></div>  </a></div>    ")
    }
    geByClass1("summary_tabs", a.bodyNode)
        .innerHTML = e.join("")
}
