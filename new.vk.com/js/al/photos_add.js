var PhotosAdd = {
    ...
    initBeforeUnload: function() {
        cur.unloadInited || (cur.unloadInited = !0, cur.nav.push(function(o, e, t, r) {
                return PhotosAdd.checkChanges(1) ? (cur.onContinueCb = nav.go.pbind(t), !1) : cur.album == vk.id + "_-7" && cur.savedPhotos && cur.savedPhotos.length &&
                    !cur.savingPhotos ? (cur.savingPhotos = !0, ajax.post("/al_photos.php", {
                        act: "publish_photos",
                        hash: cur.post_hash,
            ...
            }), addEvent(window, "mousewheel", PhotosAdd.wheelHandler), cur.prevBefUnload = window.onbeforeunload, window.onbeforeunload = PhotosAdd.checkChanges, cur.destroy
            .push(function() {
    ...
    addFile: function() {
        ...
        extend(e, {
            ...
            .appendChild(e), PhotosAdd.initFile(o), cur.files.push({})
    },
    filesLoad: function() {
    ...
    fileSelected: function() {
        ...
        if (cur.files[o].deleting || !cur.files[o].cont && !cur.files[o].id) {
            ...
            lockButton(r), setTimeout(function() {
                ...
                .innerHTML = getLang("global_cancel"), o == cur.files.length - 1 && PhotosAdd.addFile()
        }
    },
        ...
        PhotosAdd.fetchGeo(obj), setTimeout(ajax.post.pbind("al_photos.php", extend({
            ...
            onDone: function(o, e) {
                return o ? (cur.files[i].cont.innerHTML = "", utilsNode.removeChild(cur.files[i].cont), extend(cur.files[i], {
                        ...
                        deleting: !1,
                        cont: !1
                    }), ge("photo_upload_row" + i)
                    .innerHTML = e, autosizeSetup("photo_caption" + o, {
                        minHeight: 30
                    }), show("photo_delete" + o), void(window._tbLink && _tbLink.loc && (cur.__phinputs = cur.__phinputs || [], globalHistoryDestroy(
                        _tbLink.loc)))) : PhotosAdd.fileFail(i, 0)
            },
            onFail: function(o) {
                return o ? (setTimeout(showFastBox({
                    ...
                    .hide, 3e3), PhotosAdd.fileCancel(i), !0) : void 0
            }
        }), 0)
    },
    ...
    fileDelete: function(o, e) {
        ...
        if (t != cur.files.length && !cur.files[t].deleting) {
            ...
            r.parentNode.insertBefore(PhotosAdd.genFile(t, "PhotosAdd.fileRestore('" + o + "', '" + e + "')", getLang("global_restore")), r), hide(r), PhotosAdd.initFile(t),
                show("photo_cancel" + t)
        }
    },
    ...
    scrollHandler: function(o) {
        if (cur.uplSelected) {
            if (ge("photos_add_bar")) {
                var e = scrollGetY();
                cur.scrollBarFixedY || (cur.scrollBarFixedY = getXY(ge("photos_add_bar")
                    .parentNode)[1]);
                var t = ge("photos_add_bar");
                e > cur.scrollBarFixedY && !cur.scrollBarFixed && (t.className = "photos_add_bar1", cur.scrollBarFixed = !0, cur.introTooltipHide && cur.introTooltipHide()),
                    e < cur.scrollBarFixedY && cur.scrollBarFixed && (t.className = "photos_add_bar0", cur.scrollBarFixed = !1, cur.introTooltipShow && cur.introTooltipShow())
            }
    ...
    setThumb: function(o, e) {
        var t = geByClass1("photos_add_img", o),
            r = getSize(t);
        e.mtop = 0, Math.abs(t.rotate) % 180 == 90 && this.transformAvailable() && (r.reverse(), r[1] < r[0] && (e.mtop = Math.floor((r[1] - r[0]) / 2))), browser.opera &&
            (e.mtop = e.mtop - 2), setStyle(e, {
                width: r[0],
    ...
    thumbOver: function(o, e) {
        ...
        t || (t = ce("div", {
            ...
            innerHTML: '<div class="photos_add_c_bar"><a class="photos_add_rl" onclick="PhotosAdd.rotateAngle(\'' + e +
                '\', 90);"></a><a class="photos_add_rr" onclick="PhotosAdd.rotateAngle(\'' + e + "', -90);\"></a></div>"
    ...
    updateCount: function() {
        ...
        o.innerHTML = langNumeric(cur.qsrt.count, cur.uploaderLang.photos_save_X_photos), 0 == cur.qsrt.count && (show("photos_add_empty"), hide("photos_add_box"), hide(ge(
                "photos_add_bar")
            .parentNode), Upload.fileList[cur.uplId] = !1)
    },
    saveHtml5: function() {
    ...
    onUploadStart: function(o, e) {
        if (PhotosAdd.initBeforeUnload(), cur.onPhotoAddStart && cur.onPhotoAddStart(), cur.flash_lite && void 0 === o.num && (o = e), 0 == o.num && (cur.errorCount = 0, !
                ge("photos_add_wrap"))) {
            ...
            setStyle(t, {
                    ...
                    margin: 0,
                    overflow: "hidden"
                }), each(geByClass("photos_period_delimiter_fixed"), hide), cur.prevDocTitle = document.title, cur.uploadStarted = !0, hide("photos_go_to_album"),
    ...
    onUploadComplete: function(info, res) {
        ...
        if (!obj.photos) return cur.errorCount++, re(info.prepareCont), info.prepareCont && info.prepareCont.helper && re(info.prepareCont.helper), ge(
                "photos_upload_error_msg")
            .innerHTML = cur.uploaderLang.photos_add_error, show("photos_upload_error"), scrollToTop(200), void PhotosAdd.makeTask();
            ...
            ajax.post("al_photos.php", params, {
                onDone: function(html, js, photoRaw, thumb, editHash) {
                    ...
                    thumbImage.onload = function() {
                            removeClass(thumbEl, "no_thumb"), setStyle(thumbEl, "background-image", "url('" + thumb + "')"), hide(geByClass1(
                                "photos_photo_edit_row_progress", info.prepareCont))
                        }, thumbImage.src = thumb, PhotosAdd.makeTask(), cur.photoSaveQ.shift(), cur.photoSaveQ[0] && cur.photoSaveQ[0](), cur.onPhotoFirstUploaded &&
                        cur.onPhotoFirstUploaded(), document.title = cur.uploaderLang.photos_upload_progress_title.replace("{count}", cur.count)
                        .replace("{total}", info.totalCount)
                },
                onFail: function(o) {
                    if (o && (ge("photos_upload_error_msg")
                            .innerHTML = o, show("photos_upload_error"), scrollToTop(200)), cur.errorUpload = !0, hasClass(info.prepareCont,
                            "photos_add_first_child")) {
    ...
    onUploadCompleteAll: function(o, e) {
        cur.uploadStartProgress = 0, delete cur.uploadStarted, window.onbeforeunload = cur.prevBefUnload, delete cur.unloadInited, PhotosAdd.hideUploadProgress(),
            PhotosAdd.makeTask(function() {
                ...
                document.title = cur.prevDocTitle, show("photos_go_to_album"), cur.lastPhotoRow = ge("photos_go_to_album"), PhotosAdd.updateBottomFixedPanel(), re(
                    "photos_albums_block")
            })
    },
    makeTask: function(o) {
    ...
    fetchGeo: function(o) {
        ...
        return r ? void stManager.add(["maps.js"], function() {
            cur.placeMap = new vkMaps.VKMap(!1, "google"), cur.placeMap.isLoaded("google") ? PhotosAdd.setGeo(t) : cur.placeMap.load.addHandler(PhotosAdd.setGeo.pbind(
                t))
        }) : !1
    },
    setGeo: function(o) {
