var Feed = {
                                ...
                                if (each([].slice.call(geByClass("reply", r, "div")), function() {
                                    ...
                                    h = v - h, inArray(n, cur.feedUnread) || cur.feedUnread.unshift(n), !cur.idleManager.isIdle && m > g + 100 && g + w + 100 >
                                        m ? (c.insertBefore(ge("post_ph" + n) || ce("div", {
                                            ...
                                            c.firstChild), m > g + w + 100 && (h = v), h && scrollToY(scrollGetY() + h, 0)), cur.feedUnreadCount += p
                                }
                                l.removeChild(r)
                            } else a = scrollGetY(), c.insertBefore(r, c.firstChild), nodeUpdated(r), d = r.offsetHeight, a > 100 && scrollToY(a + d, 0);
    ...
    updated: function(e, t) {
        if (("search" == cur.section || "news" == cur.section || !cur.section) && cur.add_queue && cur.add_queue.key == e) {
            if (t.failed) {
                ...
                return clearTimeout(cur.lp_error_to), void(cur.lp_error_to = setTimeout(feed.getNewQKey.bind(feed)
                    .pbind(s), 1e3 * s))
            }
            if (isArray(t.events) && t.events.length) {
                ...
                each(t.events, function() {
                    r += feed.pushEvent(this.split("<!>"), o)
                });
                var i = scrollGetY();
                r && o > 100 && Math.abs(o - i) < 100 && scrollToY(i + r, 0), feed.updateTitle(), cur.gifAutoplayScrollHandler && cur.gifAutoplayScrollHandler()
            }
        }
    },
            ...
            switch (o) {
                case "new_post":
                    ...
                    var u, f, p, h, _, g, w = cur.rowsCont,
                        ...
                        b = e[12],
                        y = "search" != n && (window._wf <= 0 || hasClass(cur.feedEls.wrap, "feed_has_new")),
                        C = !1,
                        k = v;
                    if (y && (v = wall.updatePostImages(v)), b) {
                        if (cur.ignore_owners.length && inArray(intval(b), cur.ignore_owners)) break;
                        if (f = geByClass1("feed_reposts_wrap" + b, w, "div")) p = geByClass1("feed_reposts_first", f, "div")
                            .firstChild, h = geByClass1("feed_reposts_group", f, "div"), _ = geByClass1("feed_reposts_more_link", f, "a"), t > getXY(p)[1] && (c -= p.offsetHeight),
                            p.parentNode.replaceChild(u = se(k), p), h.insertBefore(p, h.firstChild), isVisible(h) || val(_, getLang("news_show_X_reposts", h.childNodes.length)),
                            f = f.parentNode, w.firstChild != f && w.insertBefore(f, w.firstChild), t > getXY(f)[1] && (c += f.offsetHeight), f.bits = 0;
                        else if ((g = geByClass("feed_repost" + b, w, "div")) && g.length) {
                        ...
                        } else u = se('<div class="feed_row' + (y ? "_unshown" : "") + '"><div class="feed_repost' + b + '">' + v + "</div></div>"), w.insertBefore(u, w.firstChild),
                            C = !0, !y && t > getXY(u)[1] && (c += u.offsetHeight)
                    } else u = se('<div class="feed_row' + (y ? "_unshown" : "") + '">' + v + "</div>"), w.insertBefore(u, w.firstChild), C = !0, !y && t > getXY(u)[1] &&
                        (c += u.offsetHeight);
                    y && C && (cur.newPostsCount = cur.newPostsCount ? cur.newPostsCount + 1 : 1, cur.feedEls.newPosts.innerHTML = getLang("news_new_posts", cur.newPostsCount),
                ...
                case "new_post_reply":
                    ...
                    w.insertBefore(u, w.firstChild), t > getXY(u)[1] && (c += u.offsetHeight), cur.feedUnreadCount++, m.length > 300 ? w.removeChild(m[300]) : m.length <=
                ...
                case "del_post":
                    if (i) {
                        cur.wallMyDeleted[r] || (t > getXY(i)[1] && (c -= i.offsetHeight), revertLastInlineVideo(i), hide(i)), cur.options.offset--;
                        var N = i.parentNode;
                        hasClass(N, "feed_row") || (N = N.parentNode), hasClass(cur.feedEls.wrap, "feed_has_new") && !isVisible(N) && (cur.newPostsCount--, cur.newPostsCount ?
                    ...
                    if (isVisible(M) && isVisible(j) && !isVisible("reply_link" + r)) {
                        ...
                        if (cur.wallMyOpened[r]) {
                            ...
                            var A = geByClass1("wr_header", M, "a"),
                                F = geByClass("reply", M, "div")
                                .length + 1,
                                U = F;
                            A && (U = intval(A.getAttribute("offs")
                                .split("/")[1]) + 1), (U > 5 || U > F) && (A || M.insertBefore(A = ce("a", {
                                className: "wr_header"
                            }), M.firstChild), wall.updateRepliesHeader(r, A, F, U))
    ...
    feedPostRepl: function(e, t) {
        ...
        if ("search" == cur.section && cur.q) {
            ...
            for (a = i.length - 1; a >= 0; a--)
                if (l = i[a], trim(l))
                    for (c = 0; - 1 != (c = d.indexOf(l, c));) o.charAt(c - 1) != String.fromCharCode(2) ? (o = o.substr(0, c) + "" + a + "" + o.substr(c + l.length), d =
                        d.substr(0, c) + "" + a + "" + d.substr(c + l.length)) : c += 2;
    ...
    showNewPosts: function() {
        var e = cur.feedEls.newPosts,
            t = -e.offsetHeight - intval(getStyle(e, "marginTop")) - intval(getStyle(e, "marginBottom"));
        removeClass(cur.feedEls.wrap, "feed_has_new"), cur.newPostsCount = 0;
        var s = ge("feed_rows"),
            o = scrollGetY();
        Wall.loadPostImages(s), each(geByClass("feed_row_unshown", s, "div"), function() {
            removeClass(this, "feed_row_unshown"), addClass(this, "feed_row"), t += this.offsetHeight, nodeUpdated(this)
        });
        var r = scrollGetY();
        t && Math.abs(o - r) < 100 && scrollToY(r + t, 0)
    },
    ...
    checkTabsFilter: function(e, t) {
        ...
        cur.feed_types.tabs;
        s = -1 != (o = indexOf(i, t)), toggleClass(e, "checked", !s), s ? (i.splice(o, 1), cur.section == t && feed.switchSection("news")) : i.push(t), cur.my_feed_types.tabs =
            i;
    ...
    switchSection: function(e, t, s) {
        if (t && checkEvent(t)) return !0;
        if (cur.feedVideoTabHintEl && cur.feedVideoTabHintEl.destroy(), removeClass(cur.feedEls.wrap, "feed_has_new"), cur.newPostsCount = 0, "photos_search" == e && !trim(
        ...
        var o = feed.getSectionParams(e || "news");
    ...
    applyOptions: function(options, from) {
        if (from = from || 0, options.owner && (cur.owner = options.owner), cur.subsection = options.subsection || "", feed.setSection(options.section, from), cur.options ||
            (cur.options = {
                reply_names: {}
        ...
        options.last_view && (cur.options.last_view = options.last_view), feed.searchUpdate(), "comments" != cur.section || cur.reposts || toggle("comments_filters", !cur.reposts),
            cur.all_shown_text && val("all_shown", cur.all_shown_text), cur.empty_text && val("feed_empty", cur.empty_text), cur.count >= 0 && re("feed_error_wrap");
        var hasNews = geByClass1("feed_row", cur.rowsCont, "div") || !1,
            isEmpty = !hasNews,
            nextRows = ge("feed_rows_next");
        if (isEmpty ? (toggleClass(cur.feedEls.wrap, "feed_is_empty", !isVisible("feed_error_wrap")), hide("all_shown"), toggle("show_more_link", cur.count > 0 && !cur.all_shown)) :
            !cur.all_shown || nextRows && nextRows.firstChild ? (hide("all_shown"), show("show_more_link"), removeClass(cur.feedEls.wrap, "feed_is_empty")) : (hide(
                "show_more_link"), show("all_shown"), removeClass(cur.feedEls.wrap, "feed_is_empty"), re(nextRows)), options.playlistsData && (options.playlistsData = JSON
                .parse(options.playlistsData), cur.pageVideosList = extend(cur.pageVideosList || {}, options.playlistsData)), options.showVideoTabHint && stManager.add([
                "ui_controls.js", "ui_controls.css"
            ], function() {
                var e = geByClass1("feed_tab_videos");
                e && isVisible(e) && (ajax.post("al_feed.php", {
                    act: "a_vhint_shown"
                }), cur.feedVideoTabHintEl = new ElementTooltip(e, {
                    showImmediate: !0,
                    content: options.showVideoTabHint,
                    offset: [0, -4],
                    noHideOnMouseLeave: !0,
                    onHide: function() {
                        setTimeout(function() {
            ...
            }), options.showSubsectionTopHint && stManager.add(["ui_controls.js", "ui_controls.css"], function() {
                var e = ge("feed_summary");
                if (e) {
                    var t = geByClass1("feed_summary_top", e);
                    cur.feedTopHintEl = new ElementTooltip(t, {
                        showImmediate: !0,
                        ...
                        cur.feedTopHintEl.destroy(), delete cur.feedTopHintEl, delete cur.closeFeedTopHint, statlogsValueEvent("newsfeed_tooltip_close", 1,
                            "usetop")
                    }
                }
            }), ("notifications" == cur.section || "replies" == cur.section) && cur.notify) {
    ...
    closeVideoTabHint: function() {
        cur.feedVideoTabHintEl && cur.feedVideoTabHintEl.hide()
    },
    showMore: function() {
            ...
            ajax.post("al_feed.php?sm_" + cur.section, r, {
                onDone: function(e, t) {
                    if (removeEvent(document, "keyup", o), i == cur.section) {
                        ...
                        if (t) {
                            var r, n = ce("div");
                            for (n.innerHTML = t; r = n.firstChild;) r.firstChild && r.firstChild.id && !ge(r.firstChild.id) || "feedback_unread_bar" == r.id ||
                                "feed_row_fb_hidden" == r.className ? cur.rowsCont.appendChild(r) : n.removeChild(r)
                        }
            ...
            function() {
                ...
                each(cur.notifyPrefs, function(t, s) {
                    ...
                    onDone: function(e) {
                        addTemplates({
                                top_notify_prefs: e
                            }), toggleClass("top_notify_pref_" + t, "checked", cur.notifyPrefs[t]), cur.notifyPrefs = {}, window.TopNotifier && TopNotifier
                            .invalidate(), nav.go(nav.strLoc), cur.feedEls.rmenu && uiRightMenu.showProgress(cur.feedEls.rmenu)
                    }
                })
            }, 500)
    },
    ...
    notifyClick: function(e, t, s) {
        ...
        if (Wall.checkPostClick(o, t)) {
            ...
            if (cur.editing && cur.editing != e && cur.notifyReplyData && cur.notifyReplyData[cur.editing].disabled && feed.notifyCheckHideReply(cur.editing, (window.event ||
                        {})
                    .target), r && isVisible(r)) return void feed.notifyCheckHideReply(e, !1);
            ...
            i.setAttribute("placeholder", s.ph), window.Emoji && Emoji.val(i, s.greet.replace(/ $/, "&nbsp;")), data(i, "send", feed.notifySendReply), removeClass(
                "reply_box" + e, "clear_fix")
        }
    },
    notifySendReply: function(e, t, s) {
        ...
        if (o && !o.sending) {
            ...
            extend(l, {
                ...
                onDone: function(t, s) {
                    if (delete o.sending, c ? r = Composer.reset(c) : window.Emoji && Emoji.val(i, ""), i.autosize && i.autosize.update(), feed.notifyHideReply(
                            e), s) {
    ...
    unsubscribe: function(e, t, s) {
        triggerEvent(ge("post_delete" + e), "mouseout"), cur.feedEntriesHTML[e] = ge("post" + e)
            .innerHTML;
        ...
        o && ajax.post("al_feed.php", {
            ...
            onDone: function(t) {
                ge("post" + e)
                    .innerHTML = t.replace("%post_raw%", e)
            },
    ...
    restorePost: function(e) {
        ge("post" + e)
            .innerHTML = cur.feedEntriesHTML[e];
    ...
    deleteList: function(e, t, s, o) {
        ...
        if (s) {
            ...
            ajax.post("al_feed.php", extend({
                ...
                onDone: function() {
                    re(geByClass1("feed_section_list" + e, cur.feedEls.rmenu)), re(geByClass1("feed_filter_list" + e, cur.feedEls.rmenu)), boxQueue.hideAll(),
                        "list" == cur.section && cur.list == e && feed.switchSection("news")
                },
                showProgress: lockButton.pbind(r.btns.ok[0]),
                hideProgress: unlockButton.pbind(r.btns.ok[0])
            })
            ...
            var r = showFastBox({
                    ...
                    bodyStyle: "padding: 20px; line-height: 160%;"
                }, getLang("news_delete_list_sure")
                .replace("{list}", t), getLang("global_delete"),
                function() {
    ...
    go: function(params, onBeforeReplace, noscroll) {
        ...
        (browser.msie || noscroll) && (frame = !1, hideProgress = cur.onFrameBlocksDone), cur.wasScroll = noscroll ? scrollGetY() : !1, cur.feedReq = ajax.post(
            "al_feed.php", extend(params, {
                part: 1
            }), {
                onDone: function(options, rows, js) {
                    if (revertLastInlineVideo(), removeClass(cur.feedEls.wrap, "feed_has_new"), cur.newPostsCount = 0, window.tooltips && tooltips.destroyAll(ge(
                            "feed_rows")), boxQueue.hideAll(), layers.fullhide && layers.fullhide(!0), frame && ajax._framenext(), window.wall && wall.cancelEdit(),
                        boxQueue.hideAll(), onBeforeReplace ? onBeforeReplace(rows || "") : val(cur.rowsCont, rows || ""), feed.applyOptions(options, 2), js &&
                        eval(js), checkPageBlocks(), scrollToTop(0), !params.norecom) {
                        val("feed_recommends", options.recommends || "");
                        var str = "/al_feed.php#" + ajx2q({
                            act: "recom"
                        });
                        ajaxCache[str] && delete ajaxCache[str], cur.recomPreload = !1
                    }
                    if (shortCurrency(), cur.feedEls.wall) {
                    ...
                    ge("feed_wall")
                        .className = wallClass, toggle("feed_recommends", inArray(cur.section, ["news", "recommended", "videos"]));
    ...
    onFeedSearch: function(e, t, s, o) {
        ...
        n.indexOf("photos") ? n.indexOf("articles") ? (r = "search", i = "news") : (r = "articles_search", i = "articles") : (r = "photos_search", i = "photos"), "search" ==
            r || feed.hasSearchParams(feed.getSectionParams(r)) ? (r != cur.section && feed.setSection(r, 1), feed.go(feed.getSectionParams(r)), window.searcher &&
                searcher.highlightHotHashtag(t || val(e))) : feed.go(feed.getSectionParams(i)), uiSearch.onChanged(e), uiSearch.showProgress(e)
    },
        ...
        setTimeout(function() {
            ...
            if (void 0 === e[0]) {
                ...
                if (delete r[0], void 0 === e.section || inArray(cur.section, ["notifications", "replies"]) == inArray(e.section, ["notifications", "replies"]))
                    return "notifications" == cur.section ? (feed.switchNotifyList(s.list || "all", extend(r, o.params || {})), !1) : e.list ? (feed.switchList(e.list), !
                        1) : (void 0 !== e.section && feed.switchSection(e.section || "news", !1, !0), e.notify ? !1 : e.q ? (val(cur.feedEls.search, e.q),
                        feed.onFeedSearch(cur.feedEls.search), !1) : (feed.go(extend(r, o.params || {})), !1))
            }
        }), cur.idleManager.onUnIdle = feed.updateTitle, cur.idleManager.onIdle = feed.reSortItems, cur.options = cur.options || {}, extend(cur.options, e), feed.applyOptions(
            e, 3), cur.rowsCont = e.wallCont = ge("feed_rows"), wall.init(e), cur._back = {
            text: getLang("news_return_to_news"),
            show: [feed.startEvents],
            hide: [function() {
                clearInterval(cur.updateInt), removeEvent(window, "scroll", feed.scrollCheck), removeEvent(window, "resize", feed.scrollCheck), cur.idleManager
                    .stop(), clearTimeout(cur.lp_error_to)
            }],
            loc: !1
        }, feed.startEvents();
