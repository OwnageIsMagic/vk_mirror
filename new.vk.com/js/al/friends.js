var Friends = {
    ...
    initBackFunc: function() {
        cur._back = {
            ...
            hide: [function() {
                ...
                cur.bigphShown = {}, removeEvent(Friends.scrollNode, "scroll", Friends.scrollResize)
            }],
            text: cur.backLang
        }
    },
    ...
    showSection: function(e) {
        ...
        if (!i) {
            if ("recent" == e || "phonebook" == e || "requests" == e) var n = e;
            else var n = "all";
            i = cur.friendsList[cur.curList] = this.filter(cur.friendsList[n], cur.section)
        }
        ...
        return cur.silent ? (cur.onSilentLoad = function() {
            ...
            ajax.post("friends", extend({
                ...
                onDone: function(e) {
                    ...
                    "all" != cur.section && "phonebook" != cur.section && (Friends.selectTab("all"), Friends.selectSection("all"), cur.curList = cur.section =
    ...
    changeFriendsOrder: function(e) {
        "date" != nav.objLoc.sort ? (nav.change({
            sort: "date"
        }), addClass(e, "friends_sort_sel_date"), removeClass(e, "friends_sort_sel_common")) : (nav.change({
            sort: !1
        }), addClass(e, "friends_sort_sel_common"), removeClass(e, "friends_sort_sel_date"))
    },
