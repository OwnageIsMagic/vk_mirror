...
var AudioUtils = {
    ...
    AUDIO_LAYER_TOP: 46,
    AUDIO_ENOUGH_LOCAL_SEARCH_RESULTS: 20,
    AUDIO_PAGINATED: -1,
...
AudioPlayer.tabIcons = {
...
}, AudioPlayer.prototype.updateAudio = function(i) {
    return each(this.audioPlaylists, function(t, e) {
        for (var o = 0, a = e.list.length; a > o; o++)
            if (e.list[o][AudioUtils.AUDIO_ITEM_INDEX_ID] == i[AudioUtils.AUDIO_ITEM_INDEX_ID] && e.list[o][AudioUtils.AUDIO_ITEM_INDEX_OWNER_ID] == i[AudioUtils.AUDIO_ITEM_INDEX_OWNER_ID])
                return e.list[o] = i, void AudioUtils.indexPlaylist(e)
    }), this._currentAudio[AudioUtils.AUDIO_ITEM_INDEX_ID] == i[AudioUtils.AUDIO_ITEM_INDEX_ID] && this._currentAudio[AudioUtils.AUDIO_ITEM_INDEX_OWNER_ID] == i[AudioUtils
        .AUDIO_ITEM_INDEX_OWNER_ID] && (this._currentAudio = i), this._notify(AudioPlayer.EVENT_UPDATE), i
    ...
    return AudioUtils.findAudioInPlaylist(i, t)[1]
