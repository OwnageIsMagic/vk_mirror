...
function AudioPlaylist(t, i, e) {
    ...
    var o = {};
    return t instanceof AudioPlaylist ? (this._ref = t, void getAudioPlayer()
...
if (!window.AudioUtils) {
    var AudioUtils = {
            ...
            stManager.add(["ui_controls.js", "ui_controls.css", "audio.css"], function() {
                ...
                if (ap.layer)
                    ...
                    ap.layer = new ElementTooltip(btn, {
                        ...
                        onHide: function(t, i) {
                            audioPage = data(ap.layer, "audio-page"), audioPage && audioPage.onHide(), removeClass(btn, "active"), i &&
                                topHeaderClearClose()
                        },
                        width: getLayerWidth,
                        setPos: function() {
        ...
        getContextPlaylist: function(t) {
            ...
            } else(r = gpeByClass("_module", t)) ? (e = a.getPlaylist(AudioPlaylist.TYPE_ALBUM, cur.oid, AudioUtils.AUDIO_ALBUM_ID_ALL), e.loadSilent(), o = [r]) : o = [
                domPN(t)
            ];
    ...
    TopAudioPlayer.TITLE_CHANGE_ANIM_SPEED = 190, TopAudioPlayer.init = function() {
            ...
            function t(t) {
                return hasClass(this, "top_audio_player_play") ? (i.ap.isPlaying() ? i.ap.pause() : i.ap.play(), !1) : hasClass(this, "top_audio_player_prev") ? (i.ap.playPrev(), !
                    1) : hasClass(this, "top_audio_player_next") ? (i.ap.playNext(), !1) : void 0
            }
            var i = this;
            ...
            function o() {
                ...
                if (0 != e) {
                    var s = 0 > e ? -10 : 10,
                        l = o.offsetLeft,
                        r = se('<div class="top_audio_player_title top_audio_player_title_next" style="opacity: 0; top:' + s + "px; left: " + l + 'px">' + t.performer +
                            " &ndash; " + t.title + "</div>");
        ...
        "live", AudioPlaylist.TYPE_WALL = "wall", AudioPlaylist.prototype.serialize = function() {
            ...
            function e(t) {
                if (!AudioUtils.isClaimedAudio(t)) {
                    ...
                    t = clone(t), t[AudioUtils.AUDIO_ITEM_INDEX_TITLE] = clean(replaceEntities(t[AudioUtils.AUDIO_ITEM_INDEX_TITLE])
                        .replace(/(<em>|<\/em>)/g, "")), t[AudioUtils.AUDIO_ITEM_INDEX_PERFORMER] = clean(replaceEntities(t[AudioUtils.AUDIO_ITEM_INDEX_PERFORMER])
                        .replace(/(<em>|<\/em>)/g, "")), t[AudioUtils.AUDIO_ITEM_INDEX_FLAGS] &= ~AudioUtils.AUDIO_ITEM_INLINED_BIT, a ? o._list.push(t) : o._list.splice(i, 0,
                        t), o._index && o._index.remove(t)
                }
            }
            this._unref();
            var o = this,
            ...
            if (!t) return -1;
            var i;
            isString(t) ? i = t : isObject(t) ? i = t.fullId : isArray(t) && (i = t[AudioUtils.AUDIO_ITEM_INDEX_OWNER_ID] + "_" + t[AudioUtils.AUDIO_ITEM_INDEX_ID]), i = i.split(
                "_");
        ...
        "loaded", AudioPlayer.EVENT_ENDED = "ended", AudioPlayer.EVENT_FAILED = "failed", AudioPlayer.EVENT_BUFFERED = "buffered", AudioPlayer.EVENT_PROGRESS = "progress",
        AudioPlayer.EVENT_VOLUME = "volume", AudioPlayer.EVENT_PLAYLIST_CHANGED = "plchange", AudioPlayer.EVENT_ADDED = "added", AudioPlayer.EVENT_REMOVED = "removed", AudioPlayer
        .LS_VER = "v10", AudioPlayer.LS_KEY_PREFIX = "audio", AudioPlayer.LS_PREFIX = AudioPlayer.LS_KEY_PREFIX + "_" + AudioPlayer.LS_VER + "_", AudioPlayer.LS_VOLUME = "vol",
        AudioPlayer.LS_PL = "pl", AudioPlayer.LS_TRACK = "track", AudioPlayer.LS_SAVED = "saved", AudioPlayer.LS_PROGRESS = "progress", AudioPlayer.LS_DURATION_TYPE = "dur_type",
    ...
    AudioPlayer.tabIcons = {
        ...
        if (void 0 === t.getPlaybackParams()) {
            ...
            if (t.getType() == AudioPlaylist.TYPE_FEED && (e.feed_audio = 1), t.getType() == AudioPlaylist.TYPE_ALBUM && (t.getAlbumId() == AudioUtils.AUDIO_ALBUM_ID_ALL && t.isPopBand() &&
                    (e.top_bands = 1, e.friend = t.getOwnerId()), t.getAlbumId() != AudioUtils.AUDIO_ALBUM_ID_ALL && (e.album = 1)), t.getType() == AudioPlaylist.TYPE_ALBUM &&
                nav.objLoc.friend) {
                var a = intval(nav.objLoc.friend);
                0 > a ? e.club = a : e.friend = a
            }
            "search" != cur.module || "audio" != nav.objLoc["c[section]"] || nav.objLoc["c[q]"] || (e.top = 1), (("groups" == cur.module || "public" == cur.module) && cur.oid ==
                    i.ownerId && cur.oid < 0 || cur.audioPage && cur.audioPage.options.oid == i.ownerId && cur.audioPage.options.oid < 0) && (e.group = 1), (("audio" == cur.module ||
        ...
        var e = domClosest("_audio_row", t),
            o = AudioUtils.getAudioFromEl(e, !0),
            a = hasClass(e, "claimed");
        if (a) {
            var s = domData(e, "claim-id"),
                l = domData(e, "delete-hash"),
                r = domData(e, "title");
            return void showAudioClaimWarning(domData(e, "owner-id"), domData(e, "id"), l, s, r)
        }
        var u = hasClass(e, AudioUtils.AUDIO_PLAYING_CLS);
        if (u) this.pause();
        else {
            var n = AudioUtils.getContextPlaylist(e),
                d = domData(e, "live");
            if (d) {
                var _ = this.getAudioPlaylistPosition(o.fullId, n);
                _ >= 0 && (n.list = [n.list[_]], n.total = 1), n.live = d, this.startListenLive(d)
            }
            this.play(o.fullId, n)
        }
    }, AudioPlayer.prototype._onFailedUrl = function(t) {
        this.pause(), this.notify(AudioPlayer.EVENT_FAILED), this.playNext(!0)
