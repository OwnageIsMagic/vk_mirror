var slide_show = function(e) {
    ...
    searcher = {
        getSectionParams: function(e) {
            ...
            for (var r in t) t[r] && "0" != t[r] || delete t[r], "-1" == t[r] && t[r + "_custom"] ? (t[r] = t[r + "_custom"], delete t[r + "_custom"]) : t[r + "_custom"] &&
                delete t[r + "_custom"];
            return "video" != cur.section || t["c[sort]"] || (t["c[sort]"] = "0"), "people" == cur.section && ge("c[name]") && !t["c[name]"] && (t["c[name]"] = "0"), "people" ==
                cur.section && ge("c[photo]") && !t["c[photo]"] && (t["c[photo]"] = "0"), "communities" != cur.section || !cur.filtersShown || t["c[q]"] || t["c[category]"] ||
                (t["c[skip_catalog]"] = "1"), t
        },
        ...
        updResults: function() {
            ...
            return searcher.sameParams(e) || "video" == e["c[section]"] && !e["c[q]"] && !nav.objLoc["c[q]"] ? !1 : (cur.onSearchChange && cur.onSearchChange(e), searcher.sendSearchReq(
                e, ("auto" == cur.section || "audio" == cur.section && e["c[q]"] && !ge("audio_lyrics_filter") || "audio" == cur.section && !e["c[q]"] && ge(
                    "audio_lyrics_filter")) && !e.offset), void(hasClass(gpeByClass("ui_search", "search_query"), "ui_search_fixed") && scrollToTop()))
        },
        ...
        onEnter: function(e, s) {
            window.iSearch && iSearch.select && iSearch.select.isVisible() && iSearch.select.active > -1 || (clearTimeout(cur.requestTimeout), ge("search_filters_minimized") &&
                searcher.toggleMinimizedFilters(!!val(e), !0), searcher.updResults(), searcher.highlightHotHashtag(s))
        },
            ...
            s && !e.offset && (vk.no_ads = inArray(e["c[section]"], ["audio"]), extend(e, {
                ...
                cur.searchLoc && (e.search_loc = cur.searchLoc), void 0 !== cur.topType && (e.type = cur.topType, delete cur.topType), window.iSearch && iSearch.select && (
                    ...
                    onDone: function(t, r, o) {
                        ...
                        if (c.innerHTML = r || "", s && (i.innerHTML = o || "", ge("search_query")
                                .focus(), t.loc)) {
        ...
        applyOptions: function(options, changeSection) {
            if (iSearch.initSelect(), searcher.setSection(options.section), options.reply_names && (extend(cur.options.reply_names, options.reply_names), delete options.reply_names),
                extend(cur, options), cur.params = searcher.getSectionParams(), options.tabs ? (val("search_tabs_wrap", options.tabs), hide("search_header"), show(
                    "search_tabs_wrap")) : options.title && (val("search_header_text", options.title), hide("search_tabs_wrap"), show("search_header")), options.summary ? val(
                    "search_summary", langNumeric(options.summary, "%s", !0)) : void 0 != options.summary && val("search_summary", ""), void 0 != options.controls && val(
                    "search_header_controls", options.controls || ""), void 0 !== options.auto_rows && ge("search_auto_rows") && (ge("search_auto_rows")
                    .innerHTML = options.auto_rows || ""), clearTimeout(cur.setLocTO), options.loc)
                if (changeSection) try {
                    nav.setLoc(options.loc)
                } catch (e) {
                    debugLog(e)
                } else cur.setLocTO = setTimeout(function() {
                    if ("search" == nav.objLoc[0] || "communities" == nav.objLoc[0] || "brands" == nav.objLoc[0] || nav.objLoc[0].match(/^people($|\/)/) || cur.searchLoc)
                        try {
                            nav.setLoc(options.loc)
                        } catch (e) {
                            debugLog(e)
            ...
            cur.uiSort && void 0 !== options.sortHide && (options.sortHide && cur.uiSort.selectItem(0, !1), cur.uiSort.disable(options.sortHide)), "auto" == cur.section &&
                show(geByClass1("search_menu_auto", "search_menu")), options.top_hashtags && !ge("search_hot_hashtags") ? ge("search_menu")
                .insertAdjacentHTML("afterend", options.top_hashtags) : "statuses" != options.section && re("search_hot_hashtags"), options.script && eval(options.script);
            var res = ge("results"),
                sc = ge("search_content"),
                lighted = hasClass(sc, "highlight");
            res.className = "search_results search_" + cur.section + "_results" + ("statuses" == cur.section || "auto" == cur.section ? " wall_module" : "") + ("statuses" !=
                cur.section ? " page_block" : ""), cur.uiSearchPageBlock = res, lighted && addClass(sc, "highlight");
            var more_results = ge("search_more_results");
            cur.has_more || more_results && more_results.firstChild ? (hide("seach_pages"), show("show_more_link")) : hide("show_more_link")
        },
        toggleHotHashtags: function(e) {
            function s(e, s, t) {
                return animate(e, {
                    height: "show",
                    paddingBottom: "show"
            ...
            var r = geByClass1("search_hot_hashtags_toggle_btn", "search_hot_hashtags"),
                o = geByClass1("search_hot_hashtags_wrap", "search_hot_hashtags"),
                c = isVisible(o);
            isUndefined(e) && (e = !c), e != c && (e ? (hide(r), s(o, 500)) : t(o, 300, function() {
                fadeIn(r, 300)
            }))
        },
        ...
        highlightHotHashtag: function(e) {
            ...
            return each(t, function(t, r) {
                val(r)
                    .toLowerCase() == e ? (s = !0, addClass(r, "search_hot_hashtags_item_active")) : removeClass(r, "search_hot_hashtags_item_active")
            }), s
        },
        ...
        switchFilter: function(e, s, t) {
            return checkEvent(t) ? !1 : (ge("c[" + e + "]") && (ge("c[" + e + "]")
                .value = s), "video" == cur.section && "quality" == e && ge("c[hd]") && (ge("c[hd]")
                .value = 0 > s ? 0 : 1), void searcher.updResults())
        },
        ...
        showMore: function() {
            ...
            if (s && searcher.appendElements(s), !cur.has_more) return void hide("show_more_link");
            cur.disableAutoMore = !1, cur.isSearchLoading = !0, addClass("show_more_link", "load_more");
            ...
            t.edit = nav.objLoc.edit, t.sign = nav.objLoc.sign, t.all = nav.objLoc.all, ajax.post("al_search.php", t, {
                onDone: function(s, t) {
                    cur.isSearchLoading = !1, t && (ge("no_results") && re("no_results"), ge("results")
                        .insertBefore(ce("div", {
                            innerHTML: t,
                            id: "search_more_results"
                        }), e)), removeClass("show_more_link", "load_more"), searcher.applyOptions(s), searcher.scrollCheck()
                },
        ...
        toggleMinimizedFilters: function(e, s) {
            function t(e, s, t) {
                return animate(e, {
                    height: "show",
                    paddingTop: "show",
            ...
            var r = s ? 0 : 500;
            return void 0 === e && (e = !isVisible("search_filters_block")), !e && isVisible("search_filters_block") ? (cur.filtersShown = !1, slideUp("search_filters_block",
                r,
                function() {
                    show("search_filters_minimized")
                })) : e && !isVisible("search_filters_block") && (cur.filtersShown = !0, val("c[category]", 0), uiRightMenu.switchMenu(geByClass1("search_menu_communities",
                "search_menu")), hide("search_filters_minimized"), t("search_filters_block", r)), !1
        },
        subscribe: function(e, s, t, r, o, c, i) {
            ...
            if (cur.unsubscribed = cur.unsubscribed || {}, !r && c && !cur.unsubscribed[s]) {
                var h = showFastBox({
                    ...
                    h.hide(), searcher.subscribe(e, s, t, r, o)
        ...
        init: function(e) {
            ...
            r && r.showCurrentTrack && r.showCurrentTrack(), cur._back = {
                ...
                show: [function() {
                    ...
                    e && globalHistory[e - 1] && globalHistory[e - 1].loc.indexOf("search") && (cur.search_return_to = globalHistory[e - 1].loc), addEvent(window,
                        "scroll", searcher.scrollCheck), addEvent(window, "resize", searcher.onResize), iSearch.destroy(), vk.id && iSearch.init(ge(
                        "search_query"))
                }],
                hide: [function() {
...
void 0 === window.iSearch && (iSearch = {
    init: function(e, s) {
        if (!this.inited) {
            ...
            this.cont.appendChild(r), this.resultList = geByClass("result_list", r)[0], hide(this.resultList), browser.chrome && (this.resultList.style.opacity = 1),
                this.resultList.style.width = r.style.width = "552px", this.onShowCallback = s ? s.onShow : !1, this.initSelect(s), addEvent(e, "keyup click mouseup",
                    t.inputUpHandler), addEvent(document, "click", t.documentClick), addEvent(e, "keypress keydown", t.inputDownHandler), ge("top_search") && (ge(
                        "top_search")
                    .onclick = function(e) {
                        return hab.getLoc()
    ...
    inputUpHandler: function(e) {
        var s = iSearch;
        if (s.select) {
            if ((s.select.isVisible() && s.select.active > -1 || cur.preventISRequest) && (delete cur.preventISRequest, inArray(e.keyCode, [KEY.UP, KEY.DOWN, KEY.PAGEUP,
    ...
    inputDownHandler: function(e) {
        ...
        if (s.select) {
            ...
            if (e.keyCode == KEY.SPACE || (e.keyCode == KEY.RETURN || 10 == e.keyCode) && s.select && s.select.isVisible()) {
                ...
                return val(s.input, t[3] + (e.keyCode == KEY.SPACE ? " " : "")), elfocus(s.input, s.input.length), e.keyCode != KEY.SPACE && (cur.preventISRequest = !0,
                    s.select.hide(), searcher.updResults()), cancelEvent(e)
            }
    ...
    onItemSelect: function(e) {
        if (this.select) {
            ...
            if (each(this.lastItems, function() {
                ...
                val(this.input, t.innerText || t.textContent), this.input.blur(), searcher.updResults(), ge("search_filters_minimized") && searcher.toggleMinimizedFilters(!
                    !ge("search_query")
                    .value, !0)
            }
        }
    ...
    destroy: function(e) {
        cleanElems(this.resultList), clearTimeout(e ? e.requestTimeout : cur.requestTimeout), removeEvent(this.input, "keyup click mouseup", this.inputUpHandler),
    ...
    showLyrics: function(e, s, t) {
        ...
        r ? isVisible(r) ? hide(r) : show(r) : (r = ce("div", {
            ...
            .appendChild(r), ajax.post("/al_audio.php", {
                act: "get_lyrics",
                lid: s,
                aid: e,
                top: t
    ...
    selectCategory: function(e, s, t) {
        ge("c[category]")
            .value = s, uiRightMenu.switchMenu(e);
        var e = ge("search_query");
        return val(e) && (val(e, ""), e.focus(), triggerEvent(e, "keyup")), searcher.toggleMinimizedFilters(!1), searcher.updResults(), !1
    },
    ...
    chooseGeoPoint: function(e, s, t, r) {
        ...
        var c = (new Array(o + 1)
            ...
            i = 200,
            a = 120;
        window.devicePixelRatio >= 2 && (i *= 2, a *= 2), e = Math.round(e * c) / c, s = Math.round(s * c) / c;
    ...
    searchUrlOnChange: function(e, s, t) {
        var r = ge("search_status_url"),
            o = r.name,
            c = s ? "c[domain]" : "c[url]";
        return radiobtn(e, s, "search_status_hint_domain"), elfocus(r), c != o && (r.name = c, searcher.updResults()), cancelEvent(t)
    }
};
try {
