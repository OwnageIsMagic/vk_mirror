function AudioPage(e, i, t, o) {
    ...
    addTemplates({
        ...
        .canAudioAddToGroup, this.ap = getAudioPlayer(), ap.langs = t.langs, extend(cur.lang || {}, t.langs), i.type ? (i = new AudioPlaylist(i), i.loadSilent()) : i = this.ap.getCurrentPlaylist(),
...
AudioPage.address = "audio", AudioPage.onSearchFocused = function(e) {
    ...
    return ajax.post("al_audio.php", n, {
        ...
        onDone: function(i, t, o, a) {
            var n = getAudioPlayer(),
                l = n.getPlaylist(AudioPlaylist.TYPE_ALBUM, s, i);
            if (l.clean(), l.mergeWith({
                    list: a,
                    hasMore: !1
                ...
                var d = geByClass1("ui_rmenu", cur.audioPage._container),
                    u = domPN(d);
                u.replaceChild(se(o), d), cur.audioPage._initAlbumsSort()
            }
            curBox()
    ...
    switch (e) {
        case "performer":
            var o = "audio_search_type_" + intval(t.options.isLayer),
    ...
    var i = "audio_search_type_" + intval(this.options.isLayer),
        t = window.radioBtns[i];
    radiobtn(t.els[e.performer ? 1 : 0], !!e.performer, i);
    var o = e.sort;
    ...
    if (!this._muteFilterEvent) {
        var i = window.radioBtns["audio_search_type_" + intval(this.options.isLayer)],
    ...
    this.searchInputEl = geByClass1("_field", e), uiSearch.init(e), window.radioBtns["audio_search_type_" + intval(this.options.isLayer)] = {
    ...
    if (e = trim(e)) {
        var o = this,
            ...
            s = (getSize(a)[1], se('<div class="audio_friends_list _audio_friends_list" style="opacity: 0; position: absolute; top: 0;">' + e + "</div>"));
    ...
    function i(i, t, o) {
        var s = domData(i, "full-id"),
            ...
            d = e.indexOfAudio(r),
            u = e.indexOfAudio(n);
        r ? e.moveAudio(l, d) : n && e.moveAudio(l, u + 1), a.isLayer() || (s = s.split("_")[1], r = r ? r.split("_")[1] : "", n = n ? n.split("_")[1] : "", ajax.post(
            "al_audio.php", {
                act: "reorder_audios",
                oid: a.options.oid,
                aid: intval(s),
        ...
        var n = this.isLayer() ? {} : {
            ...
            onDragDrop: function(i, o) {
                ...
                var n = a.getCurrentPlaylist(),
                    l = n.indexOfAudio(r);
                if (n.getAlbumId() != AudioUtils.AUDIO_ALBUM_ID_ALL && l >= 0) n.removeAudio(r), a.switchToSection(n);
                else {
                    var d = a.ap.getPlaylist(AudioPlaylist.TYPE_ALBUM, a.options.oid, s);
                    d.clean()
                }
                var u = {};
    ...
    this._autoList = new AutoList(o, {
        ...
        onRendered: function() {
            t(!1), s.isLayer() && s.getLayer()
                .sb.update(), s.ap.updateCurrentPlaying()
        },
        onNeedRows: function(l, d, u, _) {
            function h(e) {
                if (e) {
                    0 == d && (o.innerHTML = "");
                    var t = !1,
                        a = !1;
                    if (e.getType() == AudioPlaylist.TYPE_FEED && e != ap.getCurrentPlaylist()) c = e.getItemsList()
                        .slice(d, d + r);
                    else {
                        p = e.getAudiosList()
                            .slice(d, d + r);
                        ...
                        each(p, function(i, o) {
                            t && d + i == e.getLocalFoundCount() && c.push("<h3>" + langNumeric(e.getTotalCount(), ap.langs.audio_global_search_found, !0) +
                                ...
                                "$1<em>$2</em>"), c.push(AudioUtils.drawAudio(o))
                        }), a && (i.innerHTML = "", a = !1)
                    }
                    if (l(c), !d && !s.options.isLayer) {
            ...
            var p, c = [];
            n = d, _ || t(!0), d > 0 && (show(a), lockButton(a)), e.load(d, function(e) {
                h(e)
            })
        }
    ...
    if (this.isLayer()) {
        ...
        return setStyle(t, {
            ...
            var l = (getSize(e)[1], getSize(i)[1], i.scrollTop - o);
            o = i.scrollTop, a -= l, a = Math.max(getSize(i)[1] - getSize(e)[1], a), a = Math.min(0, a), setStyle(e, "top", a);
            var d = geByClass1("_audio_padding_cont", r._container);
            i.scrollTop > 0 ? (setStyle(d, {
                "padding-top": s[1]
            }), addClass(t, "fixed")) : (setStyle(d, {
                "padding-top": null
            }), removeClass(t, "fixed"))
        })
    }
    ...
    addEvent(window, "scroll", this._ev_onScroll = function() {
        scrollGetY() >= h - _ ? (addClass(n, "fixed"), setStyle(d, {
            "padding-top": l,
            "z-index": 2
        })) : (removeClass(n, "fixed"), setStyle(d, {
            "padding-top": null
        }))
    }), this.options.isLayer || cur.destroy.push(function() {
        removeEvent(window, "scroll", r._ev_onScroll)
    })
}, AudioPage.prototype._updateRowsList = function(e, i) {
    if (e) {
        var t = geByClass1("_audio_playlist", this._container);
        geByClass1("_ui_load_more_btn", this._container);
        this._initAutoList(e, t, function(o) {
            o || data(t, "playlist", e), i && i(o)
    ...
    if (e.getAudiosCount()) hide(i);
        ...
        var t = "",
            o = e.getType();
        t = o == AudioPlaylist.TYPE_ALBUM ? AudioPlayer.getLang("audio_no_rec_load_msg") : o == AudioPlaylist.TYPE_SEARCH ? AudioPlayer.getLang("audio_no_audios_found")
    ...
    var t = this,
        o = this._getMenuEl(),
        a = null;
    if (e == this.ap.getCurrentPlaylist()) a = geByClass1("_ui_item_audio_current", o);
    else switch (e.getType()) {
        case AudioPlaylist.TYPE_RECOM:
            a = geByClass1("_ui_item_audio_recoms_" + e.getOwnerId(), o);
            break;
        case AudioPlaylist.TYPE_FEED:
            a = geByClass1("_ui_item_audio_feed_" + vk.id, o);
            break;
        case AudioPlaylist.TYPE_ALBUM:
            a = geByClass1("_ui_item_audio_" + e.getId(), o);
            break;
        case AudioPlaylist.TYPE_POPULAR:
            var s = this._normalizePlaylistId(e);
            a = geByClass1("_ui_item_audio_" + s, o)
    }
    a ? (this._unselectFriends(), removeClass(a, "unshown"), uiRightMenu.switchMenu(a)) : uiRightMenu.unselectAll(this._getMenuEl());
    var r = e.getBlocks(),
        n = "_ui_item_audio_" + AudioPlaylist.TYPE_POPULAR + "_" + this.options.oid + "_0",
        l = geByClass1(n, this._getMenuEl()),
        d = geByClass1("_ui_item_audio_popular_" + this.options.oid, this._getMenuEl());
    if (r.submenu && !l) {
        var u = se(r.submenu);
        domInsertAfter(u.children[1], d), domInsertAfter(u.children[0], d), l = geByClass1(n, this._getMenuEl()), uiRightMenu.switchMenu(l)
    }
    var _ = geByClass1("_ui_item_audio_genres", this._getMenuEl());
    isVisible(d);
    if (e.getType() == AudioPlaylist.TYPE_POPULAR) {
        show(_), show(domNS(_)), hide(d), uiRightMenu.hideSliding(this._getMenuEl());
    ...
    } else hide(_), hide(domNS(_)), show(d);
    var p = geByClass1("_audio_foreign_filter_block", this._container);
    toggle(p, e.getType() == AudioPlaylist.TYPE_POPULAR), setTimeout(function() {
        ...
        this._blocks || {}, e.getType() == AudioPlaylist.TYPE_SEARCH && r.search && (this._blocks[e.getId()] = r.search), each(r, function(e, i) {
    ...
    switch (e.getType()) {
        ...
        case AudioPlaylist.TYPE_FEED:
            var g = e.getOwnerId();
            e.getType() == AudioUtils.AUDIO_PLAYLIST_TYPE_ALBUM && e.isPopBand() ? c.push("pop_band_" + g) : 0 > g ? c.push(this._prevSearchPlaylistId) : c.push("friends");
            break;
        case AudioPlaylist.TYPE_RECOM:
            c.push("recoms");
            break;
    ...
    return
}, AudioPage.prototype._loadMorePaginatedPlaylist = function(e, i, t) {
    ...
    this._prevSearchPlaylistId = null, cur.nav.push(this._nav_func = function(i, t, o, a) {
        ...
        if (each(cur._audioAddRestoreInfo || {}, function(e, i) {
                "deleted" == i.state && getAudioPlayer()
        ...
        if (this.options.isLayer && (a.hist || a.back || i[0] && 0 != i[0].indexOf("audio"))) return this.options.eltt.hide(), !0;
        if (0 == Object.keys(i)
        ...
        if (this._unselectFriends(), o.q) {
            ...
            each(["performer", "lyrics", "sort"], function(e, i) {
                ...
                }), u = hashCode(u), l = this.ap.getPlaylist(AudioPlaylist.TYPE_SEARCH, this.options.oid, u), l.mergeWith({
                    searchParams: _
            ...
            var h = hasClass(this._getForeignTogglerEl(), "on") ? "foreign" : "";
            l = this.ap.getPlaylist(AudioPlaylist.TYPE_POPULAR, vk.id, h + intval(o.genre))
        } else if (o.friend) {
            var p = intval(o.friend),
                c = geByClass1("_audio_friend_" + p, this._container);
            addClass(c, "audio_friend_selected"), l = this.ap.getPlaylist(AudioPlaylist.TYPE_ALBUM, p, AudioUtils.AUDIO_ALBUM_ID_ALL), geByClass1("_audio_friend_" + p) ||
                this.showMoreFriends(!1, p)
        } else if (o.section == AudioPlaylist.TYPE_RECOM) {
            var g = AudioUtils.AUDIO_ALBUM_ID_ALL;
            o.audio_id ? g = "audio" + o.audio_id : o.album_id && (g = "album" + o.album_id), l = this.ap.getPlaylist(AudioPlaylist.TYPE_RECOM, this.options.oid, g);
        ...
        return o.section != AudioUtils.AUDIO_PLAYLIST_TYPE_RECOMS && (delete o.audio_id, o.section && delete o.album_id), r && (this._prevRenderedPlaylistId = !1, val(
            ...
            this._muteFilterEvent = !1), this.options.isLayer ? e = o : nav.setLoc(o), this.syncFilters(o), this.switchToSection(l, !0), !1
    }.bind(this))
    ...
    function e(e) {
        e = AudioUtils.asObject(e), l.innerHTML = e.performer, d.innerHTML = "&ndash; " + e.title
    }
    ...
    function t() {
        if (o._trackSlider) {
            ...
            addClass(h, "no_transition"), toggleClass(h, "audio_player_btn_added", !(!r || "added" != r.state)), removeClassDelayed(h, "no_transition")
        }
    }
    var o = this,
        a = getAudioPlayer(),
        ...
        n = (geByClass1("audio_player_controls", r), geByClass1("audio_page_line_player", r), geByClass1("audio_page_player_volume_wrap", r), geByClass1(
            "audio_page_player_progress", r), geByClass1("audio_page_player_progress_line", r), geByClass1("audio_page_player_volume_line", r), geByClass1(
            "audio_page_player_title", r)),
        l = geByClass1("audio_page_player_title_performer", r),
        d = geByClass1("audio_page_player_title_song", r),
        u = geByClass1("audio_page_player_duration", r),
        _ = geByClass1("_audio_page_player_play", r),
        h = (geByClass1("audio_page_player_title", r), geByClass1("_audio_page_player_add", r)),
        p = void 0;
    t(), this._trackSlider = new Slider(geByClass1("audio_page_player_track_slider", r), {
        ...
        e = AudioUtils.asObject(e), e && e.fullId == i && addClass(h, "audio_player_btn_added")
    }), this.ap.on(this, AudioPlayer.EVENT_REMOVED, function(e, i) {
        e = AudioUtils.asObject(e), e && e.fullId == i && removeClass(h, "audio_player_btn_added")
    ...
    var c = this.ap.getCurrentAudio() || this._readyAudio;
    c && (domData(r, "audio", JSON.stringify(c)), e(c)), t()
