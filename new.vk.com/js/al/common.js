...
function updateNarrow() {
    ...
    var wh = window.lastWindowHeight || 0,
        ...
        barMT = intval(getStyle(barBlock, 'marginTop')),
        barH = intval(getSize(bar)[1]) - (isFixed ? barMT : 0),
        pageH = intval(getSize(wideCol)[1]),
        pagePos = wideCol.offsetTop,
...
function updateLeftMenu() {
    ...
    var wh = window.lastWindowHeight || 0,
        ...
        head = ge('page_header_wrap'),
        headH = getSize(head)[1],
        menuH = intval(getSize(menu)[1]),
        menuPos = getXY(menu)[1],
