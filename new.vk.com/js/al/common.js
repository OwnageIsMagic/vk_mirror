...
function lockButton(e) {
    if ((e = ge(e)) && ("button" == e.tagName.toLowerCase() || hasClass(e, "wr_header") || hasClass(e, "_ui_load_more_btn")) && !isButtonLocked(e)) {
        var t = getSize(e);
...
function autosizeSetup(e, t) {
    if (e = ge(e)) {
        ...
        1 > n && (n = intval(getStyle(e, "width", !1))), a.indexOf("em") > 0 && (a = floatval(a) * vk.fs), a = intval(a), e.autosize = {
                options: t,
                helper: ce("textarea", {
                    className: "ashelper"
                }, {
                    ...
                    padding: t.ignorePadding ? "0" : getStyle(e, "padding")
                }),
...
function showVideo(e, t, o, n) {
    ...
    var l = new callHub(function() {
        o.hidden ? o.hidden(l.data, o, t, e) : (revertLastInlineVideo(), videoview.showVideo.apply(videoview, l.data))
    }, 2);
    stManager.add(i, function() {
        o.hidden || videoview.show(n, e, t, o), l.done()
    }), extend(o, {
        onDone: function() {
...
function showInlineVideo(videoId, listId, options, ev, thumb) {
    ...
    return extend(options.params, {
        ...
        _videoLastInlined = [videoWrap, thumb], thumb.parentNode.appendChild(videoWrap), videoBg && setStyle(geByTag1("img", videoBg), {
            width: w,
            height: h
        }), cur.mvOpts = opts && opts.mvData ? opts.mvData : !1;
        try {
            eval("(function () {" + js + "})();")
        } catch (e) {}
...
function revertLastInlineVideo(e) {
    if (_videoLastInlined) {
        ...
        re(_videoLastInlined[0]), show(_videoLastInlined[1]), _videoLastInlined = !1, delete cur.mvOpts
    }
}
...
function mentionOver(e, t) {
    t = t || {}, showTooltip(e, {
        ...
        slide: 15,
        dir: "auto",
        appendEl: domClosest("rb_box_wrap", e) || domClosest("wk_cont", e) || domClosest("scroll_fix_wrap", e)
    })
}
...
TopSearch = {
    ...
    row: function(e, t, o, n, a, i, r, s) {
        ...
        return i && (n = n.replace(i, '$1<em class="ts_clist_hl">$2</em>')), inArray(r, ["h_friends", "h_correspondents", "h_chats"]) && (l = e), s || (s = ""),
            ...
            r + '"><span class="ts_contact_photo fl_l"><img src="' + o + '"/></span><span class="ts_contact_name fl_l">' + n + '<div class="ts_contact_info">' + s +
