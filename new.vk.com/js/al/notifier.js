...
var TopNotifier = {
    ...
    show: function(ev) {
        ...
        if (!cont) {
            var c = ce('div', {
                innerHTML: '<div class="top_notify_header"><a href="/settings?act=notify" class="top_notify_prefs_lnk">' + getLang('global_notifications_settings') +
                    '</a>' + getLang('global_last_notifitications') +
