...
FastChat = {
    ...
    clistWrapPeer: function(id, data, re) {
        ...
        return '<a href="' + href + '" class="fc_contact clear_fix' + cls + '" id="fc_contact' + id + '" onclick="return FastChat.selectPeer(' + id +
            ...
            photoEvents + '>' + photoStr + '</span><span class="fc_contact_status"></span><span class="fc_contact_name">' + name + '<span id="fc_contact_unread' + id +
            '" class="fc_contact_unread">' + (unread ? ' <b>+' + unread + '</b>' : '') + '</span></span></a>';
    },
