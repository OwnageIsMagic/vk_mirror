...
extend(IdleManager.prototype, EventEmitter.prototype), extend(IdleManager.prototype, {
    ...
    initCommunityQueues: function(t) {
        var e = ls.get("im_m_comms_key"),
            i = e && e.split ? e.split(";") : [];
        return "empty" === i[0] && i[1] && Date.now() - i[1] < 6e4 ? e = "empty" : "empty" === i[0] && (e = !1), e ? Notifier.proccessCommunityQueues(e, t || 0) : void ajax
            .post("al_im.php", {
                act: "a_get_comms_key"
            }, {
                onDone: function(e) {
            ...
            var v = h + s[0] - e - c,
                ...
                C = function(t) {
                    removeEvent(document, "mousemove", g), removeEvent(document, "mouseup", C), removeEvent(document, p, cancelEvent), setStyle(bodyNode, "cursor", ""),
                        setStyle(o, "cursor", ""), (a.toBottom = u == v) && (setStyle(a.wrap, {
                            top: "auto",
                            bottom: 0
        ...
        return each(e, function(e, i) {
            ...
            switch (o[1]) {
                case "new":
                    ...
                    break;
                case "read":
                    each(o[3].split(","), function(t, e) {
                        var a = ge("fc_msg" + e),
                            o = a && a.parentNode;
                        a && (i.msgs[e] && i.msgs[e][1] && (i.msgs[e][1] = 0, i.msgs[e][0] || i.unread--), removeClass(a, "fc_msg_unread"), hasClass(o.parentNode,
                            "fc_msgs_unread") && each(o.childNodes, function() {
                            return hasClass(this, "fc_msg_unread") ? void 0 : (removeClass(o.parentNode, "fc_msgs_unread"), !1)
                        }))
                    });
                    break;
                case "typing":
    ...
    TopNotifier = {
        ...
        show: function(t) {
            if (checkEvent(t) !== !0 && !vk.isBanned) {
                if (t !== !0 && TopNotifier.tooglePrefs(!1, 0), this.shown() && t !== !0) return gpeByClass("top_notify_wrap", t.target, ge("top_nav")) || this.hide(),
                    cancelEvent(t);
                ...
                if (e.tt && e.tt.hide && e.tt.hide(), !i) {
                    var a = ce("div", {
                        innerHTML: '<div class="top_notify_header">' + getTemplate("top_notify_prefs") + getLang("global_last_notifitications") +
                            '</div><div id="top_notify_cont" class="top_notify_cont wall_module"  ontouchstart="event.cancelBubble = true;" onmousedown="event.cancelBubble = true; TopNotifier.tooglePrefs(false, 0);"></div><a href="/feed?section=notifications" class="top_notify_show_all" onmousedown="event.cancelBubble = true;" onclick="TopNotifier.hide(); return nav.go(this, event);">' +
                ...
                return cur.tnScrollbar || (cur.tnScrollbar = new Scrollbar("top_notify_cont", {
                    nomargin: !0,
                    right: vk.rtl ? "auto" : 0,
                    left: vk.rtl ? 0 : "auto",
                    forceCancelEvent: !0,
        ...
        hide: function() {
            removeClass(this.tnLink, "active"), topHeaderClearClose(), TopNotifier.tooglePrefs(!1, 0)
        },
        shown: function() {
        ...
        tooglePrefs: function(t, e) {
            ...
            return void 0 === e && (e = !hasClass(i, "shown")), uiActionsMenu.toggle(i, e), t && cancelEvent(t)
        },
        clickPref: function(t, e) {
            if (cur.topNotifyHash) {
                var i = toggleClass(t, "checked");
                cur.topNotifyPrefs || (cur.topNotifyPrefs = {}), cur.topNotifyPrefs[e] = i, checkbox("filter_notifications" + e, i), clearTimeout(cur.saveNotifyPrefsTO), cur.saveNotifyPrefsTO =
                    setTimeout(function() {
                        var t = [];
                        each(cur.topNotifyPrefs, function(e, i) {
                            t.push((i ? "" : "-") + e)
                        }), t = t.join(","), ajax.post("/al_feed.php", {
                            act: "a_set_notify_prefs",
                            prefs: t,
                            hash: cur.topNotifyHash
                        }, {
                            onDone: function() {
                                cur.topNotifyPrefs = {}, TopNotifier.invalidate(), TopNotifier.show(!0), "notifications" == cur.section && window.feed && nav.go(
                                    nav.strLoc)
                            }
                        })
                    }, 500), TopNotifier.showProgress()
            }
        }
    };
try {
