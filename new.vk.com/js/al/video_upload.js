var VideoUpload = {
    ...
    showBox: function(e) {
        return cur.uploadBanned ? (setTimeout(showFastBox({
            ...
            .hide, 5e3), !1) : ge("video_upload_tab") || 4 != vk.al ? (e = e || {}, e = extend(e, {
            act: "upload_box",
            oid: cur.oid,
            ocl: cur.ocl ? 1 : 0
    ...
    startEvents: function() {
        ...
        addEvent(e, "scroll", VideoUpload.checkResize), addEvent(window, "resize", VideoUpload.checkResize)
    },
    stopEvents: function() {
        var e = browser.msie6 ? pageNode : window;
        removeEvent(e, "scroll", VideoUpload.checkResize), removeEvent(window, "resize", VideoUpload.checkResize)
    },
    ...
    onShowUploadPanel: function() {
        ge("video_upload_box_placeholder") && removeClass(ge("video_upload_box_wrapper"), "video_upload_hide")
    },
    checkResize: function() {
        VideoUpload.doResize(), cur.uploadVideoResizeTimeout && clearTimeout(cur.uploadVideoResizeTimeout), cur.uploadVideoResizeTimeout = setTimeout(VideoUpload.doResize,
            1)
    },
    destroyTab: function() {
    ...
    initUpload: function(url, vars, uploadLang, uploadOpts, uiLang, itemTemplate) {
        ...
        if (hashs[vars.tag] = uploadOpts.update_db_hash, cur.videoHashs = extend(cur.videoHashs || {}, hashs), !ge("video_dropbox")) {
            var p = ge("video_upload_box_tab")
                .parentNode.parentNode.parentNode,
                d = se(
                    '<div id="video_dropbox" class="dropbox choose">          <div class="dropbox_wrap">            <div class="dropbox_area">              <div class="dropbox_label">' +
                    uploadLang.drop_files_here + "</div>            </div>          </div>        </div>");
            p.appendChild(d)
        }
        var el;
        ...
        var placeholder = ge("video_upload_box_placeholder"),
            initButton = function() {
                ...
                uploadErrorInfo && (hide(uploadErrorInfo), setTimeout(function() {
                    ...
                    setStyle(el, "width", e[0]), setStyle(el, "height", e[1]), setStyle(placeholder, "width", e[0]), setStyle(placeholder, "height", e[1]),
                        VideoUpload.doResize(), placeholder.removeChild(domFC(placeholder))
                    ...
                    onUploadStart: function(e, o) {
                        ...
                        var d = function() {
                            ...
                            if (i ? (addClass(o, "video_upload_with_divider"), d.insertBefore(o, domNS(ge("video_upload_no_video")))) : (d.appendChild(
                                    o), i = geByClass1("video_upload_item_panel", d)), hide("video_upload_no_video"), cur.ocl && cur.oid > 0) {
                                each(geByClass("video_upload_privacy"), hide), hide("video_edit_repeat"), hide(geByClass1("video_upload_status_export")),
                            ...
                            if (vars.oid > 0 && (cur.privacy["video" + vars.tag] || (cur.privacy["video" + vars.tag] = cur.privacy.video, cur.privacy[
                                        "videocomm" + vars.tag] = cur.privacy.video), Privacy.update("video" + vars.tag), Privacy.update("videocomm" +
                                        vars.tag), cur.tag2ElMap = cur.tag2ElMap || {}, cur.tag2ElMap[vars.tag] = o, cur.onPrivacyChanged = VideoUpload
                                    .onPrivacyChanged), curBox() && curBox()
                                .hide(), hide("video_main_block"), hide("videocat_other_blocks"), show("video_upload_block"), cur.videoReupload && (
                                    VideoUpload.deleteItem(cur.videoReupload, !1), delete cur.videoReupload), show(d), show(o), e.fileName) {
                                var r, l = e.fileName,
                            ...
                            VideoUpload.videoUploadCallback && (VideoUpload.videoUploadCallback(), delete VideoUpload.videoUploadCallback), cur.videoThumbUploadOpts &&
                                isObject(cur.videoThumbUploadOpts) && VideoUpload.initThumbUpload(cur.videoThumbUploadOpts, o), VideoUpload._uploadAlbumChooser =
                                VideoUpload._uploadAlbumChooser || {}, cur.videoPlaylists && cur.videoPlaylists.length ? VideoUpload._uploadAlbumChooser[
                                    a] = new Dropdown(geByClass1("video_upload_album_chooser_input", o), [
                                ...
                                callback = function() {
                                    ...
                                    if (o) {
                                        ...
                                        if (a) {
                                            ...
                                            domPN(a)
                                                .insertBefore(d, a), re(a)
                                        }
                                    }
                                    VideoUpload.setStatusHeader(getLang("video_upload_encode_waiting"), e), VideoUpload.setProgressValue(100, getLang(
                                        "video_upload_waiting"), e), VideoUpload.runVideoProgressUpdate(e, vars.oid, video_id, video_hash, 1, -1)
                                };
                    ...
                    onUploadProgress: function(e, o, a) {
                        ...
                        if (r) {
                            ...
                            var l = getLang("video_upload_uploaded_percent")
                                .replace("{percent}", i);
                            ...
                            callback = function() {
                                ...
                                if (e) {
                                    var o; - 3 == err ? o = getLang("video_upload_error_file") : -4 == err ? o = getLang("video_upload_error_audio")
                                        .replace("{link}", '<a href="/audio">')
                                        .replace("{/link}", "</a>") : -5 == err ? (o = getLang("video_claimed_not_uploaded"), debug && debug.claim_id && (o +=
                                            " [" + debug.claim_id + "]")) : o = data(e, "max_size_error") ? getLang("video_upload_big_file_error") :
                                        getLang("video_upload_error_common"), VideoUpload.showError(e, o)
                                }
                            };
        ...
        if (cur.videoLastError) {
            cur.videoLastError = !1, show("video_upload_fail_info");
            var errorEl = ge("video_upload_fail_info"),
                current = 60,
                lang = getLang("video_upload_timeout_msg"),
                text = lang.replace("{time}", "1:00");
            val(errorEl, text);
            var intervalId = setInterval(function() {
                if (current--, 0 >= current) clearInterval(intervalId), initButton();
                else {
                    var e = lang.replace("{time}", "0:" + (10 > current ? "0" + current : current));
                    val(errorEl, e)
                }
            }, 1e3)
        } else initButton()
        ...
        if (e && isObject(e)) {
            var a = {
                    ...
                    onUploadComplete: function(e, o) {
                        ...
                        }), d.setAttribute("data-thumb-url", o.thumb.l), d.setAttribute("data-thumb-id", o.photo_id + "_" + o.photo_owner_id), d.setAttribute(
                            "data-thumb-hash", o.photo_hash), VideoUpload.selectThumb(d)
                    },
                    onUploadProgress: function(e, o, a) {
            ...
            onDone: function(s) {
                if (domPN(e) && isVisible("video_upload_tab")) {
                    ...
                    if (s) {
                        ...
                        if (i && s.thumb) {
                            var _ = VideoUpload.getPlaceholderEl(e);
                            _.setAttribute("data-main-thumb", s.thumb), _.getAttribute("data-thumb-id") || setStyle(_, {
                                backgroundImage: "url('" + s.thumb + "')"
                            }), i = ""
                        }
                        t && (s.tc || s.tc_msg) && (VideoUpload.initTC(s.tc, s.tc_msg, e), t = 0);
                        var p = s.duration;
                        if (u = s.percents, "undefined" != typeof p) {
                            if (u >= 100) {
                                if (100 > r) {
                                    if (s.published) VideoUpload.setPublished(e);
                                        ...
                                        setStyle(v, "opacity", 0), setStyle(c, "opacity", 1), VideoUpload.setStatusHeader(getLang(
                                            "video_upload_completed_title"), e)
                                    }
                                    if (i || t) {
                                        var g = i ? 2 : 0;
                                ...
                                var h = intval(u),
                                    m = getLang("video_upload_encode_percent")
                                    .replace("{percent}", h);
                                VideoUpload.setProgressValue(u, m, e, !0)
                            }
                            u >= 100 && !i && !t && (n = !1)
                        } else u = -1
                    }
                    n && setTimeout(VideoUpload.runVideoProgressUpdate.pbind(e, o, a, d, i, t, u, l), 1e3)
                }
            },
            onError: function() {
    ...
    showError: function(e, o, a) {
        ...
        t && val(t, o), toggle(r, !a), toggle(l, !!a), hide(i), show(d), disableButton(geByClass1("video_upload_ready_button", e), !0), disableButton(geByClass1(
            "video_upload_back_edit", e), !0), data(e, "error", !0)
    },
    ...
    saveParams: function(e) {
        ...
        a.oid = i.oid, a.tag = i.tag, a.act = "save_video_params", a.hash = cur.videoHashs[i.tag], a.ocl = cur.ocl ? 1 : void 0, ajax.post("al_video.php", a, {
            onDone: function(d, i, t) {
                ...
                val(n, t || "");
                var u = geByClass1("video_upload_item_name", o);
                val(u, (a.title || getLang("video_upload_no_name"))
                    .substr(0, cur.videoTitleLength));
                var _ = geByClass1("video_upload_description", o);
                val(_, (a.desc || "")
                    .substr(0, cur.videoDescriptionLength)), data(o, "saved", !0), slideUp(r, {
                    duration: 150,
                    transition: Fx.Transitions.swiftOut
                }), slideDown(l, {
                    duration: 150,
    ...
    getParams: function(e) {
        var o = e.id.substr("video_upload_item_".length),
            ...
            u = geByClass1("video_edit_repeat", e),
            _ = 0;
        VideoUpload._uploadAlbumChooser[o] && (_ = VideoUpload._uploadAlbumChooser[o].selectedItems()[0]);
        ...
        return a.oid > 0 ? (g.privacy_video = Privacy.getValue("video" + d), g.privacy_videocomm = Privacy.getValue("videocomm" + d)) : g.privacy_video = isChecked(
            "video_upload_group_privacy"), g
    },
    ...
    resumeUpload: function(e) {
        var o = VideoUpload.getUploadItem(e);
        hide(geByClass1("upload_video_error_panel", o)), show(geByClass1("upload_video_info_panel", o)), disableButton(geByClass1("video_upload_ready_button", o), !1),
            disableButton(geByClass1("video_upload_back_edit", o), !1), data(o, "error", !1);
    ...
    checkChanges: function(e) {
        if (!cur.leaving) {
            ...
            return o ? winToUtf(o.replace(/<\/?b>/g, "")
                .replace(/<br\s*\/?>/g, "\n")) : void 0
        }
    },
    ...
    toExternalAdd: function() {
        ...
        e.setOptions({
            ...
            }), VideoUpload.onHideUploadPanel(), hide("video_upload_box_tab"), show("video_add_from_youtube_tab"), e.removeButtons(), isVisible("video_extra_settings") ||
            isVisible("video_share_not_allowed") || isVisible("video_share_error") ? (e.setOptions({
                hideButtons: 0
            }), e.addButton(getLang("global_save"), cur.saveExternalVideo)) : e.setOptions({
                hideButtons: 1
            }), e.addButton(getLang("global_cancel"), e.hide, "no"), ge("video_external_link")
            .focus()
    },
    ...
    initShare: function(e, o) {
        ...
        var t, r, l, s = function() {
            var e = trim(i.value);
            e && r != e && (d.showProgress(), r = e, ge("video_share_form")
                .submit())
        };
        window.onParseDone = function(e) {
            if (hide("video_share_server_error"), hide("video_share_error"), e.images_proxy) {
                var o = ge("video_share_form")
                    .action.replace(/\/[^\/]*$/, "") + "/upload.php?act=proxy_img&";
                each(e.images_proxy, function(a, d) {
                    e.images_proxy[a] = o + d
                })
            } else e.images_proxy = e.images;
            if (e.extra > 0 && e.extraData && e.images[0]) {
                if (hide("video_share_descr"), hide("video_share_error"), d.hideProgress(), ge("video_share_photo_url")
                    .value = e.url, ge("video_share_photo_image")
                    .value = e.images[0], ge("video_share_photo_extra")
                    .value = e.extra, cur.changeExternalImage = function(o) {
                        ...
                        o.onerror = function() {
                            ...
                            each(e.images_proxy, function(e, d) {
                                if (0 != e) {
                                    var i = vkImage();
                                    i.onload = function() {
                                        o || (o = !0, ge("video_share_photo_image")
                                            .value = d, cur.externalVideoImage = e, setStyle(a, {
                ...
                ge("video_external_title")
                    .value = replaceEntities(e.title), ge("video_external_description")
                    .value = replaceEntities(e.description), cur.videoPlaylists.length ? cur._addExternalAlbumDD = new Dropdown(geByClass1(
                        "video_external_upload_album_chooser_input", curBox()
                        .bodyNode), [
                        [0, getLang("video_upload_choose_album_placeholder")]
                    ].concat(cur.videoPlaylists), {
                        autocomplete: !0,
                        ...
                        selectedItems: [0],
                        big: !0
                    }) : re(geByClass1("video_upload_album_chooser_wrap")), show("video_extra_settings"), l = e, d.removeButtons(), d.addButton(getLang("global_cancel"),
                        d.hide, "no"), cur.saveExternalVideo = function() {
                        e && e.images && (VideoUpload.lockSaveButton(), cur.shareExternalImageSave = e.images[cur.externalVideoImage], ge("video_share_photo_image")
                            .value = cur.shareExternalImageSave, ge("video_share_photo_form")
                            .submit())
                    }, d.setOptions({
                        hideButtons: 0
                    }), d.addButton(getLang("global_save"), cur.saveExternalVideo)
            } else -1 == e.extra ? (show("video_share_not_allowed"), VideoUpload.unlockSaveButton()) : (show("video_share_error"), notaBene("video_external_link"),
                VideoUpload.unlockSaveButton())
            ...
            if (i.photo_id && i.user_id && l) {
                var t = l.title;
                l.title = ge("video_external_title")
                    .value;
                var r = ge("video_external_description")
                    .value,
                    s = 0;
                if (cur.vSection) {
                ...
                var u = extend(l, {
                    ...
                    act: "save_external",
                    hash: o,
                    share_title: t || ge("video_external_title")
                        .value,
                    share_text: r,
                ...
                u.openGraph && delete u.openGraph, delete l.extraData, u.oid > 0 ? (u.privacy_video = Privacy.getValue("video_external"), u.privacy_videocomm = Privacy
                    .getValue("videocomm_external")) : u.gid = -u.oid, isChecked("video_external_status_export") && (u.to_status = 1), isChecked(
                    "video_external_no_comments") && (u.no_comments = 1), delete u.images, delete u.images_proxy, setTimeout(function() {
                    ajax.post("/al_video.php", u, {
                        onDone: function(e) {
                            hide("share_error"), e.owner_id && e.video_id ? (d.hide(), nav.reload()) : show("share_server_error")
                        },
                        onFail: function(e) {
                            return VideoUpload.unlockSaveButton(), hide("video_share_error"), ge("video_share_server_error")
                                .innerHTML = e, show("video_share_server_error"), !0
                        }
                    })
                }, 0)
