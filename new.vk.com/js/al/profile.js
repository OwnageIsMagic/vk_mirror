var Profile = {
        ...
        hideGroups: function(e) {
            if (checkEvent(e) === !1) {
                var i = ge("profile_groups_link");
                return val(i, i.oldText), i.onclick = Profile.showGroups, hide(ge("profile_all_groups")
                    .parentNode), cancelEvent(e)
            }
        },
        photoRemove: function(e, i, o) {
            return cur.viewAsBox ? (cur.viewAsBox(), cancelEvent(o)) : (cur.hidingPh || (cur.hidingPh = {}), cur.hidingPh[i] ? cancelEvent(o) : (ajax.post("al_profile.php", {
                ...
                onDone: function(e, i) {
                    var o = ge("profile_photos_about") || ge("profile_photos_module")
                        .insertBefore(se('<div class="info_msg" id="profile_photos_about"><div class="msg_text"></div></div>'), ge("page_photos_module"));
        ...
        toggleFriend: function(e, i, o, t, s) {
            ...
            ajax.post("al_friends.php", {
                ...
                onDone: function(e, i, t, s, n) {
                    ...
                    var r = (ge("profile_am_subscribed") || {})
                        .tt;
                    r && r.hide && (r.hide({
                        fasthide: 1
                    }), r.destroy());
                ...
                showProgress: function() {
                    "BUTTON" == e.tagName ? lockButton(e) : hasClass(e, "page_actions_item") ? window.Page && Page.actionsDropdownLock(e) : hasClass(domFC(e),
                        "progress") ? show(domFC(e)) : r.replaceChild(n, r.firstChild)
                },
                hideProgress: function() {
                    "BUTTON" == e.tagName ? unlockButton(e) : hasClass(e, "page_actions_item") ? window.Page && Page.actionsDropdownUnlock(e) : hasClass(domFC(e),
                        "progress") ? hide(domFC(e)) : r.replaceChild(r.firstChild, n)
                },
                onFail: function(e) {
        ...
        friendTTHide: function(e) {
            var i = (ge("profile_am_subscribed") || {})
                .tt;
            if (e)
        ...
        frListsDDShow: function(e) {
            ...
            for (var o, t = [], s = cur.frListsCats, n = [28, 29, 27, 25, 26], r = 0; 5 > r; ++r) o = n[r], cur.options.publicLists[o] && t.push(
        ...
        frListsCheck: function(e, i) {
            ...
            o ? t & 1 << i && (t -= 1 << i) : t & 1 << i || (t += 1 << i), cur.frListsCats = t, (o ? removeClass : addClass)(e, "checked"), cur.frListsTO && clearTimeout(cur.frListsTO),
            ...
            ajax.post("al_friends.php", {
                ...
                onDone: function(e) {
                    if (curBox() && curBox()
                        .hide(), e) {
                        var i = ge("preq_text");
                        val(i, e), show(i.parentNode), hide(ge("preq_input")
                            .parentNode)
                    }
                },
            ...
            if (i.lastLen !== o.length) {
                ...
                var t = function(e, i, o) {
                        for (var t = {
                            ...
                            var d = t[e.charAt(a)],
                                l = e.charCodeAt(a);
                            10 == l && ++n, s += void 0 !== d ? d : l > 128 && 192 > l || l > 1280 ? ("&#" + l + ";")
                                .length : 1, r === !1 && (i && s > i || o && n > o) && (r = a ? e.substr(0, a) : "")
                        }
                        return [s, n, r === !1 ? e : r]
                    },
                    s = 240,
                    ...
                    c = r[1],
                    d = ge("preq_warn");
                r[2] !== o && (a > s ? a = s : c > 4 && (c = 4), val(i, r[2]), i.lastLen = trim(r[2])
                    .length), a > s - 40 || c > n ? (a > s ? d.innerHTML = getLang("friends_exceeds_symbol_limit", a - s) : c > 4 ? d.innerHTML = getLang(
        ...
        showHideGiftsBox: function(e) {
            if (cur.viewAsBox) return cur.viewAsBox();
            var i = getLang("profile_sure_hide_gifts")
        ...
        showClassHint: function(e) {
            ...
            if (i) {
                var o = cur.classhint = bodyNode.appendChild(ce("div", {
                        ...
                        innerHTML: '<table cellspacing="0" cellpadding="0">  <tr>    <td rowspan="2"><div class="pointer"></div></td>    <td><div class="content">' + e +
                            '</div></td>  </tr>  <tr><td><div class="bottom"></div></td></tr></table>'
                    }, {
                        display: "none"
                    })),
                    t = getXY(i),
        ...
        init: function(e) {
            extend(cur, {
                ...
                }, 1e3)), (cur._back ? cur._back.hide : cur.destroy)
                .push(function(e) {
                    clearTimeout((e || cur)
                        .clHintTimer), clearTimeout((e || cur)
                        .invHintTimer), Profile.friendTTHide(!0)
        ...
        inviteHintUpdate: function() {
            ...
            if (e && e.tt && e.tt.container) {
                var i = isVisible("ts_wrap") ? ge("ts_settings") : ge("top_invite_link"),
                    o = 0,
                    t = 0;
                vk.rtl ? t = 413 - i.parentNode.parentNode.offsetLeft - i.offsetWidth / 2 + "px" : o = i.parentNode.parentNode.offsetLeft + i.offsetWidth / 2 - 370 + "px",
                    geByClass1("top_pointer", e.tt.container)
                    .style.margin = "0px " + t + " 0px " + o
            }
        },
        ...
        uploadPhotos: function(e, i) {
            var o = (window.XMLHttpRequest || window.XDomainRequest) && (window.FormData || window.FileReader && (window.XMLHttpRequest && XMLHttpRequest.sendAsBinary ||
