var Profile = {
        ...
        toggleFave: function(e, i, o, t) {
            return cur.viewAsBox ? cur.viewAsBox() : (void 0 != cur.toggleFaveAct && (o = cur.toggleFaveAct), ajax.post("fave.php", {
                ...
                onDone: function(i) {
                    e.firstChild.nextSibling.innerHTML = i, cur.toggleFaveAct = !o
                },
                progress: e.firstChild
            }), void cancelEvent(t))
        },
        toggleSubscription: function(e, i, o, t) {
            void 0 != cur.toggleSubscriptionAct && (o = cur.toggleSubscriptionAct), ajax.post("al_wall.php", {
                ...
                onDone: function(i) {
                    e.firstChild.nextSibling.innerHTML = i, cur.toggleSubscriptionAct = !o
                },
                progress: e.firstChild
            }), cancelEvent(t)
        },
            ...
            if (i.lastLen !== o.length) {
                ...
                var t = function(e, i, o) {
                        for (var t = {
                            ...
                            var l = t[e.charAt(a)],
                                d = e.charCodeAt(a);
                            10 == d && ++s, r += void 0 !== l ? l : d > 128 && 192 > d || d > 1280 ? ("&#" + d + ";")
                ...
                n[2] !== o && (a > r ? a = r : c > 4 && (c = 4), val(i, n[2]), i.lastLen = trim(n[2])
                    .length), a > r - 40 || c > s ? (a > r ? l.innerHTML = getLang("friends_exceeds_symbol_limit", a - r) : c > 4 ? l.innerHTML = getLang(
                    "friends_exceeds_lines_limit", c - 4) : l.innerHTML = getLang("text_N_symbols_remain", r - a), show(l)) : hide(l)
            }
        },
        toggleBlacklist: function(e, i, o) {
            return cur.viewAsBox ? cur.viewAsBox() : (ajax.post("al_settings.php", {
                ...
                onDone: function(i) {
                    domNS(domFC(e))
                        .innerHTML = i, cur.options.bannedhim = !cur.options.bannedhim
                },
                progress: domFC(e)
            }), void cancelEvent(o))
        },
        toggleFeedIgnored: function(e, i, o) {
            return cur.viewAsBox ? cur.viewAsBox() : (ajax.post("al_feed.php", {
                ...
                onDone: function(i) {
                    domNS(domFC(e))
                        .innerHTML = i, cur.options.ignoredhim = !cur.options.ignoredhim, Profile.frDropdownClear()
                },
                progress: domFC(e)
            }), void cancelEvent(o))
        },
