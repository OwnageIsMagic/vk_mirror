function initReg(prefix, opts) {
    ...
    extend(cur, {
        ...
        register: function(pref, ignoreBadPwd) {
            ...
            var params = {
                act: 'register',
                first_name: ge(pref + 'fn')
                    .value,
                last_name: ge(pref + 'ln')
                    .value,
                regemail: email,
                regpass: pass,
                sex: intval(ge(pref + 'sex')
                    .value),
