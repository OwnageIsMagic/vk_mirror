...
forum_delete_not_unique_topic_confirm =
    'This question is located in multiple sections. If you remove the question, it will be put away from all those sections. If you want to remove the question from this section only, click the link below:';
...
forum_delete_not_unique_section_confirm =
    'This question is located in multiple sections. If you remove the question, it will be put away from all those sections. If you want to remove the question from this section only, please click the link below:';
