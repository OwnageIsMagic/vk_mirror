...
AdsWeb.showAds = function() {
    ...
    ge('ads_web_widget_result')
        .innerHTML = '';
    ge('ads_web_widget_resize')
        .innerHTML = '';

    var adsCount = intval(ge('ads_web_site_code_ads_ads_count')
        .value);
...
AdsWeb.onAdsReady = function(errorCode) {
    ge('ads_web_widget_result')
        .innerHTML = "onAdsReady(): errorCode = " + errorCode;
}
...
AdsWeb.onAdsResizeWidget = function() {
    ...
    ge('ads_web_widget_resize')
        .innerHTML = 'Widget: ' + widgetWidth + ' x ' + widgetHeight;
}
...
AdsWeb.updateSiteCodeAdsParams = function(paramName, paramValue, paramElem, showError) {
    ...
    try {
        ...
        ge('ads_web_site_code_widget_html')
            .value = widgetHtml;
    } catch (e) {
        debugLog(e);
    }
...
AdsWeb.saveSite = function(editBox, actionParams) {
    ...
    ajaxParams.domain_name = ge('ads_web_site_edit_domain_name')
        .value;
...
AdsWeb.saveTag = function(editBox, actionParams) {
    ...
    var ajaxParams = {};
    ajaxParams = extend({}, ajaxParams, actionParams);
    ajaxParams.tag_name = ge('ads_web_tag_edit_tag_name')
        .value;
...
AdsWeb.saveAdmin = function(editBox, actionParams) {
    ...
    var ajaxParams = {};
    ajaxParams = extend({}, ajaxParams, actionParams);
    ajaxParams.admin_link = ge('ads_web_admin_edit_admin_link')
        .value;
...
AdsWeb.initDomainSpecialEdit = function(editBox, actionParams, domainSpecialType) {
    ...
    window.radioBtns['ads_domain_special_type'] = {
        ...
        els: Array.prototype.slice.apply(geByClass('radiobtn', ge('ads_web_domain_special_wrap')))
    };
